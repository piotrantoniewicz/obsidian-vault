...
type: "Web"
authors: "[[Audrey Tang]]"
url: "https://au.civic.ai/p/mission-not-race"
...
*These are my remarks from **“ [State of Wikimedia & AI 2026: Freedom, Equity, Reliability at a Crossroad](https://www.youtube.com/watch?v=EQ4dNEOlAlY&t=7020s),”** a panel at Wikimania 2026 in Paris, on Friday 24 July 2026, 11:00–11:55 CEST, in the Est Room. I took part remotely. Questions are paraphrased in italics, and my [transcribed answers](https://archive.tw/2026-07-24-state-of-wikimedia-and-ai-panel) are lightly edited for readability.*

![](https://substackcdn.com/image/fetch/$s_!xWwD!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F89ac0c2d-2be5-434b-b464-e4fe5cfcce7b_1672x941.png)
...
I call it a **Kami** — knowledge artefact management intelligence. It’s a new word, a kind of backronym, from knowledge management, KM, and artificial intelligence, AI. Put the two together and you get Kami.
...
I also hear the question still hanging in the air: AI is a political project. Is the only work worth funding making AI more capable? Or is it to make it obey? Some call that alignment. But I don’t think so. I think there is another side of alignment. Some of us call it **reverse alignment** — you can find it at [reversealignment.ai](https://reversealignment.ai/). It is about redesigning our institutions and norms and skills so that society can absorb AI safely, and also share its gains.
...
And the Wikipedia movement is already that, in the image of the commons. If we can extend that into the age of AI, so that extractive versions are outcompeted by the demo of provenance and verification and contestability — that is my hope for 2030: that every answer shows its sources.
