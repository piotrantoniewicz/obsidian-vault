...
tags:
  ...
  - narzędzia-AI
---
# Jeden standard, który zmieni wszystko (i 1,5 etatu oszczędności)

[[MCP]] (Model Context Protocol) trafił pod parasol [[Linux Foundation]], a [[Anthropic]], [[OpenAI]], [[Google]] i Microsoft zjednoczyły się wokół jednego standardu integracji AI — analogia do USB: budujesz integrację raz, działa wszędzie, ponad 10 000 publicznych serwerów już działa z [[ChatGPT]], Cursor i Gemini. Woliński prezentuje case wdrożenia automatyzacji dla działu sprzedaży B2B: 2 dni warsztatów przyniosły oszczędność ~1,5 etatu rocznie (kilkadziesiąt tys. PLN) — kluczem było poprzedzające mapowanie procesów, nie samo narzędzie. [[n8n]] 2.0 z separacją Save/Publish eliminuje główną barierę adopcji w środowiskach produkcyjnych.
