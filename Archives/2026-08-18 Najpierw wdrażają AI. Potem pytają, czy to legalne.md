...
Francuski organ ochrony danych CNIL – który chyba najbardziej konkretnie podszedł do tego problemu – [==zaleca przeprowadzenie analizy ryzyka oraz ustalenie zasad zarządzania jeszcze przed wdrożeniem generatywnej AI==](https://www.cnil.fr/en/cnils-qa-use-generative-ai-systems). Organizacja powinna określić swoją rolę i rolę dostawcy, sprawdzić warunki przekazywania danych oraz ustalić, kto odpowiada za poszczególne operacje. W przypadku usług działających w chmurze zakres odpowiedzialności i dostęp do danych powinny wynikać z umowy, nie z domysłów użytkownika.
...
W sierpniu UODO opublikował [cztery zestawy pytań, które organizacje powinny zadać przed wdrożeniem AI](https://uodo.gov.pl/pl/138/4533). Oddzielne wersje przygotowano dla małych i średnich przedsiębiorstw, sektora publicznego oraz pozostałych podmiotów. Powstała również wersja rozszerzona, uwzględniająca między innymi klasyfikację ryzyka na podstawie AI Act i ocenę wpływu na prawa podstawowe.
