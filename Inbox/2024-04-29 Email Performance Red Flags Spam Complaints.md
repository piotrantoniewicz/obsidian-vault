...
![spam complaints](https://www.socketlabs.com/wp-content/uploads/2024/04/Red-Flag-Spam-Complaints.png)
...
We’re going to collaborate with the brightest and most knowledgeable minds in the email community to help you hone your red flag detection skills. We’ll bring expert opinions, anecdotes, and guidance on multiple topics over the next few months, including [unsubscribes](https://www.socketlabs.com/blog/email-performance-red-flags-high-unsubscribe-rate/), [open](https://www.socketlabs.com/blog/email-performance-red-flags-low-open-rates/) and click rates, blocklistings, and much, much more.
...
Soon you’ll see quotes and opinions from three well-regarded email experts in our community: [Alison Gootee](https://www.linkedin.com/in/alisongootee/), [Marcus Biel](https://www.linkedin.com/in/marcus-biel-139a47245/), and [Will Boyd.](https://www.linkedin.com/in/wbboyd/)

Alison Gootee is the compliance and deliverability enablement principal II at [Braze](https://www.braze.com/), where she’s spent five years mastering all things email. Before Braze, she was in compliance at Campaign Monitor (Emma) for more than two years, and before that, she was advising at MailChimp. This year marks 10 years in email for Alison! Fun fact: she’s also the email meme queen of LinkedIn. There are too many good ones to share, so just [go take a look for yourself](https://www.linkedin.com/in/alisongootee/). You will not be disappointed.

Marcus Biel is the founder at [Maildroppa](https://maildroppa.com/), a GDPR-compliant email-marketing-app he’s been building with German-engineered precision for the past 3+ years. When he’s not building tools to enable bootstrappers and single-founders to grow their businesses, he’s changing diapers, drinking coffee, and keeping his wife happy…not necessarily in that order.

Will Boyd is currently the director of deliverability services at [Simon Data](https://www.simondata.com/). Previously he spent more than four years doing deliverability and email consulting at SendGrid, and more than five years at Campaign Monitor (now Emma), making him more than a decade-deep into email. And it shows! Here’s an example from our [Email in 2025 series](https://www.socketlabs.com/blog/what-is-the-future-of-email-in-2025/).
...
Generally speaking, you could go by [what Google considers “high”](https://support.google.com/a/answer/81126?visit_id=638481862165907009-4257318505&rd=1) and avoid ever going any higher than 0.1%. If you surpass a 0.3% rate, you could find your mail blocked by Google.
...
You’ll also want to continuously clean your lists. Remove unengaged parts of your [email audience](https://www.socketlabs.com/blog/your-audience-and-your-email-performance-the-musical/), be diligent about how you handle hard bounces, and make sure you’re letting your audience be your guide. Remember, just because you don’t think your email is “spam” doesn’t mean your recipients agree with your assessment.
...
You should always, always be looking at your email performance data. Most ESPs report on your spam complaint rate using [feedback loop](https://help.socketlabs.com/docs/feedback-loops) (FBL) data provided by Yahoo, Hotmail, and many other mailbox providers. This can be helpful in seeing recipient-level spam complaint data to determine which emails are generating the most complaints.

Though Google provides aggregate data instead of a traditional FBL, if you know you have lots of Gmail domains on your list, you can refer to their [FBL](https://support.google.com/a/answer/6254652?hl=en) to see if complaints are piling up there. You’ll also want to monitor your spam rate through [Google Postmaster Tools](https://www.socketlabs.com/blog/google-postmaster-tools/).
...
![spam complaints report](https://www.socketlabs.com/wp-content/uploads/2024/04/Screenshot-2024-04-25-at-10.00.32%E2%80%AFAM.png)
...
Ultimately, looking at your overall performance can paint a complete picture. We encourage our senders to use their [StreamScore](https://www.socketlabs.com/hub/streamscore/) as a starting point for investigations since it incorporates 26+ data points including your delivery and engagement stats, plus 3rd-party data points like postmaster and spam trap data feeds, bounce responses, seed testing, and more. As you can see in the example below, you would very quickly see your Engagement score and overall Streamscore drop quite a bit if you sent to a new (ahem, not so great) list and your complaint rate spiked. This would be your indicator to jump into your sending statistics to [start diagnosing the problem](https://www.socketlabs.com/hub/spotlight-diagnostics/).

![A view of the guided insights available through SocketLabs Streamscore.](https://www.socketlabs.com/wp-content/uploads/2024/05/Screenshot-2024-04-25-at-10.00.40%E2%80%AFAM.png)
...
We love our StreamScore in [these situations](https://www.socketlabs.com/blog/resurrecting-performance-how-streamscore-detected-and-protected-a-sender-from-disaster/)!
...
Ultimately, the best thing to do when you notice an issue with spam complaints is to breathe, run through your checklist to collect some *facts,* and then determine what your next steps should be — if there are any! It’s always possible that high spam rate (or low spam rate) you saw in your ESP stats or in Google Postmaster tools is a false positive; these are particularly common when using deliverability monitoring tools since they typically make use of third party data points like seed and panel data, spam trap feeds and blocklist monitors in place of your first-party email data (e.g. deliveries, opens, clicks, unsubs, complaints). Relying upon reality-based metrics such as your [ESP statistics](https://www.socketlabs.com/hub/sending-overview/) and other sender health metrics like [Streamscore](https://www.socketlabs.com/hub/streamscore/) is going to save you a lot of time and frustration.
...
We won’t stop here. Next time, we’ll help you spot another nefarious email red flag… [unsubscribes](https://www.socketlabs.com/blog/email-performance-red-flags-high-unsubscribe-rate/). But wait, don’t jump to conclusions! Unsubscribes can be a good sign, too. So, we’ll walk you through what makes them a sign of danger, how to figure out if you should be concerned, and what to do next in each circumstance.

If you need some more help with an email performance issue — spam complaint or otherwise — let us know and we’ll set up a [free consultation](https://www.socketlabs.com/contact/). We can help you make sense of what you’re seeing and plan your next steps.

Until next time!

1. [Email Performance Red Flags: Spam Complaints](#elementor-toc__heading-anchor-0)
2. [Today’s Red Flags: SPAM COMPLAINT RATES](#elementor-toc__heading-anchor-1)
	1. [But First, Our Experts](#elementor-toc__heading-anchor-2)
3. [Red Flag 1: High Spam Complaint Rate](#elementor-toc__heading-anchor-3)
	1. [What Can Be Considered “High?”](#elementor-toc__heading-anchor-4)
		2. [What Causes High Spam Rates?](#elementor-toc__heading-anchor-5)
		3. [How Do You Catch A High Spam Rate?](#elementor-toc__heading-anchor-6)
4. [Red Flag 2: Low Spam Complaint Rate](#elementor-toc__heading-anchor-7)
	1. [Signs Your Low Spam Rate is NOT a Problem](#elementor-toc__heading-anchor-8)
		2. [Signs Your Low Spam Rate is a Problem](#elementor-toc__heading-anchor-9)
		3. [The Impact of a Problematic Low Spam Complaint Rate](#elementor-toc__heading-anchor-10)
5. [Managing Spam Complaint Rates](#elementor-toc__heading-anchor-11)
	1. [Investigating an Issue](#elementor-toc__heading-anchor-12)
		2. [Resolving Your Spam Complaint Issue](#elementor-toc__heading-anchor-13)
6. [The More You Know…](#elementor-toc__heading-anchor-14)
7. [Related Posts](#elementor-toc__heading-anchor-15)
