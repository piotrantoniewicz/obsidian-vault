...
![Czym jest Personal Knowledge Management?](https://sektor3-0.pl/wp-content/uploads/elementor/thumbs/blog-sektor30personal-kno-qdy6s970bidi7cmsqxcnpc7rbjws0hsrnspess3912.jpg "blog-sektor30personal-kno")

A gdyby tak skonstruować system, w którym zbierane są tylko sprawdzone informacje, które są dla nas ważne, ciekawe i inspirujące, pobudzają naszą kreatywność i pozwalają wpadać na nowe pomysły? Tak, jest to możliwe – proszę Państwa, przed Państwem: Personal Knowledge Management (PKM)!

A gdyby tak skonstruować system, w którym zbierane są tylko sprawdzone informacje, które są dla nas ważne, ciekawe i inspirujące, pobudzają naszą kreatywność i pozwalają wpadać na nowe pomysły? Tak, jest to możliwe – proszę Państwa, przed Państwem: Personal Knowledge Management (PKM)!

Wyobraź sobie, że jesteś na spotkaniu i podczas rozmowy dowiadujesz się czegoś ciekawego na interesujący cię temat. Wyciągasz telefon, robisz notatkę. Notatka trafia do twojego Systemu Zarządzania Wiedzą. Masz już tam inną notatkę związaną z tym tematem, więc linkujesz ze sobą obie notatki. Kiedy za jakiś czas zajrzysz do swojego systemu, może się wtedy okazać, że niespodziewanie uda ci się „połączyć kropki” – że informacja z notatki zrobionej na spotkaniu była brakującym elementem, dzięki któremu udało ci się umiejętnie połączyć fakty, wyciągnąć wnioski i wpaść na super pomysł. Tak właśnie działa **Personal Knowledge Management (PKM)** – **osobisty system, który ułatwia zarządzanie wiedzą**.

![](https://www.youtube.com/watch?v=YWkCmR3KkLs)

## Personal Knowledge Management (PKM) – co to takiego?

**[Personal Knowledge Management](https://en.wikipedia.org/wiki/Personal_knowledge_management)** (**osobiste zarządzanie wiedzą**, w skrócie: **PKM**) to termin używany do określenia różnorodnych procesów służących do:  
...
![Czym jest Personal Knowledge Management (PKM)?](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201024%201024'%3E%3C/svg%3E)
...
- Systemów szufladek z indeksowanymi karteczkami – [Zettelkasten](https://pwlk.pl/zettelkasten/)
- Aplikacji do przechowywania notatek, np. [Evernote](https://evernote.com/intl/pl).
- Osobistych wiki,

Czy bardziej zaawansowanych systemów wykorzystujących oprogramowanie typu [Obsidian](https://obsidian.md/) czy [Roam Research](https://roamresearch.com/), umożliwiające nie tylko kategoryzowanie i tagowanie notatek, ale także ich dwustronne linkowanie i graficzną wizualizację połączeń.
...
## Zarządzanie wiedzą na sterydach. Czym PKM różni się od notatnika?
...
[![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201024%20512'%3E%3C/svg%3E)](https://sektor3-0.pl/wp-content/uploads/2021/10/Copy-of-blog-sektor30-facebook-1100x1100-2.png)

##### Piramida DIKW | Źródło: https://blog.stratasan.com/data-driven-decisions-dikw-pyramid

Dlaczego przekuwanie informacji w wiedzę jest tak istotne? Ponieważ każdego dnia dociera do nas bardzo wiele informacji – tak wiele, że często nie jesteśmy w stanie ich „skonsumować”: zatrzymać się, przemyśleć, ocenić ich rzetelność i wartość. Poprzez zjawiska takie jako FOMO (Fear Of Missing Out – lęk przed pominięciem) możemy mieć do czynienia ze zjawiskiem [przeciążenia informacją](https://pl.wikipedia.org/wiki/Przeci%C4%85%C5%BCenie_informacj%C4%85) (ang. *information overload*), czyli z sytuacją, w której z powodu nadmiaru informacji mamy trudność w podjęciu decyzji lub wyłuskaniu sensu danego tematu. Docierają do nas pojedyncze informacje, ale nie mamy czasu i narzędzi, aby w porę je połączyć.

Jak zauważa [Rob Lambert](https://www.linkedin.com/pulse/how-build-personal-knowledge-management-system-pkm-rob-lambert):
...
## Jak działa Personal Knowledge Management (PKM)?
...
![Piramida DIKW Personal knowledge management zarządzanie wiedzą](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201024%20573'%3E%3C/svg%3E)

##### Rys. www.buildingasecondbrain.com

## Personal Knowledge Management (PKM) na blogu Sektor 3.0

Tym tekstem rozpoczynamy na blogu cykl materiałów, z których dowiecie się więcej m.in. nt. budowania własnego **systemu zarządzania wiedzą**, nauczycie przygotowywać dobre i pomocne notatki i poznacie **przykłady zastosowań Personal Knowledge Management (PKM) w codziennej nauce i pracy**. By nie przegapić kolejnych artukułów, warto zapisać się do naszego newslettera.
