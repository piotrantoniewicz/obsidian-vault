...
![Zarządzanie wiedzą w NGO- Jak zamienić rozmowy na czacie w systematyczny rozwój zespołu blog](https://sektor3-0.pl/wp-content/uploads/elementor/thumbs/Zarzadzanie-wiedza-w-NGO-Jak-zamienic-rozmowy-na-czacie-w-systematyczny-rozwoj-zespolu-blog-rk928hirhujepm9pn04smlbhscpj23l87rlfk845fa.png "Zarządzanie wiedzą w NGO- Jak zamienić rozmowy na czacie w systematyczny rozwój zespołu blog")
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20640%20360'%3E%3C/svg%3E) Dlatego pierwszym krokiem w przekuwaniu czatu w narzędzie wspierające systematyczny rozwój zespołu powinno być wspólne zastanowienie się w zespole, jakie treści z czatu mają stać się częścią systemu wiedzy – czyli jakie warto zachowywać na dłużej. Mogą to być na przykład:
...
- [współdzielony dokument](https://sektor3-0.pl/blog/google-docs-jak-lepiej-wykorzystywac-dokumenty-google-w-ngo/) typu „najczęściej zadawane pytania”, podzielony na sekcje (np. fundraising, projekty, procedury, jak załatwić) lub folder.
- prosta strona lub notatka typu wiki (np. [w Notion](https://sektor3-0.pl/blog/notion-jeden-notatnik-by-rzadzic-wszystkimi/)), gdzie każde pytanie ma swoją stronę z odpowiedzią,
- tablica w narzędziu do [zarządzania projektami](https://publicystyka.ngo.pl/lista-zadan-od-google-minimalistyczne-zarzadzanie-zadaniami-tau) (np. Kanban „Baza wiedzy”: Pytania / Odpowiedzi / Do aktualizacji).
...
Dowiedz się więcej nt. tego, [jak uporządkować dane w NGO, aby ułatwić zarządzanie i pracę zespołową](https://sektor3-0.pl/blog/jak-uporzadkowac-dane-w-ngo-aby-ulatwic-zarzadzanie-i-prace-zespolowa/).
...
Informacje „wyłowione” z czatu mają służyć jako wiedza, więc zachowując je w bazie wiedzy, warto poddać je odpowiedniej „obróbce”. Notatki typu pytanie-odpowiedź powinny być pisane [prostym, „ludzkim” językiem](https://sektor3-0.pl/blog/prosty-jezyk-czyli-jak-pisac-w-zrozumialy-sposob/):
...
**Więcej praktycznych wskazówek i informacji nt. tworzenia systemu zarządzania wiedzą w organizacji, znajdziesz w [moim kursie e-learningowym](https://elearning.sektor3-0.pl/obszary/system-zarzadzania-wiedza-w-organizacji/). [![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201100%201100'%3E%3C/svg%3E)](https://elearning.sektor3-0.pl/obszary/system-zarzadzania-wiedza-w-organizacji/)** 
