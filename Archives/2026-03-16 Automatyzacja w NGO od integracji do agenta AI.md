...
![Automatyzacja w NGO- od integracji do agenta AI - Michał Nikrasz](https://sektor3-0.pl/wp-content/uploads/elementor/thumbs/Automatyzacja-w-NGO-od-integracji-do-agenta-AI-Michal-Nikrasz-rklazbjj0d1e14t3h12to5gwf93r8gtjdawmks7aeu.jpg "Automatyzacja w NGO- od integracji do agenta AI – Michał Nikrasz")
...
**Jeśli chcesz nauczyć się tego narzędzia krok po kroku, przeczytaj tekst Marzeny Kacprowicz:** [**Airtable: przyjazna baza danych z funkcją formularzy online i automatyzacji**](https://sektor3-0.pl/wideo/airtable-narzedzie-do-zarzadzania-bazami-danych-automatyzacji/)
...
Dla organizacji mieszczących się w darmowym limicie (a większość się zmieści) to bezpłatne rozwiązanie. Dla tych, którym go zabraknie – [Airtable ma program dla NGO-sów](https://blog.airtable.com/how-to-use-airtable-to-support-your-nonprofit-work/).

## Claude Cowork i Projects – kiedy asystent zna kontekst Twojej organizacji

Na sali dominowali użytkownicy i użytkowniczki ChatGPT. Michał Niekrasz zachęcał podczas swojego wystąpienia, by przyjrzeć się bliżej [Claude](https://claude.com/) ’owi – szczególnie w kontekście pracy w organizacjach pozarządowych. Dlaczego? Oto dwa powody, które padły wprost z ust prowadzącego:
...
![Michał Niekrasz podczas Śniadania z AI | AUTOMATYZACJA: Jak wybrać między asystentem a agentem AI? (12.03.2026 r., Wrzenie Świata, Warszawa). Fot. Karolina Szczepocka](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%202048%201418'%3E%3C/svg%3E)
...
- [Recykling treści. Jak zautomatyzować tworzenie transkrypcji, postów do social mediów i wpisów na bloga?](https://sektor3-0.pl/blog/recykling-tresci-jak-zautomatyzowac-tworzenie-transkrypcji/)
...
[Fireflies](https://fireflies.ai/) to narzędzie, które dołącza do każdego spotkania online, nagrywa, transkrybuje i wysyła podsumowanie. Michał Niekrasz zaproponował uczestnikom i uczestniczkom gotową automatyzację w Make, która robi jeszcze więcej:
...
Automatyzowanie tworzenia notatek z pomocą AI ma też swoje minusy, głównie związane z rezygnacją z wykorzystania naszych własnych mózgów. Warto o tym pamiętać, a więcej poczytać można o tym w artykule Agnieszki Goncerzewicz pt. [Notatka z AI: asystent uczenia czy substytut myślenia](https://epale.ec.europa.eu/pl/blog/notatka-z-ai-asystent-uczenia-czy-substytut-myslenia)?

![Uczestniczki i uczestnicy podczas Śniadania z AI | AUTOMATYZACJA: Jak wybrać między asystentem a agentem AI? (12.03.2026 r., Wrzenie Świata, Warszawa). Fot. Karolina Szczepocka](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%202048%201418'%3E%3C/svg%3E)
...
![Co warto zapamiętać? Jeden ze slajdów prezentacji Michała Niekrasza.](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201660%20930'%3E%3C/svg%3E)

Co warto zapamiętać? Jeden ze slajdów prezentacji Michała Niekrasza.

**Jeśli chcesz dołączyć do nas podczas kolejnych spotkań z serii [Śniadanie z AI](https://sektor3-0.pl/sniadania-z-ai/), śledź kanały Sektor 3.0 i zapisz się do naszego** [**newslettera**](https://sektor3-0.pl/zapisz-sie-do-newslettera/)**.**
...
- [Automatyzacja zadań w NGO, czyli jak odzyskać czas na to, co naprawdę ważne?](https://sektor3-0.pl/podcast/automatyzacja-zadan-w-ngo-czyli-jak-odzyskac-czas-na-to-co-naprawde-wazne/)
- [No-code jest jak budownictwo modułowe. Łatwe i elastyczne.](https://sektor3-0.pl/podcast/no-code-jest-jak-budownictwo-modulowe-latwe-i-elastyczne/)
- [I znowu od początku! Serio? Dlaczego warto świadomie zarządzać procesami w NGO?](https://publicystyka.ngo.pl/i-znowu-od-poczatku-serio-dlaczego-warto-swiadomie-zarzadzac-procesami-w-ngo-tau)
