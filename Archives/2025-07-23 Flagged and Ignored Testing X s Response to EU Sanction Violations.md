---
type: Web
authors: '[[Saman Nazari]]'
url: 'https://alliance4europe.eu/flagged-and-ignored'
...
\[dsm\_breadcrumbs home\_text=" " home\_icon="||divi||400" separator\_icon="5||divi||400" admin\_label="Supreme Breadcrumbs" \_builder\_version="4.17.1" \_module\_preset="default" home\_icon\_font\_size="18px" separators\_font\_size="18px" global\_colors\_info="{}" theme\_builder\_area="et\_body\_layout"\]\[/dsm\_breadcrumbs\]

**Authors:**

Charles Terroille, [Science Feedback](https://science.feedback.org/).

Saman Nazari, Alliance4Europe.

Ewan Casandjian, Alliance4Europe.

Commissioned by [WeMove Europe.](https://wemove.eu/en)

Alliance4Europe’s participation was made possible through funding from the Polish Ministry of Foreign [Affairs](https://alliance4europe.eu/project/information-defence-alliance).
...
Under the current EU sanctions regime against Russia, Russian state media outlets and affiliated figures are banned from broadcasting their content within the European Union. This measure serves to safeguard the EU’s information environment from Russian Government-affiliated actors who actively spread disinformation and conduct information manipulation, especially in the context of Russia’s full-scale invasion of Ukraine. Such sanctioned actors are [explicitly prohibited](https://finance.ec.europa.eu/document/download/99b8682b-4f41-4d78-9756-7087d0a93965_en?filename=faqs-sanctions-russia-media_en.pdf) from making such content accessible to people in the EU via any platform.
...
Despite this, X (formerly Twitter) continues to violate these rules, as numerous [reports and investigations](https://science.feedback.org/sanctioned-but-thriving-how-online-platforms-fail-to-address-the-widespread-presence-of-entities-under-eu-sanctions/) have already shown. This report follows up on [our](https://alliance4europe.eu/banned-yet-broadcasting) [previous](https://alliance4europe.eu/doppelganger-poland-elections) [reports](https://science.feedback.org/european-union-sanctioned-russian-media-entities-and-individuals-accessible-on-x/) to systematically evaluate X’s EU-mandated illegal content reporting system.
...
![](https://alliance4europe.eu/wp-content/uploads/2025/07/sputnik-africa.png "sputnik africa")

Image 1: Screenshot showing the button in a post’s menu on X used to initiate a report.

Disseminating content from sanctioned Russian state media, particularly for commercial gain, has already triggered criminal investigations. In Germany, for instance, a couple is [facing prosecution](https://www.worldecr.com/news/german-authorities-arrest-couple-for-illegal-streaming-of-russian-tv-channels/) and up to one year in prison for operating a paid service that gave users digital access to several banned Russian TV channels.

![](https://alliance4europe.eu/wp-content/uploads/2025/07/MFA-op-ukraine.png "MFA op ukraine")

Image 2: Screenshot of a [post](https://archive.ph/Cji8k) by the official Russian Ministry of Foreign Affairs account on X, sharing an excerpt from a documentary produced by state broadcaster RT and providing a link to bypass sanctions and access the full film on Telegram.
...
![](https://alliance4europe.eu/wp-content/uploads/2025/07/image.png "image")

Image 3: Screenshot of a [post](https://archive.is/tsO8g) by the official X account of Margarita Simonyan, RT Editor-in-Chief and listed under EU sanctions list, sharing an excerpt from a video produced by state broadcaster RT and providing a link to bypass sanctions and access the full film on Telegram.
...
![](https://alliance4europe.eu/wp-content/uploads/2025/07/Pie-Chart-Outcomes-Reporting.png "Pie Chart Outcomes Reporting")

Figure 1: Distribution of platform responses to 125 user-flagged illegal posts. While one flagged content was removed, the majority either received no acknowledgement or was not acted upon despite receiving a response.

### The Social Design Agency and Doppelgänger

The long-running Russian influence operation “ [Doppelgänger](https://alliance4europe.eu/russian-influence-doppelganger-june-x-meta) ” is run by the Social Design Agency (SDA). The SDA is listed under the EU sanctions regime targeting Russian entities taking actions undermining or threatening the territorial integrity, sovereignty and independence of Ukraine (Council Regulation (EU) No 269/2014).
...
It also bears mentioning that the specificities of the sharing patterns deployed by the Doppelgänger operation were provided to [X in September 2024](https://alliance4europe.eu/russian-influence-doppelganger-june-x-meta), which should have allowed X to stop the operation from functioning, as was the case with [Bluesky, which did take effective action when provided with the same information.](https://alliance4europe.eu/doppelganger-bluesky)

### Transparency GapsX does not provide detailed feedback to users on reports related to sanctions violations. All responses were generic, lacking any indication of whether human review took place or whether the post was checked against official sanctions lists.Strangely, the platform’s reporting mechanism does include a dedicated section on EU law enforcement, stating that “this form enables an individual or an entity to notify us about content that is illegal under EU law or under the national law of an EU member state, in compliance with Union law.” However, there appears to be no corresponding follow-up process specifically aligned with EU legal requirements.The process of reporting illegal content on X is also cumbersome and makes it impossible to report issues at the scale at which they appear on the platform, only allowing users to report content from one account at a time. X also blocks users from being able to report multiple posts within a short period, re-directing them away from the reporting page after reporting around 5-10 posts. On the other hand, it is only possible to report a post from one account at a time.. Furthermore, the CAPTCHA put in place is also time-consuming. Lastly, when reporting larger numbers of posts, you don’t always get a confirmation of receipt from X, which is an obligation under the DSA. In short, X claims to offer a way to report illegal content under EU law, but there is no evidence that it follows up in a manner consistent with its legal obligations.

### Conclusion: A Weak Link in Countering Systematic Risks and Disinformation
...
Alliance4Europe is a proud member of the FIMI ISAC.

![](https://alliance4europe.eu/wp-content/uploads/2025/10/logo-1.png "logo (1)")
...
![](https://alliance4europe.eu/wp-content/uploads/2025/01/the-colors-of-the-Republic-of-Poland-and-the-image-of-the-Coat-of-Arms-of-the-Republic-of-Poland.jpg)
