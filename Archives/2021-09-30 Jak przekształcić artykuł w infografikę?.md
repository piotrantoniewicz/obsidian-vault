...
![pexels-rodnae-productions-7948070](https://sektor3-0.pl/wp-content/uploads/elementor/thumbs/pexels-rodnae-productions-7948070-pdtldjg53j4y8e53uplyi8kjfzf22kwd7cmfrolaie.jpeg "pexels-rodnae-productions-7948070")
...
Jednym ze sposobów, który to ułatwia jest udostępnianie informacji w przystępny sposób. Może to być tworzenie infografik ilustrujących wyniki badań, skomplikowane zagadnienia czy procesy. **[W serwisach społecznościowych infografiki są „lubiane” i udostępniane 3 razy częściej](http://blog.hubspot.com/marketing/visual-content-marketing-strategy)** niż inne rodzaje treści.

Laurence Dessart zamieściła wpis na blogu zatytułowany: „ [Od artykułu do obrazu: tworzenie infografiki na podstawie badań](https://www.jmmnews.com/paper-picture-creating-infographic-research/) ”, w którym opisuje swoje doświadczenia związane z tworzeniem infografiki na podstawie artykułu w czasopiśmie JMM pod tytułem [Uchwycenie zaangażowania konsumenta: dwoistość, wymiarowość i pomiar](http://www.tandfonline.com/doi/full/10.1080/0267257X.2015.1130738) (stworzonego we współpracy z Cleopatrą Veloutsou i Anną Morgan-Thomas).
...
- Jeśli używasz narzędzia online do tworzenia infografik, mogą one zawierać obrazy stockowe. Inne źródła obejmują np. [istock,](http://www.istockphoto.com/) [shutterstock](https://www.shutterstock.com/). Upewnij się, że posiadasz niezbędne [pozwolenie](https://visme.co/blog/copyright-images/) na wykorzystanie zdjęć.
...
Więcej informacji na temat kolorów można znaleźć w artykule „ [Podstawy teorii kolorów. Jak wybrać właściwe kolory dla swoich projektów](http://blog.hubspot.com/marketing/color-theory-design) ”.  
...
Jeżeli obraz zostanie przycięty w celu wyświetlenia w mediach społecznościowych, która część obrazu będzie widoczna? Media społecznościowe często zmieniają optymalne rozmiary obrazów, więc sprawdź to, zanim zaczniesz. [Zawsze sprawdzaj aktualny przewodnik po rozmiarach grafik w mediach społecznościowych](http://sproutsocial.com/insights/social-media-image-sizes-guide/) (np. na [Socialsprout](https://sproutsocial.com/insights/social-media-image-sizes-guide/)).
...
Jeśli publikujesz na własnej stronie, pamiętaj o dołączeniu [metadanych](https://support.google.com/webmasters/answer/114016?hl=en) i umożliwieniu udostępniania na portalach społecznościowych lub udostępnieniu kodu osadzania. Więcej informacji na temat kodów osadzania możesz znaleźć [tutaj](http://blogpros.com/blog/2016/07/add-embed-code-infographic), a generatory kodów osadzania są dostępne w internecie, np. na stronie [http://www.siegemedia.com/embed-code-generator](http://www.siegemedia.com/embed-code-generator).
...
- Stones i Gent (2015) zidentyfikowali [7 zasad, które nazwali: GRAPHIC – przydatny zestaw opartych na dowodach wytycznych](https://visualisinghealth.com/design-guidelines/) do tworzenia infografik dotyczących zdrowia.
- [Najlepszy przewodnik po projektowaniu infografik: 13 sztuczek, które sprawią, że twoje projekty będą lepsze](https://venngage.com/blog/infographic-design/).
- [Jak robią to projektanci: 15 prostych kroków do zaprojektowania infografiki od podstaw](https://www.canva.com/learn/create-infographics/).
- Joanna C. Dunlap & Patrick R. Lowenthal (2016) Getting graphic about infographics: design lessons learned from popular infographics, Journal of Visual Literacy, 35:1, 42-59, [https://doi.org/10.1080/1051144X.2016.1205832](https://doi.org/10.1080/1051144X.2016.1205832)

**Inspiracje:**

- [100 najlepszych infografik](http://www.siegemedia.com/creation/best-infographics)
- [BMJ posiada wiele infografik z artykułów](https://www.bmj.com/infographics) na swojej stronie internetowej.
- [Strona ylmsportscience autorstwa Yann Le Meur](https://ylmsportscience.com/infographics/) zawiera wiele przykładów infografik utworzonych na podstawie artykułów naukowych z dziedziny nauk o sporcie.
...
Oryginalny tekst pochodzi z internetowego czasopisma [Journal of Marketing Management](https://www.jmmnews.com/how-to-turn-journal-article-into-infographic/), został przetłumaczony z języka angielskiego. Oryginał dostępny na zasadach licencji [Creative Commons Uznanie Autorstwa (CC BY) 4.0 wersja międzynarodowa.](https://creativecommons.org/licenses/by/4.0/deed.en)

## Przeczytaj także

- [**Jak stworzyć angażujący podcast – rozmowa z Ewą (Dziardziel) Dunal z Sounds and Stories**](https://sektor3-0.pl/blog/jak-stworzyc-angazujacy-podcast-rozmowa-z-ewa-dziardziel-dunal-z-sounds-and-stories/)
