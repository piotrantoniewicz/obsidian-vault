...
![windows-SwHvzwEzCfA-unsplash](https://sektor3-0.pl/wp-content/uploads/elementor/thumbs/windows-SwHvzwEzCfA-unsplash-qdy5zj8jhr23gacogif1il4pvph0tfs11n3aweob5i.jpeg "windows-SwHvzwEzCfA-unsplash")
...
Sprawność w komunikacji dominuje na listach kompetencji potrzebnych zarówno dziś, jak i w przyszłości. Nie jest to jedynie zestaw umiejętności językowych oraz interpersonalnych, ale również zdolność dobierania odpowiednich kanałów i narzędzi oraz przewidywanie, jak sprawnie dotrzeć do naszych odbiorców w różnych sytuacjach. Od [pracy zdalnej](https://sektor3-0.pl/blog/category/wszystko/praca-zdalna/) przez wdrażanie nowych pracowników aż po budowanie wspólnej bazy wiedzy, komunikacja asynchroniczna staje się coraz ważniejsza i zastępuje część spotkań i wydarzeń na żywo.
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20508%20512'%3E%3C/svg%3E)
...
- [nagrywamy wiadomości wideo jak w Loom, Cloudapp](https://sektor3-0.pl/blog/nagrywanie-ekranu-i-wiadomosci-wideo-z-loom-jak-zastapic-niektore-spotkania/) lub [Canva](https://www.canva.com/pl_pl/funkcje/nagrywanie-wideo-online/)
- współpracujemy na [wirtualnych dokumentach i tablicach](https://publicystyka.ngo.pl/interaktywne-tablice-do-kreatywnej-pracy-online).
...
Spójrz w swój kalendarz lub przypomnij sobie, jak wygląda Twój typowy dzień pracy. Prawdopodobnie dzieli się on na [spotkania](https://sektor3-0.pl/blog/mistrz-ceremonii-empatia-i-zaufanie-o-pracy-zdalnej-spotkaniach-online-i-byciu-czlowiekiem-przed-ekranem/) i czas, w którym wykonujesz samodzielnie zadania. Czy zdarza Ci się organizować lub uczestniczyć w zebraniach, które służą wyłącznie przekazaniu jakiejś informacji lub przedstawieniu zadania współpracownikom, lub zespołowi? Może trudno Ci się skupić pomiędzy spotkaniami lub łatwo odrywasz się od zdań, aby odpowiedzieć na pytania niewymagające natychmiastowej odpowiedzi?
...
![Infografika przedstawiająca logotypy narzędzi do komunikacji asynchronicznej.](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201024%201024'%3E%3C/svg%3E)

Wysyłając wiadomość tekstową (e-mail, ogłoszenie na Slacku) lub wideo, **możemy poprosić o potwierdzenie zapoznania się z informacją czy nawet sprawdzać to automatycznie****.** Również pytania (które mogą pojawić się dopiero jakiś czas po zapoznaniu z informacją) lepiej zbierać na dokumencie czy kanale czatu, dzięki czemu wszyscy będą mogli łatwo wrócić do udzielonych odpowiedzi, zamiast zadawać je ponownie bezpośrednio. Do takich zadań świetnie sprawdzają się nagrania filmów (np. w [aplikacjach Loom, Cloudapp](https://sektor3-0.pl/blog/nagrywanie-ekranu-i-wiadomosci-wideo-z-loom-jak-zastapic-niektore-spotkania/) czy popularnej [Canvie](https://www.canva.com/pl_pl/funkcje/nagrywanie-wideo-online/)) oraz aplikacje do zarządzania zadaniami takie jak Trello czy [Asana](https://sektor3-0.pl/blog/jak-efektywnie-wdrozyc-asane-w-zespole-dowiedz-sie-jak-zrobilismy-to-w-sektor-3-0/), w których każdy może oznaczyć i skomentować informacje czy zadanie.
...
[**Wykorzystaj potęgę emoji i komunikacji wizualnej**](https://sektor3-0.pl/blog/co-moze-emodzi-o-roli-emoji-w-komunikacji-zespolowej/). Brak interakcji podczas spotkań na żywo, które budują i wzmacniają relacje w zespole można nadrabiać mądrym wykorzystaniem emoji, gifów i zdjęć.
...
**Aplikacje do [nagrywania wideo wiadomości](https://sektor3-0.pl/blog/nagrywanie-ekranu-i-wiadomosci-wideo-z-loom-jak-zastapic-niektore-spotkania/) takie jak** [**Loom,**](https://www.loom.com/)[**Cloudapp,**](https://www.getcloudapp.com/) **[Canva](https://www.canva.com/pl_pl/funkcje/nagrywanie-wideo-online/)** mogą wzbogacić przesyłane instrukcje i informacje o element wideo, zarówno nagrania mówiącej osoby lub ekranu, na którym przedstawia prezentację czy narzędzia.

Przygotowane **tablice wirtualne takie jak** [**Miro**](https://miro.com/app/dashboard/) **czy** [**Mural**](https://www.mural.co/) mogą z kolei pozwolić na włączenie do procesu kreatywnego więcej osób, które będą w stanie zostawić swoje pomysły lub informacje zwrotne w różnych momentach. Wirtualne tablice idealnie nadają się do pracy warsztatowej na żywo, jak i do komunikacji asynchronicznej.

[**Doodle**](https://doodle.com/en/) i [**Calendly**](https://calendly.com/), czyli aplikacje do wspólnego umawiania terminów spotkań, zaoszczędzą Ci czas na dogadywanie tego bezpośrednio przez mail, telefon lub podczas spotkań. Więcej o tym, jak efektywnie umawiać z pomocą tych aplikacji przeczytasz w tym [poradniku na stronach ngo.pl](https://publicystyka.ngo.pl/jak-sprawnie-ustalic-termin-spotkania-3-proste-sposoby)

## Komunikacja asynchroniczna – podsumowanie

Nie ma jednego idealnego sposobu komunikowania się podczas pracy lub nauki zdalnej w rozproszonych zespołach. Potencjał komunikacji asynchronicznej nie leży w zupełnym porzuceniu spotkań na żywo, ale zastosowaniu takich reguł i narzędzi w zespole, które pozwolą osobom o różnych potrzebach pracować równie efektywnie i wygodnie. Dzięki temu nasze środowisko pracy może być bardziej inkluzywne i zróżnicowane (np. ułatwiając pracę osobom z innych miast, pracującym rodzicom, [osobom z niepełnosprawnościami](https://sektor3-0.pl/blog/osoby-z-niepelnosprawnosciami-maja-moc-pozwolmy-im-ja-pokazac-takze-w-pracy/)). Natomiast spotkania na żywo można odzyskać jako czas na budowanie relacji w zespole, pracę kreatywną czy wspólne rozwiązywanie problemów.

## Przeczytaj także

- [Nagrywanie ekranu i wiadomości wideo z Loom – jak zastąpić (niektóre) spotkania?](https://sektor3-0.pl/blog/nagrywanie-ekranu-i-wiadomosci-wideo-z-loom-jak-zastapic-niektore-spotkania/)
- [6 sposobów na ułatwienie sobie pracy – poleca ekipa Sektor 3.0](https://sektor3-0.pl/blog/6-sposobow-na-ulatwienie-sobie-pracy-poleca-ekipa-sektora-3-0/)
- [Mistrz ceremonii, empatia i zaufanie – o pracy zdalnej, spotkaniach online i byciu człowiekiem przed ekranem](https://sektor3-0.pl/blog/mistrz-ceremonii-empatia-i-zaufanie-o-pracy-zdalnej-spotkaniach-online-i-byciu-czlowiekiem-przed-ekranem/)
