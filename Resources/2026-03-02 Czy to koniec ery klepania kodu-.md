...
- Anthropic zebrał kolejne 30 mld USD w rundzie finansowania
- SpaceX: koszt wynoszenia sprzętu w kosmos to 3700 USD/kg dzięki Starship

## Wnioski
- Zmiana roli dewelopera z „pisarza kodu" na „architekta systemu" to istotny sygnał dla projektowania szkoleń AI — warto przesunąć akcent ze znajomości narzędzi na myślenie systemowe i intuicję architektoniczną, co przekłada się też na szkolenia dla NGO.
- Prompt injection to nowe zagrożenie bezpieczeństwa bezpośrednio dotyczące organizacji korzystających z asystentów AI do przetwarzania dokumentów i raportów — warto uwzględniać ten temat w szkoleniach z [[prompt-engineering]] dla NGO.
- Autonomiczne agenty AI działające na lokalnym sprzęcie (Mac Mini + OpenClaw) to krok w stronę pełnej automatyzacji procesów bez zależności od dużych platform chmurowych — kierunek wart śledzenia przy projektowaniu narzędzi [[automatyzacja]] dla organizacji.
