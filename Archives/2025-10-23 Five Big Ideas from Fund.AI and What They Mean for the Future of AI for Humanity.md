...
![Five Big Ideas from Fund.AI — and What They Mean for the Future of AI for Humanity](https://cdn.sanity.io/images/4cwcet86/production/8d2a9ad6744a4bc82db287a52b5a978a4f19b276-6000x4000.jpg?rect=0,96,6000,3375&w=3840&h=2160&q=70&auto=format)
...
At Fund.AI, a convening hosted by the [Patrick J. McGovern Foundation](https://www.mcgovern.org/) and Fast Forward, we explored how AI can be harnessed for humanity — and the role philanthropy plays in actualizing AI’s potential for good. From responsible AI to radical collaboration, the discussions illuminated how the next decade of AI will be shaped by the partnerships we forge today.
...
> 
> Nick Cain, VP of Strategy & Innovation, Patrick J. McGovern Foundation

### 1\. Nonprofits Need Philanthropy’s Support Navigating AI

Nonprofits deeply care about serving their beneficiaries and will do whatever it takes to meet their missions, often with limited resources and boundless commitment. Stacy Palmer, CEO of [The Chronicle of Philanthropy](https://www.philanthropy.com/article/nonprofits-are-embracing-ai-but-many-struggle-to-find-funding?sra=true), in her conversation with Vilas Dhar, President of the Patrick J. McGovern Foundation, gave an overview of what nonprofits say they most need at this moment.
...
The conversation kicked off with [Divya Siddarth](https://www.ffwd.org/blog/divya-siddarth-is-shaping-ai-with-global-input), co-founder of the [Collective Intelligence Project](https://www.ffwd.org/blog/divya-siddarth-is-shaping-ai-with-global-input), who invited us to widen the frame. Responsible AI, she argued, isn’t just about mitigating harm…it’s about who gets to shape the technology itself. Her work brings new voices into the process of training and governing AI models, ensuring that the systems defining our future reflect the diversity of the people they serve.

That idea resonated throughout the event. [Baratunde Thurston](https://www.baratunde.com/), put it best: “Nothing for us without us.” Largely founded by those proximate to the problem, tech and AI-powered nonprofits (APNs) are often the closest to the problems AI promises to solve. They understand the nuances, the gaps, and the ethical tradeoffs. But too often, those same organizations are absent from the rooms where AI’s future is defined — or constrained by less-than-ideal tools.

They're not letting that stop them from modeling responsible AI practices for the entire industry. [Kevin Barenblat](https://www.linkedin.com/in/barenblat) shared some findings from Fast Forward's new [2025 AI for Humanity Report:](https://www.ffwd.org/2025-ai-for-humanity-report) 61% of surveyed AI-powered nonprofits customize LLMs with their own data — a step that can help them tailor tools for the specific communities they serve. Plus, 70% regularly incorporate community feedback into system updates. By centering community voices in development, APNs ensure their technology reflects lived realities and builds trust with the people they serve."
...
Several nonprofits offered a glimpse of what it looks like when mission and machine intelligence align. Fast Forward co-founder [Shannon Farley](https://www.linkedin.com/in/farleyshannon) highlighted a growing class of founders building AI-powered nonprofits that are mission-driven, product-minded, and structurally built for speed — like [Karya](https://www.karya.in/), [RebootRx](https://rebootrx.org/), and [CareerVillage’s Coach](https://www.careervillage.org/articles/coach/coach-ai-for-career-readiness/?gad_source=1&gad_campaignid=11896538063&gbraid=0AAAAADqJ0xIio9fQQ1gwd3TLK8GLNNVVk&gclid=CjwKCAjwx-zHBhBhEiwA7Kjq64jYu82PPtDe3S0tPv1ysYfqAXb7lkKMORA0EmsUgirkp_g_LdpSexoCuOgQAvD_BwE). And we heard from others directly.

[Materiom](https://www.materiom.org/about) co-founders Liz Corbin and Alysia Garmulewicz shared how their organization is rethinking how we make and use materials. They’re building [Materiom AI](https://www.materiom.org/resources/introducing-materiom-ai-chatbot-for-bio-based-material-discovery), a tool that helps companies design natural alternatives to plastics — materials made from things like seaweed, food waste, and mushrooms that can safely return to the earth. What might have taken twenty years of trial and error in a lab can now happen in a fraction of the time. Their open database already connects more than 20,000 researchers and makers in over 100 countries, all sharing recipes for a world where garbage really can feed the soil.

[Lemontree](https://www.foodhelpline.org/) founder Kasumi Quinlan shared how her organization uses AI to make food assistance programs actually work for the people who need them. Their technology helps families find nearby pantries that are open, accessible, and welcoming, solving problems that shouldn’t exist in the first place. Each day, 15,000 households get personalized recommendations built from real user feedback and lived experience. The AI mirrors the thoughtfulness of a social worker, scaling empathy rather than replacing it.

AI is the ingredient helping these solutions grow into systems that can reach millions. As [ReFED](https://refed.org/about/who-we-are/?gad_source=1&gad_campaignid=22306393903&gbraid=0AAAAACdMtWqycmvZfx0LcCMskXJR-8XDm&gclid=CjwKCAjwx-zHBhBhEiwA7Kjq6-H2XNtCH1OvC8w3M0BqOvZrojER27A4tQkUqd0OfldqFpTk1_KpqBoCzEEQAvD_BwE) President Dana Gunders put it: “We use data to model solutions — and now AI helps us find and test thousands more. It’s already helping us see things we might’ve missed before. It feels like an unlock — and we’re just getting started.”
