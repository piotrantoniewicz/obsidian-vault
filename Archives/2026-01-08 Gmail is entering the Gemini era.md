...
<audio title="Gmail is entering the Gemini era"><source src="https://storage.googleapis.com/gweb-uniblog-publish-prod/media/tts_audio_83028_umbriel_2026_02_12_17_39_52.wav" type="audio/x-wav"><p>Your browser does not support the audio element.</p></audio>
...
Today, 3 billion users rely on Gmail to connect and get things done. AI has been a big part of that — from [Smart Replies](https://workspace.google.com/features/smart-reply/) to [AI-powered spam blocking](https://workspace.google.com/blog/identity-and-security/an-overview-of-gmails-spam-filters).
...
Just like they do [in Google Search](https://search.google/ways-to-search/ai-overviews/), AI Overviews turn information into answers without the digging. When you open an email with dozens of replies, Gmail synthesizes the entire conversation into a concise summary of key points.
...
Starting today, everyone can use [Help Me Write](https://blog.google/products/gmail/gmail-ai-features/) to polish emails or draft them from scratch. There are also new Suggested Replies (an update to Smart Replies) which use the context of your conversation to offer relevant, one-click responses that match how you write.
...
Many of these improvements are made possible by [Gemini 3](https://blog.google/products/gemini/gemini-3/). These new capabilities begin rolling out today in the U.S. to Gmail users as well as [Google AI Pro and Ultra subscribers](https://gemini.google/subscriptions/). We're starting with English and excited to roll out more languages and to more regions in the coming months.
