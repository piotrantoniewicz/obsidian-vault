...
![fundusz](https://sektor3-0.pl/wp-content/uploads/elementor/thumbs/fundusz-r1svl61n8t2gi42en6f9arincy4f5ihbtwmffe4eie.png "fundusz")

Fundusz Sektor 3.0 to nie tylko wsparcie finansowe, ale przede wszystkim kompleksowy ekosystem, który pozwala przejść organizacjom społecznym przez pełny proces inkubacji – od pomysłu po gotowy produkt – cyfrowe narzędzie realizujące ważną społeczną misję. W tym roku 9 zespołów intensywnie pracuje nad swoimi rozwiązaniami cyfrowymi, korzystając z narzędzi takich jak Slack, Miro czy Figma. Jak wygląda ta praca od kuchni i jakie wyzwania stoją przed uczestnikami i uczestniczkami? O procesie inkubacji, wykorzystywanych technologiach i zmianach w Funduszu rozmawiamy z jego koordynatorką i koordynatorem – Karoliną Walecką i Jakubem Gruszeckim.
...
**KW:** W samym zespole Funduszu działa pięć osób, w tym ja i Jakub, oraz trójka ekspertów z [WUD Silesia](https://wudsilesia.pl/) – Paweł Nowak, Agata Nowak i Katarzyna Drożdżal. To osoby, które od lat dbają o merytorykę procesu inkubacji.

![Katarzyna Drożdżal i Paweł Nowak podczas spotkania z zespołami Funduszu Sektor 3.0.](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201892%201023'%3E%3C/svg%3E)

Katarzyna Drożdżal i Paweł Nowak podczas spotkania z zespołami Funduszu Sektor 3.0 na Zoom’ie.
...
**JG:** Nasz proces inkubacji to spore przedsięwzięcie, więc od lat korzystamy ze sprawdzonego zestawu narzędzi. Kluczowe elementy naszego **tech stacku** to:
...
**KW:** Stawiamy na stabilność i przewidywalność. Nie eksperymentujemy co roku z nowymi rozwiązaniami, bo wiemy, że zespoły nie zawsze są biegłe w obsłudze tych narzędzi. Nie chodzi o testowanie nowinek, ale o maksymalne wykorzystanie tego, co działa.
...
**KW:** To był krok w dobrym kierunku. W trakcie rozmów odkryliśmy, że niektóre zespoły świetnie opisały swoje pomysły, ale nie były gotowe na udział w Funduszu. Gdybyśmy ich nie przepytali, moglibyśmy przyjąć kogoś, kto nie do końca wiedział, czego się spodziewać.
...
**KW:** Slack to absolutnie kluczowe narzędzie, jeśli chodzi o codzienną pracę Funduszu. To tutaj toczy się większość komunikacji, zarówno między zespołami, jak i z ekspertami i ekspertkami, czy organizatorami.

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20796%20349'%3E%3C/svg%3E)

Plan spotkania opublikowany w kanale general na Slack’u.
...
**JG:** W tym miejscu warto dodać, że zespoły z poprzednich lat nie są usuwane ze Slack’a Funduszu. Archiwizujemy starsze kanały, dzięki czemu zespoły mogą wracać do rozmów, ale nie uczestniczą w nowej edycji.

A co dalej? Przede wszystkim staramy się, żeby Slack był czytelny i uporządkowany. Dlatego każdy zespół ma swój prywatny kanał, gdzie może dyskutować wewnętrznie i wymieniać się materiałami. Do tego dochodzą kanały ogólne, np. informacyjny, w którym publikujemy kluczowe komunikaty, oraz kanały tematyczne, np. dla wolontariuszy i wolontariuszek czy do rozmów z ekspertami i ekspertkami.
...
Druga zasada: **konsekwentnie używamy wątków w dyskusjach**. To ułatwia nawigację i pozwala uniknąć chaosu w kanałach. Od początku uczymy zespoły, że nie odpisujemy na głównym kanale, tylko w ramach konkretnego wątku. Dzięki temu ważne informacje nie giną.

**KW:** Mamy też **przypięte wiadomości i sekcję z plikami**, gdzie zapisujemy kluczowe informacje np. najważniejsze linki czy dostęp do Miro i SharePoint’a.
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20918%20521'%3E%3C/svg%3E)

Slack to nie tylko praca! To również miejsce do luźnych rozmów i świątecznych konkursów Jakuba, które angażują i integrują zespoły.
...
![Tablice Miro Fundacji Rak'n'Roll, która bierze udział w tegorocznej inkubacji Funduszu Sektor 3.0.](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201461%20827'%3E%3C/svg%3E)

Tablice Miro Fundacji Rak’n’Roll, która bierze udział w tegorocznej inkubacji Funduszu Sektor 3.0.
...
![Tablice Fundacji Niezła Sztuka, łączą wirtualne karteczki i zdjęcia realnych kartek. Miro pozwala na łatwe scalanie ze sobą różnych formatów i źródeł.](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201328%20823'%3E%3C/svg%3E)

Tablice Fundacji Niezła Sztuka, łączą wirtualne karteczki i zdjęcia realnych kartek. Miro pozwala na łatwe scalanie ze sobą różnych formatów i źródeł.

- **[Co zamiast Google Jamboard? Alternatywne tablice online](https://sektor3-0.pl/blog/co-zamiast-google-jamboard-alternatywne-tablice/)**
- **[Mapy myśli, czyli uczenie się przez skojarzenia](https://sektor3-0.pl/blog/mapy-mysli-czyli-uczenie-sie-przez-skojarzenia/)  
	**

## Płacicie za narzędzia, czy bazuje na darmowych?
...
**JG:** To nie znaczy jednak, że wszystko opieramy na darmowych wersjach. Kluczowe narzędzia są płatne:
...
**KW:** Zespoły dostają też **darmowe konta na** [**Landingi.pl**](http://landingi.pl/) – to dzięki współpracy z naszym partnerem. Mogą tam stworzyć **stronę swojego projektu** bez konieczności inwestowania w płatne narzędzia.

**[Bezpłatny kurs: Landing Pages – tworzenie skutecznych stron docelowych](https://elearning.sektor3-0.pl/obszary/landing-pages-tworzenie-skutecznych-stron-docelowych/)**

## Czy organizujecie i archiwizujecie wiedzę i materiały z inkubacji?

**KW:** Tak, używamy do tego **SharePointa**. To tam trafiają **nagrania ze spotkań, materiały od ekspertów i inne ważne zasoby**. Każdy zespół ma dostęp do tego miejsca i może wracać do materiałów w dowolnym momencie. Miro też pełni w tym obszarze ważną funkcję – choć nie jest archiwum w klasycznym sensie. Jako centrum pracy koncepcyjnej jednocześnie dokumentuje cały proces.
...
Spotkania na żywo są niezbędne. Odbywają się w **soboty, raz na dwa tygodnie**, trwają sześć godzin i to jest **rdzeń procesu**. Między spotkaniami zespoły pracują **asynchronicznie**, a komunikacja odbywa się na **Slacku**. Niektóre rzeczy wymagają jednak dodatkowego wsparcia, więc zespoły mogą umawiać się na konsultacje z ekspertami.

**KW:** Ułatwiamy też ten balans narzędziami. Na przykład **nagrywamy spotkania na Zoomie**, więc jeśli ktoś nie może w nich uczestniczyć, może do nich wrócić później. A kiedy trzeba coś wyjaśnić szybciej niż na kolejnym spotkaniu, korzystamy z aplikacji [**Loom**](https://sektor3-0.pl/blog/nagrywanie-ekranu-i-wiadomosci-wideo-z-loom-jak-zastapic-niektore-spotkania/). Nagrywamy krótkie wideo, zamiast umawiać się na kolejne spotkanie.

![Wiadomość na Slack'u z wprowadzeniem do narzędzia. Tutorial został nagrany w aplikacji Loom.](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201121%20598'%3E%3C/svg%3E)

Wiadomość z wprowadzeniem do aplikacji Slack przypięta do głównego kanału (#general). Karolina nagrała tutorial w aplikacji Loom.

**[Bezpłatny kurs: Zarządzanie projektami w organizacji społecznej](https://elearning.sektor3-0.pl/obszary/zarzadzanie-projektami-w-organizacji-spolecznej/)**
...
**KW:** Kolejna ważna zmiana to **balans między online a offline**. Fundusz przez długi czas działał w pełni online, ale w zeszłym roku wróciliśmy do **hybrydowego modelu**. Inauguracja i finał odbywają się na żywo w Warszawie, a reszta spotkań pozostaje online.
...
**KW:** Wnioski? Każda edycja uczy nas czegoś nowego, ale widać, że kierunek, który obraliśmy, sprawdza się i daje zespołom realne wsparcie.
