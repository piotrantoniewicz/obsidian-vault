...
- [[ElevenLabs]] ($11 mld wyceny) integruje się z [[n8n]] przez webhook — gotowy stack do budowania voice botów dla NGO (rezerwacje, kwalifikacja zgłoszeń, obsługa 24/7) bez konieczności własnej infrastruktury głosowej.
- [[n8n]] 2.8.0 z AI builderem generującym workflow z analizy codebase to kolejny krok obniżający barierę automatyzacji — ale: 8 krytycznych CVE w tej wersji wymaga natychmiastowej aktualizacji.

## Cytat
> AI nie likwiduje pracy. Likwiduje stanowiska ludzi, którzy AI nie używają. Różnica jest ogromna.

## Zastosowanie
Argument "80% sukcesu wdrożenia to ludzie i procesy, nie technologia" to gotowy frame do rozmów z NGO o tym, dlaczego samo kupienie dostępu do AI nie wystarczy — i dlaczego potrzebują wsparcia w projektowaniu procesów i edukacji zespołów.
