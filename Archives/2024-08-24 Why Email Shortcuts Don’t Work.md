...
url: "https://send-it-right.com/blog/email-shortcuts-dont-work"
...
Well, when people do things like purchasing or scraping lists to reach short-term goals…doubling or tripling their sending frequency overnight to hit that sales target…or sending to that dusty old list [Milton found in the basement before he set the building on fire](https://www.youtube.com/watch?v=V09fnmAUDVQ), it leads to problems ranging from high bounces and spam complaints, to spam trap hits, blocklistings, and more.
...
- **You may consider paying a list validation company** to help clean up a mailing list after you find out it’s rife with spam traps. (Even though you should think twice about this approach…I explain a bit in [this article I wrote on email myths for Kickbox](https://blog.kickbox.com/common-email-deliverability-myths-debunked/) a few years ago).
...
- **You may find yourself paying for a variety of** [**unforeseen costs**](https://send-it-right.com/blog/business-impact-of-deliverability-issues) that come along with inbox placement troubles.
...
**❌ Moving to a new IP or ESP instead of just** **fixing what’s not working****.** Mailbox providers are continually becoming more focused on domain reputation. Case in point: the biggest ones like [Google and Yahoo are now requiring you to authenticate](https://www.socketlabs.com/blog/first-2024-priority-meeting-google-and-yahoo-email-standards/?utm_source=senditright&utm_medium=blog&utm_campaign=shortcuts) your sending domain if you want to reach the inboxes of their users.
...
You’d learn a lot if you took an *email shortcut*, too…but [it could cost you](https://send-it-right.com/blog/business-impact-of-deliverability-issues):
...
I told you my family loves shortcuts, yeah? Well, let me tell you…we once saw a doozie of a shortcut on the map while vacationing in Arizona. Looked like a main road, and it was a direct path to our destination! Silly [Mapquest](https://en.wikipedia.org/wiki/MapQuest), taking us so far out of the way. 🙄
...
<iframe src="https://giphy.com/embed/BuJH72iBZIMWkb8ANi" width="480" height="480" frameborder="0" allowfullscreen=""></iframe>

[via GIPHY](https://giphy.com/gifs/BuJH72iBZIMWkb8ANi)
...
1. **It’s required by law.** For example, [CAN-SPAM](https://www.ftc.gov/business-guidance/resources/can-spam-act-compliance-guide-business), [CASL](https://crtc.gc.ca/eng/internet/anti.htm?ref=blog.kickbox.com) (Canadian Anti-Spam Law), [GDPR](https://gdpr.eu/what-is-gdpr/) (General Data Protection Regulation), and [CCPA](https://blog.kickbox.com/ccpa-impact-for-marketers-consumers/) (California Consumer Privacy Act), just to name a few.
2. **It’s required by mailbox providers** your business sends to. For example, [Yahoo and Google’s (semi) new sender requirements](https://www.socketlabs.com/blog/first-2024-priority-meeting-google-and-yahoo-email-standards/?utm_source=senditright&utm_medium=blog&utm_campaign=shortcuts).
3. **Your data supports the fact that doing that thing is helping you reach your goals.** For example, if you see [spam complaints](https://www.socketlabs.com/blog/email-performance-red-flags-spam-complaints/?utm_source=senditright&utm_medium=blog&utm_campaign=shortcuts) go down and revenue goes UP when sending to recipients who’ve opted in vs those who haven’t.
...
1. **Did it get delivered?** If not, is it because you’re sending to invalid addresses or do you have an issue with [sender reputation](https://send-it-right.com/blog/building-sender-reputation)?
2. **Did it go** **to the inbox****?** [Last week’s lesson](https://send-it-right.com/blog/why-your-deliverability-rate-is-wrong) was all about why answering this question can be tricky, but there *are* ways to gauge whether you’re (likely) going to the inbox or the spam folder. For example, by reviewing your open rates at the destination level (e.g. Gmail vs Hotmail vs any other destination you send to). I talk about that at length (with the help of some email industry smarties, Drew Price, Jaina Mistry, and Travis Hazleton) in [this article for the SocketLabs blog](https://www.socketlabs.com/blog/email-performance-red-flags-low-open-rates/).
3. **How did recipients engage?** Positively, by opening, clicking, replying, and/or makin’ your business some money — or negatively, by marking your email as spam or creating [a post on LinkedIn calling you out for bad behavior](https://www.linkedin.com/posts/danoshinsky_the-hardest-part-about-operating-a-newsletter-activity-7232004768817127425-CCRi?utm_source=share&utm_medium=member_desktop)? Mailbox providers care a lot about recipient engagement these days, so this one’s important to pay attention to.
...
- **Tricks for landing in the primary tab** instead of the “dreaded promotions tab”. If you’re sending promotional mail, you belong in the promotions tab. End of story. (Today, anyway…here are [several thoughts I had about it recently](https://crm.buzz/en/the-promotions-tab-is-coming-to-apple-mail-what-does-this-mean-for-marketeers/), which I shared with Sella Yoffe on his Email Geeks Show podcast.)
...
<iframe src="https://giphy.com/embed/FuNxmqgomVdMovVxmq" width="480" height="319" frameborder="0" allowfullscreen=""></iframe>

[via GIPHY](https://giphy.com/stickers/transparent-FuNxmqgomVdMovVxmq)
...
- **Make the unsubscribe process easy!** It’s required by mailbox providers like Google and Yahoo, but more importantly, it’s what’s right for subscribers. Plus, [unsubscribes don’t actually hurt your deliverability](https://send-it-right.com/blog/why-unsubscribes-arent-bad-for-deliverability) (just your heart)!
...
[Hubspot recently gave it a shout-out on their blog](https://blog.hubspot.com/marketing/best-marketing-newsletters), so you know it’s at least halfway decent.