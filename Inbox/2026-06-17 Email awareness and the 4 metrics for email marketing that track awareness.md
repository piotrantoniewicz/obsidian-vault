...
url: "https://weareastral.co.uk/thevault/email-is-an-awareness-channel?utm_medium=email&_hsenc=p2ANqtz-8XqAF8putCpiDPl3ydO8qxER6heOlwXyRPjOQMFuY7yVbW4Val9uUok1m-q4PReZky0X28-GTZBP85XduQDHtVSLXa9sJZgpDnvRXKINCO61vmQTo&_hsmi=138619692&utm_content=138604867&utm_source=hs_email"
...
Layer 1 — Email Health (quarterly)

**List growth rate** — is the programme attracting new subscribers consistently? Growth signals that the value proposition is working.

**Subscriber-to-customer rate** — what proportion of email subscribers become customers, and how does that compare to non-subscribers through other channels?

**Value per subscriber** — the commercial output of the programme divided by the active subscriber base.

**Time to first meaningful action** — how long does it take a new subscriber to take a meaningful action? Shorter times indicate stronger orientation and awareness-to-action velocity.

**Subscriber retention over time** — how long do subscribers stay? Long retention periods indicate sustained positive awareness value.

**Time to disengaged** — at what point does the typical subscriber go quiet, and what happens to their non-email brand interactions when they do?

Layer 2 — Impact Signals (monthly)

**Direct replies** — the clearest possible signal that an email created a positive enough impression to prompt a response.

**Email-assisted conversions** — contacts who were active in the email programme at any point in a conversion journey, not just last-click.

**Brand search uplift** — does brand search volume increase during periods of active email sending? That correlation is the awareness effect made measurable.

**Email-attributed web traffic** — direct and brand search traffic that correlates with email activity.

**Pipeline velocity and value** — do email-active contacts move through the sales pipeline faster? Do they convert at higher rates?

**MQLs from email-active contacts** — what proportion of marketing qualified leads have email as part of their attribution journey?
