---
type: "Web"
authors: "[[Abigail Stahl]]"
url: "https://www.centerfordigitalaction.eu/3-digital-progress-magazine/from-sympathy-to-salience?link_id=2&can_id=32cae499f95a9349c734a72403321b9c&source=email-something-has-changed-top-picks-from-digital-progressive-3&email_referrer=email_3309255&email_subject=the-new-normal-top-picks-from-digital-progressive-3&&"
published:
created: 2026-07-24
tags:
---
...
![Image-empty-state_edited_edited_edited_e](https://static.wixstatic.com/media/4c02c5_69985d7afc564b619404558c3696da39~mv2.jpg/v1/fill/w_744,h_590,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Image-empty-state_edited_edited_edited_e.jpg)

Have advocates for issues like climate action, inequality, workers’ rights, and public services relied too heavily on sympathy and not enough on salience? Abigail Stahl is the Global Head of Narrative and Messaging at Global Fund for a New Economy. She explains how a shift in approach can open up new possibilities for shaping the political agenda and information ecosystem, which in turn can lead voters to rethink priorities and imagine different solutions.
...
Sympathy measures agreement. Salience measures priority. As political scientist Sheri Berman [writes,](https://www.annualreviews.org/content/journals/10.1146/annurev-polisci-041719-102503#:~:text=Whereas%20preferences%20refer,Budge%202015\).) only salient preferences “decisively influence political behavior.” That distinction matters. Shaping what becomes salient is therefore not a communications afterthought – it is the heartbeat of political strategy.
...
My organization, the Global Fund for a New Economy, invests in groups that give voice to people and topics that are often left out of economic debates. As a regranter and capacity builder, we support “communication hubs” around the world and in Europe, like [Laintersección](https://lainterseccion.net/proyectos/formacion-gestion-de-medios-y-estrategias-para-ocupar-la-conversacion-publica/) in Spain, [Das Momentum](https://das-momentum.de/en/) in Germany, [Huba Fundacja](https://www.fundacjahuba.org/) in Poland, and [NEON](https://neweconomyorganisers.org/#main-content) in the UK. These hubs book advocates, activists, and issue experts into the media to change narratives. But comparatively, these groups and interventions are underfunded.

To drive attention, we must build communications infrastructure to compete at the scale of the millions of euros [flowing into the continent from right-wing donors](https://youtu.be/GHQAfk_5Ekk?si=jliANjhFuMfMenXC). This is not just about money. It’s also about talent development from programs like the [Global Messaging Programme](https://www.australianprogress.org.au/global-messaging-programme), amplification networks like [Project Bullhorn](https://www.nytimes.com/2025/05/20/us/politics/democrats-influencers-trump.html) in the US, and organizations working together to create a sense of “surround sound” – a consistent drumbeat that demands attention.
...
![Image-empty-state_edited_edited_edited_e](https://static.wixstatic.com/media/4c02c5_dc4925daf42c4255815542ae839cf7e6~mv2.png/v1/fill/w_75,h_75,al_c,q_85,usm_0.66_1.00_0.01,blur_2,enc_avif,quality_auto/Image-empty-state_edited_edited_edited_e.png)
