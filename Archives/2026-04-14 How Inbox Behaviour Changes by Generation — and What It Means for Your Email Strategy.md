...
Generational labels are useful shorthand, not absolute truth. Every generation contains enormous variation in how individuals relate to technology, communication, and the inbox. A 58-year-old who runs a digital agency and a 58-year-old who still prints their emails both technically qualify as Baby Boomers. A 24-year-old Gen Z marketer who lives in their inbox and a 24-year-old who only checks email when forced to share the same generational bracket. The patterns described in this blog are based on research, behavioural trends, and observable shifts — not a claim that all humans born within a certain date range behave identically. Use these as a lens, not a rule.
...
Email is utility infrastructure. Nobody abandons it. What changes across generations is the emotional relationship with it, the frequency of use, the mode of engagement, and the expectations brought to the inbox.
...
### **Approximate age range in 2026: 62–80**

Baby Boomers were the first professional generation to adopt email as a work tool. For many in this cohort, email replaced letters, faxes, and phone calls in professional life — and that formative experience shaped a relationship with the inbox that remains fundamentally different from every generation that came after.  
  
For Boomers, email is often the primary communication channel, not one of many. It is where important things live. Where decisions get documented. Where relationships are maintained. The inbox is treated with a degree of intentionality and seriousness that younger generations — who grew up with overflowing inboxes from the start — simply don't share.  
  
This doesn't mean Boomers open everything. It means that when they engage with email, they tend to engage more deliberately. They are more likely to read rather than skim. More likely to take action based on email content. Less likely to have trained their brain to auto-delete at speed.  
  
In B2C, Boomers are significant email buyers — they are comfortable with email as a purchase-driver in a way that not all younger generations are. In B2B, they are often the decision-makers that email nurture programmes are trying to reach — and they are frequently more reachable via email than through social media or newer communication channels.
...
### **Approximate age range in 2026: 46–61**

Gen X grew up without the internet and then adopted it as adults — making them arguably the most digitally pragmatic generation. They have experienced enough technology change to be sceptical of hype, but they have also embedded digital tools into their professional and personal lives deeply enough to use them efficiently.  
  
 For Gen X, email is functional. It is a tool. They use it well, they manage it deliberately, and they have low tolerance for anything that wastes their time. This is the generation that invented inbox zero as a concept — not because email is precious to them, but because it is a system that needs to be managed, and they are efficient at managing systems.  
  
 Gen X professionals are often mid-to-senior level, making them significant decision-makers in B2B contexts. They have seen enough email marketing to be deeply sceptical of it, and they respond much better to content that feels intelligent and useful than to content that feels promotional. In B2C, they are digital buyers who value convenience and will use email to track, manage, and access their purchases — but they are not emotionally invested in brand email programmes the way some marketers hope they are.
...
### **Approximate age range in 2026: 30–45**

Millennials have the most complicated relationship with email of any generation — because they came of age as both the inbox became overwhelmed with marketing and social media emerged as an alternative communication space.  
  
 They are the first generation to have grown up with the inbox already busy. They did not experience email as a clean, novel communication tool — they encountered it already cluttered, already commercialised, already a source of mental overhead. This created a more ambivalent relationship: they use email extensively (particularly for work and utility), but they are also more likely than Boomers or Gen X to have developed efficient ignore and delete habits.  
  
 At the same time, Millennials are the generation most likely to have intentionally opted into email content they care about. They subscribe to newsletters, they follow writers and thinkers via email, they use email as a deliberate curation mechanism — seeking out voices and perspectives worth hearing. The key word is intentional. Millennials are sophisticated enough about email to distinguish between programmes they chose and programmes they landed on accidentally, and they treat those categories very differently.  
  
 In B2B, Millennials now occupy a wide range of seniority levels — from individual contributors to C-suite — and their inbox behaviour reflects the demands of that range. They have high email volume, developed filtering instincts, and low tolerance for anything that feels like noise.
...
### **Approximate age range in 2026: 14–29**

Here is where most of the generational panic in email marketing lives — and where most of it is misplaced.  
  
 Gen Z grew up with email as a requirement, not a preference. You need an email address to exist online: to make purchases, to create accounts, to access services. They have email. They check email. But their relationship with it is fundamentally utility-first in a way that no previous generation's was from the start.  
  
 For Gen Z, email is not a social or communication platform in the way it was for Boomers, or even a professional document system in the way it is for Gen X. It's the key to the digital infrastructure. They go in when they need something — a confirmation, a receipt, a reset link, a notification about something they signed up for — and they come back out. The inbox is a utility drawer, not a living room.  
  
 This does not mean email doesn't work for Gen Z. It means email works differently. They are more likely to use inbox search than to scroll chronologically. More likely to have notifications turned off and batch-process their email. More likely to interact with transactional email (they actually read order confirmations and delivery updates) and less likely to engage with unsolicited promotional content.  
  
 In B2B, the oldest Gen Z members are now entering the workforce and beginning to take on professional roles. Their inbox behaviour in professional contexts is developing — and early evidence suggests they are adopting the work-email pragmatism of Gen X faster than the emotional scepticism of Millennials. Email works at work. It's just a tool.  
  
 In B2C and D2C, Gen Z's inbox behaviour is heavily search-oriented. They go looking for specific things. They remember brands they've interacted with and search for them by name when the need arises. This makes inbox retrievability — the principles of Search Inbox Optimisation (SIO) — particularly relevant for Gen Z audiences.
...
Is your email designed for someone who has three seconds to decide if it's worth their attention — or for someone who is comfortably reading at their desk with a cup of tea? The answer needs to be both, because your audience includes both.
...
Google is not trying to replace email. It is trying to make email more useful, more searchable, and more intelligent. Marketers who design for clarity, retrievability, and genuine relevance will benefit from these changes. Marketers who design for promotional impact will find the AI layer increasingly works against them.

## [Search Inbox Optimisation](/thevault/sio-search-inbox-optimisation): why retrievability is becoming the new deliverability
...
Is your B2B email content designed for the inbox habits of the decision-makers you're trying to reach — or for the habits of the generation that dominated your audience five years ago? Both might still be relevant, but the balance may be shifting.
...
## Prediction: Retrieval will overtake browsing as the dominant inbox mode.

As Gen Z and younger Millennials make up a larger share of email audiences, the search-first, open-when-needed behaviour will become the norm rather than the exception. Email metrics that measure immediate engagement will become less reliable as the primary indicator of programme health. Metrics that measure retrieval, return visits, and long-term influence will become more important.

## Prediction: The promotional tab will become more intelligent and more aggressive.

Google and other inbox providers will continue developing AI capabilities that categorise content more accurately. The distinction between 'genuinely useful email' and 'mass promotional send' will be made increasingly automatically, at scale, by machine learning — not human choice. The promotional category will catch more of what deserves to be there, and it will be harder to escape it by tweaking design or copy.

## Prediction: BIMI and visual brand identity in the inbox will matter more.

As inbox environments become more crowded and filters become more sophisticated, the visual presence of a brand in the inbox — sender logo, consistent identity, recognisable formatting — will do more work before the email is opened. Brands that invest in inbox identity now are building a head start that will compound.

## Prediction: Email will increasingly support rather than compete with other channels.

The generational shift is not toward email replacing social, search, or messaging — or toward those channels replacing email. It's toward email settling into its most durable role: utility infrastructure, relationship maintenance, and the retrieval layer that connects people back to things they encountered elsewhere. Email that understands this role and designs for it will outperform email that still tries to behave like a conversion machine.

## Prediction: AI-generated content will create a new relevance threshold.

As AI makes it easier to produce more email content faster, inbox fatigue will intensify across all generations. The bar for what earns genuine attention will rise. Human voice, genuine perspective, and real expertise will become more valuable differentiators — not less — as the volume of generic AI-generated content increases. The email programmes that survive this environment will be the ones that sound unmistakably like a person who knows something, not a language model that learned from the internet.
...
The most durable email strategy is not one built for a specific generation. It's one built for human beings who use their inbox for utility, engage with it on their own terms, and return to things they found valuable when the moment of need arrives. That describes every generation — the proportions and patterns just vary. 

![Email health check](https://weareastral.co.uk/hs-fs/hubfs/Email%20health%20check%20(1200%20x%20800%20px)%20(1).png?width=3600&height=2400&name=Email%20health%20check%20(1200%20x%20800%20px)%20(1).png)
...
[Take the Health Check →](https://www.emailhealthcheck.co.uk/)
