...
On 7 May 2026, negotiators from the Council of the European Union, the European Parliament, and the European Commission reached a provisional agreement on the terms of the Digital Omnibus on AI, marking the first set of amendments to the EU AI Act since its adoption in June 2024. The final [package](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CONSIL:ST_9247_2026_INIT) of amendments reflects a mix of pragmatic timeline extensions, focused simplification measures, and a small number of substantive policy changes.
...
## B. Expanded Role of the AI Office in Supervising Certain AI Systems

The amendments clarify the allocation of supervisory competence for certain AI systems, including those based on general-purpose AI (GPAI) models, reinforcing a more centralized, EU-level approach in certain cases.
...
This is particularly relevant for global AI developers and platform providers, as it centralizes supervision at the EU level in certain high-impact scenarios. The trade-off is that the AI Office wields a potent enforcement toolkit, including the power to impose binding commitments, conduct on-site inspections, and impose substantial fines.
...
- making available technical documentation sufficient for the new (downstream) provider to assess the AI system’s compliance with Article 16 requirements (i.e., high-risk AI system requirements);
...
These amendments are expected to proceed through formal adoption in the coming months, with final approval anticipated in June and publication expected in July. It is important that they be in force ahead of the next key implementation milestone under the AI Act in August 2026.
...
The Covington team is actively monitoring the Digital Omnibus on AI and supporting clients in assessing its practical implications and preparing for compliance. Please reach out to a member of the team if you would like to discuss how these developments may affect your organization.