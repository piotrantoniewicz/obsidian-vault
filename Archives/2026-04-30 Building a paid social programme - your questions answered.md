...
If you missed the session, you can catch up by [watching the recording](https://www.youtube.com/watch?v=SRQuln0Xdyo&feature=youtu.be)**.**
...
Using images is generally acceptable where they are publicly available with creative commons licenses. **You can access these from [Wikimedia Commons](https://commons.wikimedia.org/wiki/Main_Page)** – they often provide approved official images for public figures.
...
- [iStock](https://www.istockphoto.com/) for stock imagery – usually getting an account and buying credits makes it more affordable
- [Canva Pro](https://www.canva.com/) also has a huge amount of stock imagery you’re able to use included in the price, as long as you edit the image, so it can make paying for Canva more cost effective
- [Unsplash](https://unsplash.com/) also has some free imagery, but it’s quite limited
...
**We find that the most engaged supporters are recruited via an optimised sign-up form.** That’s why we developed our [Blueprint sign-up form tool](https://forwardaction.uk/product/blueprint-signup-and-mobilisation-tool/), to make it easier for more organisations to develop high-performing sign up pages to power their campaigns.  
...
Depending on what platforms you’re using, they will have their own reports built in, but it might be worth setting yourselves up in [Google Analytics](https://developers.google.com/analytics) and using their reports and Looker Studios to create dashboards that help you look at your performance data in a simple and regular way. **The focus should be on making insights easy to access and act on, so optimisation can happen in real time.**  
  
This is also an area where Forward Action supports organisations – helping define the right metrics and build reporting frameworks that are clear, practical, and easy to use. [Get in touch](https://forwardaction.uk/contact/) if you’d like to chat about how we could support your organisation!
...
[Get in touch](https://forwardaction.uk/contact/)
