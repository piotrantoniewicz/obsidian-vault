...
We have rounded up 25 [peer-to-peer fundraising](https://www.causevox.com/peer-to-peer-fundraising/) examples to show you what is possible, spark some ideas, and give you a clear starting point no matter where you are in your journey.
...
![peer-to-peer honorary day](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjU2MCAxNzU0IiB3aWR0aD0iMjU2MCIgaGVpZ2h0PSIxNzU0IiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)

peer-to-peer honorary day

*Empower’s peer-to-peer fundraising campaign with CauseVox*

The key is making it easy for supporters to self-launch. Give them a [template, a pre-written appeal, and a simple way](https://www.causevox.com/blog/customizable-peer-to-peer-fundraising-toolkit-template/) to set up their page then let them run with it (no pun intended).

![peer-to-peer fundraising page](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjU2MCAxNzU0IiB3aWR0aD0iMjU2MCIgaGVpZ2h0PSIxNzU0IiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
![peer-to-peer toolkit](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjU2MCAxNzIwIiB3aWR0aD0iMjU2MCIgaGVpZ2h0PSIxNzIwIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
A single focused day of giving creates urgency that spreads fast. When your supporters know the clock is ticking, they are far more likely to share their [fundraising pages](https://www.causevox.com/fundraising-sites-pages/), follow up with their networks, and push toward the finish line. [GivingTuesday](https://www.causevox.com/blog/year-end-givingtuesday-2025-fundraising-toolkit/) alone raises hundreds of millions of dollars every year, but you don’t have to wait for a cultural moment to make it work.
...
![peer to peer fundraising giving day](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjU2MCAxNzU0IiB3aWR0aD0iMjU2MCIgaGVpZ2h0PSIxNzU0IiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)

peer to peer fundraising giving day

![peer-to-peer fundraising example](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjU2MCAxNzU0IiB3aWR0aD0iMjU2MCIgaGVpZ2h0PSIxNzU0IiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
Their personal fundraising pages become part of the [story,](https://www.causevox.com/blog/storytelling-in-fundraising-campaigns/) with supporters sponsoring them for every hour they tough it out. What makes it so shareable is the visibility. Participants are posting from their sleeping bags, updating their networks in real time, and creating a night’s worth of content that keeps donations coming in. It connects the act directly to the mission in a way that a standard donation ask never could, and that emotional resonance is exactly what turns a one-time donor into a [long-term supporter](https://www.causevox.com/blog/major-gifts-through-donor-stewardship/).

### 5\. Golf Tournament

[Golf tournaments](https://www.causevox.com/use-case-golf-fundraising-events/) are a nonprofit staple for good reason. They attract [corporate sponsors](https://www.causevox.com/blog/how-to-get-sponsors-for-nonprofit/), bring in higher-dollar donations, and create a relaxed social environment that is genuinely fun to be part of. What makes a [golf event](https://www.causevox.com/blog/golf-tournament-fundraiser-how-to/) shine as a peer-to-peer format is the team structure. Each group becomes a fundraising team with their own fundraising page, competing against other groups to see who can raise the most.

![peer to peer golf tournament](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMTYwMCA3NDEiIHdpZHRoPSIxNjAwIiBoZWlnaHQ9Ijc0MSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4=)

peer to peer golf tournament

*Golf tournament peer-to-peer fundraiser hosted with CauseVox*

That friendly rivalry between the finance team and the marketing crew can do wonders for your final total. Pair your tournament with [event ticketing](https://www.causevox.com/event-ticketing-forms/) where you can easily set up a customized registration form that captures all of the information you need from registrants, including things like t-shirt sizes and sponsorship packages in one place.
...
The most powerful fundraising tool your organization has is not a matching gift or a deadline. It is a story. A [storytelling campaign](https://www.causevox.com/blog/the-complete-guide-to-storytelling-for-nonprofits/) invites your supporters to share their personal connection to your cause on their individual fundraising pages, whether that is a short video, a written reflection, or a photo with a caption.
...
![storytelling-peer-to-peer-fundraiser](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMTMzNSA4MTIiIHdpZHRoPSIxMzM1IiBoZWlnaHQ9IjgxMiIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4=)
...
![pickleball-peer-to-peer fundraiser ](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjU2MCAxNDQ4IiB3aWR0aD0iMjU2MCIgaGVpZ2h0PSIxNDQ4IiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
A [social media](https://www.causevox.com/blog/effective-social-media-planning-for-nonprofit-fundraising-success/) takeover flips the script on traditional peer-to-peer fundraising. Instead of just asking supporters to share a link, you hand them the keys to your organization’s Instagram, TikTok, or Facebook for a day and let them tell your story to their audience and yours at the same time.
...
![fundraiser-team-peer-to-peer-example](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjU2MCAxNTI0IiB3aWR0aD0iMjU2MCIgaGVpZ2h0PSIxNTI0IiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
![talent-show-peer-to-peer fundraiser](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjU2MCAxNTI0IiB3aWR0aD0iMjU2MCIgaGVpZ2h0PSIxNTI0IiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
A [pledge](https://www.causevox.com/use-case-pledge-donations/) campaign is one of the simplest ways to increase the average gift size across your entire peer-to-peer fundraiser without asking donors to give more upfront. Instead of a single lump sum donation, supporters commit to giving in a series of smaller installments over time.
...
Ask your fundraisers to set clear [giving tiers](https://www.causevox.com/blog/donation-tiers/) on their personal pages so donors can see exactly what each pledge level makes possible. That tangible impact framing is what turns a maybe into a yes.
...
![board-fundraiser](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjU2MCAxNDMwIiB3aWR0aD0iMjU2MCIgaGVpZ2h0PSIxNDMwIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
[Walk-a-thons](https://www.causevox.com/blog/spring-fundraisers-5-best-practices/) can be localized, such as a local high school service group, or nationwide, occurring simultaneously in many cities. Like other activity-based events, supporters raise a set amount of money to participate.

Beyond this, walk-a-thons can layer in additional revenue through corporate sponsorships, matching gifts, and branded merchandise, while team-based competition and milestone incentives help keep participant energy high throughout the campaign. With relatively low upfront costs and high engagement potential, walk-a-thons consistently rank among the [highest-ROI](https://www.causevox.com/blog/fundraising-roi/) activity-based peer-to-peer fundraisers available to nonprofits.

![walk-a-thon-peer-to-peer-fundraising-examples](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjU2MCAxMjA3IiB3aWR0aD0iMjU2MCIgaGVpZ2h0PSIxMjA3IiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
![peer-to-peer fundraising examples](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMTEyMiA2OTYiIHdpZHRoPSIxMTIyIiBoZWlnaHQ9IjY5NiIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4=)
...
![peer-to-peer build-a-thon](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMTAyNCA2ODgiIHdpZHRoPSIxMDI0IiBoZWlnaHQ9IjY4OCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4=)
...
Another common denominator behind all of these peer-to-peer fundraising examples is that they all emphasize a quality user experience. Make sure you are set up for success with an [optimized website](https://www.causevox.com/blog/optimized-donation-page/).
...
Start your own peer-to-peer fundraiser today with [CauseVox](https://www.causevox.com/peer-to-peer-fundraising-software/)!
