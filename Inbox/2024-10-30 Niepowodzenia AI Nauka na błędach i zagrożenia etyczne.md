---
type: "Web"
authors: "[[Rami Al Naib]]"
url: "https://www.univio.com/pl/blog/wpadki-ai-gdy-sztuczna-inteligencja-wymyka-sie-spod-kontroli/?utm_medium=email&_hsenc=p2ANqtz-8yIGCsIzve1F2lzicXIq-Jsr4nXiRJJOWm7xiCcjnu7WkOXAK9r61JoaaRpNmh7wLtPx7k6KCHslUcoBsjp_uAplMWLSH7rClRYEMZCw8NcnRHAh0&_hsmi=378594285&utm_content=378594285&utm_source=hs_automation"
...
![Obraz przedstawia minimalistycznego, ręcznie rysowanego robota z kwadratową głową, cylindrycznymi ramionami i nogami, siedzącego z neutralnym wyrazem twarzy. Jego oczy mają spiralny wzór, sugerujący poczucie kontemplacji lub „zagubienia w myślach”. Robot otoczony jest unoszącymi się abstrakcyjnymi kształtami w kolorze fioletowym i pomarańczowym, w tym gwiazdami, wirami i okręgami, co nadaje mu kapryśną, kosmiczną atmosferę. Logo Univio znajduje się w prawym górnym rogu](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20width='1500'%20height='1500'%20viewBox='0%200%201500%201500'%3E%3C/svg%3E)

Obraz przedstawia minimalistycznego, ręcznie rysowanego robota z kwadratową głową, cylindrycznymi ramionami i nogami, siedzącego z neutralnym wyrazem twarzy. Jego oczy mają spiralny wzór, sugerujący poczucie kontemplacji lub „zagubienia w myślach”. Robot otoczony jest unoszącymi się abstrakcyjnymi kształtami w kolorze fioletowym i pomarańczowym, w tym gwiazdami, wirami i okręgami, co nadaje mu kapryśną, kosmiczną atmosferę. Logo Univio znajduje się w prawym górnym rogu

### Konsekwencje halucynacji AI

W sprawie dotyczącej niewłaściwego wykorzystania sztucznej inteligencji dwóch prawników i ich kancelaria prawna Levidow, Levidow & Oberman, P.C., zostali ukarani grzywną w wysokości 5000 USD po [przedstawieniu fikcyjnych spraw prawnych wygenerowanych przez chatbota AI](https://apnews.com/article/artificial-intelligence-chatgpt-fake-case-lawyers-d6ae9fa79d0542db9e1455397aef381c). Incydent miał miejsce podczas roszczenia o odszkodowanie lotnicze przeciwko Avianca Airlines z Kolumbii. Prawnicy, szukając precedensów prawnych, zwrócili się do chatbota AI, który dostarczył im nieistniejące orzeczenia sądowe. Pomimo sygnałów ostrzegawczych mecenasi nadal opierali się na sfabrykowanych sprawach, nawet po tym, jak sędzia wyraził obawy co do ich ważności. Arbiter w sprawie, P. Kevin Castel, stwierdził, że prawnicy działali w złej wierze, przedstawiając fałszywe informacje, a następnie broniąc ich dokładności, gdy zostały zakwestionowane.
...
![](https://www.univio.com/wp-content/uploads/2024/10/univio_robot_toga.png)

### Stronniczość w opiece zdrowotnej

Badanie opublikowane przez MIT Technology Review wykazało, że narzędzia AI w opiece zdrowotnej nieproporcjonalnie faworyzowały pacjentów białych w stosunku do czarnych w przewidywaniu potencjalnej potrzeby interwencji medycznej ([Uniwersytet Chicago](https://news.uchicago.edu/story/health-care-prediction-algorithm-biased-against-black-patients-study-finds)).

### Stronniczość w narzędziach rekrutacyjnych

Badanie przeprowadzone przez University of Pennsylvania podkreśla [utrzymywanie się uprzedzeń związanych ze sztuczną inteligencją w rekrutacji](https://www.thomsonreuters.com/en-us/posts/legal/ai-enabled-anti-black-bias/). Raport mówi, że ==40% czarnoskórych specjalistów otrzymało rekomendacje dotyczące pracy oparte na tożsamości==, a nie na kwalifikacjach, a ==30% otrzymało powiadomienia dotyczące ról poniżej ich poziomu umiejętności==. Co więcej, ==63% stwierdziło, że rekomendacje akademickie były niższe niż ich rzeczywiste osiągnięcia==, co odzwierciedla sposób, w jaki systemy AI mogą utrwalać uprzedzenia rasowe.
...
Zapewnienie różnorodności wśród zespołów opracowujących te algorytmy i wdrażanie narzędzi takich jak [Fairlearn firmy Microsoft](https://fairlearn.org/) może pomóc złagodzić takie uprzedzenia i sprawić, że rekrutacja oparta na sztucznej inteligencji będzie bardziej sprawiedliwa.
...
Jednym z głównych problemów związanych z wykrywaniem oszustw za pomocą sztucznej inteligencji są fałszywe alarmy, w których legalne transakcje są niesłusznie oznaczane jako oszukańcze (fraudulent). Takie sytuacje frustrują klientów i prowadzą do strat finansowych dla firm. [Badania MIT](https://news.mit.edu/2018/machine-learning-financial-credit-card-fraud-0920) pokazują, że tradycyjne modele mają często niską dokładność (niektóre szacunki sugerują, że tylko jeden na pięć wskaźników sukcesu w przewidywaniu oszustw, powodując niepotrzebne blokady transakcji). [W 2018 r. amerykańscy sprzedawcy e-commerce stracili 2 miliardy dolarów](https://softjourn.com/insights/how-machine-learning-can-reduce-false-positives-increase-fraud-detection) z powodu tych fałszywych alertów, zrażając klientów i niszcząc relacje biznesowe.

![](https://www.univio.com/wp-content/uploads/2024/10/univio_fraud_blogpost.png)
...
O kluczowej roli zrozumienia, przygotowania i modelowania danych pisaliśmy [w tym artykule](https://www.univio.com/pl/blog/jak-wykorzystac-sztuczna-inteligencje-w-biznesie-praktyczny-przewodnik/).
...
![](https://www.univio.com/wp-content/uploads/2024/10/univio_keyboard_blogpost.png)
