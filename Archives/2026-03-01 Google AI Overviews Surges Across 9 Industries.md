...
![Google AI Overviews Surges Across 9 Industries](https://cdn.searchenginejournal.com/wp-content/uploads/2026/03/google-aio-surges-718.jpg)

Google AI Overviews Surges Across 9 Industries

<iframe title="Special Offer" src="https://www.searchenginejournal.com/wp-json/sscats/v2/stext/seo" frameborder="0"></iframe>
...
These results track with a [report](https://cdn.openai.com/pdf/2cb29276-68cd-4ec6-a5f4-c01c5e7a36e9/OpenAI-AI-as-a-Healthcare-Ally-Jan-2026.pdf) published by OpenAI in January 2026 that showed over 5% of all chats are healthcare-related and that 25% of weekly active users globally search ChatGPT with health-related questions.

It’s not just patients who are using AI for health related questions. According to a recent Brookings Institution [survey](https://www.brookings.edu/articles/how-are-americans-using-ai-evidence-from-a-nationwide-survey/#:~:text=A%20deeper%20dive%20into%20business,of%20respondents%20report%20AI%20use.), 53% of healthcare professionals use AI.
...
This is due to the effect of [Google’s FastSearch](https://www.searchenginejournal.com/google-antitrust-case-ai-overviews-use-fastsearch-not-links/555220/), a method of retrieving the top 3 organic search results for multiple queries in response to one conversational query and then using those FastSearch organic results to create an answer.
...
[BrightEdge’s report](https://www.brightedge.com/resources/weekly-ai-search-insights/ai-overviews-one-year-presence-size-citing) shows continued expansion of AIO rather than stabilization. AI Overviews presence has risen 58 percent year over year and is now approaching half of all tracked queries.
