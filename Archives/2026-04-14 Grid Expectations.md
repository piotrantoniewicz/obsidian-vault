...
Patrick Gold of [The Change Climate Project](https://www.changeclimate.org/) wrote the [clearest articulation](https://www.changeclimate.org/blog/the-emissions-of-ai) I’ve seen of how a climate nonprofit can use AI in good conscience. His framing has stuck with me:
...
- **Know your provider.** Review their commitments to clean energy and their track record for meeting them. ([Climate TRACE](https://climatetrace.org/) is tracking emissions from all AI data centers globally, and will release free tools later this year so anyone can see the data for themselves.)
- **Time it right.** If you want to make your AI use pollution-free, tools exist to help. WattTime [offers a service](https://watttime.org/solutions/load-shifting/) that shifts compute to surplus clean energy, and Microsoft’s [Carbon-Aware Kubernetes](https://medium.com/@StackGpu/carbon-aware-kubernetes-redirecting-workloads-for-a-greener-cloud-4ffd33557acb) does similar work.
...
- Good things come in seven: Wonders of the Ancient World, days of the week, and the AI principles Center for Humane Technology just dropped. Their report, “ [The AI Roadmap](https://www.humanetech.com/ai-roadmap),” offers a framework for how AI should be built, deployed, and governed, covering everything from corporate accountability to international guardrails.
- Funders want to see impact before they invest. Nonprofits need investment before they can show impact. Classic catch-22. In a new [Candid piece](https://candid.org/blogs/using-ai-to-advance-mission-for-nonprofits/) with Elisha Smith Arrillaga and Nick Cain, we dig into why the AI funding gap persists and what it takes to close it.
- After seeing how effective its unreleased model, Mythos, can be at finding high-severity security issues, Anthropic has announced [Project Glasswing](https://www.anthropic.com/glasswing). The Project gives partners the opportunity to use Mythos defensively, with Anthropic’s financial support, prior to its release.
- Following last year’s [2025 AI for Humanity Report](https://www.ffwd.org/2025-ai-for-humanity-report), Fast Forward is developing the 2026 edition to understand how nonprofits are building, funding, and deploying AI for social impact. If you’re a founder or CTO at a nonprofit using AI, fill out the [interest form](https://tally.so/forms/dWP1yz) to be notified when the survey goes live.

#### APN Opportunities and Funding News

- Applications are still open for the [$30M Google.org Impact Challenge: AI for Science](https://www.google.org/impact-challenges/ai-science/). Apply by April 17.
- [UNICEF Venture Fund](https://www.unicefventurefund.org/call/funding-frontier-climate-tech-childrens-health) is offering up to $100,000 in equity-free funding for early-stage startups in UNICEF program countries using AI, ML, or blockchain for climate and children’s health. Must be open-source. Apply by May 17.
