...
[Oakville Hospital Foundation](https://oakvillehospitalfoundation.com/), based in Ontario, Canada, is on a mission to transform the community health care experience at Oakville Trafalgar Memorial Hospital. By raising and distributing funds for medical equipment and technology, the foundation helps build and sustain a healthy, resilient community.
...
While the foundation had been using Intuit Mailchimp for its email marketing and fundraising efforts, it wasn’t leveraging the platform’s full potential. That changed when they partnered with [NVISION](https://nvision.co/), a Mailchimp [pro partner](https://mailchimp.com/find-an-expert/nvision) and full-service digital marketing agency based in Toronto. NVISION helped them optimize their email marketing strategy for [Giving Tuesday](https://mailchimp.com/resources/giving-tuesday-campaigns/?igaag=154664726859&igaat=&igacm=20637339549&igacr=687230856184&igakw=&igamt=&igant=g&ds_c=DEPT_AOC_Google_Search_US_EN_NB_Acquire_Broad_DSA-Rsrc_US&ds_kids=p78250621731&ds_a_lid=dsa-2227026702184&ds_cid=71700000115207178&ds_agid=58700008574686663&gclsrc=aw.ds&gad_source=1&gclid=CjwKCAiAlPu9BhAjEiwA5NDSAzib5l-UDcsOIVm1_LHNyz9HEQmcxuMdnmCOyn50vbYtQA3gu1__TBoCc9AQAvD_BwE), a global movement that encourages people to give back in whatever ways they can.
...
1. Lack of targeted **email segmentation**
2. Limited insight into **donor behavior**
3. Shortage of **personalized donor communication**
...
- Mailchimp’s [marketing dashboard](https://mailchimp.com/help/about-email-analytics/) to determine optimal campaign timing and frequency
- [Custom reports](https://mailchimp.com/help/create-custom-reports/) to analyze donor behavior and refine messaging throughout the campaign
- [A/B testing](https://mailchimp.com/help/create-ab-tests/) to refine email content and calls to action
- [Send Time Optimization](https://mailchimp.com/help/use-send-time-optimization/) to fine-tune email delivery, aligning AI-driven recommendations with their existing strategy, to reach donors at peak engagement times
...
NVISION’s strategic approach and use of Mailchimp’s [advanced marketing tools](https://mailchimp.com/solutions/audience-segmentation-tools/) led to great results.
...
NVISION’s relationship with Mailchimp has evolved since they joined [Mailchimp & Co](https://mailchimp.com/andco/) as members in November 2020. As a Mailchimp [pro partner](https://mailchimp.com/find-an-expert/nvision) today, with a listing in [Mailchimp’s Experts Directory](https://mailchimp.com/find-an-expert/), NVISION continues to use Mailchimp’s advanced marketing tools and platform to help drive results for its clients.
...
Thanks for reading our customer stories. We hope they give you the insights and inspiration needed to take your marketing to the next level.

That being said, we have to tell you that:

1. The views, information, or opinions expressed in this article are solely those of the individuals involved and do not represent those of Intuit Mailchimp or any of its cornerstone brands or employees.
2. Features and functionality vary by plan.
