...
## Personalisation is not cosmetic anymore (it’s contextual)
...
## Actions speak louder than words (and that’s why intent wins)
...
1) Active intent: “I’m close to a decision”

Active intent is what most people think of when they think of intent. It’s the down-funnel stuff. The “I’m in buying mode” signals. The “I’m evaluating” signals. The “this could happen soon” signals.

In B2C and D2C, active intent is obvious:

- Someone abandons a basket.
- Someone repeatedly views a product page.
- Someone gets to checkout and stops.
- Someone starts a subscription flow and bails.

In B2B, it looks different, but it’s the same underlying truth.

- Someone requests a demo.
- Someone visits the pricing page repeatedly.
- Someone reads high-intent pages like implementation, migration, integrations, or security.
- Someone consumes decision-stage content and then returns again.

In my own business, I track visits to my “Work with me” page because that page is explicit. It is not an educational page. It is a commercial page. If someone lands there, they’re not casually browsing. They are signalling something far stronger than curiosity.

Active intent usually means the person is either in buying mode or in decision-making mode.

And if you get active intent wrong, you lose easy wins. Because this is the moment where the email can genuinely help someone take a next step.

But here’s the catch: active intent also needs restraint. Because active intent can overlap. It can spike. It can trigger multiple flows. It can be misinterpreted without exclusions. We’ll come back to that.

2) Passive warming intent: “I’m paying attention, but I’m not ready”

This is the bucket that matters most for long-term growth, and the bucket most teams treat badly.

Passive warming intent is not someone shouting “take my money.”

It’s someone showing interest. Quietly. Repeatedly. Sometimes inconsistently. Often alongside other priorities.

This looks like:

- They consume content in clusters.
- They return to your blog several times.
- They attend a webinar.
- They browse a product category.
- They spend time on site.
- They read, save, and come back later.

These people are warming up. They’re building familiarity. They’re forming an opinion. They’re learning. They are not necessarily asking for a pitch.

And this is where most programmes misfire.

Because instead of using passive warming intent to guide someone through understanding, reassurance, proof, and clarity, many brands treat it like a sales signal and jump too quickly to pressure.

Passive intent requires sequencing. It requires pacing. It requires content that matches the mental and emotional state of someone who is exploring, not deciding.

3) Negative intent: “This is the wrong time” (and nobody talks about it)

This is my hill.

Negative intent is the missing pillar of personalisation.

Negative intent isn’t always an action. Often it’s inaction. It’s absence. It’s drop-off. It’s a behaviour shift. It’s the signal that the relationship has changed.

Negative intent can look like:

- They stop opening after a period of activity.
- They stop visiting the site.
- They go cold after being warm.
- They repeatedly visit FAQs and never convert.
- They open a support ticket.
- Their trial becomes inactive.
- They sign up for a discount code and never purchase within the expected window.

Negative intent matters because it tells you something very different:

- It might be hesitation.
- It might be objections.
- It might be confusion.
- It might be distrust.
- It might be wrong timing.
- It might be that you’re not the right solution.

And if you keep sending “buy now” emails during negative intent, you create friction. You train inbox algorithms that your emails are ignorable. You burn trust. You burn permission.

Which means: negative intent isn’t just a strategy problem. It’s a deliverability and reputation problem too.

## Exercise 1: Build your intent signal matrix
...
## Where prediction fits (and why prediction is not the same as assuming)
...
- The first is predicting what people are likely to do next.
- The second is predicting what step they need before they will do it.
...
## Exercise 2: The “Prediction without assumptions” worksheet
...
## Your ecosystem is not opens and clicks (and it never was)
...
## The “wrong time” problem (and why exclusion is personalisation)
...
## A B2C example: the haircare brand that keeps sending discounts
...
This is exactly where [TFDS becomes an intent-to-messaging bridge](https://weareastral.co.uk/thevault/designing-email-journeys-using-tfds).

## TFDS is your intent mapping tool

If you’ve [read my blog on designing email journeys using TFDS](https://weareastral.co.uk/thevault/designing-email-journeys-using-tfds), you already know I’m obsessed with it for a reason.
...
## How to build an intent-led email strategy
...
## The future of personalisation: fewer tokens, more timing
