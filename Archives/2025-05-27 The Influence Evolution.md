...
![Aitana Lopez is an influencer created with artificial intelligence by The Clueless, a catalan modeling company](https://dgap.org/sites/default/files/styles/dgap_content_large/public/imago443583971_169.jpg?itok=WT6pqR79)

Social media stands at a pivotal juncture where technology and humanity converge. From productivity tools to fully autonomous AI agents, we are witnessing a fundamental shift in how content is created, distributed, and consumed. This evolution presents dual futures: one in which AI influencers and agents dominate engagement, and another that embraces decentralized networks that enhance user agency. What is now at stake isn’t merely technological advancement but the authenticity of human connection.

![DGAP Policy Brief_Nr-13_Mai-2025_12S-COVER](https://dgap.org/sites/default/files/styles/issue_cover_teaser/public/article_pdfs/13_DGAP%20Policy%20Brief-Influence%20Evolution.png?itok=ohttNhd9)

[DGAP Policy Brief No. 13, May 2025, 12 pp](https://dgap.org/system/files/article_pdfs/13_DGAP%20Policy%20Brief-Influence%20Evolution%203.pdf "13_DGAP Policy Brief-Influence Evolution 3.pdf")

application/pdf302.36 KB

The relationship between AI and influencers exists on a spectrum rather than as a binary distinction.The unique ability of social media to foster parasocial relationships is being transformed by AI, raising fundamental questions about authenticity, trust, and the nature of digital influence.The tension between AI agent deployment and decentralized human-centered models represents fundamentally different visions for how social media will evolve – each with distinct implications for human connection, content authenticity, and platform governance.Effective policy must balance innovation with the safeguarding of human agency by creating frameworks that harness AI’s capabilities while ensuring transparency, user control, and the preservation of meaningful human connection.
...
[Accept all cookies](https://dgap.org/en/research/publications/influence-evolution#cookiesjsrAccept)
...
[  
](https://dgap.org/sites/default/files/styles/dgap_content_large/public/13_dgap-policy-brief-influence-evolution-2_1.png?itok=qlls3hal)
...
The scenario presented in Part III is the result of intensive discussions among those attending the Berlin Study Visit of DGAP’s “German-American Initiative on Influencers, Disinformation, and Democracy in the Digital Age” from April 8 to 12, 2025.

The scenario emerged from a structured foresight methodology that identified the key drivers and uncertainties shaping social media’s future based on this specified premise: **AI Agents are coming; it’s not a question of if, but when, and it will happen sooner rather than later.**
...
[Center for Geopolitics, Geoeconomics, and Technology](https://dgap.org/en/research/programs/center-geopolitics-geoeconomics-and-technology)

[German-American Initiative on Influencers and Leadership in the Digital Age](https://dgap.org/en/research/programs/technology/center-geopolitics-geoeconomics-and-technology/german-american)

### Themen & Regionen

- [Technology](https://dgap.org/en/research/expertise/technology)

[Dr. Katja Muñoz](https://dgap.org/en/user/29072/katja-munoz)

Senior Research Fellow, Center for Geopolitics, Geoeconomics, and Technology

[Maria Pericàs Riera](https://dgap.org/en/user/30446/maria-pericas-riera)
