...
![Grafika promująca artykuł TechSoup Polska pt. Jak pisać czytelne i zwięzłe e-maile? Przegląd technik strukturyzacji treści. W tle laptop z otwartą skrzynką mailową, na pierwszym planie dłonie piszące na klawiaturze.](https://api.ngo.pl/media/get/266882?w=1200&h=800)

Grafika promująca artykuł TechSoup Polska pt. Jak pisać czytelne i zwięzłe e-maile? Przegląd technik strukturyzacji treści. W tle laptop z otwartą skrzynką mailową, na pierwszym planie dłonie piszące na klawiaturze.
...
Badania [eye-trackingu](https://www.nngroup.com/articles/f-shaped-pattern-reading-web-content-discovered/?utm_source=blog.polkadotinnovations.com&utm_medium=referral&utm_campaign=write-internal-emails-that-get-actioned-with-the-bluf-technique-and-a-skimmable-f-structure) pokazują, że ludzie **czytają tekst w kształcie litery F**, skupiają się na pierwszych liniach i szybko „zjeżdżają” po lewej stronie treści. To znaczy, że jeśli kluczowa informacja schowa się w środku drugiego akapitu, jest spora szansa, że **nikt jej nie zauważy**.
...
![Zrzut ekranu z długiego, nieuporządkowanego maila dotyczącego komunikacji z wolontariuszami. Wiadomość ma formę jednego bloku tekstu bez wyróżnień ani streszczenia, przez co trudno szybko wychwycić najważniejsze informacje.](https://api.ngo.pl/media/get/266884?w=1465&h=933)

Zrzut ekranu z długiego, nieuporządkowanego maila dotyczącego komunikacji z wolontariuszami. Wiadomość ma formę jednego bloku tekstu bez wyróżnień ani streszczenia, przez co trudno szybko wychwycić najważniejsze informacje.
...
![Zrzut ekranu z maila napisanego metodą BLUF – kluczowy wniosek i propozycja umieszczone na początku wiadomości pogrubionym tekstem. Niżej znajduje się uzasadnienie i szczegóły. Mail jest krótki, uporządkowany i łatwy do przeskanowania](https://api.ngo.pl/media/get/266885?w=1448&h=860)

Zrzut ekranu z maila napisanego metodą BLUF – kluczowy wniosek i propozycja umieszczone na początku wiadomości pogrubionym tekstem. Niżej znajduje się uzasadnienie i szczegóły. Mail jest krótki, uporządkowany i łatwy do przeskanowania
...
![Zrzut ekranu z maila napisanego według schematu SCQA: najpierw opis sytuacji, potem komplikacji, pytanie prowadzące do rozwiązania i na końcu propozycja działania. Każdy fragment oddzielony akapitem i oznaczony pogrubionym nagłówkiem.](https://api.ngo.pl/media/get/266886?w=1460&h=935)

Zrzut ekranu z maila napisanego według schematu SCQA: najpierw opis sytuacji, potem komplikacji, pytanie prowadzące do rozwiązania i na końcu propozycja działania. Każdy fragment oddzielony akapitem i oznaczony pogrubionym nagłówkiem.
...
![Zrzut ekranu z maila zawierającego krótkie streszczenie TL;DR na początku – jedno zdanie podsumowujące propozycję, wyróżnione pogrubieniem. Niżej pełna treść wiadomości z kontekstem i argumentacją.]](https://api.ngo.pl/media/get/266887?w=1458&h=916)

Zrzut ekranu z maila zawierającego krótkie streszczenie TL;DR na początku – jedno zdanie podsumowujące propozycję, wyróżnione pogrubieniem. Niżej pełna treść wiadomości z kontekstem i argumentacją.\]
...
Źródło: [Fundacja TechSoup Polska](https://www.techsoup.pl/)
