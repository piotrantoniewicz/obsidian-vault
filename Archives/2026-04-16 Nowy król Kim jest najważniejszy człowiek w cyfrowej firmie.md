...
Jako wiarygodną podstawę dla wyceny tych kompetencji często przywołuje się stawki oferowane przez sektor publiczny, który jako pierwszy zaczął budować dedykowane struktury nadzoru. Nabory prowadzone przez ==[Europejski Urząd ds. Sztucznej Inteligencji](https://artificialintelligenceact.eu/job-opportunities-european-ai-office/)== (European AI Office) dla ekspertów technicznych i prawnych przewidują wynagrodzenia bazowe w przedziałach od ok. 4,1 tys. do ponad 8,6 tys. euro miesięcznie.
