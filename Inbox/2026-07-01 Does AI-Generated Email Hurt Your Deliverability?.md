...
url: "https://weareastral.co.uk/thevault/does-ai-generated-email-hurt-your-deliverability-the-honest-answer?utm_medium=email&_hsenc=p2ANqtz-8tVidsPMp2nZKDolngBN-wSN4zlSetVwy4p2mAAYeDtIlWc5kx2EFdWozNdtaODx1kwwLLDQnfk2as65bBktxdcsurnl6gE2o6qfC_AJTUlsoPfS4&_hsmi=139798729&utm_content=139799049&utm_source=hs_email"
...
## Are spam filters targeting AI-generated content? Not quite.
...
*→ Litmus: The Dangers of Generative AI in Email Marketing ([litmus.com/blog/the-dangers-of-generative-ai-in-email-marketing](https://www.litmus.com/blog/the-dangers-of-generative-ai-in-email-marketing))*  
*→ Validity 2026 Deliverability Benchmark Report ([validity.com](https://www.validity.com/resource-center/2026-email-deliverability-benchmark-report/))*

### The volume problem is making this worse for everyone
...
## The homogenisation problem — why AI copy erodes your sender association
...
## Gemini in Gmail, the bigger deliverability story that most people are not talking about yet
...
\- Gmail now synthesises email threads into concise summaries. When a subscriber opens an email thread, Gemini generates a summary of the key points. They can also ask their inbox natural language questions — "what offers have I received from this brand?" or "did my order ship?" — and Gemini surfaces answers drawn from their email history without them opening any individual email. Google is explicit about the intent: AI Overviews exist so users "don't have to open and read through individual messages."

AI Inbox

\- currently in trusted tester phase, broader rollout expected throughout 2026. This is a new inbox view that gives subscribers a personalised briefing: to-dos extracted from emails, topics to catch up on, urgent items surfaced, and everything else — which for most subscribers means marketing email — deprioritised as background noise. Gmail prioritises by relationship signals (people the subscriber emails frequently, contacts in their address book, inferred relationships from message content) and by actionability (bills, appointments, time-sensitive items).

Relevance-based Promotions tab

\- already live for most users. Gmail moved the Promotions tab from chronological sorting to relevance-based sorting. An email that arrived an hour ago from a brand with strong engagement history can now sit above an email that arrived yesterday from a brand with weaker signals. Your position in the Promotions tab is no longer determined by when you sent. It is determined by how much your subscribers have historically wanted what you send.
...
*→ Folderly: How Gmail's Gemini AI Changes Email Deliverability in 2026 ([folderly.com/blog/gmail-gemini-ai-email-deliverability-2026](http://folderly.com/blog/gmail-gemini-ai-email-deliverability-2026))*  
*→ Google: Gmail is entering the Gemini era ([blog.google/products-and-platforms/products/gmail/gmail-is-entering-the-gemini-era/](http://blog.google/products-and-platforms/products/gmail/gmail-is-entering-the-gemini-era/))*  
*→ Emailexpert: Gmail Launches AI Inbox ([emailexpert.com/gmail-launches-ai-inbox/](http://emailexpert.com/gmail-launches-ai-inbox/))*

### What this means for how you think about engagement signals
...
*→ Harro: Gmail's AI Inbox may redefine deliverability ([harro.com/2026/05/08/gmails-ai-inbox-may-redefine-deliverability/](http://harro.com/2026/05/08/gmails-ai-inbox-may-redefine-deliverability/))*

### The open rate inflation problem — why your data just got even less reliable
...
*→ Stop Reporting on Opens and Clicks. Here's What to Measure Instead ([weareastral.co.uk/thevault/stop-reporting-on-opens-and-clicks.-heres-what-to-measure-instead](https://weareastral.co.uk/thevault/stop-reporting-on-opens-and-clicks.-heres-what-to-measure-instead))*  
*→ Zepic: Gmail Update 2026 — What It Means for Email Marketing ([zepic.com/article/gmail-update-2026-gemini-integration-what-it-means-for-email-marketing-in-2026](http://zepic.com/article/gmail-update-2026-gemini-integration-what-it-means-for-email-marketing-in-2026))*

## Outlook and Copilot — the inbox environment that was already harder and is getting more so
...
*→ Microsoft Copilot in Outlook — April 2026 Agent Mode rollout ([testingcatalog.com/microsoft-copilot-in-outlook-adds-ai-to-manage-inbox-and-calendar/](http://testingcatalog.com/microsoft-copilot-in-outlook-adds-ai-to-manage-inbox-and-calendar/))*  
*→ Practical 365: Copilot in Outlook brings AI to email filtering ([practical365.com/prioritize-my-inbox/](http://practical365.com/prioritize-my-inbox/))*

## One more thing: image-heavy emails are now a bigger problem than they were
...
→ Bloomreach: Gmail Changed the Game — What Google's AI-Powered Inbox Means for Email Marketers ([bloomreach.com/en/blog/gemini-gmail](http://bloomreach.com/en/blog/gemini-gmail))

## Pulling it together — five ways AI is affecting deliverability right now
...
1\. AI copy → lower engagement → worse deliverability

*The mechanism is engagement-based, not spam-detection-based*

Spam filters are not detecting AI-generated content. What they are detecting is the consequence of it — generic, low-relevance email that subscribers do not click. Lower click signals feed into sender reputation models at every inbox provider, and sustained low engagement produces sustained inbox placement deterioration. The fix is not to stop using AI. It is to stop using AI as a shortcut that bypasses the thinking that makes email relevant.

2\. AI spam volume → stricter filters for everyone

*Bad actors have made the environment harder for legitimate senders*

Over half of spam sent globally is now AI-generated. Inbox providers have responded by tightening their filters across the board, which means legitimate senders with marginal engagement signals are getting caught in nets that were built in response to AI-enabled spammers. The standard for "good enough to reach the inbox" has risen, and it will continue to rise.

3\. Gemini in Gmail → semantic layer on top of spam filtering

*Content quality and relevance are now inbox placement signals*

Gmail has added a relevance assessment layer that operates above traditional spam filtering. Even emails that clear spam filters can be deprioritised if Gemini's model rates them as low relevance for that specific subscriber. The ranking signals are engagement depth, actionability, relationship strength, and content clarity. Promotional email that lacks specificity, personalisation, and genuine value is structurally disadvantaged in this model — regardless of authentication and list hygiene.

4\. Gmail auto-opens → open rate data is even less reliable than it was

*If you are using opens to make programme decisions, stop*

Gemini opens emails to generate summaries. This registers as an open in your ESP. Industry open rates have risen to 45.6% on average — an inflation driven by machine opens, not human ones. Any programme decision based on open rate is now based on data that is further from reality than it has ever been. Click rate, reply rate, and complaint rate are the metrics worth tracking.

5\. Outlook Copilot → email triage by relationship signal

*B2B senders are operating in the hardest inbox environment of any major provider*

Microsoft's AI-driven inbox prioritisation — Focused Inbox, Prioritise My Inbox, and now Copilot Agent Mode — all sort by relationship signal and actionability. Marketing email is structurally disadvantaged in a model built to serve the recipient's working life. Combined with Outlook's already-below-average inbox placement rate of 77.4%, B2B email programmes sending primarily to Microsoft addresses are navigating a materially harder environment than the industry averages suggest.

## What all of this actually points to
