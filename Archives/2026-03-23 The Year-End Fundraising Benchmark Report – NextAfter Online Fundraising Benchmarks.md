...
type: Web
authors: null
url: 'https://benchmarks.nextafter.com/year-end/'
published:
created: 2026-03-23
tags:
  - fundraising
...
![](https://benchmarks.nextafter.com/wp-content/uploads/2024/09/Donor-Retention-Year-End_3D_cover-2048x1366.png)
...
What kinds of organizations are in this report?
...
![](https://benchmarks.nextafter.com/wp-content/uploads/2024/02/subscribers-icon.svg)
...
When looking at the communication frequency of 211 organizations, we found that **40% of nonprofits did not send a single email to their online donors** during the entire year-season (November 15—December 31).

##### 40% of nonprofits sent zero emails to their new online donors during the year-end giving season.
...
Looking at our email inbox and postal mail during the year-end season, we received 2,003 emails and 248 pieces of mail. Most organizations communicated via a single channel (if at all). **Only** **36% of organizations communicated with their donors in multiple channels during the year-end season.**

But how much does a multi-channel approach impact results?

A Shocking Finding From Analyzing Year-End Direct Mail
...
![](https://benchmarks.nextafter.com/wp-content/uploads/2024/09/Screenshot-2024-09-27-at-9.58.57%E2%80%AFAM.png) ![](https://benchmarks.nextafter.com/wp-content/uploads/2024/02/lifetime-value-icon.svg)
...
##### Test Idea:Instead of sending all your emails during peak times, test sending some on weekends and in the evening.

![](https://benchmarks.nextafter.com/wp-content/uploads/2024/09/Screenshot-2024-07-25-at-2.56.49%E2%80%AFPM.png)
...
![](https://benchmarks.nextafter.com/wp-content/uploads/2024/02/gifts-icon.svg)
...
##### December 31st brought in nearly 3x more revenue than Giving Tuesday.

Even more, **the last full week of the year brought in an additional 32% of online year-end revenue.**
...
##### Key Takeaway:Build an email plan that incorporates both giving days, but prioritize your communications around the last week of the year.
...
**Active Cultivation** requires the reader to engage in order to receive the value. This often includes offers like eBook downloads, surveys, petitions, online courses, and more. This type of cultivation allows you to create **a clear pathway from email engagement to a donation using the “ [instant donation page](https://www.nextafter.com/blog/instant-donation-pages/) ” funnel**.
...
But when analyzing the communication sent by 200+ nonprofits during year-end, we found that an **overwhelming amount of cultivation was purely passive** information.

##### High retention organizations are more inclined to send “Active Cultivation” to donors during year-end.
...
##### High retention organizations are more likely to actively encourage donors to reply to their emails.

![](https://benchmarks.nextafter.com/wp-content/uploads/2023/12/analytics-print-2048x2048.png)
...
**Let’s break down online year-end revenue data from 2024.**

1. 5% of online year-end revenue came in on Giving Tuesday.
2. 14% of online year-end revenue came in on December 31st.
3. Almost 32% came in during the last week of the year.
...
##### The website traffic volumes between Giving Tuesday and December 31st are very similar.

[Web traffic](https://infogram.com/4bd637e8-50d2-40f2-9709-95882d03182a)  
...
##### Website traffic is 60% more likely to donate on December 31st than on Giving Tuesday.
...
##### The average donation size is 92% higher on December 31st than on Giving Tuesday.
...
##### Go from "what now?" to "dialed in" in under 90 days
