...
As the adage goes, “when you have a hammer, everything looks like a nail”. Or, in the case of the miners in the fantastic [Chernobyl miniseries](https://en.wikipedia.org/wiki/Chernobyl_\(miniseries\)?ref=gfsc.community), when you have massive nationalised manufacturing, everything looks like an opportunity to create an over-engineered, hyperspecialised steam engine.
...
This tendency to over-engineer is sadly, ubiquitous. How did it get like this? In a previous article I wrote about how [technology isn't a magic wand, it's a treasure map](https://gfsc.studio/blog/2021/technology-isnt-a-magic-wand/?ref=gfsc.community). I think we are now so used to thinking of technology as set of magic bullets that we sort of know probably won't work, or just create new problems: [this hilarious thread about someone trying to set up a smart home](https://retro.social/@ifixcoinops/113449116942689314?ref=gfsc.community) comes to mind. After 100s of magic bullets and our lives *still* being admin hell, only with more surveillance and logins than we ever dreamed existed, and somehow a dozen monthly fees for the privilege, the problems we are trying to solve have never been less clear.
...
![A diagram of the CTP approach which shows the elements below in the text laid out in a square with the CTP in the middle.](https://gfsc.community/content/images/size/w2400/2025/04/ctp-program-model.png)

A diagram of the CTP approach which shows the elements below in the text laid out in a square with the CTP in the middle.
...
![](https://gfsc.community/content/images/2025/04/Screenshot-2025-04-15-at-15.30.37.png)
...
This also allows for tech to be reused, reduced and recycled, something we mentioned in our [first ever post](https://gfsc.studio/blog/2017/tech-culture-failing-communities/?ref=gfsc.community) on this concept way back in 2017. In other domains it would be self explanatory to try and do as much as possible with existing resources *before* commissioning new work, however the culture and practice of the tech world demands constantly shipping new things.
...
As a methodology-in-development, we've had a chance to try out some bits of this approach with some clients, but never from the start as a complete intervention from the ground up. [GFSC studios](https://gfsc.studio/?ref=gfsc.community) 's theory of change's ultimate goal is:
