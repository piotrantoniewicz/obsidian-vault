...
url: "https://weareastral.co.uk/thevault/how-email-copy-and-design-work-together?utm_medium=email&_hsenc=p2ANqtz-9H8w1U42zefrc18IvWtn81hxObiJUUUKAz_OO5hDeIW36EaePNugyJJgkOd5EPfXKpaPMNjn0SrC7iomRFR6yWM7O4cQUO5yO6Ta64crGGodIs0Zw&_hsmi=138049633&utm_content=137955817&utm_source=hs_email"
...
- The copy says one thing and the design emphasises something else
- The most important sentence is buried in body text while the most prominent visual element is a decorative header.
- The copy builds emotional momentum that the design interrupts
- The design creates a visual hierarchy that contradicts what the copy is trying to say is most important.
...
## Most emails are designed twice and written once
...
## Both are working on the same brain at the same time
...
The colours, the typography, the imagery, the overall visual tone. Both design and copy contribute: design determines the visual palette; copy determines the verbal register. A mismatch between a warm, chatty email and a cold, corporate-looking layout is an aesthetic misalignment.

Functional - how it works

Does the email do what it is supposed to do? Can the reader find what they need, understand the message, and take the action? Both design and copy contribute: design determines whether the call to action is visible and clickable, copy determines whether the call to action is clear and compelling. A beautiful button with "click here" on it is a functional failure.

Experiential - how it feels

Does the email feel right for this audience, this moment, this relationship? Design contributes through visual tone, spacing, and hierarchy. Copy contributes through language, pace, and emotional register. This is the layer that is hardest to get right and impossible to get right if design and copy are made separately.

## The five places where design and copy must be aligned
...
### 1\. The pre-open package and the first visual
...
| **When they work against each other** | **When they work together** |
| --- | --- |
| Subject line: "Your Q3 results are in." First visual: a large hero image of the product with a tagline about features. | Subject line: "Your Q3 results are in." First visual: the key result, large, clear, immediately visible. Design serves the copy promise. |
| Subject line: "The haircare secret we've been keeping." First visual: generic brand header with logo and navigation bar. | Subject line: "The haircare secret we've been keeping." First visual: the product or ingredient, prominent, mysterious, matching the tone of the subject line. |

### 2\. Visual hierarchy and information hierarchy
...
| **When they work against each other** | **When they work together** |
| --- | --- |
| Copy tone: empathetic, personal, direct. "We know this has been a hard year for a lot of teams." Design: dense, formal, product-image-heavy, no white space. | Copy tone: empathetic, personal. Design: spacious, clean, minimal visual noise, copy leading rather than images. Both feel warm. Both feel human. |
| Copy tone: urgent, commercial. "Three days left. Don't miss out." Design: leisurely, editorial, no visual emphasis on deadline. | Copy tone: urgent. Design: prominent deadline, high-contrast CTA, visual weight on the time-sensitive element. Both create urgency. |
...
### 5\. White space as a message amplifier
...
## How to build design and copy together
...
- **Who is this for?** Not "our newsletter subscribers." The specific segment, where they are in the journey, what they are thinking and feeling right now based on the [TFDS framework](https://weareastral.co.uk/thevault/designing-email-journeys-using-tfds).
...
## Write copy for the design, design for the copy
...
## When design and copy work for each other and when they work against each other

They work for each other when:

- The subject line's emotional register matches the visual tone of the email opening
- The most visually prominent element carries the most strategically important message
- The call to action is both clearly worded and visually distinct
- White space is used deliberately to give weight to the sentences that need it
- The email communicates its core message without any images
- The emotional tone of copy and the visual tone of design are telling the same story
- Both start from the same brief answering the same six questions

They work against each other when:

- The design was built before the copy was written, and the copy was fitted to the template
- The most visually prominent element is decorative rather than strategic
- The CTA is perfectly designed but generically worded, or perfectly worded but visually buried
- The copy is warm and conversational but the design is cold and product-catalogue-heavy
- The subject line creates an expectation that the first visual does not immediately resolve
- White space is applied uniformly rather than used to emphasise specific messages
- The images-off version does not communicate the email's core message
- Copy and design were made by different people from different briefs and merged at the end
