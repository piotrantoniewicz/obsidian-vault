...
One of the few people who has figured out how to turn that endless scroll into real-world power is Gabriella Zutrau. She’s helped shape campaigns for [New York State Senator Julia Salazar](https://www.nysenate.gov/senators/julia-salazar) and MoveOn, and she was the brain behind the Instagram chatbot that turned [**Zohran Mamdani’s** campaign into a viral organizing machine](https://www.wired.com/story/the-big-interview-podcast-zohran-mamdani/): racking up over 21,000 clicks straight out of DMs during the primary alone. (No big deal or anything.)
...
![](https://mccdn.me/imgopt/width=256,quality=90,format=auto/martech/blog/2025/11/Gabbi-Z-1.png)
...
![](https://mccdn.me/imgopt/width=256,quality=90,format=auto/martech/blog/2025/11/Gabbi-Z-2.png)

Her work with Manychat has been quietly revolutionary. She introduced the tool to [MoveOn,](https://front.moveon.org/) where it’s now core to their national strategy. It didn’t make headlines, but **it proved automation could be an organizing force — not a gimmick**. The success of those same tactics used on the Mamdani campaign landed her a 2025 Media Innovation Fellowship with [Higher Ground Institute](https://highergroundlabs.com/institute/), where she trained hundreds of organizers and comms staffers on how to use chatbots to rally actual humans.
...
![](https://mccdn.me/imgopt/width=256,quality=90,format=auto/martech/blog/2025/11/Gabbi-Z-3.png)

And it worked. [*Campaigns & Elections*](https://campaignsandelections.com/) reported that Mamdani’s Instagram chatbot wasn’t just clever — it delivered. In two months, the Manychat bot fired off 77,000 messages, drove 21,000 clicks, and pulled in 10,000 emails — on a **$318 budget**.

That’s **three cents per contact,** all managed by Zutrau on her laptop.

Her success fits into a broader trend. A [Pew Research Center study found one in five Americans](https://www.pewresearch.org/journalism/2024/11/18/americas-news-influencers/) now gets news from influencers instead of traditional outlets. Those audiences skew young, diverse, and broke — the exact crowd campaigns like Mamdani’s need. Seeing a politician talk *to* voters instead of *at* them hit differently. Zutrau’s work lives at that messy, fascinating intersection of authenticity, tech, and grassroots energy.
...
![Skies](https://mccdn.me/imgopt/width=1800,quality=100,format=auto/martcdn/blog/contents/article/product-link_skies.jpg) ![Phone](https://mccdn.me/imgopt/width=1800,quality=100,format=auto/martcdn/blog/contents/article/product-link_phone.png)

## Learn more or get started in Manychat

[Learn more Learn more Learn more](https://manychat.com/) [Get started Get started Get started](https://app.manychat.com/signup/facebookAuth?channel=instagram)
