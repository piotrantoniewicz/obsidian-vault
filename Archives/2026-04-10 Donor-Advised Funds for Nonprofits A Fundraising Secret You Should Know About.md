...
url: 'https://www.causevox.com/blog/donor-advised-funds-for-nonprofits/'
...
![How-DAF-works](https://causevox.com/nitropack_static/JFPqmTyVxWjeXYSyoyXguULdpBolhTvd/assets/images/optimized/rev-389a089/www.causevox.com/wp-content/uploads/2026/04/image.png)
...
Donor-advised funds have been around since the 1930s, but they have exploded in popularity over the last decade. According to the [National Philanthropic Trust,](https://www.nptrust.org/reports/daf-report/) there are now over 1.9 million individual DAF accounts in the United States, holding hundreds of billions of dollars in charitable assets!
...
Donors who use donor-advised funds tend to give more generously than average donors. Research from [Fidelity Charitable](https://www.fidelitycharitable.org/) has found that DAF donors give significantly more to charity overall compared to donors who don’t use a DAF. When someone opens a donor-advised fund account, it often signals a deeper [commitment to philanthropy](https://www.causevox.com/blog/the-complete-guide-to-recurring-donations/), not just a one-time gift.
...
You don’t need to overhaul your entire [fundraising strategy](https://www.causevox.com/blog/fundraising-plan-calendar/) to start benefiting from donor-advised funds. A few simple steps can open the door.
...
Add a short note to your [donation page](https://www.causevox.com/donation-forms/) explaining that you accept donor-advised fund gifts, and include your organization’s EIN (Employer Identification Number), which donors will need when recommending a grant from their fund.

![EIN-on-donation-page](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjU2MCAxODgzIiB3aWR0aD0iMjU2MCIgaGVpZ2h0PSIxODgzIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
You don’t need to dedicate an entire [email newsletter](https://www.causevox.com/blog/nonprofit-email-marketing-guide/) to the topic. A single line in a [year-end appeal,](https://www.causevox.com/blog/year-end-giving-guide/) something like “Did you know you can recommend a grant to us directly from your donor-advised fund?” can plant a seed with donors who already have DAF accounts.
...
Look for gifts that come through Fidelity Charitable, Schwab Charitable, or similar sponsoring organizations. Those [donors are worth cultivating](https://www.causevox.com/blog/donor-cultivation-cycle/). Reach out, thank them personally, and build the relationship.

### 4\. Talk To Your Major Gift Prospects

If you’re having conversations with donors who are considering a [larger gift](https://www.causevox.com/blog/major-gifts-through-donor-stewardship/), donor-advised funds are worth bringing up. For donors who are charitably inclined and financially savvy, a DAF might be a natural fit that makes a bigger gift much easier for them to execute.
...
That said, sending a [warm acknowledgment](https://www.causevox.com/blog/donor-recognition-ideas/) is still best practice for relationship-building. Just make sure your receipt language is accurate: avoid stating that “no goods or services were provided in exchange” in a way that implies tax deductibility, since the donor’s deduction has already been handled elsewhere.

![what-to-know-about-DAF](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMTY0NCAxODgwIiB3aWR0aD0iMTY0NCIgaGVpZ2h0PSIxODgwIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)

what-to-know-about-DAF

*3 key things your nonprofit needs to know about DAF* s.
...
For nonprofits, the opportunity is real. You don’t have to be a large institution or have a dedicated major gifts team to start tapping into donor-advised fund giving. You just need to [make your organization easy to find](https://www.causevox.com/blog/ai-and-search-discoverability-for-nonprofits/), easy to give to, and worth investing in.

Start simple. Add a line to your [donation page](https://www.causevox.com/blog/complete-guide-donation-page/), mention donor-advised funds in your next appeal, and keep an eye on where your gifts are coming from. The donors who are already giving through DAFs might be your best partners for the long haul.

Get started building your [donation page](https://www.causevox.com/donation-forms/) with CauseVox today!
