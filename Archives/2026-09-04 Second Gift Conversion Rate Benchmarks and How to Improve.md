...
It sounds like donor retention, and it's related, but it isn't the same thing. Overall retention blends your loyal ten-year supporters in with the people who gave once last March. Those two groups behave nothing alike, so averaging them hides the problem. Second gift conversion isolates the single hardest and most valuable transition in fundraising: the moment a donation becomes a donor. It's one of the core measures behind [the Smart Steward Method](https://www.donordock.com/smart-steward-method?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup), our framework for stewardship that compounds instead of resetting every year.

## What percentage of first-time donors give again?

**About 19%.** According to the [Fundraising Effectiveness Project](https://publications.fepreports.org/retention-by-donor-type/), new donor retention was **18.9%** in the most recent reporting period, essentially flat year over year. Repeat donors, by contrast, were retained at **59.3%**.
...
Fundraising researcher Adrian Sargeant [found](https://nonprofitquarterly.org/donor-retention-nonprofit-donors/) that it typically costs two to three times as much to recruit a new donor as that donor gives in their first gift, and it can take 12 to 18 months before the relationship turns profitable.
...
This is also why “we need more donors” is so often the wrong diagnosis. A team converting first-time donors at 15% has to acquire nearly twice as many new donors to build the same base as a team converting at 28%. Fixing conversion is almost always cheaper than fixing volume, which is the whole case for [fixing retention before acquisition](https://www.donordock.com/articles/fix-retention-before-acquisition-nonprofit-growth?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup).
...
That's the job a donor management platform should be doing for you. Your CRM should know who's new, put the thank-you in front of the right person while it still counts, and flag the 90-day mark before it passes. In DonorDock, first-time donors surface on your [Action Board](https://www.donordock.com/features/like-a-virtual-assistant?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup) as their own segment, and [Smart Nudges](https://www.donordock.com/features/smart-nudges?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup) prompt the follow-up so the window doesn't close while you're heads-down on the next campaign.

If you want the step-by-step version of building that workflow, we wrote it up in [Stop the One-Time Donor Carousel](https://www.donordock.com/articles/stop-the-one-time-donor-carousel-building-relationships-that-last?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup). This piece is the why and the benchmark. That one is the how. For the wider view, start with our [donor retention strategies](https://www.donordock.com/articles/donor-retention-strategies?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup) guide.
