...
authors: ["[[Reid Robinson]]"]
url: https://www.youtube.com/watch?v=B5yDJAkz0rw
source: "[[Archives/2026-02-02 How this PM uses MCPs to automate his meeting prep CRM updates and customer feedback synthesis|2026-02-02 How this PM uses MCPs to automate his meeting prep CRM updates and customer feedback synthesis]]"
...
- [[Claude Projects]] pozwala nie tylko ładować wiedzę, ale precyzyjnie instruować model o kolejności i sposobie korzystania z narzędzi MCP — to niedoceniany mechanizm poprawy jakości automatyzacji
- Wybór modelu ma znaczenie: Gemini sprawdza się lepiej przy plikach PDF/HTML, Claude przy złożonych instrukcjach sekwencyjnych — warto dostosować model do formatu danych
- Myślenie o automatyzacji przez pryzmat „zadań, które nienawidzisz robić" jest efektywniejsze niż podejście „jak przyspieszyć to, co już robię"

## Zastosowanie

[[Zapier]] MCP + [[Claude Projects]] to gotowy stack do automatyzacji rutynowych zadań: aktualizacji [[Notion]], przygotowania do spotkań z organizacjami NGO, czy budowania bazy wiedzy z korespondencji emailowej. Schemat pętli feedbackowej można zastosować bezpośrednio do automatycznego przetwarzania odpowiedzi na outreach i aktualizacji bazy kontaktów.
