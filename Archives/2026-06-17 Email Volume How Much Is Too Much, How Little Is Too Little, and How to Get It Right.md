...
url: "https://weareastral.co.uk/thevault/email-volume-how-much-is-too-much-how-little-is-too-little-and-how-to-get-it-right?utm_medium=email&_hsenc=p2ANqtz-8_7po7uikRiQaR-ZWOHv3gjek8DTSAKEAiZvajNIE-AAW4NSU2Po-2gpr_YX5nhbBfGRzdMNZho47IG-POlyfMdY4eOVsafRs0XbmtKXshJxLTfZs&_hsmi=138619692&utm_content=138604867&utm_source=hs_email"
...
## The "more is more" myth - why high volume is not the same as high performance
...
### What high volume actually does to a subscriber relationship
...
## The "less is safer" myth — why low volume has its own costs
...
Problem 1: Sender reputation decay

*What happens when you go quiet for too long*

Inbox providers build sender reputation models based on sending patterns over time, and those models expect a degree of consistency. A sender who sends regularly — whether that is weekly, twice weekly, or monthly — builds a reputation based on that pattern, and the providers learn to trust the pattern. A sender who goes quiet for extended periods and then re-emerges with a large send has broken the pattern, and the providers respond to that disruption by applying additional scrutiny to the sends that follow.

This is one of the reasons seasonal senders — businesses that go quiet between peak periods and then send heavily during them — consistently report worse deliverability during their most commercially important windows than they achieve during their quieter periods when they maintain more consistent contact. The reputation they built during the consistent period decays during the silence, and the sudden volume spike looks to the providers like the kind of behaviour associated with compromised accounts and purchased lists.

Maintaining at least a minimal, consistent send cadence — even in periods when the commercial calendar is quiet — is a deliverability investment that most businesses undervalue because the cost of making it is diffuse and the cost of not making it only becomes apparent when it is too late.

Problem 2: Relationship atrophy

*The subscriber who forgot you signed up*

Familiarity and trust in the inbox are built through consistent, positive exposure over time — the billboard effect applied to the sender relationship. When contact becomes infrequent, the accumulated familiarity begins to decay. The subscriber who received your email every week for six months and then heard nothing for three months will encounter your next email in a fundamentally different relationship state than the one who received it consistently throughout.

The re-emergence email, arriving after a long silence, is processed by a brain that no longer has the pattern recognition infrastructure to categorise it quickly and positively. It has to be assessed more deliberately, against a weaker set of positive associations, with a higher probability of being treated as unexpected and therefore potentially unwanted. This is why re-engagement campaigns that go out to lists that have been ignored for months consistently underperform relative to their commercial potential — the relationship atrophy during the silence has done damage that a single re-engagement email cannot undo.

Problem 3: Missed commercial moments

*The cost of not being there when intent arrives*

Intent is not a state that subscribers maintain indefinitely while waiting for your email to arrive. It is a moment — a window of readiness that opens when circumstances align and closes when they shift. A subscriber who is actively considering a purchase, a renewal, or a new commitment will not wait for your next monthly send. They will make a decision based on what is in front of them, and if you are not in front of them during that window, a competitor probably is.

Low-frequency senders systematically miss intent windows that higher-frequency senders catch, not because the higher-frequency senders are sending better email but simply because they are present more often. This is the commercial cost of low volume that never appears in any email marketing metric, because you cannot measure the revenue generated by an email you did not send.
...
### What the changes specifically mean for volume
...
## How to find the right volume for your emails
...
### Step 1: Map your current volume by segment
...
### Step 2: Segment your list by engagement level before making any volume changes
...
### Step 3: Look at your per-send performance curve
...
### Step 4: Test before you change permanently
...
## How to reduce volume without losing commercial performance
...
### Strategy 1: Reduce to disengaged contacts first, maintain to engaged ones
...
### Strategy 2: Replace frequency with relevance through better segmentation
...
### Strategy 3: Move from calendar-based to intent-based sending
...
### Strategy 4: Consolidate sends rather than cutting them
...
### Strategy 5: Use frequency capping as a programme-level protection

***The technical rule that prevents the accumulation problem***

Frequency capping is a setting available in most sophisticated email platforms that limits how many emails a single subscriber can receive from you within a defined time window, regardless of how many campaigns and flows they qualify for simultaneously. A cap of three emails per week, for example, means that a subscriber who qualifies for a campaign send, a re-engagement trigger, and a newsletter in the same week will only receive three of those — the three with the highest priority as defined by the programme.

Frequency capping does not solve a relevance problem — if all three emails were going to be irrelevant, limiting the subscriber to three still sends three irrelevant emails — but it does solve the accumulation problem that occurs when multiple legitimate send types converge on the same subscriber simultaneously, and it provides a programme-level protection against the kind of unintended high-frequency experience that nobody planned but that happens when campaigns and flows are built independently without considering their combined impact.

## Having the volume conversation with stakeholders and winning it
