...
url: >-
  https://sektor3-0.pl/blog/skrzynka-e-mail-nie-musi-straszyc-poznaj-inbox-zero/?utm_source=newsletter&utm_medium=email&utm_term=2026-03-24&utm_campaign=+AI+w+r%C4%99kach+Gospody%C5%84+Wiejskich
...
![Skrzynka e-mail nie musi straszyć. Poznaj inbox zero](https://sektor3-0.pl/wp-content/uploads/elementor/thumbs/inbox-zero-blog-rhl29ax081j5y09jxctl5tw691b8oexods6b75qxdi.png "inbox-zero-blog")
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20940%20788'%3E%3C/svg%3E)
...
- zasugeruj w zespole przejście na inny kanał komunikacji, który nie wymaga wysyłania e-maili w najmniejszych sprawach (dobry do tego będzie [Slack](https://publicystyka.ngo.pl/slack-piec-funkcji-ktore-usprawnia-prace-twojego-zespolu));
...
- możesz postawić na asynchroniczną pracę i wysyłać [wideo-wiadomości](https://sektor3-0.pl/blog/nagrywanie-ekranu-i-wiadomosci-wideo-z-loom-jak-zastapic-niektore-spotkania/) lub głosówki, to format, który każdy może odtworzyć w dowolnym (i dogodnym) momencie;
...
**Czytaj także:** [Jak zapanować nad cyfrową mową ciała? Trzy rady dla pracujących zdalnie](https://publicystyka.ngo.pl/jak-zapanowac-nad-cyfrowa-mowa-ciala-trzy-rady-dla-pracujacych-zdalnie)

## Sprzątanie w skrzynce – pierwszy krok

Jeśli bierzemy się za porządki, to dobrze robić to z głową. Usuń lub archiwizuj to, co niepotrzebne: Powiadomienia Google Alerts i powiadomienia z Kickstartera to w mojej skrzynce łącznie ponad 750 wiadomości! I nie, nie z kilkunastu lat, a z zaledwie kilku. Pozbyłem się ich w sposób radykalny, dodatkowo wypisując się z kilku Kickstarterowych powiadomień. Podobne wiadomości dostajemy także od firm kurierskich, przy kupnie biletu przez aplikację lub ze sklepu online.  ![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20717%20208'%3E%3C/svg%3E)Szybkie rozwiązanie na mniej piętrzących się wiadomości: odsubskrybuj newslettery i inne formy, których nie czytasz lub są zbyt częste (wiesz dobrze, o które chodzi). W swojej skrzynce twórz etykiety, foldery i filtry (pozwolą na segregowanie wiadomości).
...
- [Shortwave](https://www.shortwave.com/) – narzędzie oparte na sztucznej inteligencji, pozwala na dostosowanie skrzynki do swoich potrzeb i migrację z innych rozwiązań, dostępna wersja darmowa, ale z ograniczeniami dotyczącymi korzystania z AI.
- [Missive](https://missiveapp.com/) – narzędzie przygotowane dla zespołów i wspólnej pracy, umożliwia “czaty” w mailach (na przykład w celu omówienia treści), najlepiej opisze to chyba równanie: Asana + Skrzynka e-mail, 30 dni darmowego okresu próbnego.
- [Hey](https://www.hey.com/) – próba wymyślenia skrzynki na nowo, możliwość akceptowania i odrzucania nowych nadawców, automatyczne segregowanie i archiwizacja treści, możliwość bezpłatnych testów przez 30 dni.
- [CanaryMail](https://canarymail.io/) – klient poczty e-mail, który umożliwia odsubskrybowanie jednym kliknięciem, oferuje szablony e-maili, współpracę w zespole i podłączenie dowolnej liczby kont, także w wersji darmowej.

**Sprawdź także:**

- [(Podcast) O newsletterach, skrzynkach i relacjach z odbiorcami](https://sektor3-0.pl/podcast/o-newsletterach-skrzynkach-i-relacjach-z-odbiorcami/)
- [Cyberprzestępcy to nie są zakapturzeni goście. Jak atakowane są organizacje społeczne?](https://sektor3-0.pl/blog/cyberbezpieczenstwo-w-organizacjach-spolecznych-maciej-broniarz/)
...
- [Sztuka email marketingu dla organizacji pozarządowych, czyli jak tworzyć niezapomniane newslettery](https://publicystyka.ngo.pl/sztuka-email-marketingu-dla-organizacji-pozarzadowych-czyli-jak-tworzyc-niezapomniane-newslettery)
