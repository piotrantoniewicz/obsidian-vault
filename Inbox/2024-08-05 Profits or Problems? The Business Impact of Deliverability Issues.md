...
Deliverability is complicated. But if you’re doing your best to send it right on a regular basis, you’ll [be better prepared to deal with an issue when you suspect one](https://send-it-right.com/blog/what-to-do-with-deliverability-issues). It’ll be quicker and easier to fix, too.

Here are some ways to proactively set yourself up for email deliverability success:

#### Build a strong sender reputation

Get permission before sending, lock down your [email authentication](https://send-it-right.com/blog/intro-to-email-authentication), optimize for engagement by sending relevant, valuable content your recipients can’t help but love, make it easy to unsubscribe in case they *don’t* love what you send. Avoid using clickbait and engaging in other activities that are likely to trigger spam complaints. Which reminds me…

#### Monitor email performance closely!

Track key metrics like delivery and [open rates](https://www.socketlabs.com/blog/email-performance-red-flags-low-open-rates/?utm_source=senditright&utm_medium=blog&utm_campaign=unforeseen_costs), [click-through rates](https://www.socketlabs.com/blog/email-performance-red-flags-low-click-through-rates/?utm_source=senditright&utm_medium=blog&utm_campaign=unforeseen_costs), [unsubscribes](https://send-it-right.com/blog/why-unsubscribes-arent-bad-for-deliverability/?utm_source=senditright&utm_medium=blog&utm_campaign=unforeseen_costs), and [spam complaint rates](https://www.socketlabs.com/blog/email-performance-red-flags-spam-complaints/?utm_source=senditright&utm_medium=blog&utm_campaign=unforeseen_costs) to identify potential problems early. Monitor for [blocklistings](https://www.socketlabs.com/blog/how-to-avoid-email-blocklists/?utm_source=senditright&utm_medium=blog&utm_campaign=unforeseen_costs) and learn from what they tell you (usually that there’s a problem with spam complaints or spam trap hits caused by poor list health).
...
- **Google.** Risky due to all the [problematic advice that’s passed around](https://send-it-right.com/blog/email-myths). Be wary of what you read unless you know it’s coming from a reputable source.
- **Artificial Intelligence (AI)** This one’s very risky, even though the advice comes off more confident than my 3 year-old nephew climbing countertops. Can’t tell you how many times AI has spit out something that’s completely wrong. Here’s an example where a [LinkedIn collaborative article (written by machines) has shared](https://www.linkedin.com/advice/1/whats-your-email-marketing-deliverability-rate?trk=cah1) [the wrong calculation](https://www.linkedin.com/advice/1/whats-your-email-marketing-deliverability-rate?trk=cah1) for the topic at hand: deliverability. Come on now, Bobby Robot!
...
So, be sure to join online communities, attend conferences and virtual events, and network with other email marketers to stay updated on what’s happening in the email industry as often as time allows. You will not regret it. Heck, you might even make some really awesome people along the way! Here’s a list of [people who’ve helped me send it right](https://send-it-right.com/experts-to-learn-from) over the years.
...
What other unforeseen costs have you experienced in your storied email career? [**Hit me up**](https://send-it-right.com/contact) **and let me know.** 💌
