...
- Maryland + [[Anthropic]] + Rockefeller + Claude do modernizacji usług publicznych — pierwszy duży precedens partnerstwa publiczno-prywatnego z AI dla dobra mieszkańców; warto śledzić jako model dla polskich samorządów.
- Free Our Vote: AI do identyfikacji uprawnionych wyborców z wyrokami + outreach + wsparcie w procesie przywracania praw — 1M osób, wzrost frekwencji o 26%; przykład AI w digital campaigning dla praw obywatelskich.

## Cytat
> AI mogło zakończyć niedobory, zniszczyć ludzkość lub... podnieść wzrost trendów o 0,2%. Kryształowa kula naprawdę by się przydała.

## Zastosowanie
Case studies z konkretnymi kosztami na beneficjenta (Lemontree, Koko, Darsel, Quill) są gotowym materiałem do szkoleń Piotra na temat mierzenia impaktu AI w NGO i budowania narracji fundraisingowej wokół AI.
