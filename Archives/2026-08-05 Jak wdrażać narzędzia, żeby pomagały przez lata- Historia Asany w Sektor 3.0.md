...
![Grafika przedstawia widok listy zadań i elementów interfejsu aplikacji. Na pierwszym planie widnieje biały arkusz z kolorowymi ikonkami odznaczenia (fajkami) oraz czarnymi liniami symbolizującymi tekst i żółtymi zakreśleniami. Wokół arkusza rozmieszczono mniejsze elementy interfejsu, takie jak przyciski z ikoną strzałki, dodatkowe zaciągnięte zadania oraz zielona kropka z pomyślnym odznaczeniem. W lewym dolnym rogu znajduje się logo marki Asana (trzy różowo-pomarańczowe kropki oraz napis „asana”).](https://api.ngo.pl/media/get/283917?w=1200&h=800)

Grafika przedstawia widok listy zadań i elementów interfejsu aplikacji. Na pierwszym planie widnieje biały arkusz z kolorowymi ikonkami odznaczenia (fajkami) oraz czarnymi liniami symbolizującymi tekst i żółtymi zakreśleniami. Wokół arkusza rozmieszczono mniejsze elementy interfejsu, takie jak przyciski z ikoną strzałki, dodatkowe zaciągnięte zadania oraz zielona kropka z pomyślnym odznaczeniem. W lewym dolnym rogu znajduje się logo marki Asana (trzy różowo-pomarańczowe kropki oraz napis „asana”).

Kilka lat temu [pisałam](https://sektor3-0.pl/blog/jak-efektywnie-wdrozyc-asane-w-zespole-dowiedz-sie-jak-zrobilismy-to-w-sektor-3-0/), że zespół Sektor 3.0 wprowadził do swojej pracy i zarządzania zadaniami [Asanę](https://asana.com/pl). Dziś, po latach, mogę napisać coś, co w świecie narzędzi cyfrowych zdarza się rzadko: nadal z niej korzystają – codziennie i systematycznie.

Dane pokazują, że Sektor 3.0 jest w mniejszości. Pokazują też, jak realny jest to problem. Dziś tylko [7% organizacji społecznych deklaruje](https://sektor3-0.pl/raport-nie-tylko-sztuczna-inteligencja-technologie-cyfrowe-w-organizacjach-pozarzadowych/) korzystanie z narzędzi do zarządzania projektami. Dodatkowo warto zauważyć, że liczba takich organizacji maleje (w 2021 było ich 16%). Jednocześnie 13% organizacji wprost wskazuje uporządkowanie pracy jako kluczową potrzebę rozwojową, a aż 79% czuje, że powinno korzystać z technologii szerzej.
...
![](https://api.ngo.pl/media/get/283998?w=1200&h=800)
...
![Szablon zadania dotyczącego odcinka podcastu przypisany do kilku projektów z tagami tematycznymi i podzadaniami.](https://api.ngo.pl/media/get/283968?w=605&h=493)

Szablon zadania dotyczącego odcinka podcastu przypisany do kilku projektów z tagami tematycznymi i podzadaniami. Autor/źródło: Asana Sektor 3.0
...
![Mem stworzony wewnątrz zespołu, który ma miał przypominać o wysłaniu raportu w Asanie.](https://api.ngo.pl/media/get/283984?w=605&h=403)

Mem stworzony wewnątrz zespołu, który ma miał przypominać o wysłaniu raportu w Asanie. Autor/źródło: Asana Sektor 3.0
...
Dobrze pokazuje to [Fundacja Przedsiębiorczości Kobiet](https://siecprzedsiebiorczychkobiet.pl/). Agata Zioło opowiada, że zespół stworzył osobny projekt onboardingowy, w którym krok po kroku wypisane są narzędzia, dokumenty i role. Dzięki temu nowa osoba nie musi o wszystko dopytywać, bo – jak mówi – „wszystko jest w Asanie”. Pomysł na onboarding w Asanie Agata Zioło zaczerpnęła właśnie z [artykułu na blogu Sektor 3.0](https://sektor3-0.pl/blog/jak-efektywnie-wdrozyc-asane-w-zespole-dowiedz-sie-jak-zrobilismy-to-w-sektor-3-0/). Dobre praktyki krążą po sektorze i wracają.

![Struktura projektu służącego do tworzenia treści w ramach portalu Sektor 3.0. Układ kanban w Asanie.](https://api.ngo.pl/media/get/283999?w=1200&h=800)

Struktura projektu służącego do tworzenia treści w ramach portalu Sektor 3.0. Układ kanban w Asanie. Autor/źródło: Asana Sektor 3.0
...
To właśnie dlatego w Remote Sensei zbudowaliśmy [Protokół Niezawodności](https://remotesensei.org/pl/protokol-niezawodnosci/) – 4-fazową metodykę wdrażania narzędzi, opartą na jednej zasadzie: oprogramowanie nie zmienia tego, jak ludzie pracują; zmieniają to nawyki. To te same mechanizmy, które w badaniach nad zarządzaniem zmianą decydują o trwałości: koalicja liderów, która prowadzi zmianę, i wzmacnianie nawyku, aż stanie się domyślny.
...
1. Jaki dokładnie problem ma rozwiązać to narzędzie?
2. Po czym poznacie, że został rozwiązany?
...
**Dołącz do bezpłatnego kursu e-learningowego:** [**Technologie cyfrowe w organizacji – jak wdrażać je świadomie, etycznie i z sensem?**](https://elearning.sektor3-0.pl/obszary/technologie-cyfrowe-w-organizacji-jak-wdrazac-je-swiadomie-etycznie-i-z-sensem/)

[![](https://api.ngo.pl/media/get/283986?sid=9e668ca734e04414afa049e802073f50.2)](https://elearning.sektor3-0.pl/obszary/technologie-cyfrowe-w-organizacji-jak-wdrazac-je-swiadomie-etycznie-i-z-sensem/)
...
Ciach Barbara [🡢](https://publicystyka.ngo.pl/kategoria/ciach-barbara)
