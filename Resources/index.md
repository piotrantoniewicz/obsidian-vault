# Indeks
- [[2000-04-21 What Millions of Campaigns Reveal About the Real Value of Email Opens — Blog]] — analiza milionów kampanii emailowych pokazująca, że otwarcia emaili wciąż mają kluczowe znaczenie dla dostarczalności i segmentacji wg świeżości angażowania.
- [[2000-06-03 Lessons from building Claude Code How we use skills]] — Anthropic: dziewięć kategorii skilli Claude Code i praktyczne wskazówki ich pisania — sekcja Gotchas, progresywne ujawnianie, opisy jako trigger dla modelu, pamięć skilla.
- [[2000-06-25 Michigan Election Ad Prompts Questions About Use of GenAI]] — spór o reklamę polityczną z manipulowanym wideo ujawnia luki w egzekwowaniu stanowego prawa Michigan o ujawnianiu AI w reklamach politycznych.
...
- [[2021-12-10 How to Engage Donors for Year-End Fundraising 5 Tips]] — 5 strategii angażowania darczyńców w sezonie końcoworocznym: harmonogram EOY, personalizacja apeli, matching gifts.
...
- [[2021-12-28 Email Marketing Tips and Tricks Live Text]] — Monica Hoyer: live text jako niezbędna podstawa kampanii emailowych — KISS design, dostępność i zasięg mobilny jako argumenty za minimalizacją obrazów w emailach.
...
- [[2023-12-28 2026 Cause Awareness & Giving Day Calendar for Nonprofits]] — Heather Mansfield: 70+ światowych dni tematycznych z hashtagami do planowania kampanii fundraisingowych NGO w 2026.
...
- [[2024-01-29 What the public think of charities using AI  CAF]] — Badanie CAF (6 000+ osób, 10 krajów): większość uważa, że AI daje organizacjom społecznym więcej szans niż ryzyk; kluczowe wnioski o transparentności i „ludzkim wymiarze" wdrożeń.
...
- [[2024-02-28 Ulepsz fundraising z wykorzystaniem AI]] — Przystępne wprowadzenie do zastosowania ChatGPT i Copilot Chat w fundraisingu NGO: generowanie pomysłów, planowanie kampanii, pisanie wniosków o dotacje.
...
- [[2024-03-18 The Dangers of Generative AI in Email Marketing]] — Litmus: AI przyspiesza kampanie mailowe, ale ułatwia też phishing niemal nieodróżnialny od prawdziwej komunikacji; transparentność, human-in-the-loop i autentykacja nadawcy jako odpowiedź.
...
- [[2024-06-11 6 Things to Do This Summer to Get Ready for a Profitable Q3 & Q4]] — Jess Campbell: 6 letnich działań (wdzięczność, czyszczenie listy, historie wpływu, transparentność, ankiety) przed sezonem end-of-year giving.
...
- [[2024-07-21 Why Unsubscribes Aren’t Bad For Deliverability]] — Lauren Meyer: dlaczego wypisania z newslettera nie szkodzą deliverability tak jak skargi spamowe, i 3-krokowy plan działania przy podwyższonym unsubscribe rate.
...
- [[2024-07-27 My (least) Favorite Email Myths]] — Lauren Meyer: 8 mitów email marketingu — zmiana IP nie naprawi reputacji, zakładka Promocje to nie porażka.
...
- [[2024-08-01 Key Takeaways from the 2025 Texting Insights Report]] — momoGood/MissionWired: analiza 138 mln SMS-ów NGO — ROI 4,38 USD na 1 USD, proporcja 2:1 (engagement vs. ask) i sekwencja MMS+SMS jako najskuteczniejszy wzorzec.
...
- [[2024-08-24 Why Email Shortcuts Don’t Work]] — Lauren Meyer: skróty emailowe (zakup list, warmup, zmiana IP) niszczą reputację nadawcy; jedyna skuteczna droga to opt-in i dostarczanie wartości.
...
- [[2024-09-12 Why Your Emails Aren't Reaching The Inbox]] — Lauren Meyer: 4 strukturalne przyczyny lądowania emaili w spamie — brak zgody, podejrzane wzorce, słabe zaangażowanie i ignorowanie sygnałów.
...
- [[2024-09-25 2024 Nonprofit Advertising Benchmark Study]] — Whole Whale: analiza 7 000+ organizacji społecznych — budżety reklamowe rosną (+12%), a mniejsze organizacje inwestują w reklamę proporcjonalnie więcej.
...
- [[2025-01-01 Email Marketing for Nonprofits The Complete Guide]] — Bloomerang: kompleksowy przewodnik po email marketingu dla organizacji społecznych z benchmarkami 2026, frameworkiem cadence, wyborem platform i gotowymi szablonami.
...
- [[2025-02-18 1 podstawyAI -> dwa przydatne prompty (szablony) oraz 4 najciekawsze wpisy]] — Przemek Jurgiel-Zyla: dwa szablony promptów — jeden dla GPT-4/Claude, drugi dla modeli rozumujących (o1/o3).
...
- [[2025-02-25 2 podstawyAI -> Rewolucja AI w zasięgu ręki - przewodnik po darmowych i płatnych modelach językowych 2025]] — Jurgiel-Zyla: strategia hybrydowa modeli AI — Claude do dokumentów, ChatGPT do rutyny, $20/mies. wystarczy.
...
- [[2025-03-11 3 podstawyAI -> AI dla małych firm - przewaga konkurencyjna w zasięgu ręki]] — Jurgiel-Zyla: 91% MŚP z AI raportuje poprawę wyników; Polska 16% adopcji; 3,5h oszczędności dziennie.
...
- [[2025-03-18 AI w codziennym życiu Kompletny przewodnik po efektywnym wykorzystaniu modeli językowych w 2025 roku 🚀💻]] — Karpathy: strategia multi-model (flagowe/darmowe/thinking), rada LLM do ważnych decyzji i vibe coding w Cursor.
...
- [[2025-03-25 Anthropic Claude – kooperacja z LLM - codzienność managera]] — Jurgiel-Zyla: Claude project knowledge jako fundament, tryb rozszerzonego myślenia i artefakty jako żywe dokumenty.
...
- [[2025-04-01 Dlaczego sztuczna inteligencja halucynuje? Zrozumieć mechanizmy błędów w dużych modelach językowych]] — Jurgiel-Zyla: mechanizmy halucynacji LLM — RLHF, Constitutional AI Anthropic i 96% redukcja kombinacją technik.
- [[2025-04-01 The Nonprofit Guide to a Full-Funnel Fundraising Strategy]] — Megan Anhalt (Whole Whale): model Funnel of Engagement (Aware/Interested/Engaged/Committed) do budowania długoterminowych relacji z darczyńcami zamiast jednorazowych apeli.
...
- [[2025-04-08 Agenci AI od podstaw do przyszłości współpracy ze sztuczną inteligencją]] — Jurgiel-Zyla: agenci AI, rynek 5,1→47,1 mld USD, CAGR 44,8%; WEF: -92 mln etatów +170 mln nowych do 2030.
...
- [[2025-04-15 Rewolucja AI-First w E-Commerce Shopify Zmienia Reguły Gry! + niespodzianka od OpenAI podstawyAI]] — Jurgiel-Zyla: dyrektywa Shopify AI-first (6 zasad) i analiza ryzyk; Shopify +26% przychodów (Q3).
...
- [[2025-04-22 Magia Vibe Codingu Jak stworzyłem własną stronę z Notion jako CMS]] — Jurgiel-Zyla: vibe coding z Claude — Notion API jako CMS, weekend pracy, własna domena bez wiedzy programistycznej.
...
- [[2025-05-06 Claude Code Przewodnik po najlepszych praktykach dla początkujących programistów]] — Jurgiel-Zyla: framework Badaj→Planuj→Implementuj, plik CLAUDE.md i komendy ultrathink w Claude Code.
...
- [[2025-05-13 czy udało się utrzymać uwagę słuchaczy przez 8h warsztatów podstawyAI?]] — Jurgiel-Zyla: relacja z 8h warsztatów dla 100 osób (10 modułów); aspekty prawne AI niespodziewanie najpopularniejsze.
...
- [[2025-05-20 We did the math on AI s energy footprint Here s the story you haven t heard]] — We did the math on AI's energy
...
- [[2025-05-20 A Simple Year-Round Nonprofit Fundraising Strategy Explained]] — WholeWhale: full-funnel fundraising — praca na wszystkich etapach lejka (aware, interested, engaged, committed) przez cały rok zamiast tylko w Q4.
...
- [[2025-05-22 77 million miles of waterways were missing from maps AI found them in record time]] — 77 million miles of waterways were missing from
...
- [[2025-05-27 15 podstawyAI (a bardziej podstawyDEV), czyli nowoczesne środowiska programistyczne z integracją AI (również dla osób nietechnicznych)]] — Jurgiel-Zyla: porównanie VSCode+Copilot, Cursor ($20/mies.), Windsurf i Replit dla osób bez technicznego tła.
...
- [[2025-05-29 Stop Sending the Wrong Emails Step-By-Step Exclusion Strategies]] — Beth O'Malley: strategia wykluczeń w e-mail marketingu — 7 pytań przed wysyłką i centralna mapa wykluczeń jako sposób na uniknięcie kolizji między działami i irytacji odbiorców.
...
- [[2025-06-05 How to Get The Most Out Of Midjourney]] — Przewodnik po personalizacji Midjourney: Global Profile, moodboardy i meta-prompting jako workflow dla spójnych assetów wizualnych.
...
- [[2025-06-10 How to Build Subscriber Personas that Drive Better Email Results (and Understand What Your Audience Truly Wants)]] — Beth O'Malley: 4-krokowy proces budowania subscriber personas dla e-mail marketingu — od analizy danych przez profilowanie, po koncepcję "read the room" uwzględniającą zewnętrzny kontekst.
...
- [[2025-06-17 18 podstawyAI - czyli uruchom Bielika na swoim komputerze (manual dla każdego!)]] — Jurgiel-Zyla: instrukcja uruchomienia polskiego modelu Bielik 4.5B v3 lokalnie przez LM Studio bez internetu.
...
- [[2025-07-01 20 podstawyAI - czy Apple ma rację podważając "inteligencję" LLMów? (i dlaczego to bardziej skomplikowane)]] — Jurgiel-Zyla: krytyczna analiza badań Apple o LLM; metodologiczne błędy i kontekst 18-miesięcznego opóźnienia Apple.
...
- [[2025-07-08 21 podstawyAI -> PRD.md Dlaczego dokumentacja produktowa w formacie Markdown zmienia zasady gry w startupach (ale i większych firmach)]] — Jurgiel-Zyla: PRD.md wersjonowany w Git jako fundament kultury produktowej; struktura od MVP po skalowanie.
...
- [[2025-07-15 22 podstawyAI -> o linkedin i wyboistej drodze budowania zasięgów w obszarze AI, VC i DEV]] — Jurgiel-Zyla: 6 miesięcy codziennego postowania na LinkedIn — 180+ postów, 2000 subskrybentów newslettera.
...
- [[2025-07-22 23 podstawyAI -> o agentGPT, czyli nowym produkcie od openAI (na konkretnym przykładzie)]] — Jurgiel-Zyla: agentGPT (przeglądarka+wyszukiwarka+terminal) testowany na strategii podcastowej — wyniki od pierwszego strzału.
...
- [[2025-07-23 IP Reputation vs. Domain Reputation Guide for Email Senders]] — Twilio: reputacja domeny przenośna i ważniejsza niż IP; odbudowa domeny trwa 6–12 tygodni, Google Postmaster Tools.
...
- [[2025-07-27 "Nasi chłopcy" i niemożliwość historii maszynowej]] — Wilkowski: LLM-y strukturalnie niezdolne do pisania wbrew dominującym narracjom treningowym; trzy ograniczenia AI w historiografii (contra-narracja, brak pamięci wertykalnej, niemożność sprawczości społecznej).
...
- [[2025-07-29 24 podstawyAI -> JAK CLAUDE CODE ZMIENIA TWORZENIE POSTÓW NA SOCIAL MEDIA (albo i nie?)]] — Jurgiel-Zyla: 3-agentowy system LinkedIn/X z Claude Code; style fingerprinting własnych 200+ postów.
...
- [[2025-07-29 What Great Email Marketing Looks Like in 2025]] — Beth O'Malley: email jako ekosystem biznesowy oparty na trzech filarach (systemy, strategia, dane) — argument przeciw "volume trap" i optymalizacji tematów zamiast segmentacji.
- [[2025-07-29 7 Fundraising Reports Every Nonprofit Should Utilize (+ How to Actually Use Them!)]] — CauseVox (Gia Chow): 7 raportów fundraisingowych — LYBUNT, SYBUNT, nowi darczyńcy, powtarzający się, major gift prospect, RFM, wydajność kampanii.
...
- [[2025-07-30 The Silent Threat Lurking Inside Our Smartest Machines!]] — SidLabs: prompt injection, zatruwanie danych i ataki inferencyjne w LLM; red teaming i zero-trust jako standard.
...
- [[2025-07-31 Still Landing In Spam? Check Under the Floorboards]] — Lauren Meyer: trzy warstwy problemów z dostarczalnością emaili — model biznesowy, ukryte hazardy i infrastruktura techniczna (SPF/DKIM/DMARC).
...
- [[2025-08-01 Jak rozpoznać, czy tekst został wygenerowany przez AI? Ograniczenia perpleksji i propozycja Wikipedii]] — analiza ograniczeń detektorów AI opartych na perpleksji i propozycja ręcznych heurystyk (tabela Wikipedii) do rozpoznawania tekstów maszynowych
...
- [[2025-08-05 25 podstawyAI -> jak AI używa naszych danych oraz dlaczego deep research jest ułomnym narzędziem]] — Jurgiel-Zyla: Deep Research bazuje na publicznych źródłach; prywatność danych w AI — każda rozmowa to potencjalnie publiczny dokument.
...
- [[2025-08-11 What is a Data Collection Strategy (and Why Is It the Backbone of Great Email Marketing)?]] — Beth O'Malley: 7-krokowy framework strategii zbierania danych dla e-mail marketingu — od definicji celów przez typy danych (demograficzne, behawioralne, motywacyjne, psychograficzne) po ciągłe testowanie.
...
- [[2025-08-27 AI Max for Google Ads The Complete Guide]] — Whole Whale: AI Max for Search w Google Ads — automatyzacja dopasowania zapytań, kreacji i URL przy zachowanej kontroli marki; +14% konwersji dla organizacji społecznych.
...
- [[2025-08-28 Google Workspace for Nonprofits FREE AI Tools for Social Impact]] — Whole Whale: przegląd bezpłatnych narzędzi AI (Gemini, NotebookLM, Veo, Imagen) dla organizacji społecznych w ramach Google for Nonprofits; wartość ekwiwalentna 10 000+ USD/rok.
...
- [[2025-09-02 Donor Retention Math Made Simple]] — Bloomerang: wzrost retencji darczyńców o 10 pkt proc. podwaja lifetime value bazy, z matematyką i mnożnikami efektu.
...
- [[2025-09-09 Charity AI Brand Footprint Study]] — Whole Whale: pierwsze badanie rekomendacji charytatywnych przez AI (650+ odpowiedzi, 6 modeli) ujawnia efekt stada i nowe reguły widoczności organizacji społecznych w erze AI.
...
- [[2025-09-21 From managing people to managing AI The leadership skills everyone needs now  Julie Zhuo]] — Julie Zhuo: kompetencje menedżerskie = zarządzanie agentami AI; trend small "builder teams" i bycie "drzewem wierzby".
...
- [[2025-09-22 Syntetyczny prababkizm, czyli głęboki wymiar uprzedzeń dużych modeli językowych]] — Badanie z Bergen: LLM generują homogeniczne narracje dla 236 krajów oparte na "syntetycznym imaginarium" zachodnich danych treningowych; kulturowe klisze zamiast lokalnego kontekstu.
- [[2025-09-22 AI-Resistant Content Stop Losing 50% of Your Organic Traffic to ChatGPT]] — Whole Whale / Nicholas Velarde: koncepcja AI-resistant content (Avinash Kaushik) i 7 strategii tworzenia treści, których AI nie może zastąpić — oryginalne badania, ludzki głos, omnichannel, "spike and sustain".
...
- [[2025-10-13 NextAfter Minute 14 Purpose Beats Perks How Mission Wins More Sustainers]] — NextAfter: test Oregon Public Broadcasting — apel z misją na pierwszym miejscu dał 25,1% wzrostu konwersji na upgrade darowizny miesięcznej vs. apel z premią na pierwszym miejscu.
...
- [[2025-10-26 How Block is becoming the most AI-native enterprise in the world  Dhanji R. Prasanna]] — Dhanji Prasanna (Block CTO): transformacja 3500+ inżynierów w AI-native; agent Goose oszczędza 8–10h/tydz.
...
- [[2025-10-28 The Crawl-Walk-Run Approach to Nonprofit AI Adoption]] — Whole Whale: framework czterech obszarów (Polityka, Ludzie, Produkt, Wydajność) do stopniowego wdrażania AI w organizacjach społecznych.
...
- [[2025-10-31 Żywi, martwi i cyfrowi]] — Artykuł o rynku cyfrowego życia pozagrobowego: deadboty, griefboty i etyczne dylematy AI tworzącego cyfrowe repliki osób zmarłych.
...
- [[2025-11-04 26 Raffle Ideas to Bring Buzz to Your Fundraising]] — Neon One: trzy typy loterii fantowych (nagrodowa, 50/50, online) i cztery kryteria doboru nagrody, plus 26 pomysłów na nagrody pogrupowanych tematycznie.
- [[2025-11-04 Być może model stylu literackiego powinien być chroniony]] — Wilkowski: fine-tuned GPT-4o generuje prozę w stylu noblistów lepiej ocenianą niż ghostwriterzy-eksperci, za 0,3% ceny; otwarte pytanie o ochronę „modelu stylu" w prawie autorskim.
...
- [[2025-11-09 B2B Email Deliverability Report 2025 Inbox Rates, DMARC & ESP Trends]]
- [[2025-11-09 Odrzucenie akceleracjonizmu technologicznego łączy prawicę i lewicę]] — Jacek Mańko: nowy podział polityczny up-wingers/down-wingers przecina lewicę i prawicę w debacie o ideologiach technologicznych Doliny Krzemowej. — Raport 2025: Office365 -26,7pp inbox placement; DMARC z egzekucją daje 2,7× lepszą dostarczalność B2B.
...
- [[2025-11-13 When boring delivers 40% more revenue]] — Email Civic Shout: kopia wiadomości o plain-text emailach; trzy testy A/B (KUOW +28%, przyroda +40%, Litmus aktywni darczyńcy 60%).
...
- [[2025-11-14 Creator Campaigns Moving Beyond Vanity Metrics]] — Social Currant: jak mierzyć kampanie z twórcami przez shares/saves i topic modelling komentarzy zamiast lajków i zasięgów.
...
- [[2025-11-18 Jak rozwijać odporność na medialny hype, by chronić demokrację?]] — Belsunces Gonçalves/Bareis: technologiczny hype jako świadomy instrument polityczny i ekonomiczny; "hype literacy" jako narzędzie ochrony demokratycznej suwerenności.
...
- [[2025-11-26 TechLider nr1 - 8 filarów skutecznego wdrożenia Automatyzacji i AI]] — 8 kroków wdrożenia AI: audyt procesów przed automatyzacją chroni przed "zautomatyzowanym chaosem"; case MOTO46.
...
- [[2025-12-08 Jak rozpoznawać slopy AI w tekstach? Na pewno nie maszynowo]] — Wilkowski: typologia 7Vs slopu AI i taksonomia 11 cech tekstowego slopu do użycia jako prompt; automatyczna detekcja wciąż zbyt niezgodna z oceną ludzką.
...
- [[2025-12-08 DAY 17 Doing More with Less — How AI Helps Startups Run Lean]] — SidLabs: AI do lean operations w startupach — automatyzacja fakturowania, prognozowanie cash flow, support +40% capacity.
...
- [[2025-12-09 Kiedy krytyka AI niechcący staje się jej apologią]] — Mańko demaskuje paradoks: tekst odrzucający technohype może nieświadomie go reprodukować — przez techno-deterministyczny język i odwołania do „osobliwości".
...
- [[2025-12-15 How AI got me 3 promotions the ultimate guide for EAs (w Zapier's EA)]] — Cortney Hickey (Zapier): EA używa AI do budowania systemów org — meeting prep z CRM, kultura feedback i baza wiedzy.
...
- [[2025-12-15 NextAfter Minute 23 The Free Offer That Tripled Donor Conversions]] — NextAfter: eksperyment Minnesota Public Radio — darmowy ebook przed prośbą o darowiznę zwiększył konwersje o 199,1%; zasada wzajemności w fundraisingu cyfrowym.
...
- [[2025-12-17 Jak dzięki zmianom w onboardingu zwiększyłem 5x LTV w moich Społecznościach]] — Michał Gutkowski: 4 zasady redesignu onboardingu, który zredukował churn do 0 i zwiększył LTV 5× — od mindset po kulturę społeczności.
...
- [[2025-12-22 How one designer led an AI revolution at Pendo The paternity leave epiphany  Brian Greenbaum]] — Brian Greenbaum (Pendo): projektant wdrożył AI w całej firmie po epifanii na urlopie ojcowskim — playbook z golden path, sentiment surveys i rolą AI championa w karierze.
...
- [[2025-12-22 Google Ads in AI Overviews What AI Ad Placements Could Mean for Your Nonprofit Search Ads Strategy]] — Whole Whale: reklamy w AI Overviews Google zmieniają strategię digital campaigningu NGO — zero-click searches, akcyjne copy i autorytatywne treści jako nowe SEO.
- [[2025-12-22 NextAfter Minute 24 The $25 Ask That Attracted New Donors]] — Test A/B Franciscan University: konkretny ask $25 zamiast ogólnej prośby zwiększył konwersję nowych darczyńców o 166,7%.
...
- [[2025-12-29 How Webflow s CPO built an AI chief of staff to manage her calendar and drive internal AI adoption]] — Rachel Wolan (Webflow): jak CPO zbudowała własną aplikację AI chief of staff do zarządzania kalendarzem i emailem; "Builder Days" jako metoda adopcji AI w organizacji.
...
- [[2025-12-29 Co tracimy, gdy wszystko zapisuje się samo? Amelia Acker, Archiving Machines From Punch Cards to Platforms, 2025]] — Recenzja książki Amelii Acker: przejście od archiwum jako miejsca do platformowej "suwerenności funkcjonalnej"; pojęcie "uśpienia danych" jako wartość podmiotowej kontroli nad własnymi zasobami.
...
- [[2025-12-30 Day 2 AI-powered customer engagement strategies Making Every Customer Feel Seen]] — SidLabs: AI do słuchania klientów na skalę, personalizacja ścieżki klienta i chatbot FAQ bez utraty ludzkiego wymiaru.
...
- [[2026-01-01 We replaced our sales team with 20 AI agents—here s what happened next  Jason Lemkin (SaaStr)]] — Jason Lemkin: 20 agentów AI + 1,2 człowieka zastąpiło 8-10 SDR; agenty wymagają tygodni treningu na najlepszych emailach.
- [[2026-01-02 The Best Nonprofit Software Solutions for 2026]] — Julie Kennon: mapa rynku oprogramowania NGO 2026 — porównanie 20+ platform CRM, fundraising i grantów z perspektywą konsolidacji branży.
...
- [[2026-01-12 The power user s guide to Codex  Alexander Embiricos (product lead)]] — Alexander Embiricos (OpenAI Codex): PLANS.md do architektonowania projektów, równoległe Git worktrees i automatyczny code review.
...
- [[2026-01-16 A tool that chains AI models together for you 🤝]] — Ryan Carr: Flora — węzłowe narzędzie do łączenia modeli AI w wizualne przepływy; workflow newsletterowy (Claude Opus + Nano Banana Pro) jako gotowy template dla zespołów.
...
- [[2026-01-18 Uratują nas tylko społeczności]] — Wilkowski/Woźniak: wywiad o upadku Mozilli, math washingu AI, copyleft jako ochronie przed Big Techami i Fediverse jako alternatywie dla scentralizowanych platform.
...
- [[2026-01-18 How a Meta PM ships products without ever writing code  Zevi Arnovitz]] — Zevi Arnovitz (Meta): PM bez tła technicznego buduje produkty samodzielnie z Cursor i Claude Code — system własnych komend.
...
- [[2026-01-24 75 Nonprofit Event Ideas for Fundraising and Community Building]] — Neon One: katalog 75 pomysłów na wydarzenia fundraisingowe P2P z konkretnymi wskazówkami startowymi; darczyńcy z eventów dają średnio 202,73 USD pierwszego daru.
- [[2026-01-25 Teologiczny benchmark modeli generatywnych i feministyczne filtry do maszynowych interpretacji Biblii i Koranu]] — Wilkowski: GPT-4o i Gemini jako „racjonalni teologowie" (86%/84% skuteczności) + feministyczne guardrails dla religijnych chatbotów reprodukujących uprzedzenia.
- [[2026-01-25 The surprising advice from a founder who built 2 unicorns  Jason Cohen (WP Engine)]] — Jason Cohen: 5-krokowy framework diagnozowania zatrzymanego wzrostu SaaS — churn, pricing, NRR, saturacja kanałów, filozofia wzrostu.
...
- [[2026-01-28 SIO Search Inbox Optimisation]] — Beth O'Malley: Search Inbox Optimisation — optymalizacja emaili pod późniejsze odnalezienie, nie natychmiastowe otwarcie; 10-punktowy checklist dla email marketingu NGO.
...
- [[2026-02-01 A child psychologist s guide to working with difficult adults  Dr. Becky Kennedy]] — Dr. Becky Kennedy: zasady wychowania dzieci = skuteczne przywództwo; "connect before you correct" i skrypty trudnych rozmów.
...
- [[2026-02-02 Jak filtrować slopy AI w wyszukiwarce?]] — DuckDuckGo i Kagi walczą z AI slopem przez listy blokowania i zgłoszenia użytkowników, bo automatyczne detektory wciąż nie działają wystarczająco skutecznie.
...
- [[2026-02-03 Analiza głosu odbiorców w NGO Jak wspierać ją narzędziami AI]] — Jak wspierać ją narzędziami AI  Artykuł Kariny Janus z TechSoup opisuje praktyczne zastosowanie narzędzi AI do analizy jakościowej…
...
- [[2026-02-03 The impact of AI search during end of year (the news isn't good)]] — M+R: AI search overviews obniżyły organiczny ruch NGO o ~40% w grudniu 2025 i przychody online o 5%.
...
- [[2026-02-10 Why Storytelling Is the Most Powerful Fundraising Tool]] — Amanda Clark-Wahl (Cocktails and Caregivers) w podcaście The Focused Fundraiser: konkretna historia i emocja biją statystyki, a nieopolerowane wideo z telefonu działa silniej niż produkcja wysokobudżetowa.
...
- [[2026-02-11 Wellbeing w erze AI w NGO Dlaczego szybsza praca nie oznacza zdrowszej pracy]] — Dlaczego szybsza praca nie oznacza zdrowszej pracy  Artykuł Kariny Janus z TechSoup Polska opisuje paradoks produktywności AI: narzędzia…
...
- [[2026-02-17 Cyfryzacja domowego archiwum lokalne przechowywanie, metadane z AI i baza danych kontra pamięć]] — Relacja z projektu digitalizacji 122 kaset Video8 z lokalnym AI (whisperX); "efekt św. Mateusza" w AI i pytanie o wpływ ciągłego dostępu do archiwum na pamięć.
- [[2026-02-17 How AI is changing charity governance five things I learned]] — Zoe Amar: pięć wniosków z sesji o AI w governance charytatywnym — „shadow AI" wśród powierników, kultura zarządu ważniejsza niż technologia, AI jako partner do myślenia dla trustees.
...
- [[2026-02-18 Donor Segmentation for Nonprofits Grow Retention & Recurring Revenue]] — Julie Kennon/Charity Engine: segmentacja darczyńców (RFM, lifecycle, predyktywna) jako strategia ochrony recurring revenue i wzrostu retencji NGO.
- [[2026-02-19 Technologia, venture capital i hype wojenny]] — Schwarz/Mańko: jak VC i Dolina Krzemowa splątały język biznesu z narracją wojenną, normalizując konflikt jako warunek wzrostu gospodarczego.
...
- [[2026-02-22 Próbowałem wygenerować w AI wpis na tego bloga i skończyło się to katastrofą]] — Wilkowski: eksperyment generowania merytorycznego wpisu przez GPT/Gemini kończy się slopem z błędnymi cytowaniami i brakiem lokalnej perspektywy; AI jako narzędzie punktu wyjścia, nie zastępstwo autora.
...
- [[2026-02-27 Rozpoznawanie tekstów AI pięć grup cech zamiast jednego wskaźnika]] — przegląd 5 grup wskaźników (powierzchniowe, dyskursywne, epistemiczne, probabilistyczne, origin) do rozpoznawania tekstów AI; argument przeciw jednemu uniwersalnemu detektorowi
...
- [[2026-03-05 Is panic turning off your donors?]] — Sara Cederberg: dekada danych League of Women Voters — nadzieja bije alarmizm w CTA, gratitude email 3-5 dni po kampanii przyspiesza re-engagement o 30%.
...
- [[2026-03-05 Labor market impacts of AI A new measure and early evidence]] — Anthropic: "observed exposure" — faktyczne użycie AI to ułamek teoretycznego potencjału; spowolnienie zatrudniania juniorów 22–25 lat.
...
- [[2026-03-09 5 steps to generate consistent brand images with Midjourney]] — Jamey Gannon: 5 kroków do spójnej identyfikacji wizualnej w Midjourney — mood boards, SREF, kody personalizacji i workflow dostarczania systemu brandingu klientom.
...
- [[2026-03-15 5 Steps To Launch A New Substack From Scratch In 2026]] — Dickie Bush: 5-etapowy playbook startu Substack — pozycjonowanie w nazwie decyduje o 80% sukcesu, Substack Notes jako arbitraż.
- [[2026-03-15 He s negotiated $1B+ in executive compensation. Here s his playbook.  Jacob Warwick]] — Jacob Warwick: psychologia i taktyki negocjacji wynagrodzeń — „sprzedaż urlopu", odkrywanie problemów i asymetria informacyjna.
...
- [[2026-03-16 LinkedIn Organic Benchmarks 2026]] — Elena Cucu: benchmarki LinkedIn 2026 — native documents liderem (7% eng.), wideo spada 36% r/r, wzrost kont hamuje.
...
- [[2026-03-19 5000 client in 3 weeks (no experience)]] — Nicolas Cole: case study Noaha — $5K ghostwriting w 3 tygodnie dzięki systemowi Leaks&Faucets i bezpłatnemu wideo-outreachowi.
- [[2026-03-19 Advocacy engagement is getting harder in 2026. Here's what to do about it.]] — Steve Anderson (New/Mode): 6 strategii odbudowania zaangażowania w advocacy przy spadających wskaźnikach; teoria zmiany i pilność jako klucz.
...
- [[2026-03-21 Stylometryczne cechy tekstów generowanych maszynowo]] — Badanie UJ: stylometria wykrywa teksty AI lepiej niż generyczne detektory — kluczowe wskaźniki to TTR, zróżnicowanie spójników i inwersja składniowa.
...
- [[2026-03-24 Your BIGGEST asset as a writer]] — Nicolas Cole: Information Advantage — wiedza dziedzinowa z doświadczenia jest 10x cenniejsza niż samo pisanie; fundament specjalizacji ghostwritera.
...
- [[2026-03-25 The system is your advantage. Not the hustle]] — Five Prompts (Tuck Ross): trzy prompty budujące system soloprzedsiębiorcy — rytm tygodniowy, silnik multiplikacji treści i filtr decyzyjny.
...
- [[2026-03-26 Early insights from the 2026 Charity Digital Skills Report survey]] — Zoe Amar Digital: pierwsze wyniki brytyjskiego badania — adopcja AI w NGO rośnie (88%), ale rosną też bariery kompetencyjne, jakościowe i RODO.
...
- [[2026-03-27 Humanistyczne prowokacje wobec AI]] — Wilkowski: 8 prowokacji humanistyki wobec generatywnej AI jako framework krytycznej oceny narzędzi — gotowy moduł szkoleniowy.
...
- [[2026-03-27 Stop calling yourself a Freelance Writer]] — Nicolas Cole: rebranding z "Freelance Writer" na "Premium Ghostwriter" zmienił stawki z $25–50 do $5 000/artykuł.
...
- [[2026-03-29 Top 3 AI-Proof Writing Services in 2026]] — Dickie Bush i Nicolas Cole (PGA): pisarze $10K–$30K/mies. używają AI do pakietowania usług; masterclass o 3 usługach odpornych na AI.
...
- [[2026-03-30 DNC Rolls Out New Organizing Playbook Ahead of Midterms]] — DNC krytykuje ilościowe metryki organizingu i proponuje playbook: modernizacja kontaktu z wyborcą, "layering" follow-upów, integracja organizingu cyfrowego i tradycyjnego.
...
- [[2026-03-31 Notes on No Kings 3 We’re Going to Need a Bigger, Broader Movement]] — Micah L. Sifry: analiza ruchu No Kings USA — demografia (mediana 70 lat), brak młodych, model minnesocki jako wzorzec głębokiego organizowania.
...
- [[2026-04-02 Claude isn't a chatbot. It's your operating system]] — Five Prompts (Tuck Ross): Claude Projects z pełnym kontekstem biznesowym jako system operacyjny soloprzedsiębiorcy; 3 prompty budujące fundament.
...
- [[2026-04-02 How to Use Giving Levels To Drive Donations]] — Wired Impact: poziomy darowizn redukują paraliż decyzyjny; każdy poziom musi mieć konkretny wyobrażalny efekt.
...
- [[2026-04-12 Day 3 - But if I niche down, won't I run out of clients]] — Nicolas Cole: myth buster — specjalizacja przyciąga Client Constellation; "mów o 1 rzeczy, klient zakłada że możesz wszystko".
- [[2026-04-12 Day 4 - The 3 most lucrative writing services]] — Nicolas Cole: reaktywność na zlecenia rozbija procesy; specjalizacja w jednej usłudze i powtarzalne systemy jako klucz do skalowania ghostwritingu.
- [[2026-04-12 Day 5 - How to package an offer clients can't say no to]] — Nicolas Cole: przejście od "sprzedaży czasu" do "sprzedaży wyników"; productization oferty ghostwritingowej z jasnym deliverable i price anchor.
...
- [[2026-04-12 Jak LLM Wiki Karpathy'ego pomogła mi uporządkować moją bazę wiedzy]] — Ewolucja od ręcznych notatek Obsidian do systemu zarządzania wiedzą pilnowanego przez agenta AI: architektura progressive disclosure, CLAUDE.md i 4 workflow (INGEST, COMPILE, Q&A, LINT) na przykładzie 185 notatek.
...
- [[2026-04-14 GOP campaigns go all-in on AI, Dems not so much]] — Alex Isenstadt, Holly Otterbein (Axios): przepaść w adopcji AI między kampaniami GOP a Demokratami; narzędzia do symulacji wyborców i ryzyka deepfake.
...
- [[2026-04-15 5 prompts that pull a business out of your resume]] — Five Prompts: 5 promptów dla profesjonalistów przechodzących na własną działalność — audit kariery, "throughlines" i unfair advantage stack.
...
- [[2026-04-15 How to land your first ghostwriting client]] — Nicolas Cole: 5-etapowy proces zamykania kontraktów bez case studies — dociekanie problemów klienta zastępuje portfolio.
...
- [[2026-04-15 Why ChatGPT Cites One Page Over Another (Study of 1.4M Prompts)]] — Ahrefs 1,4M promptów: ChatGPT cytuje na podstawie semantycznej trafności tytułu; Reddit używany ale nieco cytowany.
...
- [[2026-04-15 Fundraising Effectiveness Project Reports Strongest Revenue Growth in Five Years, Even as Fewer Donors Give]] — FEP: wzrost darowizn w USA w 2025 o 5% (najsilniejszy od 5 lat) przy spadku liczby darczyńców o 3,6%; konwersja pierwszorazowych darczyńców jako nierozwiązany problem sektora.
...
- [[2026-04-16 AI Kills Trust and Followers Don't Matter Anymore.]] — Ryan Davis (People First): AI disclaimers obniżają zaufanie; follower count to przestarzały wskaźnik — algorytm zastąpił grafy społecznościowe.
...
- [[2026-04-17 How to Use Google PageSpeed Insights to Test Your Website]] — Poradnik testowania szybkości strony przez PageSpeed Insights; Core Web Vitals a ranking w Google.
...
- [[2026-04-18 How niching down changed my life]] — Nicolas Cole: Digital Press $3,5M w 4 lata dzięki one-linerowi o ghostwritingu dla founderów szukających finansowania; AI wzmacnia konieczność niszowania.
...
- [[2026-04-19 The forklift ghostwriter who's making $18k-month]] — PGA: Information Advantage — głęboka wiedza branżowa (widłaki, muzea, budownictwo) jest tym, za co klienci naprawdę płacą, nie umiejętność pisania.
...
- [[2026-04-20 But niching down will limit my opportunity!]] — Nicolas Cole: Client Constellation — wąska specjalizacja przyciąga sieć pokrewnych branż; mit ograniczeń jako główna blokada ghostwriterów.
- [[2026-04-20 ChatGPT and Claude Will Be a Force in Elections. Nobody Knows What to Do About It.]] — Alex Roarty: LLM jako nowe źródło informacji wyborczej; sztaby obu partii nie wiedzą jak kształtować odpowiedzi chatbotów — narodziny Answer Engine Optimization.
...
- [[2026-04-20 Is Reddit REALLY The KEY to AI Search? Let's Find Out…]] — Let's Find Out…  Matt Diggity przedstawia case study klienta z branży nieruchomości, którego ruch z AI search wzrósł o 2814% dzięki…
...
- [[2026-04-20 Strategy Is Not the Problem Why Issue-Based and Systems Approaches Break Under Pressure without Defensible Decisions]] — Horizons Project: obie strategie NGO (issue i systems) zawodzą bez defensywalnej logiki alokacji zasobów; test legitymizacji jako standard decyzji.
...
- [[2026-04-20 Should Nonprofits Use an Automated Email Welcome Series?]] — Steven Shattuck (Bloomerang): automatyczna seria powitalna szkodzi retencji nowych darczyńców; 90-dniowy plan stewardship oparty na osobistym kontakcie jako alternatywa.
...
- [[2026-04-21 First-Time Donor Retention 3 Best Practices for Nonprofits]] — Diana Otero: retencja nowych darczyńców 14% vs 43,6% powracających (Bloomerang Q3 2025); ankiety i automatyczna seria powitalna.
...
- [[2026-04-21 Is a shared IP secretly harming your deliverability?]] — Is a shared IP secretly harming your
...
- [[2026-04-21 Let's talk about the "master's tools," what they are, and what they are not.]] — Vu Le: reinterpretacja cytatu Audre Lorde — strategie organizowania, fundraisingu i mediów są wartościowo neutralne, nie "narzędziami opresji".
...
- [[2026-04-22 3 uczucia, które sprawią, że klienci zostaną w Twojej społeczności na lata]] — Michał Gutkowski: framework 3 uczuć retencji (bezpieczeństwo, przynależność, jasność) jako podstawa projektowania płatnych społeczności edukacyjnych.
...
- [[2026-04-22 Build a Donor Pipeline Before You Need It]] — Tom Iselin: prospecting jako kluczowa dyscyplina organizacyjna; referencje od board, alumni i eventy — buduj zanim będziesz potrzebować.
...
- [[2026-04-22 How to Plan a Fundraising Event That Actually Raises Money]] — Claire Axelrad: event fundraisingowy to najdroższe narzędzie; sprawdza się tylko jako część strategii relacji z darczyńcami.
...
- [[2026-04-22 Stop sounding like 500 other people]] — Five Prompts: 5 promptów do wyostrzania pozycjonowania — "constraint stack" eliminuje konkurencję i zostawia tylko Ciebie.
...
- [[2026-04-22 The Neuroscience of Addictive Storytelling (And How to Master It)]] — Kallaway: dopamina jako "chemikał przewidywania"; pętla stakes→big question→head fake→re-hook jako powtarzalny algorytm angażowania.
...
- [[2026-04-23 How Anthropic s product team moves faster than anyone else  Cat Wu (Head of Product, Claude Code)]] — Cat Wu (Anthropic): czas dostarczania funkcji skrócony z 6 miesięcy do tygodnia; 95% skuteczności to nie prawdziwa automatyzacja.
...
- [[2026-04-23 [Day 1] Why 99% of Substacks fail before they start]] — Ship 30/Cole: Category Newsletter Positioning — 3-krokowy framework (Credibility Angle, Recurring Object, Category Title+Subtitle).
- [[2026-04-23 [Day 2] Please support my writing is not an offer]] — Ship 30: w erze AI ludzie płacą za outcomes (szablony, frameworki); 3-częściowy offer stack z Instant Bonus i Cliffhanger Paywall.
...
- [[2026-04-24 Want to escape the ceiling on your income]] — Nicolas Cole: ghostwriting = wysoki upside przy ograniczonej volatility; umiejętność pisania jako plan B w formie pracy korporacyjnej.
- [[2026-04-24 [Day 3] The Substack settings nobody tells you about]] — Ship 30: Recommendations generują 40%+ nowych subskrybentów na Substacku — 3 kluczowe ustawienia, które większość pomija.
- [[2026-04-25 4 ways to make money from your newsletter]] — Ship 30/Cole: newsletter jako silnik sprzedający inne produkty — 4 modele monetyzacji; $2M+ na Substacku przez łączenie modeli.
...
- [[2026-04-25 How I'd land $3,000 clients in the next 30 days]] — Nicolas Cole: 7-krokowy plan — jedna specjalizacja, własne portfolio jako case study, ciepły outreach i 5 follow-upów.
- [[2026-04-25 The growth channel hiding in plain sight]] — Ship 30: Substack Notes konwertuje bezpośrednio na emailowych subskrybentów; 35% wzrostu newslettera Write With AI.
- [[2026-04-25 [Day 4] The Cliffhanger Paywall strategy]] — Ship 30: Welcome Email + strategia Cliffhanger Paywall — upgrade z bezpłatnego na płatny Substack jako naturalne odwrócenie strony.
- [[2026-04-27 Conversational Reporting for Nonprofits Build Reports in Seconds with AI]] — Bloomerang uruchamia raportowanie CRM w języku naturalnym dla NGO; każdy pracownik może zapytać o dane bez szkoleń i filtrów
...
- [[2026-04-27 How to use referrals to land premium clients]] — Cole Schafer/PGA: 3 typy referencji — klienckie, sieciowe i partnerskie; wymiana klientów za obniżkę faktury jako systematyczny dopływ zleceń.
...
- [[2026-04-27 This naming mistake is killing your Substack]] — Ship 30: Category Newsletter Positioning — 0→100 płatnych w 3 miesiące dzięki hiperspecyficznej nazwie (case: "AI Email Marketing Prompts").
...
- [[2026-04-28 Eight seconds to make your message stick The science of donor attention]] — Nick Kristock: neuropsychologia uwagi darczyńców; Peak-End Rule Kahnemana i formuła sensory details+personal attribution+transformative narrative.
...
- [[2026-04-28 How to Run a Successful Sales Fundraiser]] — Jessica Fox: 6-krokowy model fundraisingu sprzedażowego online dla NGO — od produktu po podziękowanie.
- [[2026-04-28 How to land clients in stealth]] — Nicolas Cole: budowanie autorytetu przez LinkedIn i newsletter to cyfrowy odpowiednik książek — pracodawca nie ma powodu mieć z tym problem.
...
- [[2026-04-28 Torchbox’s Charity AI Policy Builder helping charities get started]] — Andy Gordon (Torchbox): narzędzie do budowy polityki AI dla organizacji społecznych; podejście enablement vs. control i governance wielopoziomowe dla agentic AI.
- [[2026-04-28 What happens if you get laid off this year]] — Ship 30: case Rick Gregory — lista emailowa jako nietykalny aktyw; 60 artykułów w rok → 12 ebooków Amazon + 1 książka.
...
- [[2026-04-29 How to write better content in the next 5 mins]] — Dickie Bush/PGA: 8 reguł na poziomie zdania — "reguła ostatniego słowa", krótkie akapity; bez talentu, tylko intencjonalna edycja.
...
- [[2026-04-29 Nie lubisz robić wykresów w Excelu? Wypróbuj Canvę do wizualizacji danych film]] — Klaudia Stano: Canva do prostych wykresów fundraisingowych — cztery typy; ograniczenia vs. estetyka w raportach NGO.
...
- [[2026-04-30 AI's moving goalposts what charity leaders need to know about pricing, risk and governance]] — Zoe Amar: przejście dostawców AI na „metered usage" jako ryzyko budżetowe dla charities; małe organizacje bardziej narażone niż duże, potrzeba planu ciągłości działania.
...
- [[2026-05-03 How to overcome a difficult client objection]] — PGA: reframing obiekcji "zatrudnimy ghostwritera in-house" — przekierowanie na koszt etatu vs. elastyczność zewnętrznego specjalisty.
...
- [[2026-05-04 Did you see these $255K salary jobs]] — PGA: Anthropic płaci $255K pisarzom rozumiejącym "smak" — AI-native firm potrzebuje "dowódców robotów", nie eliminuje pisarzy.
...
- [[2026-05-05 Lead With Why How Story Beats Stats in Today’s Donor Decisions]] — Rob Burke (DonorDock): struktura apelu story-first (postać → konflikt → katalizator → transformacja → dane → CTA); historie zapamiętywane 22x lepiej niż same fakty.
...
- [[2026-05-05 A blueprint for using AI to strengthen democracy]] — Andrew Sorota: trójwarstwowy blueprint AI dla demokracji — epistemiczny, agentyczny i instytucjonalny.
- [[2026-05-05 AI Efficiency Can Undermine Accountability Even With Humans in the Loop]] — Nicolas Spatola: obecność człowieka w procesie AI nie gwarantuje nadzoru — efektywność AI eroduje zdolność do krytycznej oceny.
- [[2026-05-05 How To Protect Human Autonomy In An Age Of AI]] — Daniele Cavalli: autonomia jako proces osadzony w środowisku kognitywnym; habeas cogitationem i ochrona przed hypernudgingiem w erze AI.
- [[2026-05-05 How to shorten your path to $10k per mo]] — Nicolas Cole: ghostwriting = dywidenda z talentu; 3 dochodowe usługi to kursy emailowe, newslettery i content społecznościowy — NIE książki.
- [[2026-05-05 Empower your Nonprofit with Donor Segmentation]] — DonorDock: segmentacja darczyńców jako fundament retencji — typy segmentów, mapa podróży i benchmarki (retencja 40–45%, koszt pozyskania 5× droższy niż utrzymanie).
...
- [[2026-05-07 Zanim napiszesz wniosek jak zaplanować technologię, który ma szansę na grant]] — TechSoup: 6 kroków planowania projektu cyfrowego NGO przed złożeniem wniosku grantowego — od diagnozy problemu po plan trwałości.
- [[2026-05-07 Fundraising Solutions for Nonprofits]] — Click & Pledge: różnica między PCI DSS a SOC 2 Type II dla platform fundraisingowych; model dojrzałości dowodów (Tier 0-3) do oceny dostawców technologii donacyjnych.
...
- [[2026-05-08 Sales Is Education Say these words & people buy.]] — Nicolas Cole: sprzedaż to edukacja, nie perswazja — 8-krokowy framework edukacyjnej sprzedaży, gdzie klient sam dochodzi do wniosku że potrzebuje rozwiązania.
...
- [[2026-05-11 lekcja 5 Bezpłatny kurs System Stabilnych Darowizn]] — Instytut Fundraisingu: 4-elementowy system stabilnych darowizn (strategia, kampania, ścieżka lojalności, klub regularnych darczyńców) sprawdzający się też w małych, lokalnych NGO.
...
- [[2026-05-12 How a course-style landing page impacts sign-up rate]] — NextAfter: krótki, opisowy nagłówek zamiast narracyjnego zwiększył konwersję zapisu na kurs online o 48,6% (Word of Life Fellowship).
...
- [[2026-05-12 why newsletter ghostwriting (time to forget LinkedIn)]] — PGA: lista emailowa to zasób własny vs. konto LinkedIn jako wynajmowane; email najbardziej mierzalnym kanałem przychodów.
- [[2026-05-12 How Do Required Form Fields Impact Sign-Ups and Donor Behavior?]] — NextAfter: eksperyment A/B/C MAF — pełny formularz (imię+nazwisko+email) konwertuje lepiej niż uproszczony; tarcie formularza to nie główna bariera dla ruchu z paid social.
- [[2026-05-12 How adding a Dear Reader to blog pages affects email acquisition]] — NextAfter: eksperyment A/B — sekcja „Dear Reader" na końcu artykułu zwiększyła pozyskiwanie emaili o 79,7% (wynik obiecujący, wymaga replikacji).
- [[2026-05-12 Fundraise From Your Laptop The Sprint Method with Christina Edwards]] — Christina Edwards: Sprint Method jako zamiennik cyklu grant-gala; krótkie kampanie online z laptopa, social street team i segmentacja 3-bucket.
- [[2026-05-13 3 liczby, nowy paradygmat i Daft Punk]] — Wardaszka-Deręgowska: manifest newslettera Marka 3.8™ — strategia bez energii organizacyjnej nie wdroży się; model dla MŚP.
...
- [[2026-05-14 5 Campaign Lessons from the May 2026 UK Elections]]
- [[2026-05-14 How to Launch A Peer-to-Peer Fundraising Campaign Your Supporters Want to Share]] — Praktyczny przewodnik po uruchamianiu kampanii peer-to-peer: rekrutacja fundraiserów, toolkit do udostępniania i łączenie darczyńców z dalszą relacją. — 5 lekcji z wyborów UK 2026: AI polling, mikrotargeting, monitoring deepfake'ów i integracja cyfrowa z canvassingiem.
...
- [[2026-05-14 Escola AI Weekly 39]] — Wojewodzic: agenci AI stają się infrastrukturą pracy; "skill" jako pełny workflow agenta zmienia efektywność pracy z AI z % do wielokrotności.
...
- [[2026-05-14 Here's What I Told the DNC Autopsy]] — Rob Flaherty: taktyki cyfrowe bez spójnego brandu nie działają; lekcje Harris 2024 — YouTube, twórcy treści i AI w kampaniach 2028.
...
- [[2026-05-14 The Status of UK Fundraising 2026]] — Blackbaud: roczny raport o kondycji fundraisingu UK — 63% NGO osiąga cele, rośnie rola supporter experience i dojrzałości cyfrowej jako czynników wzrostu.
- [[2026-05-14 Zacznij sprzedawać tu i teraz w DM'ach]] — Magdalena Pawłowska: sprzedaż przez DM — post z pytaniem+słowo-klucz w komentarzu → wiadomość prywatna; działa bez społeczności.
- [[2026-05-14 AE Advertising A New Model for the AI-Native User Journey]] — Whole Whale: model reklamowy AE Advertising dla środowisk AI (ChatGPT, Google AI Overviews); trzystopniowy framework Pre-Decision→Sensemaking→Commitment.
...
- [[2026-05-17 Nie fotografie, ale portrety algorytmiczne fikcje literackie]] — Wilkowski: LLM jako archiwum-reprezentacja epoki (Molière Ex Machina) i propozycja algorytmicznej fikcji historycznej — użytecznej do budowania empatii, nie jako źródła faktów.
- [[2026-05-18 Czego chcieli ode mnie rozmówcy podczas spotkań 1-1]] — Instytut Fundraisingu: paradoks NGO — organizacje grantowe deklarują chęć stabilności finansowej, ale odmawiają inwestycji w fundraising.
...
- [[2026-05-18 Why Nonprofit Storytelling Matters]] — MemoryFox: badania M+R 2025 udowadniają, że autentyczne filmy prawdziwych ludzi biją profesjonalne reklamy; storytelling buduje retencję darczyńców przez przynależność, nie perswazję.
...
- [[2026-05-19 Your Warm Content Strategy As A Ghostwriter]] — Nicolas Cole: budowanie inbound przez LinkedIn/X — potencjalni klienci obserwują w ciszy; 5 archetypów głosów klientów ghostwritera.
...
- [[2026-05-19 A new era for AI Search]] — Google I/O 2026: AI Mode przekroczył 1 mld użytkowników, Search ewoluuje w platformę agentową z agentami informacyjnymi i agentic coding (Antigravity).
...
- [[2026-05-20 An Intro & Guide to Evergreen Marketing]] — Brafton: 6-krokowy proces tworzenia evergreen content — long-tail keywords, repurposing i automatyzacje sprzedażowe działające bez nadzoru.
- [[2026-05-20 EU AI Act Update Timeline Relief, Targeted Simplification, and New Prohibitions]] — Global Policy Watch: systemy wysokiego ryzyka — compliance przesunięty do 2 XII 2027; nowe zakazy AI-CSAM od XII 2026.
...
- [[2026-05-20 Why Email Still Outperforms Every Other Fundraising Channel]] — Rob Burke/DonorDock: email bije social media na każdym wskaźniku fundraisingowym; $54/1000 emaili, 16% wzrost przychodów sektora NGO; metody micro moments i social street team.
- [[2026-05-20 Ghostwriters are landing $9,000 projects]] — PGA: Email Ghostwriter jako nisza Q3/Q4 — $9K projekt Pameli (EEC+Warm Outreach Scripts); sezonowość budżetów marketingowych.
...
- [[2026-05-21 Gmail Changes Impact Open Rates  MWD Blog]] — Zoe Clarke (MWD): Gmail proxy dla pikseli śledzących obniżył raportowane open rates; segmentacja na kliknięciach, nie otwarciach.
...
- [[2026-05-22 5 Campaign Considerations ahead of the TTPA full enforcement]] — Partisan/Luis Cano: 5 lekcji operacyjnych dla kampanii po TTPA — mapowanie środowisk, content engine, compliance jako funkcja strategiczna.
- [[2026-05-22 AI nie zależy, ale ludziom tak. Festiwal Sektor 3.0 pod hasłem „Masz Wpływ"]] — Festiwal Sektor 3.0 (1000 uczestników): 3 role AI w NGO (asystent/specjalista/ekspert); shadow AI i cyfrowa suwerenność.
- [[2026-05-22 How anyone can make $10k-mo as a ghostwriter]] — PGA: matematyka $10K/mies. = 3 klientów × $3333; framework od Information Advantage przez Free Work do poleceń.
...
- [[2026-05-22 Organic Social Amplification for Acquisition Building Predictable Growth Without Ads]] — Partisan/SoSha: social media amplification jako mierzalny kanał akwizycji dla NGO w Europie po ograniczeniu reklam politycznych przez TTPA.
...
- [[2026-05-22 Text-to-Give The Future of Donor Engagement]] — Engaging Networks: text-to-give jako mobilny kanał fundraisingowy uzupełniający email i eventy; dwa modele SMS, kiedy stosować, 5 funkcji platformy.
...
- [[2026-05-22 The One AI Writing Hack Nobody Talks About.]] — Metodologia „project room / data room" jako ochrona przed halucynacjami AI: inwentarz źródeł, dziennik konfliktów i lista brakujących kontekstów przed zleceniem agentowi napisania dokumentu.
- [[2026-05-23 How a part-time ghostwriter quit her job]] — PGA: Torunn — 1–2h/dzień na outreach, 25K USD od 2 klientów LinkedIn w kilka miesięcy; priorytet na rozmowy sprzedażowe i Free Work.
- [[2026-05-23 ‘It’s called winning’ Why a tech industry super PAC is running ads about ICE]] — Nitasha Tiku, Ian Duncan, Gerrit De Vynck (Washington Post): wojna super PAC-ów AI (Public First vs. Leading the Future) w wyborach uzupełniających; sprzeczne przekazy w różnych okręgach jako taktyka wygrywania.
- [[2026-05-24 Get Your Fundraising Emails Delivered]] — Jeff Brooks: jak AI filtry emailowe zmieniają dostarczalność — engagement jako główny sygnał; pisanie ludzkie, zmienne szablony i zapraszanie do odpowiedzi jako strategie obrony.
- [[2026-05-24 Nonprofit Stickers A Guide to Design and Fundraising]] — Jessica Fox (Eventgroove): naklejki jako narzędzie sygnalizowania tożsamości dla NGO — strategie fundraisingowe, QR kody i design "un-logo".
- [[2026-05-24 The AI paradox More automation, more humans, more work]] — Dan Shipper: paradoks — więcej automatyzacji = więcej ludzi; jeden "super-agent" firmowy skuteczniejszy niż osobisty agent każdego pracownika.
- [[2026-05-25 300 tys. nowych tytułów miesięcznie]] — Wilkowski: raport o 60% ebooków na Amazonie współtworzonych przez AI w 2025 r. — dane o skali, jakości i odporności instytucji rynku książki.
...
- [[2026-05-25 Próbowaliśmy, nie wyszło - co naprawdę za tym stoi]] — Instytut Fundraisingu: "cement bezradności" w NGO — pierwsza kampania to test danych, nie ostateczny sprawdzian; retrospekcja oparta na wskaźnikach.
...
- [[2026-05-25 🎙️ How I AI How the engineer behind Claude Cowork actually uses Claude Cowork & What launched at Google IO 2026]] — Felix Riesenberg (Anthropic): "idź o jeden poziom abstrakcji wyżej" — Claude sam wnioskuje z kontekstu zamiast otrzymywać instrukcje.
...
- [[2026-05-26 Fundraising systems self-assessment Is your nonprofit’s infrastructure helping you grow?]] — Rob Wu: sześciopytaniowy self-assessment systemów fundraisingowych; connected fundraising jako remedium na rozproszone dane darczyńców.
- [[2026-05-26 How nonprofits should approach GivingTuesday's TogetherTuesday]] — Devon Welborn: TogetherTuesday 23 VI 2026 — nowa śródroczna inicjatywa GivingTuesday; rok 2026 jako test bazowy dla NGO.
...
- [[2026-05-26 Why your fundraising emails need their own subdomain]] — Sara Cederberg (Civic Shout): subdomena mailowa dla NGO jako ochrona reputacji nadawcy przy kampaniach fundraisingowych.
- [[2026-05-27 141 Tworzenie YouTube Shorts, których nikt nie ogląda - jak tego uniknąć]] — Beeffective: YouTube Shorts jako dokument dla AI — LLM analizuje transkrypcje; E-E-A-T i czytelność kluczowe dla widoczności.
...
- [[2026-05-27 Escola AI Weekly 40]] — Wojewodzic: Anthropic na plusie, OpenAI traci mld/mies.; 49% polskich firm rozczarowanych AI — 4 błędy wdrożeniowe.
...
- [[2026-05-27 How to Build an Email Marketing Strategy]] — Beth O'Malley: strategia emailowa jako system decyzyjny; intentional vs. consequential opt-ins jako fundament zaangażowania bazy NGO.
- [[2026-05-27 How to Write Email Copy That Converts]] — Beth O'Malley: pisz z perspektywy odbiorcy, nie nadawcy; TFDS, PAS, AIDA i "word association dissonance" jako mechanizm tarcia w emailach.
- [[2026-05-27 Navigating Non-Profit Complexity]] — Bryan Neider: First Principles i Systems Thinking jako obowiązkowy fundament przed wdrożeniem Agentic AI w NGO.
- [[2026-05-27 The Email Glass Ceiling What It Is, How to Spot It, and What to Do About It]] — Beth O'Malley: "email glass ceiling" — strukturalne bariery systemu/strategii/danych; diagnostyka i priorytety naprawy.
- [[2026-05-27 The Time You Save Means Nothing If You Waste It]] — Kyle Behrend: co NGO powinny robić z czasem zaoszczędzonym przez AI — decyzja liderska o reinwestycji w relacje, eksperymenty i zaległości misji.
- [[2026-05-27 The counterintuitive fix most site owners overlook]] — Matt Diggity: content pruning — usuwanie słabych stron podnosi autorytet tematyczny domeny; 4-etapowy audyt z Screaming Frog i GSC.
- [[2026-05-27 The model is accurate. The UX is clean. So why don't users trust it, and why is that silence killing your data?]] — Katarzyna Szczesna: pewny ton AI narusza EVT i niszczy zaufanie; projektuj widzialną niepewność i oddaj kontrolę użytkownikowi.
- [[2026-05-27 Transparentność boli. Dlaczego większość liderów woli kłamać?]] — Maciej Sawicki: transparentność finansowa jako mechanizm biznesowy — dlaczego liderzy ukrywają złe wiadomości i dlaczego to błąd.
- [[2026-05-28 The Case Against the AI Thought Partner]] — Sofia Quintero: ryzyka korzystania z AI jako "thought partnera" — sycophancy, amplifikacja przekonań i mechanizmy poznawczego zagrożenia.
- [[2026-05-28 5 Simple But Powerful Ways I Used AI In My Business Last Week]] — Dickie Bush: 5 wdrożeń AI w tygodniu — ocenianie rozmów sprzedażowych, produkcja reklam statycznych, research konkurencji przez MCP.
- [[2026-05-28 AI-Driven Philanthropy How Nonprofits Can Protect Their Mission]] — Forbes/Siadkowski: 16 liderów NGO o mission drift przez AI; governance-first — strategia AI przed poszukiwaniem finansowania.
- [[2026-05-28 Never run out of ideas for what to write about]] — Ryan Carr: "wizard prompt" dla Claude generuje 20–25 tematów na podstawie krótkiego wywiadu; bank tematów z pytań publiczności.
- [[2026-05-28 Nowy Algorytm LinkedIn 2026 5 zmian, które musisz znać]] — Adrianna Wardzała: nowy algorytm LinkedIn 2026 oparty na AI rozumie sens treści — 5 zmian: headline jako sygnał AI, zapisy > lajki, wartość dla konkretnego odbiorcy ponad trik zasięgowy.
- [[2026-05-28 Przestań zakładać, zacznij pytać. Jak tworzyć usługi, których ludzie potrzebują?]] — Sektor 3.0/Wasyluk: design zorientowany na użytkownika; iteracja i "cicha dostępność" jako standard cyfrowych działań społecznych.
- [[2026-05-28 What happened when IRC branded its giving tiers]] — IRC: rebrand "Rescue Collective" (3 tiery) — przejście od "zbawiciela" do partnerstwa; +4-6 pp retencji, newsletter > gadżety.
- [[2026-05-28 dlaczego ludzie wspierają NGO]] — Social Movers Hub: główna bariera fundraisingu to brak relacji i brak pokazania sprawczości wpłaty; każda NGO może pokazać konkretną zmianę.
...
- [[2026-05-29 Advertising]] — M+R Benchmarks 2026: NGO wydają $0.10 z każdego dolara pozyskanego online na reklamę; ROAS search $2.48 vs TikTok $0.04; AI redukuje display, wzmacnia search.
- [[2026-05-29 Agents Surf the AI-Written Web]] — Human Security: ruch AI potroił się w 2025 r.; agentic browsing wzrósł 80×, malicious scraping +47%, ataki po zalogowaniu 4× wyższe.
- [[2026-05-29 Creative is becoming the new performance driver Here's what you need to know, and what to do next]] — M+R: algorytmy platform dobierają odbiorców na podstawie kreacji, nie targetowania — NGO muszą produkować więcej różnorodnych kreacji.
...
- [[2026-05-29 What Donors Are Actually Telling You Giving Motivations From the 2026 Giving Signals Report]] — Bloomerang 2026: darczyńcy dają z powodów tożsamościowych (97% troska o społeczność), nie finansowych; framework 3-elementowy i dane o wyższości konkretnych apeli o 88 pkt. proc.
- [[2026-05-29 What to Set Up Before Launching a Peer-to-Peer Campaign]] — Rob Wu: kampania p2p jako strategia relacyjna — ujawnia przyszłych ambasadorów i liderów bardziej niż sama kwota zebrana.
...
- [[2026-05-31 Humanizacja tekstu AI - jak sprawić żeby treści generowane przez AI brzmiały naturalniej?]] — Katarzyna Baranowska: humanizacja AI to przywracanie głosu autora przez few-shot prompting, listy zakazanych fraz i trójwarstwowy model (fakty, język, perspektywa).
...
- [[2026-06-01 How People Are Really Using AI in 2026]] — Marc Zao-Sanders: badanie 12 637 przypadków użycia AI — terapia/towarzystwo nadal #1, "shadow usage" w pracy i mechanizm "thinkslop" prowadzący do leniwego myślenia.
...
- [[2026-06-02 Recurring Giving Statistics 2026 Benchmarks]] — Abby Jarvis (Neon One): dane z 4107 NGO — darowizny cykliczne rosną +31,58% przy retencji 78–80%; 58,6% daje bez prośby; lifetime value 2x wyższe niż jednorazowych.
...
- [[2026-06-02 Major Gift Fundraising Strategy Guide for Nonprofits 2026]] — Bloomerang: 7-krokowy program major gifts (próg darowizny, zespół, identyfikacja 3 C's, cultywacja, ask, podziękowanie, przegląd wyników); darowizny niepieniężne rosną 66% vs 11% dla gotówki.
- [[2026-06-03 AI at Work Strategy Matters More Than Tools]] — BCG (Beauchene, Duranton, Martin, Lyon, Walters): ankieta AI at Work 2026 — strategiczna jasność ważniejsza niż dostęp do narzędzi, 5 imperatywów CEO dla transformacji AI, mierzenie wartości zamiast adopcji.
...
- [[2026-06-03 Some Lessons from the Trenches What I learned and thoughts on how to move forward]] — Cat Stern: 5 lekcji z kampanii Biden/Harris 2024 — unifikacja płatnych mediów, ground game od początku, dyscyplina przekazu, learning agenda zamiast testowania wszystkiego, jakość konsultantów ponad ilość.
...
- [[2026-06-04 43 Claude Skills that give you the teaching assistant team your department will never fund]] — Doan Winkel: biblioteka 43 gotowych Skills dla Claude Cowork eliminujących "rebuild tax" — wzorce reużywalnych instrukcji dla powtarzalnych zadań.
...
- [[2026-06-04 Escola AI Weekly nr41]] — Krzysztof Wojewodzic: encyklika papieska o AI, luka kompetencyjna w Polsce (25% firm z ekspertami), token maxing w Uberze, effort control w Claude, polski model Plum 70B i trzy zapowiadane IPO (SpaceX, OpenAI, Anthropic).
...
- [[2026-06-05 If I were Chief AI Officer of My Human Rights Campaign This is how I'd approach AI with my campaigners < Sheila McKechnie Foundation]] — Rasha Daya: framework etycznego wdrażania AI w campaigningu — 4 zasady graniczne i 5 obszarów zastosowań AI (lokalizacja treści, wzorce, monitoring); kluczowy wniosek: AI skaluje pracę, ale osąd strategiczny pozostaje po stronie kampanierów.
- [[2026-06-05 Before Fundraisers Ask What AI Can Do, We Need to Ask What AI Might Repeat]] — Meenakshi Das (AFP): AI w fundraisingu powiela odziedziczone wzorce (kto jest „dobrym prospektem"), jeśli dane już je zawierają; checklist pytań etycznych przed wdrożeniem.
...
- [[2026-06-07 Shadowbanned Politics Who Speaks and Who Disappears in the Age of AI]] — Partisan: AI jako niewidzialny redaktor polityczny — TTPA, wycofanie platform z politycznej reklamy i LLM bias tworzą efekt incumbency bias szczególnie szkodliwy dla NGO i nowych ruchów.
...
- [[2026-06-08 Kto nie musi pytać prezesa o zgodę-]] — Instytut Fundraisingu (Martyna Mazela): 90% organizacji z zarządem na konsultacji wchodzi do programu — mandat zarządu, nie kompetencje fundraiserki, decyduje o stabilności fundraisingu.
- [[2026-06-08 The Nonprofit of 2030 What It Takes to Get There]] — Dennis Fois (Bloomerang): 5 sił zmieniających sektor NGO do 2030 (transfer majątkowy, zmiana dawania, AI, dowód skuteczności, rosnące potrzeby); profil organizacji gotowej — wielopokoleniowa baza darczyńców, AI w służbie fundraisera, retencja przez zamknięcie pętli wpływu.
- [[2026-06-09 AI Playbook for charities]] — Make Sense Of It: kompleksowy przewodnik AI dla NGO (2026) — frameworki ryzyka, buy/build/assemble, redesign workflow, kryzys widoczności SEO i zarządzanie systemami agentycznymi.
- [[2026-06-09 Companies aren’t ready for how AI is accelerating impersonation attacks]] — Eric Geller (CIO Dive): raport Outtake — AI przyspiesza ataki podszywania się pod kadrę zarządzającą (53% firm dotkniętych), słaby nadzór nad agentami AI i rozproszone zarządzanie ryzykiem cyfrowego zaufania.
- [[2026-06-09 Data centers AI a susza. Dlaczego nowe serwerownie powstają tam, gdzie brakuje wody]] — Mateusz Wojdalski: 2/3 nowych centrów danych AI w USA budowanych na obszarach wysokiego stresu wodnego; zużycie wody przez sektor wzrośnie do 73 mld galonów/rok w 2028.
- [[2026-06-09 How to Catch (and Lower) Red Flags in Email Performance]] — Send It Right (Lauren): pięć czerwonych flag w email marketingu (bounce rate, open rate, spam complaints, unsubscriby, CTR) z progami alertów i procedurą reagowania.
...
- [[2026-06-09 How Humans Actually Behave in the Inbox]] — Beth O'Malley (Astral): psychologia inboxu — 4 typy odpowiedzi na email, predictive coding, „for later problem", mobile half-present reader; fundamentalne przemodelowanie założeń o tym, kto i jak czyta maile.
- [[2026-06-09 The AI dilemma Leaders are ready for results, but stuck in proof of concept]] — Nisha Verma (Avanade): 41% organizacji utknęło na PoC, 30% ma spójną strategię AI — recepta: visionary AI strategy + upskilling zamiast kolejnych pilotów.
...
- [[2026-06-11 Otwarte Klatki mailing — nowe wzorce (marzec–czerwiec 2026)]] — 23 maile OK (marzec–czerwiec 2026): zakaz futer w Polsce → kampania do KE, ankieta z publikacją wyników, e-kartka charytatywna (dobredary.pl), opt-down zamiast opt-out.
...
- [[2026-06-11 Introducing Claude Corps]] — Anthropic: program stypendialny 1000 fellows AI osadzonych w NGO w USA (150 mln USD); model „konsultant AI na miejscu" z potencjałem replikacji globalnej.
...
- [[2026-06-12 Why Peer-to-Peer Fundraising Shouldn't Stop After Spring]] — Claire Axelrad: P2P fundraising jako całoroczny ekosystem, nie sezonowa kampania; stewardship fundraiserów i model aktywacji przy osobistych momentach (urodziny, maratony, jubileusze).
- [[2026-06-12 The Generational Remix What the 2026 Giving Signals Report Reveals]] — Megan Allison (Bloomerang): mapa sygnałów dawania 4 pokoleń z raportu Giving Signals 2026; dwa sygnały universalne — przejrzystość (94%) i przynależność (87%); reframe dla milenialsow: „tu jest twoje miejsce” zamiast „potrzebujemy pomocy”.
- [[2026-06-13 Agent się nie uczy — uczą się jego wspomnienia]] — Tomasz Woliński (stormit.pl): Pętla Kontekstu (5 kroków) jako system budowania pamięci agenta AI na plikach markdown; dlaczego automatyczna pamięć bez konsolidacji degraduje agenta i kto ma prawo pisać do jego wspomnień.
- [[2026-06-14 A frontier without an ecosystem is not stable]] — Satya Nadella: framework human capital + token capital; organizacje muszą budować własne pętle uczenia się łączące ludzi z AI, żeby zdobyć trwałą przewagę niemożliwą do skopiowania przez podmianę modelu.
- [[2026-06-15 Content Marketing Is Getting Technical. That's Not the Problem.]] — Ina Toncheva: architektura Content OS według Ahrefs — blog jako codebase, vector embeddings, source-of-truth w Markdown i rola content marketera jako menedżera AI.
...
- [[2026-06-15 Year-end success starts now]] — Jarred Schremmer (RKD Group): dlaczego year-end fundraising zaczyna się w połowie roku; 4 priorytety: mid-level donors, DAF, lapsed donors, direct mail.
...
- [[2026-06-15 How we outranked the original manufacturer]] — Matt Diggity: 5-krokowy playbook SEO dla nisz opartych na zaufaniu (E-E-A-T, Reddit, intencja, kanibalizacja) z wynikiem +59,6% sesji organicznych YoY i 634 frazami w AI Overviews.
- [[2026-06-15 What "Googling" will mean in 2027]] — M+R: jak nowe funkcje Google AI (agentic shopping, expanding search box) eliminują potrzebę wejścia na stronę NGO; strona jako karma dla robotów AI; earned media jako nowy SEO w erze LLM.
- [[2026-06-15 Six Campaign Lessons from Malta and Cyprus AI, Participation, and Digital Strategy in Action]] — Luis Cano (Partisan): 6 lekcji z kampanii wyborczych Malta i Cypr 2026 — AI jako narzędzie rytmu produkcji, architektura uczestnictwa (model Fidiasa), framework 3 kategorii contentu, monitoring wiralności jako wywiad kampanijny.
- [[2026-06-15 Nonprofits Have a New Mid-Year Moment TogetherTuesday]] — Steve Isom (Bloomerang): TogetherTuesday (23 czerwca) jako mid-year moment angażujący darczyńców bez prośby o pieniądze; 97% darczyńców motywuje troska o wspólnotę, nie deadline.
- [[2026-06-16 The post-donation ask you should try]] — Civic Shout: strategia „two-way daisy chain" Born Free Foundation — wzajemne przekierowania petycja↔donacja i odwrócone emaile follow-up, które dały 12,7% ponadcelu i 2/3 darczyńców podpisujących petycję od razu.
- [[2026-06-16 13 *actually* useful things you can do with Claude Cowork this weekend]] — Tayla Burrell: 13 praktycznych use case'ów dla Claude Cowork — CRM z maili, audit treści, analiza transkryptów, repurposing i budowa kontekstu jako fundament systemu.
- [[2026-06-16 Suwerenność na wynajem]] — Dariusz Jemielniak: esej o europejskiej zależności technologicznej przez pryzmat wyłączenia modelu Fable — suwerenność, której się nie buduje, jest na wynajem.
- [[2026-06-16 Brands that bolster Three social justice leaders share strategies for building brands that create momentum]] — Claire Taylor Hansen (Big Duck): 3 strategie rebrandingu NGO social justice (centrum w społeczności, modulacja głośności, zakotwiczenie w misji/danych) z case studies CVH, Future Currents, Guttmacher Institute.
- [[2026-06-16 Website Performance]] — M+R Benchmarks 2026: 39% ruchu NGO z organiki (trend spadkowy przez AI Overview), konwersja 1,6% i $1,33/odwiedzający; desktop dominuje w darowiznach (72% przychodów, $168 średni dar vs $88 mobile).
- [[2026-06-16 Send It Right - What to Do When You Have a Deliverability Issue]] — Newsletter Lauren Meyer: trzystopniowy proces reagowania na potwierdzone problemy z deliverability (zrozumienie skali → diagnoza przyczyny → działanie); praktyczne wskazówki dla nadawców kampanii mailowych.
- [[2026-06-16 Jak zintegrować rozproszone dane w firmie]] — wPraktyce.AI: argument za spinaniem istniejących narzędzi przez API zamiast kupowania nowych systemów; diagnostyka API jako pierwszy krok wdrożenia AI; ROI integracji ~2400 zł/mies. oszczędności przy 12h strat tygodniowo.
- [[2026-06-16 3 Things Working In Inboxes Right Now]] — Jess Campbell (Out in the Boons): trzy taktyki emailowe działające w skrzynkach nonprofit — sezonowe freebie jako lead magnet, ankieta donorów przez email (legacy gifts, DAF), email "czujesz się widziany" jako automatyzacja po 2. kontakcie.
- [[2026-06-16 From Zero Subscribers to an Email List of Engaged Buyers-In Just 3 Steps]] — Jenna Kutcher: transkrypt webinaru o budowaniu listy mailingowej jako jedynego własnego assetu marketingowego; framework lead magnet → landing page → automation, ROI $42/$1, argument za priorytetyzacją email nad social media.
- [[2026-06-16 Why belonging matters in digital organizing]] — Beth Becker (Becker Digital Strategies): 5 koncepcji przynależności w digital organizingu (welcome series, aktywne słuchanie, język, ankiety z wpływem, metryki vs. retencja) jako fundament retencji zwolenników i skutecznych kampanii NGO.
- [[2026-06-16 Crowdfunding w organizacjach. Jak wybrać platformę do zbiórek internetowych porównanie]] — Maya Olszewska (ngo.pl): porównanie 3 dominujących platform crowdfundingowych w Polsce 2026 (zrzutka.pl, pomagam.pl, siepomaga.pl) z kluczowym kryterium: dostęp do danych darczyńców.
- [[2026-06-16 Turning Research Into Impact A Knowledge Translation Guide for Nonprofits]] — Jacob Barry / Arcana Creative: 7-krokowy framework knowledge translation — jak przekształcić raporty badawcze organizacji społecznych w dostępne materiały dopasowane do różnych odbiorców (decydenci, społeczność, frontline).
- [[2026-06-16 How Praxis & Rally Delivered Big Digital Impact On A Shoestring]] — Paul de Gregorio (Rally): case study małej organizacji migranckiej Praxis — dyscyplina strategiczna zamiast budżetu, framework North Star i fundamenty roku 1, wzrost listy z 1000 do 40000+ i 12-krotny wzrost przychodu online.
- [[2026-06-16 How A Slow Campaign Website Costs Votes And Donors]] — Eric Wilson: Core Web Vitals i darmowe narzędzie PageSpeed Insights do diagnozy, dlaczego wolna strona kampanii/organizacji kosztuje zapisy, darowizny i pozycję w wyszukiwarce.
- [[2026-06-17 Humanistic by Design. Transparent by Default. Values-Led Always.]] — Bryan Neider (AbilityPath): framework etycznego wdrażania AI w NGO — Reguła Trzech (Human Dignity, Algorithmic Transparency, Values-Based Governance) i dlaczego adopcja AI to projekt kulturowy, nie technologiczny.
- [[2026-06-17 Jak zbudowałem AI, które nie zmyśla o partycypacji dzieci i młodzieży]] — Przewodnik dla nieinżynierów jak działa architektura RAG na przykładzie PIA (prywatna baza wiedzy dla zespołu doradczego RPD): embedding, chunking dwupoziomowy i specyfika tokenizacji języka polskiego.
- [[2026-06-17 Zamiast grantozy. Trzy alternatywne modele finansowania organizacji społecznych]] — Trzy alternatywy dla grantów publicznych w polskim sektorze NGO: model zbilansowany (22%), usługowy (9%) i filantropijny (7%) z danymi z raportu Kondycja 2024.
- [[2026-06-17 Jak naprawdę działa LinkedIn algorytm, zasięgi i sprzedaż B2B bez ściemy]] — Rafał Szymański: demitologizacja algorytmu LinkedIn (tribes, spójność profilu, śmierć pods) z planem startowym opartym na komentarzach i praktycznym modelem mierzenia ROI z Sales Navigatora.
- [[2026-06-17 Ecosystems Are Not Nonprofit Programs]] — Tasha Van Vlack (The Nonprofit Hive): rozróżnienie między programem (output) a ekosystemem (przepływ zaufania, wiedzy, zasobów) — 5 przesunięć myślowych i pytania diagnostyczne dla liderów NGO budujących partnerstwa i koalicje.
- [[2026-06-17 10 things I stopped doing with email that most marketers still do]] — Beth O'Malley (Astral): 10 domyślnych praktyk email marketingu, które należy porzucić (open rates, benchmarki, double opt-in, time-based sequences) z konkretnymi alternatywami opartymi na psychologii inboxu.
- [[2026-06-17 Email Volume How Much Is Too Much, How Little Is Too Little, and How to Get It Right]] — Beth O'Malley (Astral): kompleksowy przewodnik po objętości wysyłek emailowych — 4 wymiary volume, 4-krokowy proces optymalizacji, 5 strategii redukcji bez straty wyników oraz wpływ zmian algorytmów Gmail/Yahoo 2025 na deliverability.
- [[2026-06-17 Email awareness and the 4 metrics for email marketing that track awareness]] — Beth O'Malley (Astral): email jako kanał awareness — psychologia działania nieotwartych emaili (mere exposure, predictive coding, mental availability) oraz framework pomiarowy ROI² zastępujący obsesję na punkcie open rate.
- [[2026-06-17 Rekordowy stream Łatwoganga. Jak nowoczesne narzędzia i autentyczność wspierają zbiórki na cele społeczne?]] — Maya Olszewska: analiza największej zbiórki streamerskiej w historii (250 mln zł dla Fundacji Cancer Fighters) — mechanizmy poczucia wpływu, autentyczności i infrastruktury płatności jako lekcje dla NGO.
- [[2026-06-17 Memorial Donation Letter Ultimate Guide + Free Templates for Nonprofits]] — Bloomerang: przewodnik po listach powiadamiających rodzinę o darowiznach pamiątkowych (tribute gifts) — struktura listu, zasada „bez kwot" i gotowe szablony dla zespołów fundraisingowych.
- [[2026-06-17 How I built my AI agent workforce]] — Allie Miller (AI with ALLIE): kulisy wieloagentowego systemu AI (34 agenty, hierarchia Chief of Staff → dyrektorzy → specjaliści + agent pamięci Toby) z frameworkiem JD-first do budowania własnego AI workforce bez kodu.
- [[2026-06-18 The ranking lever most SEOs skip]] — Matt Diggity: cztery metody naprawy struktury linków wewnętrznych (money pages, anchor text, click depth, orphan pages) jako dźwignia rankingowa bez kosztów zewnętrznych.
- [[2026-06-18 Your email program is carrying more weight than ever]] — Civic Shout: trzy wnioski z raportu CEP 2026 dla NGO — rosnąca konkurencja w inboxie, mniejsze zespoły, znaczenie darczyńców indywidualnych dla bilansu organizacji.
- [[2026-06-18 The Reason We Exist. The Anchor That Holds.]] — Bryan Neider: misja NGO jako precyzyjny instrument skracający cykl decyzyjny; kultura jako misja w trybie operacyjnym; obrona bias toward action wobec paralysis przez analizę.
- [[2026-06-18 dlaczego wiele komunikatów fundraisingowych nie działa]] — Social Movers Hub: model Problem → Zmiana → Dowód → CTA jako schemat skutecznego apelu fundraisingowego; kluczowa rola dowodu wiarygodności i konkretnego CTA.
- [[2026-06-18 Jak wzbogacać leady po NIP-ie z AI]] — wPraktyce.ai: workflow automatyzacji researchu B2B — NIP → KRS/GUS → profil firmy + scoring fit GREEN/YELLOW/RED w kilka sekund zamiast 15 min ręcznego researchu.
- [[2026-06-18 4 numbers, and I'll be quick]] — Jenna Kutcher: cztery kluczowe statystyki email marketingu (ROI 42:1, 1 USD/subskrybent/miesiąc, 3-4x wartość zamówień vs social, 2/3 konsumentów kupuje z maila) jako argument za budowaniem własnej listy.
- [[2026-06-18 How to create an irresistible ghostwriting offer]] — Ship30for30: trzyczęściowy framework budowania oferty ghostwriterskiej opartej na wartości (Information Advantage, narracja problemu/rozwiązania, 3 nieodparte wymiany) pozwalający uzasadnić premium cenę.
- [[2026-06-18 Define your audience of one]] — Moodboard/Ryan Carr: koncepcja jednego fikcyjnego idealnego czytelnika (Morning Brew) jako klucz do skuteczniejszego copy i lepszego kontekstu dla AI; wizard prompt budujący profil do użycia w projektach Claude.
- [[2026-06-18 Co działa w cyfrowej zmianie NGO? Wnioski z projektu "Transformacja cyfrowa NGO 2024-2026" (NOWEFIO)]] — TechSoup Polska/Karina Janus: ewaluacja dwóch kohort mentoringowych (n=47 NGO) — triada barier czas/kompetencje/budżet, model 4-elementowego wsparcia i wzorce operacyjne małych organizacji.
- [[2026-06-18 I'll grow your email list (yes, really)]] — Jess Campbell/Out in the Boons: listy mailowe NGO kurczą się netto o 11% rocznie (M+R Benchmarks) — budowanie listy musi być procesem ciągłym, nie zadaniem przedświątecznym.
- [[2026-06-18 AI content repurposing playbook Turn one piece of content into 15+]] — Simon Lim (Hostinger): system repurposingu treści z materiałów już stworzonych (maile, notatki) przez profil głosu AI i ekstrakcję "kątów" na blog, LinkedIn, X, wideo, newsletter i Reddit.
- [[2026-06-19 The new civic media marketplace – and what it means for progressive messaging]] — Laura Quinn (Catalist): analiza strukturalnej transformacji rynku mediów obywatelskich — dlaczego progresywne organizacje przegrywają wojnę informacyjną z młodymi wyborcami i jak wzmacniacze cyfrowe (creator agencies, culture shows) zmieniły reguły gry na korzyść prawicy.
- [[2026-06-19 Fiscal Agility. Radical Transparency. The Discipline of Sustainability.]] — Bryan Neider: piąty filar TEAMS! — dyscyplina finansowa NGO: rezerwy 6-miesięczne, transparentność wobec zarządu i przejście na unrestricted funding jako fundament trwałości organizacji misyjnych.
- [[2026-06-20 Piotr, zero razy tysiąc to dalej... zero]] — stormit.pl/Tomasz Woliński: prompt diagnostyczny „5 decyzji" ujawniający, czego nie oddawać AI przed większym zadaniem; oparty na Regule Zero × Mnożnik (AI mnoży kompetencję, nie ją zastępuje).
- [[2026-06-21 What happens after coding is solved?  Fiona Fung (Manager of the Claude Code and Cowork Teams)]] — Lenny Rachitsky / Fiona Fung (Anthropic): 12 obserwacji z prowadzenia zespołu Claude Code i Cowork — weryfikacja jako największy nierozwiązany problem AI, przejście na asynchroniczne pętle agentów, framework bad/sad i zasady kulturowe "AI-pilled" organizacji.
- [[2026-06-21 Ghostwriting jako side hustle - 3 powody i porownanie alternatyw]] — Cole Schafer/Premium Ghostwriting Academy: 3 argumenty (rosnący popyt, lifestyle 6–10 h/tyg., transferowalne umiejętności) + porównanie z dropshippingiem, krypto, YouTube, SaaS; 72% Amerykanów chce side hustle.
- [[2026-06-21 The Last Neutral Space Wikipedia and the Politics of Digital Truth]] — Partisan: Wikipedia jako infrastruktura demokratycznej kontroli wiedzy — trzy mechanizmy odporności na manipulację i postulat dziedziczenia tych zasad przez systemy AI.
- [[2026-06-21 Who Really Wins the Story Versailles Lost to a Phone]] — Partisan: pięć lekcji komunikacyjnych z G7 2026 — Meloni phone beat Macron Versailles, bo emocja i prędkość i jedna linia podróżują lepiej niż substancja bez shareable artifact.
- [[2026-06-21 The Engagement Trap, Why the Numbers Are Lying to You]] — Partisan: NGO-i optymalizują do taniego engagementu bazy (echo chamber), zamiast droższego engagementu przekonywalnej większości — tam gdzie realnie dzieje się zmiana polityczna.
- [[2026-06-22 Sprawozdania finansowe NGO niczego nie sprawozdają]] — Instytut Fundraisingu/Martyna Mazela: sprawozdania NGO to dokumenty prawne bezużyteczne zarządczo; cztery pytania diagnostyczne (struktura przychodów, koszt beneficjenta, koszt fundraisingu, baza regularnych darczyńców) jako framework strategyczny.
- [[2026-06-22 O odpowiedzialnym korzystaniu z generatywnej sztucznej inteligencji przy pisaniu wniosków grantowych]] — Paweł Łukasiak: AI może redagować wnioski grantowe, ale nie zastąpi strategicznego projektowania — ryzyko schematyzacji i utraty tożsamości organizacji przez masowe użycie tych samych modeli.
- [[2026-06-22 Dlaczego nie monetyzujesz swoich umiejetnosci - ghostwriting jako side hustle]] — Cole Schafer/Premium Ghostwriting Academy: "Invisible Skill Framework" — niszowa wiedza branżowa jako strukturalna przewaga ghostwritera; 1 zmiana pozycjonowania wystarczy by przyciągać klientów premium.
- [[2026-06-22 🎙️ How I AI How to write AI agent loops in Claude Code and Codex + How Claude Mythos found a 15-year-old bug in Mozilla Firefox]] — Lenny Rachitsky: cztery typy pętli agentów AI w Claude Code i Codex — goal-based loops jako najsilniejszy typ automatyzacji; subagenty i model onboardingowy jako klucz do precyzji.
- [[2026-06-22 When Your Team Feels Off 5 Ways Nonprofit Leaders Can Spot Misalignment]] — Nonprofit Hive/Andrés Márquez-Lara: model GRPI (Goals-Roles-Processes-Interpersonal) do diagnozy niedopasowania zespołu przed celami zamiast personaliami; zaufanie jako warunek zdrowego konfliktu.
- [[2026-06-23 Personalisation or manipulation? One design decision makes the difference.]] — Katarzyna Szczesna (BehaviorAI): behawioralne mechanizmy manipulacji w konwersacyjnym AI (aktywacja zaufania, sycophancy jako retencja, paywall przy szczycie zaangażowania) + 4 pytania audytowe dla projektantów produktów AI.
- [[2026-06-23 Attention is the currency of modern politics.]] — Jack Milroy: ekonomia uwagi w polityce — diagnoza dlaczego progresywna komunikacja przegrywa z populistami; "teoria poprawności" vs. "teoria uwagi" jako framework dla NGO i kampanii.
- [[2026-06-23 A to nie wycieknie - na ile ufasz AI]] — wPraktyce.AI (Patryk Łopat): framework bezpiecznego wdrożenia AI — rozróżnienie model vs. baza RAG, opcja offline, argument że dane są często mniej bezpieczne przed wdrożeniem niż po.
- [[2026-06-23 Send It Right - My Top 5 (Least) Favorite Email Myths]] — Lauren Meyer: 5 mitów o dostarczalności emaili — autentykacja nie gwarantuje inboxu, reputacja nadawcy i zaangażowanie odbiorców są kluczowe, nikt nie może zagwarantować inbox placement.
- [[2026-06-23 Escola AI Weekly nr43]] — Krzysztof Wojewodzic: wyłączenie Fable 5 przez rząd USA jako argument za strategią multi-model; suwerenność AI, Polska w NATO cybersecurity, SpaceX przejmuje Cursor, pokolenie AI native.
- [[2026-06-23 What Gmail, Apple, and Outlook are doing to your emails]] — Katelyn Baughan / Civic Shout: podsumowania AI w Gmailu, Apple Mail i Outlooku skanują pierwsze 150–200 znaków emaila; live text jako nowy hero image — praktyczne wskazówki dla NGO.
- [[2026-06-23 Donors gave U.S. charities $617 billion in 2025, according to the new Giving USA report]] — Giving USA 2026: rekordowe 617 mld USD datków w USA; wzrost zapisów testamentowych (+17%) jako sygnał Wielkiego Transferu Bogactwa; kluczowa rola narracji w obliczu cięć federalnych.
- [[2026-06-23 The new inner game Your unfair advantage in the age of AI]] — Joe Hudson: wisdom stack (discernment, conflict, failure, self-talk) jako cztery kluczowe kompetencje liderów w erze AI; NBA-ifikacja zespołów i klarowność emocjonalna jako przewaga nad modelami.
- [[2026-06-23 Połowa Twojego zespołu już używa AI. Czas to zauważyć]] — Piotr Antoniewicz (ngo.pl): shadow AI w organizacjach społecznych — sekwencja zobacz-zrozum-poukładaj przed spisaniem polityki AI, framework Faster/Better/New do sortowania zastosowań.
- [[2026-06-29 Webinarium Inteligentna praca z AI. Jak używać narzędzi AI przy pisaniu wniosku?]] — Fundusz Społeczeństwa Obywatelskiego EOG (Marzena Kacprowicz): 5 etapów pisania wniosku grantowego z AI (analiza wymagań, pomysł, research, treść, redakcja), narzędzia NotebookLM/Gemini gems/Perplexity i ryzyka (plagiat, halucynacje, wyciek danych).
- [[2026-06-23 Building Trust in Communities of Stakeholders]] — Harrison Holcomb: trzy filary zaufania (autentyczność, niezawodność, wzajemny szacunek) jako infrastruktura pracy z interesariuszami; pułapka dobrze intencjonowanej władzy i ćwiczenie sesji słuchania bez agendy.
- [[2026-06-23 AI in Marketing What Marketers Really Think]] — Brafton: ankieta 163 marketerów — 80%+ używa AI, 55% szybciej, ale tylko 24% widzi poprawę jakości; 70% obawia się generycznej treści.
- [[2026-06-24 Why Development Director Turnover Is a System Problem]] — Rob Burke: rotacja dyrektorów fundraisingu (średnio 16 mies.) to problem systemowy, nie personalny — jak zbudować infrastrukturę CRM i przeprojektować rolę przed nowym rekrutowaniem.
- [[2026-06-24 Oprogramowanie open source jako alternatywa. Czego nie wiecie o bezpłatnych narzędziach dla organizacji?]] — Monika Schmeichel-Zarzeczna: praktyczny przewodnik po open source dla NGO — suwerenność cyfrowa, matryca decyzyjna i hybrydowe podejście zamiast rewolucji.
- [[2026-06-24 Does Your AI Have a Personality Problem?]] — Aleksandra Przegalińska / HBR: badanie eksperymentalne — persona AI (styl interakcji) wpływa na stres, jakość pracy i opór pracowników; ankiety satysfakcji tego nie wykrywają, ale logi i dane fizjologiczne już tak.
- [[2026-06-24 Encyklika o AI nie jest o technologii. Jest o człowieku.]] — Aga Kozak / Sektor 3.0: omówienie encykliki Magnifica Humanitas — papież Leon XIV stawia pytanie o człowieka w świecie algorytmów; AI może wspierać misję NGO, ale nie zastąpi relacji i odpowiedzialności.
- [[2026-06-24 The E-E-A-T signal most sites still fail at]] — Matt Diggity: 4 metody budowania sygnału E-E-A-T (doświadczenie autora, oryginalne dane, obecność zewnętrzna, głębokość treści) jako podstawa przetrwania aktualizacji algorytmu Google.
- [[2026-06-24 AI znowu przejmuje kampanie. Pomoże czy zaszkodzi]] — ProLetter / Jakub Jacek: przegląd narzędzi AI wielkich platform (Meta, TikTok, Google, Snapchat) i ostrzeżenie przed homogenizacją komunikacji przy pełnej automatyzacji kampanii.
- [[2026-06-24 Your Email Summer To-Do List]] — Jess Campbell / Out in the Boons: miesięczna checklista zadań letnich dla fundraiserów NGO (czerwiec–sierpień) przygotowująca do kampanii końcowo-rocznej — czyszczenie listy, budowanie bazy, transparentność finansowa.
- [[2026-06-24 300 dahlias and a cabinet in my garage]] — Jenna Kutcher: newsletter-historia o hodowli kwiatów jako metafora przedsiębiorczości; heurystyk „testu trwałości pomysłu" i narracyjny styl emaila (historia osobista → lekcja biznesowa) jako wzorzec ghostwritingu.
- [[2026-06-24 Reclaiming Engagement in a Distributed World]] — Bryan Neider: framework RTO dla organizacji społecznych — powrót do biura jako inwestycja w mentoring i equity, nie nadzór; 5-krokowy plan wdrożenia.
- [[2026-06-24 Transkrypcja Webinar Why Bad Creative Happens to Good People]] — M+R: diagnoza złego creative w NGO — podział editing/approvals, urgency +48% CTR, osobiste historie −29% response rate i zasada 75-25 dla bezpiecznego eksperymentowania.
- [[2026-06-24 Webinar Recording Why Bad Creative Happens to Good People]] — M+R: post-webinarowe refleksje o procesie twórczym w małych NGO — triage zasobów, zarządzanie zatwierdzeniami przez leadership i redefinicja pilności jako dlaczego teraz, nie krzyk alarmowy.
...
- [[2026-06-24 How to Drive Advocacy and Grow Your Nonprofit's Email List for Free]] — Civic Shout: model koalicyjnych Joint Actions z opt-in per organizacja — kredyty za podpisy, reaktywacja supporterów i post-action donation asks.
...
- [[2026-06-24 Millennial Donors and Wealth Transfer Underway in 2026]] — Dennis Fois (Bloomerang): raport Giving USA 2026 — rekordowe 617 mld USD darowizn, transfer majątku 124 bln USD i millenialsi jako przyszli darczyńcy; retencja pierwszorazowych darczyńców jako główna dźwignia wzrostu.
- [[2026-06-24 Encyklika o AI nie jest o technologii. Jest o człowieku]] — Aga Kozak/Sektor 3.0: omówienie encykliki Magnifica Humanitas — papież Leon XIV pyta, czy człowiek nie zaczyna traktować siebie jak maszynę; AI wspiera, ale nie zastępuje relacji.
- [[2026-06-25 Smart Is Not Enough For Our Democracy.]] — Meenakshi (Meena) Das: newsletter o tym, co powinno nastąpić *po* AI for Good Summit 2026 w Genewie — 8 postulatów dla fundatorów, NGO i rządów; AI i demokracja, wypieranie pracy, community consent.
- [[2026-06-25 Two email habits worth copying from Ocean Conservancy]] — Sara Cederberg / Civic Shout: dwa nawyki emailowe Ocean Conservancy — storytelling od pracowników terenowych i zamykanie pętli po advocacy; 40,5% open rate, 11 000 listów do Kongresu.
- [[2026-06-25 dlaczego organizacje tracą darczyńców po pierwszej wpłacie?]] — Social Movers Hub (Paulina): cztery kroki donor retention po pierwszej wpłacie — szybkie podziękowanie, pokazanie wpływu, regularny kontakt, zaproszenie do dalszej relacji.
- [[2026-06-25 Twoi ludzie już używają ChatGPT. Bez kontroli.]] — wPraktyce.AI (Patryk Łopat): argument „shadow AI" — pracownicy używają publicznych modeli bez wiedzy zarządu; rozwiązanie: jeden firmowy system z RAG i dedykowanymi komendami zamiast zakazu.
- [[2026-06-25 The 80-20 of creating content with AI]] — Ryan Carr / Moodboard: trzyetapowy workflow AI dla twórców treści — notatka głosowa + konspekt, Claude Cowork Project (treść + prompty graficzne), generowanie obrazów w Flora lub Midjourney.
...
- [[2026-06-25 Twoi ludzie już używają ChatGPT. Bez kontroli]] — wPraktyce.AI (Patryk Łopat): argument „shadow AI" — pracownicy używają publicznych modeli bez wiedzy zarządu; rozwiązanie: jeden firmowy system z RAG i dedykowanymi komendami zamiast zakazu.
- [[2026-06-25 dlaczego organizacje tracą darczyńców po pierwszej wpłacie]] — Social Movers Hub: cztery kroki donor retention po pierwszej wpłacie — szybkie podziękowanie, pokazanie wpływu, regularny kontakt, zaproszenie do dalszej relacji.
- [[2026-06-25 Seasons of story A better rhythm for donor relationships]] — Givebutter × Max Kringen: framework "Seasons of Story" — dopasowanie komunikacji z darczyńcami do sezonów relacji (wprowadzenie, edukacja, zaangażowanie, przypomnienie).
- [[2026-06-25 The brave new world of political communication in the age of AI]] — Tibor Dessewffy: generatywna AI obniża barierę wejścia do produkcji treści politycznych — forma i platforma decydują o widoczności przekazu bardziej niż jego treść, a realnym zagrożeniem jest erozja oczekiwania istnienia prawdy.
- [[2026-06-26 A New Generation Studies AI, Apple's Recipe for On-Device Models, GLM5.2 Tackles Open-Ended Problems]] — Andrew Ng / The Batch: trzy zagnieżdżone pętle loop engineering (agentic coding, developer feedback, external feedback) jako framework budowania produktów 0-to-1 z agentami AI.
- [[2026-06-26 The Questions Are Stewardship]] — Bryan Neider (TEAMS!): esej o istocie stewardship w NGO — dlaczego trudne pytania zarządu są aktem odpowiedzialności, nie przeszkodą; jak jednoczesne trzymanie optymizmu i realizmu chroni misję przed wishful thinking.
- [[2026-06-26 Smooth Giving, Big Impact Easy Optimizations From the 2026 Giving Signals Report]] — Megan Allison (Bloomerang): trzy szybkie poprawki z raportu Giving Signals 2026 — transparentność opłat i usunięcie tip promptu, edukacja o DAF-ach, priorytet emaila nad social media w komunikacji z darczyńcami.
- [[2026-06-27 Piotr, Twoje AI nie jest za głupie. Jest zbyt samotne... a przecież idą wakacje!]] — Tomasz Woliński/stormit.pl: rozbiór 4 skarg na AI ("zmyśla", "nie pamięta", "robi papkę", "wyrywa stery") jako braki systemowe, nie wady modelu, plus quick win — trzy pliki profil/firma/cele.md dla trwałej pamięci AI.
...
- [[2026-06-29 National Council of Nonprofits Outlines Rules For Fundraising Platforms]] — NCN: 4 filary wytycznych dla platform fundraisingowych (zgoda, transparentność, partnerstwo, odpowiedzialność) poparte przez 50+ stowarzyszeń NGO w USA.
- [[2026-06-29 Fueling Political Tech Who’s Investing in Democracy’s Next Infrastructure]] — niedokapitalizowany rynek political tech w Europie, rola agentowej AI i mission-driven kapitału w budowaniu infrastruktury demokratycznej.
- [[2026-06-29 The role of online voting in increasing youth participation]] — dwie dekady europejskich eksperymentów z iVoting: efekt substytucji zamiast mobilizacji, zaufanie i wola polityczna jako prawdziwa infrastruktura, brak dowodów na wzrost frekwencji młodych.
- [[2026-06-29 5 Considerations for Democracy NGOs Operating Under Foreign-Interference Laws]] — Partisan: pięć obszarów przygotowania organizacji społecznych na ustawy o "zagranicznych agentach" — obrona narracyjna, dywersyfikacja finansowania, dokumentacja compliance, operacyjna solidarność międzynarodowa.
- [[2026-06-29 Oprogramowanie open source dla NGO – do czego warto go używać?]] — Kamil Śliwowski: czym jest open source, rozróżnienie otwartości kodu od usług chmurowych na nim opartych oraz konkretne narzędzia dla NGO (Nextcloud, CiviCRM, Jitsi Meet, LibreOffice) jako droga do niezależności cyfrowej organizacji.
...
- [[2026-06-30 Send It Right - Why Your Email Needs Sunscreen]] — Lauren Meyer: SPF, DKIM i DMARC jako wymóg dostawców skrzynek od 2024; fazowe wdrażanie DMARC (monitoring → kwarantanna → odrzucanie) i segmentacja domen wg typu wysyłki.
- [[2026-06-30 AI designers are getting coding tools. Nobody gave them tools for understanding people.]] — Kasia Szczesna: BehaviorAI Pattern Library, biblioteka wzorców projektowych dla AI zorganizowana wokół momentów behawioralnych (zaufanie, niepewność, personalizacja) zamiast kategorii interfejsu; „AI Invisibility Effect" jako przyczyna porzucania funkcji AI mimo udanych testów.
- [[2026-06-30 How to ask for help from people who don't know you]] — Pradyumna Prasad: heurystyki proszenia o pomoc oparte na jednej zasadzie — postaw się w umyśle odbiorcy; wiarygodność, skrócony kontekst, łatwa akceptacja i świadome ułatwianie odmowy.
- [[2026-06-30 Jak wiedzieć, że robisz dobrze coś, na czym się nie znasz]] — Mateusz Ufel: AI jako „genialny ślepy strzelec" bez własnego celu — technika „Zgadnij kto?" budowania osądu pytaniami zawężającymi zamiast pytania AI o zdanie, przed zleceniem mu wykonania.
- [[2026-07-01 Co zostaje z marketera, gdy AI robi wszystko]] — ProLetter: krytyka rosnącej automatyzacji AI w moderacji i tworzeniu treści (Meta 90% moderacji przez AI) — AI akceptowalne tylko gdy wspiera człowieka, ryzyko utraty kontroli nad marką i standaryzacji kreatywności.
- [[2026-07-01 California Just Did Something Worth Your Attention]] — Bryan Neider: dostęp Kalifornii do Claude dla agencji stanowych nie obejmuje automatycznie organizacji społecznych na kontraktach — trzeba samodzielnie negocjować dostęp; wzorzec human-in-the-loop do zapożyczenia.
- [[2026-07-01 The twilight of the chatbots]] — Ethan Mollick: przyspieszenie zdolności modeli AI (METR, GDPval, AA-Briefcase) i przejście z chatbotów na zarządzanie długo działającymi agentami; sukces zależy od ekspertyzy domenowej, nie zawodu.
- [[2026-07-01 The Wisdom in the Room What 300 Voices Taught Us About AI]] — Bryan Neider (AbilityPath): 300 pracowników pierwszej linii NGO chce AI jako narzędzia, nie kolegi — z governance i szkoleniami; „human in the loop" jako imperatyw moralny.
- [[2026-07-01 B2B Email Attribution How to Track Email Performance]] — Beth O'Malley: dlaczego atrybucja e-mail marketingu w B2B jest fikcją i jak zamiast niej budować „contribution" — pięć pytań i raporty do CRM/HubSpot.
- [[2026-07-01 Scrap the Email Re-engagement Campaign]] — Beth O'Malley: klasyczne kampanie re-engagement szkodzą reputacji nadawcy; zamiast nich cicha suppresja oparta na „meaningful actions" i inwestycja w akwizycję.
- [[2026-07-01 Does AI-Generated Email Hurt Your Deliverability?]] — Beth O'Malley: AI nie jest wykrywane przez filtry spamowe, ale generyczny copy obniża zaangażowanie i deliverability; Gemini w Gmailu i Copilot w Outlooku wprowadzają nową warstwę oceny trafności maili.
- [[2026-07-01 Why Relationship-First Fundraising Beats Chasing New Donors]] — Rob Burke (DonorDock): retencja 87% dla powtórnych vs. 14% dla nowych darczyńców — argument za sekwencją retencja-przed-akwizycją i CRM jako narzędziem oddającym czas na relacje.
- [[2026-07-01 Bloomerang Partners With Dataro for Predictive Donor Intelligence]] — partnerstwo Bloomerang z Dataro: predykcyjna analiza darczyńców i AI-owy research prospectów wbudowane w CRM, z asystentem Penny przygotowującym konkretne akcje.
- [[2026-07-01 Executive Director Burnout Starts With Better Board Governance]] — JB Favour: wypalenie ED jako problem strukturalny ("single-ED dependency"), niezaangażowane zarządy i potrzeba profesjonalnego wsparcia governance zamiast romantyzowania przeciążenia.
- [[2026-07-01 From Spikes to Steady World Central Kitchen's Monthly Giving Rebrand + What the Data Says About ...]] — Dana Snyder/Charity Engine/GivingTuesday Data Commons: case study rebrandu Kitchen Core (WCK) — cel 20 000 nowych darczyńców miesięcznych, wynik 2 800, ale $6 mln LTV; darczyńca miesięczny = 3x wartość jednorazowego.
- [[2026-07-03 No more babysitting one step at a time]] — Marketing AI Playbook: premiera Claude Sonnet 5 jako moment przejścia z prowadzenia AI krok po kroku na zlecanie całych zadań w jednym briefie z autonomiczną weryfikacją wyniku.
- [[2026-07-03 The human workforce behind Artificial Intelligence]] — Olivier Schulbaum (Platoniq): wywiad z Data Labelers Association o ukrytej pracy ludzkiej za AI — warunki pracy w Kenii, brak przejrzystości łańcucha danych i model organizowania się pracowników platformowych.
...
- [[2026-07-02 Jak AI zmienia sprzedaż w aplikacjach mobilnych. Przewodnik dla managerów]] — Escola: 5 funkcji AI podnoszących sprzedaż mobilną (hiperpersonalizacja, asystent zakupowy, lojalizacja, predykcja, analiza opinii) z przykładami i wskaźnikami biznesowymi.
- [[2026-07-02 Please stop the AI Confidence Theater]] — Elena Verna: krytyka „AI Confidence Theater" — przechwalania się rzekomo przełomowymi wdrożeniami AI, które nie wytrzymują pytania „pokaż mi to"; realna wartość AI powstaje w kolejnych tysiącach iteracji, nie w pierwszym prompcie.
- [[2026-07-05 How To Audit Your Newsletter A 10-Point Checklist]] — Josh Spector: 10-punktowa checklista audytu własnego newslettera — od czyszczenia listy po analizę najczęściej klikanych linków.
...
- [[2026-07-06 Your team shipped AI. Nobody asked if users wanted it or if they should have it at all.]] — Kasia Szczęsna (BehaviorAI): BehaviorAI Design Framework — trzy pytania przed wdrożeniem AI (blokada zachowania, dobór interwencji, zasadność etyczna), diagnoza COM-B i model FASCAI dla współpracy człowiek-AI.
- [[2026-07-06 How changing the tribute widget to be a slide up affects tribute donations on Single Post Page]] — NextAfter (Tristan Amaya): eksperyment A/B na CaringBridge — slide-up widget tributu obniżył konwersję darowizn o 50% mimo intuicji, że powinien być mniej inwazyjny; wzrósł za to udział komentarzy.
- [[2026-07-07 Send It Right - The Power of Permission in Email Marketing]] — Lauren Meyer: permission jako fundament deliverability — single vs. confirmed (double) opt-in, wymogi prawne (GDPR, CAN-SPAM, CASL, CCPA) i ochrona formularzy zapisu przed botami.
- [[2026-07-07 Tutorial - Which Claude Model Should You Actually Use]] — AI Break: zasada 10-sekundowej decyzji doboru modelu Claude do wagi zadania (Haiku/Sonnet/Opus/Fable) plus gotowy prompt do budowy osobistej ściągawki modeli.
- [[2026-07-07 Jak zrobić swojego CMO bez AI Marketing Lab]] — Mirek Burnejko: dziesięciokrokowy przepis na samodzielne zbudowanie systemu CMO z AI — projekt, opis firmy, persona, oferta, kanały, rytm, zakazy, bramka jakości, wyniki, automatyzacja na końcu.
- [[2026-07-07 Your Weekly Spark]] — CharityEngine: dane FEP 2025 (+5% darowizn, -3,6% darczyńców piąty rok z rzędu) jako punkt wyjścia do 30-minutowego audytu „pustych krzeseł" w bazie darczyńców.
- [[2026-07-07 Fresh new data on email from Bloomerang]] — Civic Shout: raport Bloomerang 2026 Giving Signals obala mit odchodzenia młodszych pokoleń od e-maila — e-mail pozostaje preferowanym kanałem próśb o wsparcie we wszystkich grupach wiekowych.
- [[2026-07-07 Your marketing plan is taking too long]] — Marketing AI Playbook: dlaczego plany marketingowe zawodzą przez długość, nie treść — trzykrokowe ćwiczenie wydobycia tożsamości marki i zasada „tożsamość przed taktyką".
- [[2026-07-07 How is your donation experience stacking up to benchmarks-]] — Caroline Griffin: benchmarki fundraisingu cyfrowego 2026 (M+R, Neon, FEP) — konwersja strony donacyjnej, luka mobilna, domyślna opcja miesięczna i stewardship pierwszej wpłaty jako cztery obszary audytu.
- [[2026-07-07 Target-beating winter fundraising campaigns lessons from Refuge]] — Jess Hodge: jak Refuge zebrało 530k GBP (127% celu) — 4 filary kampanii zimowej (tracking, jedna propozycja, konkretny ask, strona donacyjna) i pięciopunktowy plan na 2026.
- [[2026-07-07 Winter fundraising questions tracking, testing and tangible asks]] — Florence Jones: Q&A z webinaru Refuge — tracking, testowanie e-mail (próg 10k odbiorców), framing bez namacalnego produktu, tanie sposoby startu dla małych organizacji.
- [[2026-07-07 Work Better With Nonprofit Consultants]] — Allison Ehrich Bernstein: przewodnik dla organizacji społecznych i konsultantów — budżetowanie, precyzowanie zakresu, znajdowanie specjalisty i zarządzanie zaangażowaniem.
- [[2026-07-08 Z LinkedIna do AI.]] — ProLetter: oficjalne wytyczne LinkedIn dot. cytowania treści przez AI (GEO) — pierwsze zdanie jako URL, artykuły 800-1200 słów częściej cytowane, rytm jeden artykuł + kilka postów tygodniowo.
- [[2026-07-08 Your People, Not Your Prompts, Are Still the Strategy]] — Bryan Neider: model „centaur teams" i pięć lekcji z raportów Stanford/Meskó o wdrażaniu AI w organizacjach społecznych bez utraty zaufania.
- [[2026-07-08 The Permission Problem your AI agents' biggest risk is authorization]] — Jakub Skałbania o przejęciu 20 225 kont Instagrama przez agenta AI: nadmierna autoryzacja jako główny, niewidoczny tryb awarii agentów, „delegation gap" i pięć kontroli bezpieczeństwa przed audytem.
- [[2026-07-08 Can AI equalize political campaign ads – or will it remain a tool for spreading lies?]] — Sanya Mansoor (Guardian): deepfake'i i AI w amerykańskich kampaniach politycznych — ramowy dokument AAPC o ujawnianiu treści syntetycznych, spory o regulacje stanowe.
- [[2026-07-08 Z LinkedIna do AI]] — ProLetter: oficjalne wytyczne LinkedIn dot. cytowania treści przez AI (GEO) — pierwsze zdanie jako URL, artykuły 800-1200 słów częściej cytowane, rytm jeden artykuł + kilka postów tygodniowo.
- [[2026-07-08 AI jako dobro wspólne w stronę technologicznej suwerenności organizacji]] — Filip Jędruch/dr Jan Oleszczuk-Zygmuntowski (PLZ Spółdzielnia): koncept "retro innowacji" i spółdzielczej alternatywy dla big techów — mapa cyfrowych zależności i hybrydowy narzędziownik jako droga do suwerenności technologicznej NGO.
- [[2026-07-08 11 Ways Donor Segmentation Can Skyrocket your Fundraising Efforts]] — Candace Cody (CauseVox): 11 sposobów segmentacji darczyńców (źródło pozyskania, wysokość daru, cykl życia, kohorta pokoleniowa) plus segmenty kreatywne — najsłabsze ogniwo lejka to przejście z pierwszej do drugiej darowizny.
- [[2026-07-08 Opportunity knocks]] — Forster Communications: newsletter o tematach wychodzących z bańki (klimat, impact investing, bezpieczeństwo dzieci) i o zamianie momentu uwagi w trwałą zmianę advocacy.
- [[2026-07-08 Why Fundraisers Burn Out, and What Structure Has to Do With It]] — Rob Burke (DonorDock): wypalenie fundraiserów jako problem strukturalny, nie kwestia godzin pracy — cztery elementy "mission-driven architecture" i rotacja dyrektorów fundraisingu 16-18 miesięcy.
- [[2026-07-09 treści, które prowadzą do wpłaty]] — Social Movers Hub: struktura skutecznej treści fundraisingowej konkret → zmiana → sens oraz zasada „jedna komunikacja = jeden sens".
- [[2026-07-09 Six Campaign Lessons from My Voice, My Choice Campaign for NGOs and Parties to Learn]] — Partisan: sześć lekcji z europejskiej inicjatywy obywatelskiej ws. aborcji (1,12 mln podpisów, 300+ organizacji) — trzy dla kampanierów politycznych, trzy dla oficerów PR NGO.
- [[2026-07-09 AI Act na raty. Terminy przesunięte, ale regulacje pozostają]] — Krzysztof Mirończuk: harmonogram AI Act po pakiecie Omnibus VII — przesunięcie obowiązków dla systemów wysokiego ryzyka na 2027/2028, spór biznesu i organizacji praw cyfrowych o skutki opóźnienia.
- [[2026-07-09 LinkediNGO 5 powodów, dla których Twoja organizacja powinna aktywnie istnieć na LinkedInie]] — Aleksandra Marciniak (Fundacja Gajusz): pięć zastosowań LinkedIn dla NGO — fundraising, marka, sojusznicy, nagłaśnianie tematów, wiedza; case study programu ambasadorskiego #EmployeeAdvocacy.
- [[2026-07-09 Your Mission Is Your Sharpest Strategic Weapon]] — Bryan Neider: misja jako narzędzie decyzyjne przyspieszające decyzje w chaosie, kultura jako misja operacyjna, funkcje operacyjne jako infrastruktura chroniąca misję, koszt zwłoki w decyzjach.
...
- [[2026-07-09 Your positioning is hiding in plain sight]] — Marketing AI Playbook: pięć sekwencyjnych promptów do Claude prowadzących od chaotycznego opisu działalności do jednej linii pozycjonującej metodą odejmowania.
- [[2026-07-09 Q&A with my favorite content strategist]] — Caroline Griffin: wywiad z Joshem Spectorem o treści fundraisingowej organizacji społecznych — zasada „100% wartości" zamiast podziału 80/20, prostota stron donacyjnych, pomysły na newslettery tematyczne i „popup newsletter".
- [[2026-07-09 Luka governance w AI dlaczego 92% organizacji korzysta z AI, a tylko 7% coś dzięki temu zyskuje]] — Piotr Antoniewicz (dobryai.pl): plateau efektywności AI w organizacjach społecznych — minimalne governance AI dla zespołu 3-10 osób (zasada, repozytorium promptów, osoba odpowiedzialna) i gotowy szablon jednostronicowej polityki.
- [[2026-07-09 My Exact AI Stack Which Model I Use for What]] — Allie K. Miller: praktyczny stack modeli AI po premierze Fable 5 i GPT-5.6 — wzorzec doradca-wykonawca, routing modeli wg zadania i dane benchmarkowe kosztowo-wydajnościowe.
- [[2026-07-09 Skoro jesteś taki mądry, to czemu ci nie idzie?]] — Mateusz Ufel: kursy i AI jako alibi odsuwające pokazanie pracy światu — model „Umowa z Innymi" (wyzwanie/strategia, relacjonowanie/komunikacja, produkt) i test „robię to z ja, czy z chu-ja" przy wyborze tematu.
- [[2026-07-09 I Spent 20 Minutes Teaching Claude Who I Am. Then It Started Doing My Actual Work.]] — Wendy Clow: pięć kroków wdrożenia Claude Cowork w organizacji — folder jako granica bezpieczeństwa i 20-minutowy „wywiad" jako fundament kontekstu.
...
- [[2026-07-10 Ep. 25 Add $100K in Freelance Profit Through Podcast Guesting with Dustin Riechman]] — Freelance Cake (Dustin Riechmann): model 5P (Purpose, Plan, Pitch, Perform, Profit) budowania podcast guestingu jako powtarzalnego kanału biznesowego dla freelancerów.
- [[2026-07-11 Copilot w Firmie- Sprawdzony Plan, Jak w 90 Dni Odzyskać 20h Miesięcznie na Innowacje]] — AI Hero (Mateusz Cisowski, Bartek Szczepaniak): 90-dniowy plan wdrożenia Microsoft Copilota w firmie — pięć pytań diagnostycznych, siedem kroków wdrożenia i rola „ambasadorów AI" w skalowaniu adopcji.
- [[2026-07-11 Breakdown of Sam Parr's 87k LinkedIn account]] — Tribe Digital: case study strategii treściowej founder-influencera na LinkedIn — dopasowanie tonu do modelu biznesowego, cross-posting i przewaga treści osobistych nad sprzedażowymi.
- [[2026-07-11 Lekcja 3 - Creating Your Sign Up Form And Confirmation Email]] — Jenna Kutcher: trzecia lekcja kursu budowy listy mailingowej — trzy sposoby zbierania adresów (landing page, pop-up, formularz osadzony) i automatyzacja maila potwierdzającego.
- [[2026-07-11 Lekcja 2 - Determining The Perfect Offer For Your Audience]] — Jenna Kutcher: druga lekcja kursu budowy listy mailingowej — sześć powodów, dla których e-mail marketing jest niezastąpiony, i sekwencja „służ, zanim sprzedasz".
- [[2026-07-11 Lekcja 4 - Getting Your Offer Out Into The World]] — Jenna Kutcher: czwarta lekcja kursu budowy listy mailingowej — pięć zasad niespamerskiej promocji oferty, anatomia dobrego posta i zasada wielokrotnego powtarzania komunikatu.
- [[2026-07-11 Running on people power]] — Viktor Mák (ECDA): zwycięstwo Pétera Magyara nad Orbánem jako dowód siły people-powered campaign — trzy filary: ludzie, pieniądze, wspólnota ("Tisza Islands").
- [[2026-07-11 Monthly Donor Acquisition Community Mindfulness Project]] — Caroline Griffin: case study kampanii pozyskiwania darczyńców miesięcznych małym zespołem — donor-centric messaging, mix kanałów i efekt mnożnikowy na duże darowizny.
- [[2026-07-11 How crowdfunding solidarity saved Budapest Pride]] — Barbara Horváth, Holly Dawson (ECDA): jak Budapest Pride odzyskało 100% utraconego finansowania dzięki solidarnościowemu crowdfundingowi w reakcji na represyjną ustawę na Węgrzech.
- [[2026-07-11 Lekcja 1 - How an Email List Will Support Your Business]] — Jenna Kutcher: druga lekcja kursu budowy listy mailingowej — sześć typów lead magnetów, test czterech pytań i zasada "done is better than perfect".
...
- [[2026-07-22 What is BIMI, How to Get It, What It Costs, and Does it Help Email Deliverability-]] — czym jest BIMI, różnica VMC/CMC, koszty i kroki wdrożenia, oraz dlaczego nie poprawia deliverability wprost — najsilniejszy argument to ochrona przed phishingiem.
- [[2026-07-22 Not Sending Enough Email Is a Deliverability Problem Too]] — zbyt rzadkie wysyłanie i restarty po przerwie szkodzą deliverability tak samo jak nadmierna wysyłka; rozwiązaniem są flows oparte na intencji zamiast agresywnego czyszczenia list na bazie otwarć.
- [[2026-07-23 AI Act przesunięty- Nie tam, gdzie myślisz]] — Piotr wyjaśnia, że przesunięcie AI Act dotyczy systemów wysokiego ryzyka, a nie obowiązków transparentności (oznaczanie treści AI, informowanie o rozmowie z botem), które wchodzą w życie 2 sierpnia 2026 bez zmian.
- [[2026-07-23 The data center fight is going global]] — Waging Nonviolence: globalny wzrost lokalnego oporu wobec centrów danych AI — badanie RCT pokazujące siłę argumentów środowiskowych i gniewu, trzykrokowy framework organizowania (research, koalicja, definicja wygranej).
- [[2026-07-24 From Sympathy to Salience Owning the Economic Agenda]] — Abigail Stahl: dlaczego progresywni rzecznicy przegrywają mimo poparcia — rozróżnienie sympatii od salience i trzy strategie odzyskania agendy ekonomicznej.
...
- [[2026-07-23 Steal Our 3-Tool Design Stack]] — Ryan Carr (Moodboard) o stosie 3 narzędzi ([[Midjourney]], [[Flora]], [[Canva]]) do spójnej warstwy wizualnej lejka mailowego.
- [[2026-07-23 How I figure out what my clients need to do]] — Josh Spector: osiem pytań diagnostycznych konsultanta do szybkiego wykrywania fałszywych założeń, fałszywych dychotomii i przeciążenia działaniami u klientów.
- [[2026-07-23 How Nonprofits Can Use AI Without Losing the Human Touch]] — Rob Burke (DonorDock): zasada „automatyzuj powtarzalne, chroń znaczące" dla wdrażania AI w organizacjach społecznych — lista zadań do oddania AI vs. zadań chronionych i szkielet jednostronicowej polityki AI.
...
- [[2026-07-22 Should you have multiple social media accounts]] — Josh Spector o sugestii Gary'ego Vaynerchuka, by prowadzić kilka kont tematycznych zamiast jednego uniwersalnego, bo algorytmy dystrybuują treść po temacie, nie po liczbie followersów.
- [[2026-07-22 Donor Retention Strategies That Stop the Erosion]] — Rob Burke: retencja darczyńców jako główny silnik wzrostu — trzy dźwignie (regularne dary, systematyczny kontakt, pokazywanie wpływu) i konkretny plan pierwszego miesiąca.
- [[2026-07-22 How to Promote a Fundraising Event on Social Media]] — Peter Hair (GalaBid): gotowy kalendarz promocji wydarzenia fundraisingowego w social media od 6 tygodni przed do podsumowania po evencie, z wskazówkami platformowymi.
- [[2026-07-24 Kimi K3 Redraws the Open Frontier, Muse Spark 1.1 Undercuts Competitors, Cloudflare Moves to Cut Off Crawlers]] — Andrew Ng o incydencie, w którym zamknięty model wywołał cyberatak na Hugging Face, a otwarty GLM 5.2 pomógł go odeprzeć — argument za odpowiedzialnym użyciem AI zamiast pogoni za „bezpiecznymi" modelami.
- [[2026-07-24 A quick exercise to help you do more of what you want]] — Josh Spector: ćwiczenie podziału zadań tygodnia na trzy kategorie entuzjazmu jako sposób na redukcję zadań wykonywanych z obowiązku, plus statystyka o spadku aktywności w social media.
...
- [[2026-07-13 How to Reach Next-Generation Donors]] — Dennis Fois (Bloomerang): pokoleniowa zmiana w fundraisingu — Millenialsi i Gen Z dają jako uczestnictwo, nie transakcja, a sektor potrzebuje aktywnego pozyskiwania darczyńców zamiast czekania, aż ci sami się zgłoszą.
...
- [[2026-07-14 Your Weekly Spark]] — CharityEngine (Julie Kennon): pięć kroków przygotowania danych donorskich pod AI — czyszczenie, likwidacja silosów, kontekst zamiast transakcji, myślenie pytaniami, dokumentowanie procesów.
- [[2026-07-14 Are you fundraising alone]] — DonorDock (Leah Wiley): wypalenie liderów jako problem struktury, nie obciążenia — pytanie "czy robię to sam" i ćwiczenie mapowania ról fundraisingowych na każdym szczeblu organizacji.
- [[2026-07-12 FULL GUIDE Optimize Your Content Cadence Across All Social Platforms In Under 30 Minutes]] — Dickie Bush: system produkcji ~160 treści/tydzień na 6 platformach z ~20 treści netto-nowych — reguły "jedna platforma, jedno CTA" i podział Created/Produced/Reposted.
- [[2026-07-12 10 common social mistakes, 10 quick wins]] — Tribe Digital (Matthew Brown): 10 błędów i 10 szybkich usprawnień na X/LinkedIn — dane o wpływie weryfikacji konta, grafik i CTA na zasięg.
- [[2026-07-12 Political text messages could get more effective and annoying. Blame AI]] — Maham Javaid (NPR): boty AI trenowane do prowadzenia spersonalizowanych rozmów tekstowych z wyborcami w kampaniach politycznych; ryzyka transparentności i tempo adopcji Republikanie vs. Demokraci.
- [[2026-07-10 10 Common Annual Report Mistakes for Nonprofits and How to Avoid Them]] — Heather Mansfield (Acton Circle): dziesięć najczęstszych błędów raportów rocznych organizacji społecznych — jasny przekaz, storytelling zamiast samych danych, perspektywa darczyńcy i planowanie ponownego wykorzystania treści.
- [[2026-07-10 Predictive Intelligence for Fundraisers A Complete Guide (2026)]] — Bloomerang/Dataro: predykcyjny scoring donorów (prawdopodobieństwo daru, ryzyko lapsu, gotowość do podniesienia) i asystentka AI Penny — sześciokrokowa rutyna tygodniowej priorytetyzacji dla samodzielnych fundraiserów.
- [[2026-07-15 Your product pages are losing to AI summaries]] — Matt Diggity: cztery kroki przebudowy stron produktowych pod cytowanie przez AI Overviews i chatboty — odpowiedź przed specyfikacją, treść porównawcza, dowód użycia i FAQ oparte na realnych obiekcjach.
- [[2026-07-15 Zła i dobra Meta.]] — ProLetter: przegląd starcia platform z AI — Meta wycofuje Muse Image po krytyce, TikTok stawia na edukację, UE zaostrza nadzór nad Meta i dostępem nastolatków.
- [[2026-07-15 Choosing and Migrating an ESP What You Need to Know Before You Switch]] — Beth O'Malley: sześć faz migracji ESP i dziesięć najczęstszych błędów — kolejność importu suppresji, real-time vs. sync integracji, warm-up IP.
- [[2026-07-15 Agentic AI in Email Marketing and CRM]] — Beth O'Malley: różnica między generative a agentic AI w email marketingu i CRM, wymogi infrastrukturalne agentic AI oraz co realnie mogą robić mali marketerzy bez zespołu danych.
- [[2026-07-15 Jak z posta zrobić ofertę, czyli weź sobie cały mój system tworzenia, od pomysłu do zakupu]] — Mateusz Ufel: autorski 7-krokowy system tworzenia treści (od "złapania sceny" po "ofertę v0" testowaną przedsprzedażą) zamieniający posty w regularne treści i sprawdzone tematy w produkt.
- [[2026-07-15 Email Tracking Pixels Now Require Consent in France and Italy — Your Action Plan]] — Beth O'Malley: CNIL i Garante uznały piksel śledzący w mailach za wymagający zgody jak cookie — sześciokrokowy plan zgodności i status wsparcia platform ESP (HubSpot, Klaviyo, Mailchimp, Braze).
- [[2026-07-15 I’m Not Racing to Adopt AI. I’m Racing to Earn the Right To.]] — Bryan Neider (AbilityPath): governance-first framework wdrażania AI w organizacji społecznej — pięć zasad, evidence file i praktyczne kroki dla sektora danych wrażliwych.
- [[2026-07-15 The Five Email Flows Every Business Should Have and What Should Be in Each One]] — Beth O'Malley: pięć podstawowych flow'ów mailowych opartych na sygnałach zachowania (orientacyjny, nurture, konwersyjny, onboardingowy, re-engagement) z triggerami i strukturą wiadomości dla każdego.
- [[2026-07-15 Operations Are Not a Luxury The System Behind Sustainable Fundraising]] — Rob Burke (DonorDock): operacje fundraisingowe jako infrastruktura przetrwania dla szczupłych zespołów — wspólny system rekordu, ramowanie inwestycji dla zarządu i start od wiarygodnego raportowania.
- [[2026-07-15 Dlaczego ruch otwartej wiedzy ma dziś coś ważnego do powiedzenia o AI-|Dlaczego ruch otwartej wiedzy ma dziś coś ważnego do powiedzenia o AI?]] — Kamila Neuman (Wikimedia Polska): doświadczenia ruchu otwartej wiedzy jako lekcja dla human-centered AI — dobrostan i budowanie zaufania jako warunek udanej transformacji AI w organizacji.
- [[2026-07-15 The 3 Massive Org Chart Changes AI Is Causing]] — Allie K. Miller: trzy przesunięcia w strukturze organizacji pod wpływem agentów AI — kurczenie się zespołów, poszerzanie ról, spłaszczanie hierarchii, z case study Uber (agentic pods).
- [[2026-07-15 No more Bees]] — Josh Spector: anegdota o Lorne Michaelsie i SNL — opinie ekspertów o tym, co "nie zadziała" bywają niespójne i niepewne.
- [[2026-07-16 The case for smart risk in modern campaigns]]
- [[2026-07-17 AI Overviews Land Google In Hot Water, GPT-Live Puts Reasoning in the Background, How to Tell If Your Model is Manipulative]] — list Andrew Ng o tym, jak AI przekształca specjalistów w role „full-stack" (marketing, rekrutacja, inżynieria) — Ari Rabin-Havt (WPC): rozróżnienie smart risk vs. lekkomyślność w kampaniach politycznych — analogia z pokerem i nurkowaniem z rekinami; ostrożność organizacyjna jako strategia przegrana.
- [[2026-07-17 Stop Selling Your Nonprofit. Start a Cult.]] — Rhea Wong: fundraising jako budowanie wspólnoty zamiast sprzedaży — anatomia „dobrotliwego kultu" (mit założycielski, wspólna tożsamość, wróg, drabina zaangażowania) i matematyka 25 „prawdziwych fanów" zamiast tysięcy nazwisk na liście.
- [[2026-07-16 "AI should support people at work, not replace them." Nobody is saying how to design that.]] — Kasia Szczesna: framework FASCAI (replace/support/provoke) do świadomego projektowania poziomu automatyzacji AI w produktach, zamiast domyślnej maksymalizacji automatyzacji.
...
- [[2026-07-16 Social monitoring - scoop up the warmest leads]] — Matthew Brown (TRIBE): monitoring wzmianek w social media jako źródło gorących leadów, gwarancje jako dźwignia konwersji i 12 sposobów łączenia treści e-mailowych z social media.
...
- [[2026-07-18 Breaking down Alex Kerr's 4x-day posting strategy]] — Matthew Brown (TRIBE): case study konta LinkedIn łamiącego popularne zasady postowania (4x dziennie, minimalne CTA) przy wysokim zaangażowaniu.
- [[2026-07-19 Give it a shot]] — Josh Spector: kuracja pięciu linków o pisaniu i marce osobistej — formaty postów LinkedIn, metoda notatek George'a Carlina, start na Substacku.
- [[2026-07-19 Send It Right - Why Good Emails Get Ignored]] — Lauren Meyer: subskrybenci rzadko odrzucają maile świadomie, częściej odkładają decyzję na później — jak redukować tarcie decyzyjne i budować momentum otwarć.
- [[2026-07-19 LinkediNGO Profil osobisty, czyli jak Cię widzą]] — Aleksandra Marciniak: kompletna checklista optymalizacji profilu osobistego LinkedIn dla organizacji społecznych — od zdjęć po rekomendacje, z danymi o wpływie na widoczność i cytowania w LLM.
- [[2026-07-19 'My heart is empty' Millions of Chinese forced to end AI relationships]] — Allyson Horn (ABC News): chińskie regulacje zakazują AI-partnerów nieletnim i zmuszają ByteDance, Alibaba i Tencent do wyłączenia AI-companion — case study granic emocjonalnego zaangażowania w projektowaniu chatbotów.
- [[2026-07-20 Hire the Heart. Train the Hands.]] — Bryan Neider: rekrutacja oparta na wartościach dla NGO — Core Four pytań odpornych na wyuczone odpowiedzi i sześciokrokowy playbook budowania baseline'u kandydatów.
- [[2026-07-20 Newsletter a pozycjonowanie strony – jak e-mail wspiera SEO?]] — Ecomail.pl: newsletter nie jest czynnikiem rankingowym Google, ale pośrednio wspiera SEO przez ruch, zaangażowanie i rozpoznawalność marki; checklista błędów łączenia e-mail marketingu z SEO.
...
- [[2026-07-21 How I publish 74 pieces of content every week]] — Matthew Brown (TRIBE): krótki digest linkujący do systemu publikacji 74 treści tygodniowo na 7 platformach i kalkulacji opłacalności zatrudnienia agencji contentowej.
- [[2026-07-21 4 Fill-In-The-Blank Formulas To Explain The Value Of Your Offer]] — Josh Spector: cztery gotowe formuły językowe pokazujące transformację (problem→rozwiązanie, emocja negatywna→pozytywna, "wyobraź sobie", różnicowanie) do opisywania wartości oferty.
- [[2026-07-23 Massive increase in applications with one change]] — Matthew Brown (TRIBE): pięć taktyk contentowych — przebudowa kolejności pytań w formularzu aplikacyjnym (98%→40% ukończenia), pożyczony autorytet i szansa newsletterów LinkedIn.

- [[2026-07-24 Still In Control]] — Framework Etyka/Koszt/Nadzór i obowiązkowy Human-in-the-Loop dla zarządzania AI w organizacjach non-profit.
- [[2026-07-24 The new civic media marketplace – and what it means for progressive messaging]] — Analiza Laury Quinn, jak zmieniła się struktura rynku mediów obywatelskich i dlaczego faworyzuje prawicowy przekaz.
- [[2026-07-24 The new normal The rising power of influencers]] — Wywiad z Júlią Salander o tym, dlaczego prawica dominuje wśród influencerów w social media i jak progresywni mogą to zmienić.
- [[2026-07-22 Email Accessibility and the European Accessibility Act What It Is, Who It Affects, and What to Do About It]] — Praktyczny przewodnik po wymogach Europejskiego Aktu o Dostępności dla e-mail marketingu.
- [[2026-07-22 Nowe zasady transparentności AI zgodne nie znaczy zauważone]] — Kasia Szczesna: Artykuł 50 AI Act wymaga oznaczania treści AI, ale znacznik zgodny z prawem nie gwarantuje, że dotrze do świadomości użytkownika — efekt niewidzialności AI i różnica między zgodnością prawną a projektowaniem behawioralnym.
- [[2026-07-25 Mission, Not Race]] — Audrey Tang (Wikimania 2026): framing "misja, nie wyścig" dla ruchu wiedzy i AI, koncepcja lokalnego agenta Kami i zasada "najpierw daj zaufanie" jako fundament etyki AI.
- [[2026-07-25 How Chris Donnelly's 1.25m account grows]] — Matthew Brown (Tribe Digital): case study konta LinkedIn Chrisa Donnelly'ego — codzienna publikacja, infografiki i twarde "credibility statements" w hookach jako wzorzec wzrostu marki osobistej.
- [[2026-07-26 I don't know how to say this, so I'm just going to say it]] — Josh Spector: cotygodniowy digest "The Starting Five" z linkami o wyjaśnianiu wartości oferty, budowaniu case study i różnicowaniu oferty przez sprzedawanie tego, czego nie da się skopiować.
- [[2026-07-26 The Context Box Do It, But Right]] — Al Iverson: pięć warunków dobrego "context boxa" w mailu (specyficzny, zgodny z prawdą, oparty na zgodzie, zweryfikowany, użyteczny) i zasada, że lepiej pominąć go niż zrobić zbiorczo i ogólnikowo.
- [[2026-07-29 Zaufanie jest walutą. I to dosłownie.]] — ProLetter/Moonwise: przegląd social media 2026 pod kątem zaufania — X Money mimo chaotycznej historii X, inwazyjne AI w Threads, kampania wizerunkowa Mety i dane o rozjeździe między reklamą a cytowaniem w Google AI Mode.
- [[2026-07-29 The hidden benefit I haven't mentioned yet]] — Josh Spector o tym, dlaczego przejście z darmowego newslettera na płatny membership poprawia jego jakość, czystość danych o zaangażowaniu i dostępny czas na tworzenie treści.
- [[2026-07-29 The end of the influencer era (and what comes after)]] — Natalie MacNeil o detektorach AI wchodzących do platform, końcu ery influencerów i prompt do zmapowania trzech modeli społeczności odbiorców poza algorytmem.
- [[2026-07-27 open tabs - 3 tabs point to December]] — Rachel Bearbower: przegląd newsów dla fundraiserów — raport Virtuous + Fundraising.AI o luce między adopcją a realnym wpływem AI w organizacjach społecznych, zawieszenie CFC na jesień 2026, podwyżka stawek USPS i apel o czyszczenie list mailingowych przed Q4.
- [[2026-07-27 Greatest Hits Week - The most useful tips I've shared]] — Josh Spector: digest linków o pisaniu (mocne pierwsze zdanie, wariacje na jeden temat, masterclass wideo) i anegdota o nietypowym outreachu, który przekonał Toma Hanksa do podcastu.
- [[2026-07-27 Piotr Twoje NGO ma -5 lat- Przeczytaj to -)]] — Instytut Fundraisingu (Martyna Mazela): grudzień jako najtańszy moment na pozyskanie darczyńców, konkretne koszty pozyskania darowizny (20-50 zł) i przewaga kosztowa organizacji z już zbudowaną społecznością.
- [[2026-07-28 Send It Right - Ways to Reduce the Impact of Deliverability Issues]] — Lauren Meyer: sześć praktyk proaktywnego zabezpieczania deliverability (reputacja nadawcy, monitoring, konserwacja listy, ekspertyza, wewnętrzny marketing, uczenie się od innych) i przestroga przed bezkrytycznym AI w tym temacie.
- [[2026-07-28 4 lessons I'm learning from moving my newsletter into my membership]] — Josh Spector: obserwacje z tygodnia przenoszenia newslettera do płatnego membershipu — nieuniknione zamieszanie mimo jasnej komunikacji, sprzedaż skoncentrowana w weekend i akceptacja, że część subskrybentów nigdy nie będzie kupującymi.
- [[2026-07-28 Why your best email needs SMS]] — Civic Shout: dlaczego SMS i e-mail trzeba planować na jednym kalendarzu — dane o wzroście przychodu mobilnego, case Defenders of Wildlife i wpływ timingu follow-upu na konwersję darowizn.
- [[2026-07-29 The AI Mentorship Dilemma Rebuilding Human Judgment in the Age of Automation]] — Bryan Neider: AI automatyzuje zadania, które trenowały osąd młodszych pracowników NGO — 5-elementowy framework przeprojektowania mentoringu (narracja decyzji, dobór po luce kompetencyjnej, stay interviews).
- [[2026-07-29 Meet the Campaign AI Engineer]] — Partisan: LLM-y jako nowy pośrednik między kampaniami a wyborcami — przesunięcie z SEO (widoczność) na architekturę informacji (koherencja dla AI) i nowa rola „Campaign AI Engineer" monitorującego reprezentację kandydata w modelach językowych.
- [[2026-07-29 Memes, Myths, and the Ballot Box Lessons from the Gen Z Movement Against Authoritarian Populism]] — Partisan: jak zdecentralizowany, memowy ruch Gen Z w Indiach osłabił mit „niezniszczalnego silnika" Modiego — 4 lekcje digital campaigningu dla opozycji i społeczeństwa obywatelskiego.
- [[2026-07-29 How I Use AI to Research Funders Before I Write the Grant]] — Wendy Clow: pięcioetapowy workflow researchu funderów z AI przed pisaniem wniosku — wymuszanie „nieprzychylnej" analizy, żeby uniknąć tygodni pracy nad grantem bez szans.
- [[2026-07-29 Preserving Humanity in AI-Powered Fundraising Key Insights from Nonprofit Tech Leaders » Avid]] — relacja z webinaru Avid/Virtuous: AI w fundraisingu ma odzyskiwać czas na relacje, nie zastępować zespół — dane o tym, że donorzy cenią zaufanie bardziej niż personalizację, i zasady bezpieczeństwa danych donorów.
- [[2026-07-28 They're not buying a statistic]] — DonorDock: dlaczego statystyki w raportach usypiają darczyńców i jak zamienić ich z „sponsora" w „uczestnika" pięciominutowym ćwiczeniem stewardship.
- [[2026-07-28 The gap between investment and use where we’re getting AI adoption wrong]] — Kasia Szczesna: dlaczego 95% firm nie widzi zwrotu z inwestycji w AI mimo masowej adopcji — trzy bariery behawioralne (bodźce, normy, zaufanie) i BehaviorAI Design Framework do projektowania roli człowieka przed wdrożeniem.
...
- [[2026-07-28 How to rewire an LLM and other SEO goodies]] — Matt Diggity: zapowiedź przeglądu SEO/GEO o wzmiankach marki zakorzeniających się w danych treningowych LLM, Google June Spam Update przeciw treściom AI oraz rozjeździe cytowań między trybami ChatGPT.
...
- [[2026-07-30 The monthly giving launch that started with a miss]] — Civic Shout: case World Central Kitchen — jak brandowany program monthly giving „Kitchen Corps" i przeliczenie wyniku na lifetime value zmieniły ocenę kampanii, która osiągnęła 14% celu.
- [[2026-07-30 Transformation Asks You to Be a Dragon]] — Meenakshi Das: metafora smoka dla transformacji AI w organizacjach społecznych — lista nawyków do „złamania" i cztery zagrożenia dla zdolności mówienia „nie".
- [[2026-07-30 Hot take - you don't need a newsletter]] — Matthew Brown (Tribe Digital): pięć wskazówek do personal brandingu na LinkedIn — historie osobiste powiązane z problemem biznesowym, testowanie cen skokowo i rola e-maila jako "łatania dziurawego lejka" mimo dominacji social media.
- [[2026-07-31 Are you leaving out the most interesting part of your content]] — Josh Spector: dlaczego konkretna anegdota, a nie ogólnikowy "thought leadership", powinna być treścią posta — pytanie o "origin story" jako filtr jakości przy ghostwritingu.
