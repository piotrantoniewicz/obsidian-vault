...
**Stan (2026-07-11):** workflow zrealizowany jako plugin Cowork `artykuly-ngo` (5 komend: `/radar` → `/brief` → `/pisz` → `/redakcja` → `/dystrybucja`); artykuł nr 1 opublikowany 2026-06-23, post LinkedIn 2026-06-26; artykuł nr 2 („luka governance AI") opublikowany 2026-07-09. Oba czekają na ingest do vaultu (`Resources/` + `Galaxy/`) — Web Clipper przestał działać, więc treść wstawiona ręcznie do `Inbox/`, czeka na `/clippings-to-notes:clip`.
...
## Kolejne kroki
- [x] Cykl nr 1 — post LinkedIn opublikowany 2026-06-26 13:20 ([Notion](https://app.notion.com/p/347e4dd29ba88053a29bc6c8c0e11439?v=347e4dd29ba880e29c00000ce4c9f096))
- [ ] Domknąć cykl nr 1: ingest artykułu do vaultu (`Resources/` + aktualizacja `Galaxy/`) — surowy clip w `Inbox/`, czeka na `/clippings-to-notes:clip`
- [x] Cykl nr 2 — artykuł opublikowany 2026-07-09: [Luka governance w AI: dlaczego 92% organizacji korzysta z AI, a tylko 7% coś dzięki temu zyskuje](https://publicystyka.ngo.pl/luka-governance-w-ai-dlaczego-92-organizacji-korzysta-z-ai-a-tylko-7-cos-dzieki-temu-zyskuje); ingest do vaultu — surowy clip w `Inbox/`, czeka na `/clippings-to-notes:clip`
- [ ] Cykl nr 2 — post LinkedIn + ingest do vaultu (dystrybucja)
