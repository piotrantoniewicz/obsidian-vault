# Strategia rozbudowy Galaxy/ — 2026-07-20 (nowa strona: AI Act)
...
**Ostatnia operacja — nowa strona (2026-07-20):**
**AI Act** — czerwony link zrealizowany (2 incoming: RODO i dane wrażliwe + Suwerenność technologiczna, próg ≥2 osiągnięty 2026-07-07). 8 źródeł: przewodnik Krzywickiej (4 pytania klasyfikacji z art. 3, mapa 8 kroków compliance, role dostawca/dystrybutor/podmiot stosujący); n3xtcoder (4 poziomy ryzyka, rejestr ryzyka, lista kontrolna); Siciak (Digital Omnibus, kategoria SMC, shift z formalizmu na rozumienie procesów); Mirończuk ×2 (harmonogram „na raty" — Annex III na XII 2027, produkty sektorowe na VIII 2028, spór biznes/EDRi-Access Now; rola AI Compliance Officera, kary do 7%); Sen (instytucje publiczne bez zwolnienia, precedens SyRI, zamówienia AI); Maciejewicz (6 pytań przed wdrożeniem w NGO, kodeks AI). Linki przychodzące zaktualizowane w 2 stronach (RODO i dane wrażliwe, Suwerenność technologiczna — oba czerwone linki zrealizowane, wskazują teraz na `2026-07-20 AI Act`). Nowe świadome czerwone linki: **[[AI Office]]** (1, nadzór nad GPAI), **[[Digital Omnibus]]** (1, pakiet nowelizacyjny AI Act+RODO).

**Następny krok:** backlog ≥2 ma teraz jednego kandydata: **Sprawczość organizacyjna** (2 incoming — Agentic AI + Suwerenność technologiczna; Ganz/agency, „AI odbiera sprawczość?", agency > agents) — do napisania w pierwszej kolejności. Dalej: (a) klaster **AI jako współpracownik/digital workforce** (≥4 źródła o *organizacji* agentów — pula rośnie: Allie Miller 34 agenty, Claude Code Swarms, Agent Teams, chief of staff Webflow/Prossera); (b) **Marka osobista** (1 incoming, drugi naturalnie z Widoczności w AI search — E-E-A-T); (c) nowe czerwone linki z tej fali (AI Office, Digital Omnibus) — obserwować, czy zbiorą drugi incoming; (d) operacyjnie: **contradiction detection przy ingest** (wniosek z LLM Wiki) do pluginów `*-to-notes`.

**Klastry-kandydaci na nowe strony (z przeglądu 2026-06-22, akt. 2026-07-20):**
