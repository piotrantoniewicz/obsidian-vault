---
type: "Web"
authors: "[[Jaime-Alexis Fowler & Taymar Quezada]]"
url: "https://ssir.org/articles/entry/nonprofits-AI-integration-behind-the-scenes?utm_medium=email&_hsenc=p2ANqtz-_b8uSWhv2gKqxq9sPKEoSG1wfOnDHVW0QqJrrlgIhCBrxKRtqOyMrRRsSHRKWHeHDH5dRm7cI4E9DTn_JvIwy3rPEn_crcoUc0R0d9sg2smw5R-Ek&_hsmi=144592174&utm_content=144592174&utm_source=hs_email"
...
- [order reprints](https://ssir.org/reprint_permissions "Contact us to order reprints")
 ...
 [![Two women sit at a table looking at a laptop together](https://ssir.org/images/jcogs_img/cache/nonprofits-ai-human-connection-592x333_-_abcdef_-_ec76adfb59d23efa05b4d7ecdd5601e6950c9f26.jpg) Empower Work UX Lead Jessy Baer (left) and a peer counselor trainer collaborate on the design of its AI assistant.(Courtesy of Empower Work)](https://ssir.org/images/blog/nonprofits-ai-human-connection-592x333.jpg)

Nonprofits are racing to adopt AI, with a recent report showing [92 percent already using the technology to support their work](https://virtuous.org/resource/the-2026-nonprofit-ai-adoption-report-download/). Many early adopters have focused on direct-to-user applications like AI tutors that help students learn, AI coaches that offer guidance at scale, and AI navigators that help people find benefits or services. These tools hold real promise, especially in a sector where demand often exceeds capacity. But for organizations whose work depends on empathy and human connection, automation can also feel at odds with care. The [Center for Effective Philanthropy](https://cep.org/report-backpacks/ai-with-purpose-how-foundations-and-nonprofits-are-thinking-about-and-using-artificial-intelligence/?finding=1#finding1) has noted that social change leaders are increasingly concerned about AI’s risks, including the loss of human connection when it matters most.

[Empower Work](https://www.empowerwork.org/) feels that tension directly. While we use technology to scale, our core service, which offers free, confidential, text-based coaching for people navigating tough work challenges, relies on deep human connectivity. When someone texts into the line, they connect with a trained peer counselor ready to provide personalized support for difficult situations such as underemployment, poor management, and job loss.
...
The North Star became clear: preserve human empathy and judgment in interactions with help seekers and use AI to support our counselors behind the scenes so they can spend even more time deepening the connection that is at the heart of their job and our service. The choice reflected both what our help seekers directly told us they wanted and growing [research on AI’s empathy gap showing](https://www.nature.com/articles/s41562-025-02247-w) AI can only perform one of the three components of empathy—it can understand another’s state, but it can’t actively feel what another is feeling or invest in them. Because of that, human responses in emotional contexts are often more likely to build trust, create positive immediate emotional impact, and provide the [motivation to help people take action](https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2024.1422177/full).
