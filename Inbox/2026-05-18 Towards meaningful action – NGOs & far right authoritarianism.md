...
url: "https://thinkingdoingchanging.com/2026/05/18/towards-meaningful-action-ngos-far-right-authoritarianism/"
...
[Reform’s recent local electoral victories](https://www.localgov.co.uk/Local-Elections-2026-Results-show-Reform-surge-and-Labour-losses/64328) should be a further wake up call for the social change sector to respond to the threat of the far right. Because NGOs appear to be struggling to shift strategy (to the extent and speed required to [meet the moment](https://thinkingdoingchanging.com/2025/12/10/how-can-the-uk-social-change-sector-meet-the-moment/) – as outlined in our previous report), [Jim Coe](https://www.linkedin.com/in/jim-coe-24599a16/) and I have produced [Towards Meaningful Action](https://thinkingdoingchanging.com/wp-content/uploads/2026/05/towards-meaningful-action.pdf) – a new piece of research (drawing on a survey and focus group) exploring how NGOs are impacted, how they are responding, what the blockages to a significant strategic response are, and how these might be overcome.

You can download the [Towards Meaningful Action full report here](https://thinkingdoingchanging.com/wp-content/uploads/2026/05/towards-meaningful-action.pdf).  
  
I summarise some of the findings below and we are also hosting an [online launch event](https://luma.com/v5lipywq) on Wednesday 20th May.
...
![Diagram working elements of far right authoritarianism - power holders adopting authoritarian positions and far right positions, promoting discriminatory narratives and street fascism / racial hatred](https://thinkingdoingchanging.com/wp-content/uploads/2026/05/picture1.png)

Diagram working elements of far right authoritarianism - power holders adopting authoritarian positions and far right positions, promoting discriminatory narratives and street fascism / racial hatred
...
All this should be even more of a wake up call to the nature of the threat the social change sector faces. While we are [seeing increasing action](https://thinkingdoingchanging.com/2026/04/02/what-does-hope-look-like-in-practice/), much more is needed.

## The context is having substantial negative impacts on NGO’s & communities

Around 3/4 of those surveyed reported ‘very significant negative effects’ or ‘some serious negative effects’ to organisations missions and to communities. We’re seeing similar results from other research including the [SMK Campaigners’ survey](https://smk.org.uk/wp-content/uploads/2026/03/HopeincollaborationFinal.pdf) and from [NCVO’s feedback from its members](https://www.ncvo.org.uk/news-and-insights/news-index/charities-facing-mission-limiting-hostility-fear-and-intimidation/).
...
![Diagram showing how the recommendations split into organisational strategy, collective response and organisational capabilities and preparedness](https://thinkingdoingchanging.com/wp-content/uploads/2026/05/ngo-barriers-1120-x-1920-px-presentation.jpg)

Diagram showing how the recommendations split into organisational strategy, collective response and organisational capabilities and preparedness
...
![Diagram showing 10 steps towards meaningful action set out in the report](https://thinkingdoingchanging.com/wp-content/uploads/2026/05/picture2.jpg)

Diagram showing 10 steps towards meaningful action set out in the report
...
International democracy defenders D-Hub have just launched their [anti-authoritarian toolkit](https://antiauthoritarian.com/), filled with examples of successful tactics and strategies used to oppose authoritarianism and promote democracy around the world.
...
**What is already happening?  
**Letesia Gibson’s article ‘ [Beyond Engage or Not](https://nfpresearch.com/blog/2026-02-11-beyond-engage-or-not-how-charities-govern-proximity-legitimacy-and-staff-trust) ’ is worth reading, and her organisation [New Ways](https://www.timefornewways.com/) has been offering a [strategy clinic](https://www.timefornewways.com/lotl-strategy-clinic) supporting leaders to think through navigating when and how to engage with decision makers in alignment with anti-racist and EDI commitments.

## 3) Safety and security protocols

Survey findings make clear that security and safety are currently significant issues, but 1/4 organisations don’t have safety protocols in place and aren’t planning to develop them. This seems risky given the current situation and possible futures. There is much to consider here for safety and security of communities, staff and organisations in the frontline, including impacts on staff capacity through burnout, erosion of staff morale, and increased financial burden as set out in [*Beyond the Emergency*](https://medium.com/@migrationexchange/beyond-the-emergency-why-movement-safety-is-a-foundation-of-migration-justice-a5ac604740f6) by Li-En Yapp writing for Migration Exchange.  
  
These obligations extend to all organisations to protect staff, trustees and volunteers who are at increased risk such as visibly queer people, people of colour, Muslims and Jews – this argument is eloquently made in [Your Board Has a Duty of Care](https://anjhanda.substack.com/p/your-board-has-a-duty-of-care-16) by Anj Handa.

**What is already happening?**  
– [Common Knowledge](https://commonknowledge.coop/) has a Community Security Leadership Development Programme in development, website launching soon.  
– Civic Power Fund have collated this [list of useful resources for community security and resilience](https://docs.google.com/spreadsheets/d/1rHKorm1clwj8vqf1OgguPp-T9v9pMgNdjW1sPk9dPzw/edit?gid=0#gid=0)  
– The [Tactical Tech Holistic Security manual](https://holistic-security.tacticaltech.org/) provides excellent guidance to take a holistic approach to strategy in this space. NGOs that have significant safety/security capacity will need to continue to be proactive in sharing their policies and practices with others.
...
As identified in ‘ [Meeting the Moment’](https://drive.google.com/file/d/1uxgvUB-VgRShhWVEtY_HMSAYwfAPDrov/view?usp=sharing), traditional approaches (campaigning and advocacy focused on incremental policy progress on single issues) are decreasingly effective. The challenges we are facing aren’t going to be overcome on an issue-by-issue basis because they are bigger than that. As movement actors learnt from their experiences in Hungary:
...
> 
> [5 Lessons from Hungary](https://forgeorganizing.org/article/5-lessons-hungary-how-fight-authoritarians/) – Gordon Whitman
...
**What is already happening?**  
– There are a variety of externally focused cross issue coalition initiatives making specific interventions (such as [A Million Acts of Hope](https://millionactsofhope.org/) and the [Together Alliance](https://www.togetheralliance.org.uk/)), and projects underway to convene inside issues / sectors (such as climate and nature, migration, human rights, unions and arts organisations).  
...
– Law firm Bates-Wells produces [regular legal updates](https://bateswells.co.uk/updates/briefing-for-charities-and-social-enterprises-2/) for charities.

## 8) Increasing adaptive strategic capacity
...
**What is already happening?**  
– Co-author of this paper Jim Coe has developed [a tool](https://docs.google.com/document/d/1SeXjpOoNWkrqlk0k1C8sEvIXkSQKFwUl/edit?rtpof=true&sd=true&tab=t.0) to support strategic discussions around potential future scenarios.  
...
– We don’t know of any projects focused on producing guidance and support to develop strategic capacity, but [this article by Dr John Renouf](https://www.jeanrenouf.com/insights/navigating-uncertainty-misinformation) on navigating uncertainty may be useful.

## 9) Accountability flows to affected communities

There can be pitfalls in relying on internal judgements about the effectiveness of your own responses. A recent [survey of foundations in the US,](https://cep.org/report-backpacks/a-sector-in-crisis-how-u-s-nonprofits-and-foundations-are-responding-to-threats/?section=intro) for example, looking at how foundations have stepped up to the address the context there, found that:
...
– Potentially useful references include the [Collecting our Dues](https://actbuildchange.com/stories/collecting-our-dues-a-report-on-how-to-organise-our-money) report from Act Build Change and Love and Power (which makes the argument for finance from membership to bake in accountability to a base) and the [Grassroots Charter](https://blueprintsfc.org/grassroots-charter/) from the Global Grassroots Support Network (setting out what is needed to ensure equitable relationships between NGOs/funders and grassroots groups) – as well as our own previous work exploring [if grassroots groups can partner with NGOs](https://thinkingdoingchanging.com/2022/10/12/can-grassroots-groups-genuinely-partner-with-ngos/).
...
As ever, I’d love to hear what you think about this? Is your organisation doing some gratef strategic work you’d like to share? Please comment below or via [Linked In](https://www.linkedin.com/in/natasha-adams-62748434/) to join the conversation

If you’ve enjoyed my writing and would like to support me to create and share more, or to continue my work on the far right, you can [buy me a coffee](http://buymeacoffee.com/Natasha_Adams). I share my work for the love, in the hope that its useful to strengthen movements, and that’s the biggest reward. But I’ve been working a lot unpaid on far right stuff, trying to fit it in around freelance work, so more donations would enable me to give it more time. If you feel moved to donate something (no pressure at all) it would be gratefully received