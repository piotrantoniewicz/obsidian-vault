...
- **Brand Style Snippet Workflow** (4 kroki):
  ...
  2. Prześlij do [[Claude AI|Claude]] razem z meta-promptem — AI analizuje: paletę kolorów, styl wizualny, wzorce kompozycji, charakterystykę typografii, nastrój i unikalne identyfikatory
...
- [[Claude AI|Claude]] + [[Midjourney]] jako tandem: Claude analizuje i koduje styl, Midjourney generuje — podział pracy między modele językowe i graficzne
