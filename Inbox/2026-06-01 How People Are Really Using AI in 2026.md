...
In the third edition of this study, the authors found that people are adopting generative AI for an ever-widening range of uses. Trends from one year to the next should be understood as shifts in emphasis, rather than stark ruptures. As the breadth andmore

It’s been three-and-a-half years since generative AI exploded onto the scene. In this past year, progress has continued its relentless pace: [Vibe coding](https://x.com/karpathy/status/1886192184808149383?s=20) took off, companies embraced [agentic workflows](https://mitsloan.mit.edu/ideas-made-to-matter/agentic-ai-explained), regular users of [ChatGPT](https://techcrunch.com/2026/02/27/chatgpt-reaches-900m-weekly-active-users/) hit 900 million and Google’s [Gemini](https://techcrunch.com/2026/02/04/googles-gemini-app-has-surpassed-750m-monthly-active-users/) surpassed 750 million, and OpenAI posted an [$852 billion valuation in its latest funding round](https://www.forbes.com/sites/antoniopequenoiv/2026/03/31/openai-valuation-reaches-852-billion-after-massive-funding-round/).

Amid the hype and debate over AI’s future, one question continues to stand out: How are people actually using this technology now? This is the focus of [AI in the Wild](http://www.theaiwild.com/), a longitudinal study carried out by me and Sara Biuk that tracks how we humans are evolving alongside AI.

For the third installment (following [2024](https://hbr.org/2024/03/how-people-are-really-using-genai) and [2025](https://hbr.org/2025/04/how-people-are-really-using-gen-ai-in-2025)) of this annual research, we analyzed 12,637 AI use cases. This dataset is an order of magnitude greater than those of the previous two years: We built a database of nearly 50,000 records that were collected between March ‘25 and Feb ‘26 from a wider pool of online sources, adding LinkedIn, TikTok, and YouTube to our previous sources of Reddit, Quora, and articles. (There are pros and cons to this “social listening” approach, which I’ve [previously detailed](https://hbr.org/2025/11/making-sense-of-research-on-how-people-use-ai).) We then used a hybrid human-AI system to identify use cases.
...
![Top 10 Gen AI Use Cases (2026). Flow chart comparing the top 10 generative AI use cases in 2025 and 2026. Therapy/companionship remains the top use case in both years, while practical and entertainment uses rise sharply in 2026. Troubleshooting climbs from outside the top 10 in 2025 to number 2, fun and nonsense rises from 7 to 3, and technical use of software, which hadn’t even been in the top 100 in 2025, reaches number 5. New entries include fan fiction and storytelling at number 4, autonomous agentic operations at number 6, and astrology and tarot readings at number 9. Meanwhile, self-improvement and reflective uses decline, with organizing life, finding purpose, enhanced learning, creativity, and healthier living falling out of the top 10 ranking. Source: the ai wild.com.](https://hbr.org/resources/images/article_assets/2026/07/W250310_SANDERS_AI_USES_TOP_10_USES_360.png)

Top 10 Gen AI Use Cases (2026). Flow chart comparing the top 10 generative AI use cases in 2025 and 2026. Therapy/companionship remains the top use case in both years, while practical and entertainment uses rise sharply in 2026. Troubleshooting climbs from outside the top 10 in 2025 to number 2, fun and nonsense rises from 7 to 3, and technical use of software, which hadn’t even been in the top 100 in 2025, reaches number 5. New entries include fan fiction and storytelling at number 4, autonomous agentic operations at number 6, and astrology and tarot readings at number 9. Meanwhile, self-improvement and reflective uses decline, with organizing life, finding purpose, enhanced learning, creativity, and healthier living falling out of the top 10 ranking. Source: the ai wild.com.

[See more HBR charts in Data & Visuals](https://www.hbr.org/data-visuals)

Jumping on the bandwagon of Merriam Webster’s 2025’s word of the year, “ [*slop*](https://www.merriam-webster.com/wordplay/word-of-the-year) ” (which includes “workslop,” from [HBR’s most popular article last year](https://hbr.org/2025/09/ai-generated-workslop-is-destroying-productivity)), we’ll use the term “thinkslop” for the lazy, sloppy thinking that can be engendered by excessive use of AI.
...
When we go to AI first, we deny our brain the opportunity to solve the problem afresh and unfettered. Moreover, we may well miss out on valuable ideas that exist only in the deep recesses of our memories and imaginations. This issue has been called [“cognitive debt” in other studies.](https://arxiv.org/abs/2506.08872)
...
Second, we deny ourselves the opportunity to actually think. Writing is not just the transcription of thought; drafting and editing is the [process of thinking](https://hbr.org/1973/01/clear-writing-means-clear-thinking-means).
...
It’s precisely because it’s so seductive that we need to guard ourselves against [AI sycophancy](https://news.stanford.edu/stories/2026/03/ai-advice-sycophantic-models-research)*.*
...
![How Gen AI Use Case Themes Have Shifted (2024 to 2026). Bubble chart comparing six categories of generative AI use from 2024 to 2026. Over three years, AI use shifts away from content creation toward personal and professional support, which becomes the dominant category by 2025 and remains the highest type of AI use in 2026. The technical assistance and troubleshooting category drops from 21% in 2024 to 15% in 2026, while learning and education falls from 16% to 11%. AI use for creativity and recreation remains relatively stable, and use for research, analysis, and decision-making increases slightly by 2026.](https://hbr.org/resources/images/article_assets/2026/05/W260421_SANDERS_AI_USES_TOP_THEMES_360.png)

How Gen AI Use Case Themes Have Shifted (2024 to 2026). Bubble chart comparing six categories of generative AI use from 2024 to 2026. Over three years, AI use shifts away from content creation toward personal and professional support, which becomes the dominant category by 2025 and remains the highest type of AI use in 2026. The technical assistance and troubleshooting category drops from 21% in 2024 to 15% in 2026, while learning and education falls from 16% to 11%. AI use for creativity and recreation remains relatively stable, and use for research, analysis, and decision-making increases slightly by 2026.
...
There’s some cause for concern here. High-profile cases of [AI psychosis](https://www.wsj.com/tech/ai/ai-chatbot-psychosis-link-1abf9d57) and stories of [AI romance](https://www.nytimes.com/interactive/2025/11/05/magazine/ai-chatbot-marriage-love-romance-sex.html) over the past year have shown that therapeutic and emotional relationships with AI are [high-stakes](https://www.theguardian.com/technology/2026/mar/14/ai-chatbots-psychosis), and can lead to [heartbreak](https://www.theguardian.com/technology/2025/aug/22/ai-chatgpt-new-model-grief) and even [death](https://www.theguardian.com/technology/2025/aug/27/chatgpt-scrutiny-family-teen-killed-himself-sue-open-ai). Hamilton Morrin, academic clinical fellow in neuropsychiatry at King’s College London, said to me: “Given long waiting lists and difficulty accessing mental health care and therapy in many countries, it’s perhaps not a surprise that increasing numbers \[of people\] are turning to generative AI for support with their emotional wellbeing.” Yet he cautions that general purpose AI chatbots aren’t a substitute for trained mental health professionals. Despite the efforts of AI companies to make them safer in this context, the cases above demonstrate how AI seems to have encouraged delusional beliefs and suicidal thoughts.
...
- Vibe coding (#21)—the writing of software code by natural language prompts. The term has also captured [many of the AI headlines](https://theweek.com/tech/the-rise-of-vibe-coding) over the past 12 months as the prospect of non-coders being able to code [excites some](https://www.wsj.com/articles/vibe-coding-has-arrived-for-businesses-5528e942) and [dismays others](https://stackoverflow.blog/2026/01/02/a-new-worst-coder-has-entered-the-chat-vibe-coding-without-code-knowledge/).
...
As a result, “ [shadow usage](https://www.ibm.com/think/topics/shadow-ai) ” is common. One user reports: “I’m closing tickets 2x faster, my code reviews have fewer issues, and I got praised in my last performance review. But here’s the thing: nobody knows I’m using AI.”
...
![How People Are Using Gen AI (2026). Graphic listing the top 100 generative AI use cases in 2026, grouped into six themes: personal and professional support; content creation and editing; learning and education; technical assistance and troubleshooting; creativity and recreation; and research, analysis, and decision-making. The chart shows people using AI for an increasingly wide and intimate range of tasks, with emotional support and practical assistance featured prominently. Therapy/companionship ranks first, followed by troubleshooting, fun and nonsense, fan fiction and storytelling (which is a new use case), technical software use, and autonomous agentic operations (also a new use case). Other new use cases in 2026, which all ranked relatively high, include astrology and tarot readings, fake reality TV, and vibe coding. Other common uses include activities related to relationship advice, organizing life, career guidance, drafting documents and emails, learning, coding, medical and legal help, travel planning, and entertainment, illustrating a growing tendency to turn to AI not just to create content but to think, decide, cope, and act. Source: the ai wild.com.](https://hbr.org/resources/images/article_assets/2026/05/W260421_SANDERS_AI_USES_610.png)

How People Are Using Gen AI (2026). Graphic listing the top 100 generative AI use cases in 2026, grouped into six themes: personal and professional support; content creation and editing; learning and education; technical assistance and troubleshooting; creativity and recreation; and research, analysis, and decision-making. The chart shows people using AI for an increasingly wide and intimate range of tasks, with emotional support and practical assistance featured prominently. Therapy/companionship ranks first, followed by troubleshooting, fun and nonsense, fan fiction and storytelling (which is a new use case), technical software use, and autonomous agentic operations (also a new use case). Other new use cases in 2026, which all ranked relatively high, include astrology and tarot readings, fake reality TV, and vibe coding. Other common uses include activities related to relationship advice, organizing life, career guidance, drafting documents and emails, learning, coding, medical and legal help, travel planning, and entertainment, illustrating a growing tendency to turn to AI not just to create content but to think, decide, cope, and act. Source: the ai wild.com.

[See more HBR charts in Data & Visuals](https://www.hbr.org/data-visuals)

Readers Also Viewed These Items

- ![](https://cdn11.bigcommerce.com/s-yneuaokjib/images/stencil/250x260/products/76/344792/11150V_500__10871.1781269894.png?c=2)
	Book
- ![](https://cdn11.bigcommerce.com/s-yneuaokjib/images/stencil/250x260/products/95111/344733/10864_500__45005.1781269852.png?c=2)
	[HBR's 10 Must Reads on Artificial Intelligence Updated and Expanded (featuring "How AI Can Help Managers Think Through Problems" by Elisa Farri and Gabriele Rosani)](https://store.hbr.org/product/hbr-s-10-must-reads-on-artificial-intelligence-updated-and-expanded-featuring-how-ai-can-help-managers-think-through-problems-by-elisa-farri-and-gabriele-rosani/10864?ab=at_art_idp_v1x2_s02)
	Book