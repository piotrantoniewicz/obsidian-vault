---
type: "Web"
authors: "[[Charity Engine]]"
url: "https://charityengine.net/nonprofit-event-guide/?utm_campaign=Weekly%20Blog%20Newsletter&utm_medium=email&_hsenc=p2ANqtz--lnA8_MuDuLnADSunACGimoVyO3HECn89aLjqIwaOBqryJTcX33eT3k1d1QPVm9UOn69aIZTzwYV2GMOutAdZXw7eYWJ55485nuKRgjhevKYkpr0g&_hsmi=424071791&utm_content=424071791&utm_source=hs_email"
...
When you’re ready to party with a purpose, you’re ready to plan some nonprofit events! Raising (and giving) money is more enjoyable when you gather supporters, [board members](https://blog.charityengine.net/nonprofit-board), and community partners to have a great time while supporting a mission everyone cares about.

At CharityEngine, we’ve been both the nonprofit ([remember that story?](https://charityengine.net/philip-schmitz/)) and, more recently, the company with software that powers organizations like Wounded Warrior Project, Easterseals, and MD Anderson Cancer Center as they engage their donors and raise money. Our [enterprise clients](https://charityengine.net/solutions-enterprise-nonprofits/) aren’t strangers to events, but some of our [growing clients](https://charityengine.net/solutions-growing-nonprofits/) think that events are reserved for the big boys.
...
![](https://charityengine.net/wp-content/uploads/2023/01/CE-NonprofitEventGuide-9.jpg)
...
And as a bonus, you can download our comprehensive **[Nonprofit Event Toolkit](https://pages.charityengine.net/lp-nonprofit-event-toolkit)**. It contains three different editable worksheets you can use as the foundation of your event planning, including:

- A Nonprofit Event Plan template that![nonprofit event toolkit thumbnail](https://charityengine.net/wp-content/uploads/2023/01/nonprofit-event-toolkit-thumbnail.png)
	nonprofit event toolkit thumbnail
...
When are they perfect? When you want to keep costs down, or your audience is widely spread out, or when you want supporters to move at their own pace (think a progressive series of presentations, like a Masterclass), [virtual events](https://blog.charityengine.net/virtual-fundraising-events) are the perfect way to engage donors and raise funds.

![](https://charityengine.net/wp-content/uploads/2023/01/CE-NonprofitEventGuide-1.jpg)
...
[Peer-to-Peer events](https://charityengine.net/bdsra-success-story/), or P2P because it’s faster to type, are the bread and butter of fundraising for many of our clients. This model of enlisting supporters to become fundraising ambassadors is the easiest way we know to engage donors and reach far more than you would otherwise.
...
![](https://charityengine.net/wp-content/uploads/2023/01/CE-NonprofitEventGuide-2.jpg)
...
- Technology like [PayPal, Apple Pay, and Google Pay](https://blog.charityengine.net/apple-pay-google-pay-venmo) can make cash transactions less frequent. Not managing cash can make reporting and analytics (and accountability) less straightforward and valuable.
...
6. Monitor the performance of the campaign.

If you want to see examples of nonprofits using P2P for big fundraising wins, check out this [fundraising tools webinar](https://pages.charityengine.net/webinar-registration-top-fundraising-tool-youre-probably-not-using) that John Coogan, formerly with Wounded Warrior Project and now with CharityEngine, and Alexis Langley (she was Alexis Simoneau when the webinar was recorded! ) offered on this technique. The webinar includes many real-life examples of successful P2P campaigns.

### Auctions

![](https://charityengine.net/wp-content/uploads/2023/01/CE-NonprofitEventGuide-3.jpg)
...
- Use [auction software](https://blog.charityengine.net/nonprofit-auction-software) to register attendees, catalog items, take bids, and adjust inventory when something is sold. Ticketing and registration—even seat assignments, if it’s a live auction—should be easy-peasy if you use the right software.
- And speaking of this, make sure you offer mobile bidding. Whether your event is virtual, silent, or in person, [mobile bidding](https://blog.charityengine.net/mobile-fundraising-swiper) (and an ample mobile-bidding window of time) can amplify your success.

Here’s a to-do list for planning a nonprofit auction:

1. Plan which of the three types of auctions you want to have.
2. Choose a date and time.
3. Set goals that can be measured when the event is over.
4. Set a budget and choose a venue that fits that budget.
5. Promote your event! Set up an automated email sequence and prepare some attention-grabbing social media posts.
6. Set up a website page so all the information is readily available.
7. Think of the extras...linens, food, bars, auctioneers, music.
8. Collect your items! This can take a while, so allow plenty of time. And for heaven’s sake, ensure your board members are helping to secure donations and buy tickets!
9. Set up your online registration and ticketing.
10. Host the auction, using software to keep everything in order and streamlined.
11. Follow up with everyone...those who donated items, those who purchased them, and volunteers.

Then think about [donor retention](https://blog.charityengine.net/auction-attendee-retention). How can you keep attendees coming back? Here are five tips:
...
Auctions can seem intimidating, and they probably can be if they are large enough. If they're anchoring a big effort, like a [capital campaign](https://blog.charityengine.net/capital-campaign-plan), it can seem like a lot of work. But getting things for free and selling them to help a nonprofit mission is pure genius, so don’t overlook this idea!
...
When you’re short on [fundraising ideas](https://blog.charityengine.net/fundraising-tips-ideas), here are some creative ways to get people together:
...
- One of our clients even puts on a highly successful [Woofstock](https://charityengine.net/rescue-village-success-story/) every year!

No matter what you choose, create a hashtag and publicize the event on social media. One of the most effective tools for getting the word out, [social media for nonprofits](https://blog.charityengine.net/nonprofit-social-media) is a powerful tool. Join the chorus and get your event in front of people!

![](https://charityengine.net/wp-content/uploads/2023/01/CE-NonprofitEventGuide-4-1.jpg)

### Audience-Specific Events

To round our big bucket of ideas, let’s think about how you can create [fundraising events for nonprofits](https://blog.charityengine.net/fundraising-ideas-veteran-organizations) with a very specific twist.
...
![](https://charityengine.net/wp-content/uploads/2023/01/CE-NonprofitEventGuide-5.jpg)
...
![](https://charityengine.net/wp-content/uploads/2023/01/CE-NonprofitEventGuide-6.jpg)
...
- A chapter of your plan should confirm the **governance** or who will be responsible for what. There are a lot of duties in marketing an event. Who will manage emails and [email automation](https://blog.charityengine.net/nonprofit-email-marketing) from your CRM? Who will handle social media? Who will create a list of top donors and call them? Who will liaise with the board? Who will create an ad?
...
- What’s the **post-event follow-up**? Sometimes it’s a survey to get feedback. It’s always a big thank-you note or email.
- How about your [**volunteers**](https://blog.charityengine.net/volunteer-management)? How will you communicate with them before, during, and after the event?

![](https://charityengine.net/wp-content/uploads/2023/01/CE-NonprofitEventGuide-7.jpg)
...
Let’s talk one more time about how [event software for nonprofits](https://blog.charityengine.net/nonprofit-event-software) can make everything about running an event easier. That includes promotion.
...
1. Do a **homepage takeover** on your website. That can be as easy as using your CRM or CMS to place a lightbox highlighting the event over your normal homepage. Ensure there’s a clear way for users to bypass the advertisement, but having a visible registration button greet website viewers will help your ticket sales.
2. **Talk** about your event to everyone you see. Mention it at the grocery store, put it on the neighborhood listserv, ask your board members to tell all their friends.
3. Use email automation to enroll your donors in a **series of emails** about the event. They can start with a save-the-date and follow up through registration and even day-of reminders. End with a thank-you email that contains a post-event survey.
4. Leaning on technology once again, promote your event via **mass text**. You can send a link that takes supporters right to the donation page of your website. [Text messages](https://charityengine.net/tupelo-success-story/) have a 98% open rate, compared to a 20% open rate for emails.
5. Use **social media** for promotion and engagement. You can start by creating a video you post on all the channels, then continue with event details and teasing great guests, auction items, or delicious food. Create a hashtag and ask your followers to share photos using it, and ask them (and board members) to post about the event on their social networks.

You can look into [Google Ad Grants](https://www.google.com/grants/) for free online advertising or ask your corporate sponsors if you can piggyback your advertising on their promotions. Ask anyone you see to help spread the word, and your efforts will show in ticket sales.
...
Here are the five tips we suggest to make [volunteer management](https://blog.charityengine.net/volunteer-management-food-banks) a breeze:
...
- Create an [accessible volunteer sign-up process](https://blog.charityengine.net/designing-inclusive-volunteer-sign-up) to assemble a diverse, inclusive team.
...
Before we let you go, let’s take a moment to talk about what you can do when you feel like [donor engagement](https://blog.charityengine.net/engage-past-donors) is getting wobbly. Perhaps you just finished a massive event, and everyone is tired. Perhaps there’s a recession. Perhaps there’s a pandemic. Almost anything can cause a little bit of donor fatigue! What can you do to combat that? We’ve got a few tips:
...
![Image](https://charityengine.net/wp-content/uploads/2022/03/bofu-img.jpg)