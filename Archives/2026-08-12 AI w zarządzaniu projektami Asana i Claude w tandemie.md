...
![sniadanie-zarzadzanie1](https://sektor3-0.pl/wp-content/uploads/elementor/thumbs/sniadanie-zarzadzanie1-rouhvhp7ji382zxxodrah8nymhl5uxno8438jon4vq.jpg "sniadanie-zarzadzanie1")
...
![](https://sektor3-0.pl/wp-content/uploads/2026/06/a0L0A2527-scaled.jpg.avif)

Uczestnicy i uczestniczki Śniadania z AI: Zarządzanie, Fot. Karolina Szczepocka
...
![Slajd z prezentacji Barbary Ciach](https://sektor3-0.pl/wp-content/uploads/2026/06/sniadanie-zarzadzenie-prezentacja-CleanShot-2026-06-12-at-14.24.23.png.avif)

Slajd z prezentacji Barbary Ciach
...
1. **TYTUŁ PROJEKTU**
2. **CEL**: Jaki jest cel i po czym poznam, że go osiągnęliśmy?
3. **CZAS REALIZACJI**: Jaka jest data startu i zakończenia projektu i skąd się bierze?
4. **ETAPY**: Z jakich faz składa się projekt?
5. **ZESPÓŁ**: Kto jest w zespole, kto i za co odpowiada? (Role + osoby)
6. **INTERESARIUSZE**: Od kogo / czego jesteśmy zależni? Kiedy ich informujemy?
7. **ARTEFAKTY**: Co musimy wyprodukować / dostarczyć?
...
![Slajd z prezentacji Barbary Ciach](https://sektor3-0.pl/wp-content/uploads/2026/06/sniadanie-zarzadzenie-prezentacja-CleanShot-2026-06-12-at-14.23.59.png.avif)
...
**CZYTAJ: [Asana: aplikacja do zarządzania zadaniami. Jak wdrożyliśmy ją w zespole Sektor 3.0?](https://sektor3-0.pl/blog/jak-efektywnie-wdrozyc-asane-w-zespole-dowiedz-sie-jak-zrobilismy-to-w-sektor-3-0/)**
...
1. Claude przeszukuje strony z grantami według ustalonych kryteriów (dla kogo, minimalny budżet, zasięg geograficzny).
2. Tworzy zadania w Asanie z opisem każdego grantu, terminem, linkiem i podsumowaniem.
3. Wysyła powiadomienie na Slacku z listą nowych propozycji grantowych.
4. Człowiek sprawdza i podejmuje decyzję, na który grant aplikować odklikując zadania w Asanie.
![Slajd z prezentacji Barbary Ciach](https://sektor3-0.pl/wp-content/uploads/2026/06/sniadanie-zarzadzenie-prezentacja-CleanShot-2026-06-12-at-14.26.59.png.avif)
...
1. Zbiera dane z Asany, Slacka i skrzynki e-mailowej.
2. Wpisuje je w ustaloną strukturę raportu statusowego.
3. Wrzuca szkic do Asany z oznaczeniem „draft”.
...
**CZYTAJ: [Mierzenie czasu pracy. Wnioski po pięciu latach](https://publicystyka.ngo.pl/mierzenie-czasu-pracy-wnioski-po-5-latach-tau)**
...
1. Pobierz aplikację Claude na komputer i połącz z narzędziami, których używasz (Asana, Slack, mail).
2. Wypełnij wspomnianą checklistę siedmiu pytań dla jednego projektu ze swojej organizacji.
3. Wklej odpowiedzi do Claude’a i sprawdź, co stworzy.
4. Wybierz zmotywowaną osobę, która będzie właścicielką procesu — najlepiej z grupą sojuszniczek i sojuszników.

## Materiały dodatkowe

- [Asana: aplikacja do zarządzania zadaniami. Jak wdrożyliśmy ją w zespole Sektor 3.0?](https://sektor3-0.pl/blog/jak-efektywnie-wdrozyc-asane-w-zespole-dowiedz-sie-jak-zrobilismy-to-w-sektor-3-0/)
- [Automatyzacja w NGO: od integracji do agenta AI](https://sektor3-0.pl/aktualnosci/automatyzacja-w-ngo-od-integracji-do-agenta-ai/)
- [Współpraca w projekcie po godzinach – jak do tego podejść?](https://sektor3-0.pl/blog/wspolpraca-w-projekcie-po-godzinach-jak-do-tego-podejsc/)
- [Microsoft Copilot w pracy organizacji pozarządowych: od asystenta do agenta AI](https://sektor3-0.pl/aktualnosci/microsoft-copilot-w-pracy-organizacji-pozarzadowych-od-asystenta-do-agenta-ai/)
...
![](https://sektor3-0.pl/wp-content/uploads/2026/06/a0L0A2518-scaled.jpg.avif)

Uczestnicy i uczestniczki Śniadania z AI: Zarządzanie, Fot. Karolina Szczepocka

Partnerem Śniadań z AI jest Fundacja Instytut Reportażu, która jest gospodarzem Wrzenia. Śniadania z AI są realizowane w ramach Sektor 3.0, przedsięwzięcia Polsko-Amerykańskiej Fundacji Wolności, realizowanego przez Fundację Rozwoju Społeczeństwa Informacyjnego. Więcej o Śniadaniach z AI znajdziesz [**tutaj**](https://sektor3-0.pl/sniadania-z-ai/).

**Jeśli chcesz dołączyć do nas podczas kolejnych spotkań po wakacjach, śledź kanały Sektor 3.0 i zapisz się do naszego** [**newslettera**](https://sektor3-0.pl/zapisz-sie-do-newslettera/)**.**
