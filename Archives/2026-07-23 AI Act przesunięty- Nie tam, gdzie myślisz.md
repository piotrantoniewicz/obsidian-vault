...
Nagłówki o przesunięciu AI Act dały wielu organizacjom fałszywe poczucie, że temat wraca dopiero w 2027 roku. Tymczasem 2 sierpnia 2026 nadal wchodzi w życie obowiązek oznaczania treści AI. Dotyczy on każdej organizacji, która używa chatbota lub generuje grafiki, niezależnie od budżetu.

Zespół komunikacji świętuje. Ktoś podesłał na grupowy czat nagłówek: „AI Act przesunięty". Prezeska odkłada temat compliance na spokojniejszy moment, może na koniec roku, może na 2027, kiedy ponoć wchodzą w życie nowe obowiązki. Ulga jest realna, bo lista rzeczy do zrobienia w organizacji społecznej i tak nie ma końca.

Ktoś w tym samym zespole od miesięcy wrzuca na Facebooka grafiki wygenerowane w Canva AI. Na stronie fundacji działa prosty chatbot, który odpowiada na pytania o wpłaty. Nikt nie zadał pytania, które w tym momencie jest najważniejsze: czy ta grafika z Canvy jest gdzieś oznaczona jako wygenerowana przez AI? Czy osoba pisząca do chatbota wie, że rozmawia z botem, a nie z człowiekiem?

### Dlaczego to ma znaczenie akurat teraz?

Większość organizacji społecznych nie ma żadnej polityki dotyczącej AI, korzystają z niego doraźnie, bez udokumentowanego sposobu pracy.

To właśnie ta grupa, bez polityki, bez ustalonych zasad, z AI używanym „po cichu" przez pojedyncze osoby, jest najbardziej narażona na zderzenie z obowiązkami, które wchodzą w życie 2 sierpnia 2026. Nie dlatego, że przepisy są wymierzone w małe organizacje. Duże firmy mają działy prawne śledzące każdą zmianę w AI Act, a mała fundacja dowiaduje się o obowiązkach z nagłówków gazet.

Stawka jest duża. Kary za naruszenie przepisów AI Act mogą sięgać do 15 mln euro lub 3% globalnego rocznego obrotu organizacji. W praktyce dla małej fundacji ten drugi próg nie ma znaczenia, ale sama górna granica pokazuje, że Unia traktuje te obowiązki poważnie, niezależnie od skali podmiotu.

### Co naprawdę przesunięto w AI Act, a czego nie ruszono?

Tu trzeba rozdzielić dwie rzeczy, które w publicznej rozmowie zlały się w jedną. Digital Omnibus, przyjęty przez Radę UE 29 czerwca 2026 (po głosowaniu Parlamentu Europejskiego 16 czerwca 2026 i wstępnym porozumieniu politycznym trilogu z 6 maja 2026) to pierwsza nowelizacja AI Act od jego wejścia w życie w sierpniu 2024. Pakiet rzeczywiście przesuwa terminy, ale tylko w konkretnych, wąsko określonych miejscach.

**Systemy wysokiego ryzyka** to prawnicze określenie systemów AI, których działanie może realnie wpłynąć na zdrowie, bezpieczeństwo, prawa lub życiowe szanse człowieka, na przykład narzędzia do rekrutacji, oceny wniosków kredytowych czy dostępu do usług publicznych (Annex III AI Act). Dla tej kategorii obowiązki compliance przesunięto z 2 sierpnia 2026 na 2 grudnia 2027. Osobno przesunięto na 2 sierpnia 2028 termin dla AI wbudowanej w produkty regulowane sektorowo, jak windy czy urządzenia medyczne. Przesunięto też obowiązek utworzenia przez państwa członkowskie krajowych piaskownic regulacyjnych, programów pilotażowych, w których firmy i organizacje mogą testować nowe systemy AI pod nadzorem regulatora z 2 sierpnia 2026 na 2 sierpnia 2027.

To właśnie te przesunięcia trafiły do nagłówków i wygenerowały ulgę w organizacjach takich jak Twoja. Problem w tym, że małej fundacji omówione rozwiązania nie dotyczą. To, co realnie jej dotyczy, leży gdzie indziej w obowiązkach transparentności z artykułu 50 AI Act.

**Obowiązki transparentności (art. 50 AI Act)** to zestaw zasad nakazujących ujawnianie, że dana treść lub interakcja pochodzi od AI, a nie od człowieka. Obejmują one oznaczanie treści wygenerowanych przez AI oraz informowanie użytkownika, że rozmawia z botem. Tu odroczono wyłącznie techniczny obowiązek dostawców narzędzi (np. Canvy, generatorów obrazu) do wbudowania czytelnego dla maszyn znacznika w treściach generowanych przez systemy, które były na rynku już przed 2 sierpnia 2026, ten obowiązek dostawcy przesunięto na 2 grudnia 2026. Dla narzędzi wprowadzonych na rynek po 2 sierpnia 2026 obowiązek działa od razu, bez odroczenia.
...
Obowiązek dotyczy węższego zakresu, niż brzmi w teorii, ale szerszego, niż podpowiada intuicja. Cztery sytuacje, w których organizacja społeczna może jemu podlegać:
...
**Treści AI o sprawach publicznych**. Kampanie rzecznicze, stanowiska w debacie publicznej, teksty komentujące decyzje władz, jeśli tekst na taki temat został wygenerowany lub istotnie zmieniony przez AI i publikowany jest w celu poinformowania opinii publicznej, obowiązek ujawnienia dotyczy również tej sytuacji (chyba że treść przeszła ludzką redakcję i odpowiada za nią konkretna osoba).

**Voice AI na infolinii.** Analogicznie do chatbota. tj. jeśli osoba dzwoniąca rozmawia z systemem głosowym opartym na AI, a nie z konsultantem, powinna to wiedzieć od pierwszych sekund rozmowy.
...
Dwie proste rzeczy: przejrzenie listy rzeczy do sprawdzenia i opracowanie kilku krótkich komunikatów. Poniżej prezentuję przykłady.
...
Jeśli odpowiedź na choćby jedno pytanie brzmi „tak", to dodanie jednego zdania lub etykiety w odpowiednim miejscu załatwia sprawę. Nawet gdyby nie wymagało tego prawo, to praktyka oznaczania materiałów wygenerowanych ze wsparciem AI, to zwykła uczciwość wobec osoby po drugiej stronie ekranu.

### AI literacy - obowiązek, o którym niewiele osób w sektorze mówi

W artykule omawiam zmiany, które zaczynają obowiązywać 2 sierpnia. Jednocześnie mało kto zauważa, że jeden z obowiązków AI Act działa już od dawna. **AI literacy** to obowiązek wspierania przez organizację rozwoju wiedzy zespołu o AI: o tym, z czym mają do czynienia osoby korzystające z systemów AI, jakie dane wolno wklejać do narzędzia, czego nie wolno, i kto weryfikuje wynik jego pracy. Ten obowiązek wszedł w życie 2 lutego 2025 roku i obowiązuje niezależnie od tego, co dzieje się 2 sierpnia 2026.

Nie wymaga certyfikatu ani egzaminu. Wymaga udokumentowanej, choćby minimalnej wiedzy zespołu. Jednostronicowa polityka AI literacy dla małego zespołu może zawierać po prostu: kto może używać jakich narzędzi, jakich danych (np. danych osobowych beneficjentów) nie wolno tam wklejać bez sprawdzenia polityki prywatności, kto weryfikuje wynik pracy AI zanim trafi na zewnątrz, i kto w zespole jest punktem kontaktowym w tym temacie. To dokładnie ten sam kierunek, o którym pisałem w innym tekście [„Połowa Twojego zespołu już używa AI. Czas to zauważyć"](https://publicystyka.ngo.pl/polowa-twojego-zespolu-juz-uzywa-ai-czas-to-zauwazyc). Jeśli w Twoim zespole ktoś po cichu już od miesięcy korzysta z AI bez wspólnych zasad, to zjawisko ma nazwę: shadow AI, i warto mu się przyjrzeć zanim zrobi to za Ciebie kontrola.

### Grafika, która nikogo nie zdziwiła, dopóki nie zapytałem

Niedawno spotkałem się ze zdziwieniem u osoby z zespołu komunikacji jednej z organizacji, nie wiedziała, że wygenerowane grafiki warto opisać czy oznaczyć jako stworzone przez AI. Dla niej to było zaskoczenie, że w ogóle trzeba to zaznaczać. Temat oznaczania treści AI nigdy nie pojawił się w rozmowie o tym, jak zespół pracuje z nowymi narzędziami. Ta luka nie bierze się z niechęci do przestrzegania prawa. Bierze się z tego, że nikt jeszcze nie zadał tego pytania na głos. Warto je zadać w najbliższym tygodniu.

### Ważne zastrzeżenie

Nic z powyższego nie zastępuje pracy zarządu nad zgodnością z prawem. AI może pomóc przygotować szkic polityki, checklistę czy nawet tekst etykiety do oznaczania grafik, ale decyzja, czy organizacja spełnia obowiązki AI Act, i odpowiedzialność za tę decyzję, zostaje po stronie osób zarządzających organizacją. Warto też pamiętać, że ten artykuł porządkuje stan rzeczy na dzień publikacji, a szczegóły wdrożeniowe (zwłaszcza krajowa ustawa o systemach AI) wciąż są w procesie tworzenia. Przed podjęciem decyzji dotyczących konkretnej organizacji warto sprawdzić aktualny stan prawny lub skonsultować się z prawnikiem.
...
Jeśli chcesz przejść przez checklistę razem, zamiast robić to samodzielnie między jednym a drugim raportem grantowym to napisz na LinkedIn.
