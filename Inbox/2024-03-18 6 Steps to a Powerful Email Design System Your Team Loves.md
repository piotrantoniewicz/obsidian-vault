...
url: "https://www.litmus.com/blog/email-design-system"
...
![components + standards = design system](https://www.litmus.com/wp-content/uploads/2021/05/Webinar_-How-Design-Systems-Empower-Email-Teams-Everywhere-e1662588941171.png)

## What’s included in an email design system?

An email design system usually consists of the following components:

- **Brand colors and assets** like logos, icons, and imagery
- **Email modules** used to build emails, like [snippets and partials](https://www.litmus.com/blog/email-modules-and-modular-email/)
- **Email templates** that can be reused across campaigns

**Grab your six free [subscription email templates](https://page.litmus.com/subscription-email-templates.html) —fully customizable and optimized for over 100+ email clients, apps, and devices, including Dark Mode.**
...
| ### Example: Litmus’ email design system  Here at Litmus, we house our email design system across three areas:  - **Visual designs** like frameworks, brand colors, assets in [Figma](https://www.figma.com/) - **Email modules and templates** in [Litmus Builder](https://www.litmus.com/email-builder/) - **Documentation** for standards and usage in [Confluence](https://www.atlassian.com/software/confluence)  Our components and standards are spread across these [email design tools](https://www.litmus.com/blog/state-of-email-design-tools) and are used on a daily basis by our email team. |  |
| --- | --- |
...
- **Saves time on building.** Give your developers time back so they can invest in creating better quality emails (and other efforts like [accessibility](https://www.litmus.com/resources/ultimate-guide-to-email-accessibility/) and [Dark Mode](https://www.litmus.com/blog/the-ultimate-guide-to-dark-mode-for-email-marketers/)).

Not only does an email design system enable teams to execute quicker, but they also systematically reduce the opportunity for [errors](https://www.litmus.com/resources/anatomy-of-a-broken-email/) —allowing you to build emails more quickly (and scale, too).

## How to create your own email design system

There’s a lot that can go into an [email design system](https://www.litmus.com/email-templates/email-design-system), from graphics and brand assets to the actual code and copy (and [web safe fonts](https://www.litmus.com/blog/the-ultimate-guide-to-web-fonts)) included in emails. But most successful design systems are created using a well-tested series of steps.
...
If you answered yes to any of these questions, then creating your own email design system makes sense. Discuss the challenges your team faces with stakeholders, outline [the many benefits of a design system](https://uxplanet.org/why-are-design-systems-so-important-dda6225be5d7) to get buy-in, then set aside the time and resources to get the work done.
...
Similar to how you’d [break an email up into a modular template](https://www.litmus.com/blog/email-modules-and-modular-email/#how-to-modular-email-design), the purpose of your audit is to figure out which components are common across emails (or are unique and need to be accounted for). This helps you know what you actually need to build and the standards you need to write for using those components.
...
![email design modules](https://www.litmus.com/wp-content/uploads/2021/05/modules.png)
...
At Litmus, we use [Figma](https://www.figma.com/) to store our visual designs.
...
| We use [Design Library in Litmus](https://help.litmus.com/article/313-litmus-design-library-guide) for this, which allows you to save brand colors, modules, and full templates for your team to use when creating new campaigns.  You can also [categorize your modules](https://help.litmus.com/article/382-organizing-modules-in-design-library) in Litmus by tagging them by module type (like headers or [buttons](https://www.litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design/)), email type (like newsletter or event), or whatever fits your needs. |  |
| --- | --- |

![email design system in Litmus Design Library](https://www.litmus.com/wp-content/uploads/2021/05/Screen-Shot-2021-05-20-at-7.12.01-PM.png)
...
[**Automate QA testing**](https://www.litmus.com/email-testing/) in Litmus then empower anyone—even non-coders—to quickly build emails using the [**drag-and-drop Visual Editor**](https://www.litmus.com/blog/new-in-litmus-april-2021-product-release/). →
...
| For us, that happens in [Confluence](https://www.atlassian.com/software/confluence), but any type of docs that are shared, easy to update, and quick to reference will do. |  |
| --- | --- |

We’ve seen teams use everything from PDFs and slide decks, to full-on websites to document their design systems. (We’re huge fans of [Mutual of Omaha’s email design guide](https://design.mutualofomaha.com/email/) if you want some inspiration.)
...
Design systems aren’t meant to be static. As [Elliot Ross](https://www.litmus.com/blog/litmus-live-2021-day-2/#4) of Taxi for Email puts it, an email design system is “a living, breathing thing.”

![](https://x.com/i/status/1453405353018904580)
...
Kimberly Huang is a Content Marketing Professional.