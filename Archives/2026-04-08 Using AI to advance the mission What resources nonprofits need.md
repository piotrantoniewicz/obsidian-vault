---
type: Web
authors: ["[[Kevin Barenblat]]", "[[Elisha Smith Arrillaga]]", "[[Nick Cain]]"]
url: 'https://candid.org/blogs/using-ai-to-advance-mission-for-nonprofits/'
...
![Authors of this article standing with colleagues.](https://cms.candid.org/wp-content/uploads/2026/03/using-ai-nonprofit-mission.png)

Authors of this article standing with colleagues.

For [AI-powered nonprofits](https://ssir.org/articles/entry/ai-powered-nonprofits-landscape) —an emerging class of nonprofits that are [building AI tools to advance their mission-driven work](https://candid.org/blogs/what-data-says-about-nonprofits-building-ai-solutions/) —AI isn’t just an add-on to improve efficiency. They’re building technology to help solve humanity’s most urgent issues. But they need funding to advance that work. In fact, Fast Forward’s [2025 AI for Humanity Report](https://www.ffwd.org/2025-ai-for-humanity-report) found that 84% of AI-powered nonprofit respondents need funding to further develop and scale AI-enabled solutions.
...
At a recent [event](https://www.ffwd.org/blog/5-big-ideas-from-fund-ai), the Patrick J. McGovern Foundation (PJMF) and Fast Forward brought together 200 like-minded funders committed to using philanthropic capital to help nonprofits deploy AI for good.

What emerged from the [sessions](https://learn.mcgovern.org/Fund-AI-2025-Highlights-and-Insights-2c370021ed8c80adbd01cbf55df43c01) and conversations were a set of common practices among funders that were funding AI projects or planning to do so. They offer a high-level roadmap for supporting AI solutions in the sector.

- **Build basic AI fluency across the institution.** Program staff, grants management, senior leadership, and board members all have a responsibility to understand how the technology works. Creating an [AI use policy](https://www.ffwd.org/nonprofit-ai-policy-builder) to govern staff use of the tools and organizing [AI 101](https://learn.mcgovern.org/AI-101-16b70021ed8c80a18a2ed4dd7f7668c7) workshops are good places to start.
- **Position AI across issue areas, not as a standalone grant portfolio.** AI’s broad capabilities mean there are [high-potential use cases](https://learn.mcgovern.org/18e70021ed8c8027ba0fc4032bc0c33e?v=18e70021ed8c80318234000c85e4dce8) across issue areas as diverse as conservation, human services, and access to housing. Consider that AI is a tool that can exist alongside all of the other strategic levers used to advance progress.
- **Empower program officers to confidently evaluate proposals focused on developing and using AI.** Align on a [set of principles](https://www.ffwd.org/blog/philanthropists-guide-to-nonprofit-ai-investments) and associated [diligence questions](https://urldefense.com/v3/__https:/learn.mcgovern.org/AI-Grantmaking-Strategy-26a70021ed8c80a9b584c59794a82f34__;!!G92We9drHetJ8EofZw!aMIkJ_qvw4Nec2e64-NWtC-VHyRKOU0XfkKYSVMwOhSWR9vy9cAehbKxV_0GayhEHzSDobQ4n3SesnKyqLk$). For example, what real-world problem is this nonprofit tackling with AI? What problems or bottlenecks can AI remove? How will the nonprofit protect its beneficiaries’ data and address potential biases in their algorithms? Laying out these questions up front will help program officers identify promising proposals and pinpoint areas of uncertainty.
