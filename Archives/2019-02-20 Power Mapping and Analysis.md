...
![Image of an xy axis. The x axis is the level of support and the y axis is the level of influence.](https://i0.wp.com/commonslibrary.org/wp-content/uploads/tCA_PowerMapping.jpg?w=755&ssl=1)  
Source: The Change Agency
...
## Power Mapping and Analysis Tool
...
- [Power and Power Mapping: Start Here](https://commonslibrary.org/power-and-power-mapping-start-here/)
- [Power Mapping Guide, The Change Agency](https://commonslibrary.org/power-mapping/)
- [The Power Cube](https://commonslibrary.org/the-power-cube/)
- [The Power Matrix](https://commonslibrary.org/power-matrix/)
- [Understanding Forms of Power](https://commonslibrary.org/forms-of-power/)
- [It’s All About Power: A Guide to Thinking Differently about Power for Solidarity in Social Change](https://commonslibrary.org/its-all-about-power-a-guide-to-thinking-differently-about-power-for-solidarity-in-social-change/)
- [Campaign Strategy Planning Template](https://commonslibrary.org/campaign-strategy-planning-template/)
- [People Power Manual: Campaign Strategy Guide](https://commonslibrary.org/campaign-strategy-manual/)
- [Elements of Campaign Strategy](https://commonslibrary.org/elements-of-campaign-strategy/)
- [Spectrum of Allies](https://commonslibrary.org/spectrum-of-allies/)
- [System Map Template](https://commonslibrary.org/system-map-template/)
- [Power: Training and Planning Tools](https://commonslibrary.org/training-and-planning-tools-about-power/)
- [Pillars of Power Analysis: Identify the Institutions](https://commonslibrary.org/pillars-of-power/)
...
- Author:
- Organisation: Advocacy Advisor and Campaign Coach
- Location: Australia
- Content length: 3 pgs
- Website: [http://www.anitatang.com.au/](http://www.anitatang.com.au/)
- Resource: [Guide-to-power-mapping-and-analysis-activity.pdf](https://commonslibrary.org/wp-content/uploads/Guide-to-power-mapping-and-analysis-activity.pdf)
- File Size: 82 KB
