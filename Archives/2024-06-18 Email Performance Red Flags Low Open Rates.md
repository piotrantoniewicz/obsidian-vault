...
url: >-
  https://www.socketlabs.com/blog/email-performance-red-flags-low-open-rates/?utm_campaign=deliverability_rate&utm_medium=blog&utm_source=senditright
...
![email performance red flags low open rates](https://www.socketlabs.com/wp-content/uploads/2024/06/Open-Rates.png)

email performance red flags low open rates

Hello again! Happy to see you here for our series, Email Performance Red Flags.

Last time, we discussed [how unsubscribes impact email performance](https://www.socketlabs.com/blog/email-performance-red-flags-high-unsubscribe-rate/) with industry experts Desislava Zhivkova, Skyler Holobach, and Autumn Tyr-Salvia. Is a high unsub rate an issue? Is it more worrisome than people marking your emails as spam? What do you do when yours is high? We’ve gotten the full download.

Before that, we dug into [spam complaints](https://www.socketlabs.com/blog/email-performance-red-flags-spam-complaints/), which are like poison for your email performance (and brand). It’s a must-read for anyone pushing “Send.”

But now…

## Today’s Red Flags: Low Open Rates

Let’s talk about a very meaningful email performance red flag: low open rates. I know, I know, [opens are problematic](https://www.socketlabs.com/blog/email-open-rates-are-mostly-dead/) because they’re becoming less and less accurate over time. But they’re still a great metric to pay attention to for performance monitoring, trend analysis, and insights into what your email audience likes (and doesn’t).
...
[Drew Price](https://www.linkedin.com/in/drew-price-9081849/) has spent more than 17 years in email and lifecycle marketing across tech, publishing, and retail. Most notably, he scaled Grammarly’s email channel from 0 to 3 billion emails per year from 2014 to 2020, and now he is a lifecycle marketing advisor at HoneyBook. If lifecycle and retention marketing is part of your focus, you should sign up for his weekly newsletter: [Scaling CRM](https://scalingcrm.substack.com/). I’m a huge fan!

[Jaina Mistry](https://www.linkedin.com/in/jainamistry/) is the director of brand and content marketing at email design tool behemoth [Litmus](https://www.litmus.com/), where she’s developed her skills over the last eight years. Prior to Litmus, Jaina built a vast and varied career in freelance writing, from email to blogs, and is a deeply knowledgeable source of best practices guidance.

[Travis Hazlewood](https://www.linkedin.com/in/travis-hazlewood/) is writer and head of deliverability at [Ortto](https://ortto.com/), where he’s spent the last few years guiding their email practice to the best outcomes. He has more than five years of experience in email at large and has an extensive history doing some of the hardest work in deliverability…customer support! He’s a consistent blogger and has co-authored an [ebook on](https://ortto.com/learn/email-deliverability-ebook/) [deliverability](https://ortto.com/learn/email-deliverability-ebook/), all with the intent to educate and support email senders in reaching their highest performance possible.
...
- [**List Hygiene**](https://www.socketlabs.com/blog/your-guide-to-spring-email-cleaning-2024/)**:** Are you periodically (or frequently) removing unengaged addresses from your list? The more unengaged email addresses you’re sending to, the lower your open rate will be.
...
- [**Segmentation**](https://www.socketlabs.com/blog/5-ways-to-segment-email-for-better-performance/)**:** If you aren’t breaking your lists down into smaller chunks to make personalization easier and more effective, you could be falling into the “trying to be everything to everyone” trap. What happens then? You’re nothing to nobody!
...
The ones within your control, such as when a DNS entry is accidentally deleted due to a recent release by your dev team, can trigger providers like Microsoft, Google, and Yahoo to start [temporarily deferring](https://www.socketlabs.com/blog/hold-please-deferred-bounces/) your mail. Add your DNS records back and you’re as good as new (once the changes get rolled out around the world, which can take anywhere from 24–72 hours).
...
![](https://www.socketlabs.com/wp-content/uploads/2024/06/In-blog-Graphic-Travis-1.png)
...
![](https://www.socketlabs.com/wp-content/uploads/2024/06/Screenshot-2024-06-18-at-9.24.11%E2%80%AFAM.png)
...
![](https://www.socketlabs.com/wp-content/uploads/2024/06/In-blog-Graphic-Jaina.png)
...
![](https://www.socketlabs.com/wp-content/uploads/2024/06/Screenshot-2024-06-18-at-9.23.54%E2%80%AFAM.png)
...
1. **Check for technical issues** such as SPF, DKIM, or DMARC records potentially misconfigured.
2. **Review your delivery and engagement statistics** for signs of a change. Was there a notable increase in signup rates or sending volume, or perhaps a rise in bounce or [spam complaint rates](https://www.socketlabs.com/blog/email-performance-red-flags-spam-complaints/) within the couple of days before your open rates dropped? Look for *any change* at all. If you see one, try to understand it within the context of your other metrics.
3. **Test out your subscriber experience!** Are your signup forms, preference centers, and unsubscribe links working? Are your automations firing as expected? You’d be surprised how often automations run amok. It happens. Stay calm and email on.
...
![](https://www.socketlabs.com/wp-content/uploads/2024/06/In-blog-Graphic-Drew.png)

1. At the point of collection, **ensure your lead magnets align with what you’ll be providing.** Don’t advertise a discount on dresses and then send emails about bicycles nonstop. Make sure you’re getting subscribers whose interests align with what you’re offering via email.  
...
In some cases, such as when you’re not fully compliant with [their sender requirements](https://www.socketlabs.com/blog/first-2024-priority-meeting-google-and-yahoo-email-standards/), mailbox providers like Yahoo and Google will start by deferring a portion of your mail. This means the mail takes a few tries before it’s accepted by the recipient servers, resulting in delayed delivery.
...
Here’s an example of what thatmight look like: Imagine you have three domains sending the same type of mail. Two are properly authenticated but the third is not. In this scenario, your open rates have been chugging along like a champion for months, until Google starts sending mail from your unauthenticated domain to the spam folder because it’s not compliant. Thankfully, once you properly authenticate that third domain, your performance bounces back and it’s like it never happened. But wow, what a rough couple of days.

![](https://www.socketlabs.com/wp-content/uploads/2024/06/Screenshot-2024-06-18-at-9.21.33%E2%80%AFAM.png)
...
And, as always, if you need more insight into why your open rates are too low for comfort, consider taking a look at [SocketLabs Spotlight](https://www.socketlabs.com/hub/spotlight-email-reporting/), where we provide more in-depth [diagnostic](https://www.socketlabs.com/hub/spotlight-diagnostics/) information about [your first-party data](https://www.socketlabs.com/blog/first-party-email-data-is-the-future-of-deliverability/) than you can get anywhere else.

1. [Email Performance Red Flags: Low Open Rates](#elementor-toc__heading-anchor-0)
2. [Today’s Red Flags: Low Open Rates](#elementor-toc__heading-anchor-1)
	1. [Our Email Experts for Today](#elementor-toc__heading-anchor-2)
3. [What’s an Open Rate?](#elementor-toc__heading-anchor-3)
	1. [What’s Considered “Low”?](#elementor-toc__heading-anchor-4)
		2. [Why Should I Worry About a Low Open Rate?](#elementor-toc__heading-anchor-5)
		3. [When Should I Worry About a Low Open Rate?](#elementor-toc__heading-anchor-6)
		4. [What Causes Low Open Rates?](#elementor-toc__heading-anchor-7)
		5. [How Do You Catch a Drop in Open Rates?](#elementor-toc__heading-anchor-8)
4. [How to Improve Your Open Rates](#elementor-toc__heading-anchor-9)
	1. [Check Your Nuts and Bolts](#elementor-toc__heading-anchor-10)
		2. [Improve List Quality](#elementor-toc__heading-anchor-11)
		3. [Switch Up Your Content](#elementor-toc__heading-anchor-12)
		4. [Make Sure Everything Works the Way You Think It Works](#elementor-toc__heading-anchor-13)
		5. [Monitor Performance Regularly to Catch Problems Early](#elementor-toc__heading-anchor-14)
		6. [Reassess Your Email Strategy](#elementor-toc__heading-anchor-15)
5. [The Last Word](#elementor-toc__heading-anchor-16)
6. [Related Posts](#elementor-toc__heading-anchor-17)
