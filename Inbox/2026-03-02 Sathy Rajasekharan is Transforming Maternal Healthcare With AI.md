...
url: https://www.ffwd.org/blog/sathy-rajasekharan-is-transforming-maternal-health-care-with-ai?utm_source=substack&utm_medium=email
published:
...
[Explore Now](https://www.ffwd.org/impact-report)

April 29, 2025

![Sathy Rajasekharan is Transforming Maternal Healthcare With AI](https://cdn.sanity.io/images/4cwcet86/production/a813098dc4f39b6694fec85baccb0cd1b956c45d-2000x1000.png?rect=111,0,1778,1000&w=1778&h=1000&q=70&auto=format)

*Written by the* [*Patrick J. McGovern Foundation*](https://www.mcgovern.org/) *team.*

Meet the leaders who are putting AI to work for good. "Humans of AI for Humanity" is a joint content series from the [Patrick J. McGovern Foundation](https://www.mcgovern.org/) and Fast Forward. Each month, we highlight experts, builders, and thought leaders using AI to create a human-centered future — and the stories behind their work.
...
As the Co-Executive Director of [Jacaranda Health](https://jacarandahealth.org/), Sathy saw firsthand that digital health products can help bridge the care gap by providing timely advice to new and expecting mothers in resource-limited communities. He soon began exploring ways to leverage AI to improve service quality and scale the impact. He and his team built an AI-powered platform, [PROMPTS](https://jacarandahealth.org/prompts/), that relies on SMS messaging to triage and answer user questions in real-time, and initiate referrals for a higher level of care when necessary. PROMPTS is rooted in agency and empowerment. When mothers know when and where to seek help, they can better protect themselves and their babies.
...
![Sathy Rajasekharan is Transforming Maternal Healthcare With AI – Fast Forward – Where Tech Meets Social Impact](https://cdn.sanity.io/images/4cwcet86/production/a354050cf2fe737439192008bb91e608d44962c2-1646x918.png?q=70&auto=format)

## PROMPTS connects users to additional care when needed, leading to healthier mothers and babies. (Credit: Jacaranda Health)

> "AI is most powerful when it augments, rather than replaces, human capacity."
> 
...
Stay tuned for next month’s *Humans of AI for Humanity* blog, featuring [Visilant](https://www.visilant.org/) 's Jordan Shuff and Nakul Shekhawat. For more on AI for good, subscribe to Fast Forward’s [AI for Humanity newsletter](https://aiforhumanity.substack.com/) and keep an eye out for updates from the [Patrick J. McGovern Foundation](https://medium.com/patrick-j-mcgovern-foundation).
