...
A recent study shows that when brands display logos in their email communications it can boost open rates and interaction levels, that according to a new survey released today by [Red Sift](https://go.redsift.com/bimi-whitepaper.html) in partnership with [Entrust](https://www.entrust.com/), a leader in identity, payments and data protection. This echoes findings publishied by the BIMI working group stating “Companies like Verizon Media, which owns Yahoo Mail, have seen an [increase in engagement by an average of 10%](https://www.youtube.com/watch?v=ElfUC7s2MyU) when inboxes display logos next to email messages.”

This survey of over 1,000 U.S. and U.K. adults looked at consumer interaction when brands are able to display their logos in an email inbox consistent with the [Brand Indicators for Message Identification](https://bimigroup.org/) (BIMI) standards for displaying validated registered logos. The survey found that among consumers, the inclusion of a registered logo using BIMI standards:
