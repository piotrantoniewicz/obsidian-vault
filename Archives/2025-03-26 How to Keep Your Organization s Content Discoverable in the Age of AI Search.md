...
[Search intent](https://moz.com/learn/seo/search-intent) is the *why* behind the user’s motivation. Are they trying to learn, navigate, compare, or buy?
...
Google first introduced this concept as “EAT” in 2018, then [added the second “E” (for Experience) in 2022](https://developers.google.com/search/blog/2022/12/google-raters-guidelines-e-e-a-t). These days, *Authoritativeness* is especially critical to capturing AI search attention. Recent algorithm updates favor content with credible authors with robust bios.
...
- Courses
- Local businesses
- And more (see [Google’s full list](https://developers.google.com/search/docs/appearance/structured-data/search-gallery))
...
Site performance continues to be a critical factor in ranking at the top of organic search results, and AI overviews often reference the top-ranking pages. Improving [Core Web Vitals](https://web.dev/articles/vitals#core-web-vitals) is a solid strategy for both users and bots.
...
At Alley, we’re always adapting to stay ahead of the curve, and we’re here to help you do the same. As the internet evolves, your content strategy should evolve with it. Want to talk more about making your site future-ready? [Let’s chat](https://alley.com/contact/)!
