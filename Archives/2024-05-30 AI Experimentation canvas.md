...
[Sitemap](https://medium.com/sitemap/sitemap.xml)## [CAST Writers](https://medium.com/we-are-cast?source=post_page---publication_nav-12ab6767bfef-ddddeae34ad0---------------------------------------)

[![CAST Writers](https://miro.medium.com/v2/resize:fill:76:76/1*WDcwHUunO4LwRps28x6BWA.png)](https://medium.com/we-are-cast?source=post_page---post_publication_sidebar-12ab6767bfef-ddddeae34ad0---------------------------------------)
...
![Image of the AI experimentation canvas](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*lQMRe_RTfiVi_e6L)

Image of the AI experimentation canvas

It’s a simple canvas that helps us think through any use of GenAI. As the test or practice becomes bigger, so we might use a more detailed version to document and think through the approach. We’ve got a [Miro version](https://miro.com/app/board/uXjVKB87BLA=/?share_link_id=120786865247) that is easy to edit, and [printable versions](https://docs.google.com/document/d/1_fOiaT9F-8IP1YNzdhCiS-HAsXBnZ_pX5NyzJ8_Yyu8/edit?usp=sharing) if Post-its and Sharpies are your style.
...
## Get Dan Sutch’s stories in your inbox
...
If you have any reflections, additions or challenges to this canvas — please share them so we can improve it; please contact [hello@wearecast.org.uk](mailto:hello@wearecast.org.uk).
...
*We’ve put together a* [*living library of AI resources*](https://www.wearecast.org.uk/our-work/free-digital-resources/ai-resources/) *that we hope will support you as you explore the challenges and opportunities associated with AI. Please take a look — and do let us know if there is anything you need particular support with.*

![AI transparency statement showing this article was written using spell and grammar check](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*_p7GSF2ruf3AVLtcjv83rQ.png)

AI transparency statement showing this article was written using spell and grammar check

[![CAST Writers](https://miro.medium.com/v2/resize:fill:96:96/1*WDcwHUunO4LwRps28x6BWA.png)](https://medium.com/we-are-cast?source=post_page---post_publication_info--ddddeae34ad0---------------------------------------)

[![CAST Writers](https://miro.medium.com/v2/resize:fill:128:128/1*WDcwHUunO4LwRps28x6BWA.png)](https://medium.com/we-are-cast?source=post_page---post_publication_info--ddddeae34ad0---------------------------------------)

[Last published Feb 11, 2026](https://medium.com/we-are-cast/lo-fi-ai-7-small-experiments-with-ai-agents-27ec00434afb?source=post_page---post_publication_info--ddddeae34ad0---------------------------------------)
