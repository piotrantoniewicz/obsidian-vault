...
**Stan (2026-08-25):** workflow zrealizowany jako plugin Cowork `artykuly-ngo` (5 komend: `/radar` → `/brief` → `/pisz` → `/redakcja` → `/dystrybucja`). Cztery artykuły opublikowane: nr 1 „Połowa Twojego zespołu już używa AI" (23.06, LinkedIn 26.06), nr 2 „Luka governance w AI" (09.07, LinkedIn 13.07), nr 3 „AI Act przesunięty? Nie tam, gdzie myślisz" (23.07, LinkedIn 24.07), nr 4 „Sekretarz, nie decydent: kodeks etyczny AI dla organizacji społecznych" (13.08). Kolejny cykl (nr 5) zaplanowany na 27.08 wg `PUBLIKACJE.md`, temat do wyboru z backlogu — zacząć od `/artykuly-ngo:radar`.
...
- [x] Cykl nr 4 — artykuł „Sekretarz, nie decydent: kodeks etyczny AI dla organizacji społecznych" opublikowany 13.08; post LinkedIn i ingest do vaultu jeszcze niepotwierdzone w `PUBLIKACJE.md`, do sprawdzenia
- [ ] Cykl nr 5 — zaplanowany na 27.08; temat do wyboru z backlogu, start od `/artykuly-ngo:radar`
...
- Artykuł nr 4: [Sekretarz, nie decydent: kodeks etyczny AI dla organizacji społecznych](https://publicystyka.ngo.pl/sekretarz-nie-decydent-kodeks-etyczny-ai-dla-organizacji-spolecznych) (2026-08-13) · post LinkedIn i ingest do vaultu do potwierdzenia
...
- 2026-08-25 — odświeżenie stanu: artykuł nr 4 opublikowany 13.08 (karta o tym nie wiedziała); `PUBLIKACJE.md` planuje już cykl nr 5 na 27.08. Rytm dwutygodniowy utrzymany mimo poślizgu cyklu 4.
