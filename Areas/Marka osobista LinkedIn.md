...
## Kadencja przeglądu
Tygodniowo — czy 3 posty opublikowane i rutyna dzienna trwa. Miesięcznie — analiza wyników postów w Notion → nadpisanie `insights-miesiac.md` (+ przepakowanie zip i podbicie wersji pluginu), kontrola SSI (linkedin.com/sales/ssi) i licznika kontaktów, przegląd „Sugerowanych postów" jako testu, czy algorytm przypisuje profil do „AI + organizacje społeczne".
