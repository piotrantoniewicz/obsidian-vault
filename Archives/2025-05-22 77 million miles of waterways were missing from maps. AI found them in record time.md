...
![A bridge over a large waterway leading to a village in Gahira, Rwanda.](https://i.insider.com/682b441a68a292900801ae46?width=400&format=jpeg&auto=webp)

Bridges to Prosperity has helped the Rwandan government complete over 200 bridges, including this trail bridge in Gahira. Courtesy of Bridges to Prosperity/Robb Hohmann
...
Many rural waterways, especially the smaller streams and rivers that isolate entire villages during the rainy season, had not yet been mapped by governments or businesses. After analyzing 5,000 waterways around the world, the organization found that [38% of streams and rivers weren't on any existing maps](https://medium.com/fika-blog/waternet-ai-powered-global-water-mapping-triples-known-waterways-bc3095783661).
...
Bridges to Prosperity turned to [artificial intelligence](https://www.businessinsider.com/chatgpt-openai-ai-dictionary-help-understand-nvidia-2023-12) to fill the data gap. First, it built Fika Map, an AI tool that identifies locations where bridges could be built and estimates construction costs, among other capabilities. "Fika" means "to arrive" in Swahili.

The NGO also teamed up with Better Planet Laboratory to create WaterNet, an [AI model](https://www.businessinsider.com/artificial-intelligence-robotics-predictive-maintenance-manufacturing-factory-solutions-2025-5) that maps the world's waterways. They used satellite data to detect elevation and vegetation patterns, which the AI model then analyzed to approximate the location of waterways.

Bridges to Prosperity is using these programs with governments in Rwanda, Ethiopia, Uganda, and Zambia to help plan bridge [construction](https://www.businessinsider.com/ai-for-worker-site-safety-in-construction-2025-4) and improve infrastructure across the countries.

![Nivi Sharma](https://www.businessinsider.com/www.w3.org/2000/svg'%20width='1'%20height='1'/%3E)

Nivi Sharma is the CEO of Bridges to Prosperity. Courtesy of Bridges to Prosperity/Shotbygib
...
It also used data from less conventional sources, like the fitness tracking app [Strava](https://www.businessinsider.com/guides/tech/what-is-strava), to calculate travel times over uneven terrain.
...
The two types of data can be combined to build accurate maps — but they come with a cost. Temimi said that [satellite data](https://www.businessinsider.com/albedo-satellite-space-funding-round-2025-4) is usually collected by commercial sensors, so getting the information can be expensive.
...
"The whole argument around AI and its inclusiveness — it's not built with enough good training data," Sharma said. "It often overlooks the entire Global South, which is obviously what we're trying not to do. But that's the expensive part."

![The dashboard for Fika Map](https://www.businessinsider.com/www.w3.org/2000/svg'%20width='1'%20height='1'/%3E)

Fika Map uses geographical data to map rural regions and identify infrastructure gaps. Courtesy of Bridges to Prosperity
