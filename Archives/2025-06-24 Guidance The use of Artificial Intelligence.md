...
For staff and freelancers working for the BBC, it should be read alongside the [BBC's AI Handbook: How to Use AI Responsibly](https://staff.bbc.com/gateway/responsible-ai/handbook-overview/) which outlines key non-editorial issues to be considered and the processes which must be followed by all users of AI.
...
Artificial intelligence can be defined as a machine-based system that performs tasks commonly associated with human intelligence, including making content, predictions and/or decisions.
...
Any external AI tools used must normally be authorised in line with existing BBC software authorisation or procurement processes before being used. A full list of authorised tools can be found on the [Responsible AI site on Gateway](https://staff.bbc.com/gateway/responsible-ai/).
...
Whenever these techniques are used they should be signalled to the audience in an appropriate manner in line with the [BBC's AI Transparency advice](https://staff.bbc.com/gateway/responsible-ai/handbook/transparency/).

### Synthesised audio

The use of either synthesised or cloned audio raises particular opportunities and challenges for audience facing content.

It should not normally be used to clone the voice of another, real, individual without consent unless there is strong editorial justification, and its use does not risk materially misleading audiences or create a 'false history'.
...
However, it may be possible to use either cloned or synthesised voices where editorially justified, both context and transparency can be included, and there is no risk of materially misleading audiences.

Synthetic audio may also be used to anonymise the voices of contributors where editorially justified. There may also be other non-editorial considerations, such as rights issues, and contractual obligations to take into account. Editorial Policy should be consulted.

At all times any use of synthetic voices - not of a real person - must be clearly disclosed to avoid the risk of it being taken out of context and presented as genuine either on our own platforms or third party platforms. This is particularly the case when it is being used in audio content rather than video.

Audio editing functionality must not be used to materially mislead audiences. These are particular risks in news, current affairs or factual journalism. For example, it may be used to 'de-umm' or edit interviews for clarity, it may also be used to improve the technical quality of any recording that might otherwise be difficult to hear.

However, audio editing functionality should not be used to alter the meaning of the content – for example by creating audio that was not originally recorded, including using edit smoothing tools that work by revoicing a phrase that would otherwise contain a noticeable edit.
...
But using AI to direct news or current affairs content, where it may challenge or create the perception of a challenge, to our editorial independence and integrity, should be avoided. An example of that would be using it to provide questions for interviews, because there is a risk that an AI generated line of questioning is not based human reasoning and could be biased. Reliance on using AI in this way can risk increasingly homogenous output and undermining editorial skills.

Inaccuracy and bias remain a risk in all AI output and it should not be relied on as a research tool. Any use of generative AI or AI driven tools must be actively monitored and outcomes must be further assessed by human editorial oversight before it is employed in BBC content.
...
Similarly any use of transcription or translation technologies requires careful human editorial oversight.
...
BBC producers must also be mindful of the use of AI or synthetic media in material from external sources being used as part of BBC content for example in user generated content. They must always authenticate user generated content carefully and may consult experts in the UGC Hub/ BBC Verify.
