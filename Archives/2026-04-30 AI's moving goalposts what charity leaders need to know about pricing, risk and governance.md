...
type: "Web"
authors: "[[Zoe Amar]]"
url: "https://zoeamar.com/2026/04/30/ai-governance-risk-charity-leaders/"
...
[![A vintage typewriter with a sheet of paper reading 'Artificial Intelligence' in bold capital letters](https://sp-ao.shortpixel.ai/client/to_webp,q_glossy,ret_img,w_1024/https://zoeamar.com/wp-content/uploads/2025/10/typewrite-image-AI-1024x669.jpg)](https://zoeamar.com/wp-content/uploads/2025/10/typewrite-image-AI.jpg)
...
In case you missed it, last week [Claude tested removing Claude Code from its Pro Plan](https://arstechnica.com/ai/2026/04/anthropic-tested-removing-claude-code-from-the-pro-plan/). The change was tested on a small number of new signups and wasn’t rolled out to existing users, but the backlash was immediate.

Commenting on the test, Amol Avasare, Anthropic’s head of growth, [said on social media](https://arstechnica.com/ai/2026/04/anthropic-tested-removing-claude-code-from-the-pro-plan/) that their current pricing plans simply don’t work for a world where agents are becoming part of everyday workflows. I get that developing these models requires huge investment and the ways in which these technologies are being used is becoming more intensive and complex. So what effect could these new pricing models, and the dependency on AI we are seeing, have on the charity sector?

### Why this matters

One of my favourite podcasts is [The Artificial Intelligence Show](https://www.marketingaiinstitute.com/the-ai-show). Hosts Paul Roetzer and Mike Kaput have talked in recent episodes about how some AI tools are moving away from the traditional SaaS (software as a service) model of buying licenses for individual users to paying for ‘metered’ usage. Hence the pushback when some Claude users found last week that they would have to upgrade to the Max plan, which is five times more expensive.

I get why some tech companies are doing this. The prohibitive cost of developing the model and keeping up with the surge in demand is like scaling on steroids. When Anthropic refused to allow Claude to be used for mass surveillance or autonomous weapons – and the US government responded by blacklisting it- users flooded in from OpenAI in protest. Claude’s [paid users’ doubled](https://techcrunch.com/2026/03/28/anthropics-claude-popularity-with-paying-consumers-is-skyrocketing/) and it [jumped to number one on the US App Store,](https://mashable.com/article/claude-overtakes-chatgpt-in-apple-app-store#:~:text=In%20the%20battle%20for%20AI,Google's%20Gemini%20a%20distant%20fourth.) overtaking ChatGPT. I’ve heard that one of the assumptions behind the pricing is that organisations may be employing fewer people in the future, hence the move away from pricing based on headcount and licenses.

What does this mean for charities? We know from our interim findings from [The Charity Digital Skills Report](https://charitydigitalskills.co.uk/) that 88% of charities are now using AI, up from 76% last year. We will know the full extent of how and why charities are using AI once we launch the report in July. Yet behind these numbers there is a story of how dependent we are all becoming on these technologies. That’s not in itself a bad thing, as long as charities plan for the risks and opportunities that come with this, and budget accordingly. Which is not easy if the goalposts are moved.
...
We know from [The Charity Digital Skills Report](https://charitydigitalskills.co.uk/) that it is hard for charities to secure funding for digital infrastructure and core costs. I would love it if funders reconsidered this, with a fresh eye on how tech companies may change pricing at a moment’s notice.
...
I saw a great example of this recently when [an AI agent deleted a company’s database and backups](https://www.euronews.com/next/2026/04/28/an-ai-agent-deleted-a-companys-entire-database-in-9-seconds-then-wrote-an-apology), leaving car rental customers stranded. When challenged, the agent said: “I violated every principle I was given.”
...
As if all that wasn’t enough, two other stories this week have implications for charities: the [ICO’s consultation on automated decision-making guidance](https://ico.org.uk/about-the-ico/ico-and-stakeholder-consultations/2026/03/ico-consultation-on-the-draft-guidance-about-automated-decision-making-including-profiling/), which closes on 29 May, and its [AI Code of Practice](https://www.localgovernmentlawyer.co.uk/information-law/398-information-law-news/60311-ico-announces-new-statutory-code-to-regulate-ai-in-public-and-private-sector/), which Parliament has now formally mandated- so while the ICO still has to draft and consult on it, this one is moving forward. From a quick look at both, there are implications for charities using automation to make decisions, and there may be new responsibilities around what human review of AI outputs and decisions looks like. I’d encourage charities to respond to the consultation and to keep a close eye on the Code of Practice as it develops.
...
## Be the first to hear about new blogs and sector updates
