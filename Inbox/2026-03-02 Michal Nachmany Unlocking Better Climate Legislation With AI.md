...
![Michal Nachmany: Unlocking Better Climate Legislation With AI](https://cdn.sanity.io/images/4cwcet86/production/93dfe5e6230ba4308ee3e9c4113aa4a34c417732-2000x1000.png?rect=111,0,1778,1000&w=1778&h=1000&q=70&auto=format)
...
Dr. Michal Nachmany saw this problem and decided to build a solution. As the founder and CEO of [Climate Policy Radar](https://www.climatepolicyradar.org/), she leads a team that uses machine learning and generative AI to clean and organize climate legislation data across geographies and jurisdictions. It’s an approach that combines human intelligence with artificial intelligence. But Climate Policy Radar is more than just a one-stop shop for research and knowledge sharing. It’s rooted in a commitment to justice. Climate change disproportionately impacts marginalized communities and Climate Policy Radar ensures they have free and open access to the information they need to combat it.
...
![Michal Nachmany: Unlocking Better Climate Legislation With AI – Fast Forward – Where Tech Meets Social Impact](https://cdn.sanity.io/images/4cwcet86/production/f35d0ac17fc2125078d5df09a09e40788bb445e6-1646x918.svg?q=70&auto=format)
...
Stay tuned for next month’s *Humans of AI for Humanity* blog. For more on AI for good, subscribe to Fast Forward’s [AI for Humanity newsletter](https://aiforhumanity.substack.com/) and keep an eye out for updates from the [Patrick J. McGovern Foundation](https://medium.com/patrick-j-mcgovern-foundation).
