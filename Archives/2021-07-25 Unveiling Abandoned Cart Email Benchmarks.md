...
When a visitor to your ecommerce website browses and adds an item or products to their cart, but exits the website without making a purchase, this is referred to as an [abandoned cart](https://flowium.com/blog/abandoned-cart-email-strategy/ "abandoned cart").

An [abandoned cart email](https://www.google.com/url?q=https://flowium.com/blog/abandoned-cart-email-strategy/&sa=D&source=docs&ust=1723742882664570&usg=AOvVaw0q_Qz3U9a1xQgDmOGmMe0R) is a message that aims to recover some of this potentially lost profit by reminding subscribers about items in their carts or providing enticing offers. In most cases, this campaign is set as an automation if you use [email marketing software](https://www.google.com/url?q=https://flowium.com/blog/abandoned-cart-email-software/&sa=D&source=docs&ust=1723742882665631&usg=AOvVaw3wyARk4CBBbUFKlglQ3fEl).

![](https://flowium.com/wp-content/uploads/2024/08/abandoned-cart-email-example-columbia-1.png)
...
Verify that your industry’s average [cart abandonment rate](https://flowium.com/blog/average-cart-abandonment-rate/ "cart abandonment rate") is met before devising a cart abandonment email plan.
...
The following are [average cart abandonment rates](https://www.google.com/url?q=https://flowium.com/blog/average-cart-abandonment-rate/&sa=D&source=docs&ust=1723742882664857&usg=AOvVaw3AmUfOCRxmD8MaoYXk5npO) by industry:
...
- Average: 50.5%
- Top: 65.3% (Source: “The abandoned cart benchmarks report” by [Klaviyo](https://www.google.com/url?q=https://flowium.com/lp/klaviyo-agency/&sa=D&source=docs&ust=1723742882665402&usg=AOvVaw1nQDNXQMizj1A_1BPjQCvs))
...
***Conversions for abandoned cart [email automation](https://flowium.com/blog/email-automation/ "email automation")***:
...
When your email’s content and call-to-action have a [click-through rate](https://www.google.com/url?q=https://flowium.com/blog/ways-to-improve-email-click-through-rate/&sa=D&source=docs&ust=1723742882665893&usg=AOvVaw3FuFDv1cjZQNaiOOM1UGu9) (CTR) of 10% to 20%, it is clear that recipients are compelled to act. This number is important because it shows you how well your email’s layout and content drive visitors back to their abandoned carts, which increases the chance that lost transactions will be made.
...
| Average | Single email | Two-email series | Three-email series |
| --- | --- | --- | --- |
| **Open rate** | 62.94% | 48.65% | 46.11% |
| **Click rate** | 14.53% | 11.83% | 10.69% |
| **Revenue per recipient** | $10.75 | $8.28 | $5.52 |
| **Overall revenue** | $3.88 million | $16.4 million | $24.85 million |
...
1. **Feature the Abandoned Product**
...
1. **Address the Reason for Abandonment**
...
By familiarizing yourself with the **abandoned cart email benchmarks**, you can assess whether your email campaign is yielding the desired results or needs to be adjusted. You can pinpoint areas for development and enhance your approach to more effectively recover lost sales and optimize revenue by comparing your performance to these standards. If you need help in maintaining the efficacy and alignment of your [email marketing](https://www.google.com/url?q=https://flowium.com/lp/our-services/&sa=D&source=docs&ust=1723742882666130&usg=AOvVaw15N33R-Vwp9UqCH6uxTSl0) with your business objectives, [contact Flowium](https://flowium.com/lp/contact/) for professional services.

50 Ideas To Grow Your Email List
