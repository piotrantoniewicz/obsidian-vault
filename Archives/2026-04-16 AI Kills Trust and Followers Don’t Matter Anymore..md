...
type: "Web"
authors: "[[Ryan Davis]]"
url: "https://people1st.substack.com/p/ai-kills-trust-and-followers-dont?utm_medium=email&_hsenc=p2ANqtz-9idLoHgOlBXlNLVQJGy_fKMqq6cNic6A5AJratx6NP6vajIRJ9BHr4TlTUS1HSSWL4mSbaiEYqJhdG3tYP6PIWFT4Hv4Jvhd9vxKGIdINEgP3qPaU&_hsmi=136128316&utm_content=136128316&utm_source=hs_email"
...
The AAPC Foundation’s *[Disclaimer Effect](https://aapcfoundation.org/wp-content/uploads/2026/03/AAPCF_DisclaimerEffect_Summary.pdf)* [study](https://aapcfoundation.org/wp-content/uploads/2026/03/AAPCF_DisclaimerEffect_Summary.pdf) delivers a pretty simple takeaway: AI disclaimers hurt trust. When viewers see a disclaimer, they don’t feel informed, they get skeptical. In testing, trust dropped the moment the disclaimer appeared, even when the ad itself hadn’t changed. In other words, disclosure doesn’t just signal transparency, it can actively weaken your message.
...
![X avatar for @pmddomingos](https://substackcdn.com/image/fetch/$s_!4XGN!,w_40,h_40,c_fill,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fpbs.substack.com%2Fprofile_images%2F1775309922621890560%2FmgkCUe3q.jpg)

Pedro Domingos@pmddomingos

“Made without AI” is the new prestige label.

8:50 PM · Apr 14, 2026 · 79 TYS. Views

---

181 Replies · 926 Reposts · 5,59 TYS. Likes

](https://x.com/pmddomingos/status/2044126244003033429?s=20)

The actionable takeaway is straightforward: avoid putting yourself in a position where your ads feel AI-generated in the first place. The easiest way to do that is to use real people. [Creator-led content naturally signals authenticity,](https://www.brandsafetyinstitute.com/blog/ai-content-creator-matters) and it reduces both the need for AI production and the risk of triggering skepticism or regulatory flags.
...
In one of 2025’s best film’s, [Eddington](https://www.youtube.com/watch?v=oL6jZqExlIk&t=1s), you’ve got people living in the same small town, walking the same streets, but existing in completely different realities because of what they see online. That’s not fiction, that’s the internet in 2026. Nobody sees the same internet as you. Feeds are no longer shared spaces, they’re individually constructed environments, shaped in real time by behavior, interests, and algorithmic prediction.

And the data backs it up. Platforms have fully shifted from follower-based distribution to [algorithmic discovery.](https://www.sprinklr.com/blog/social-media-algorithm/) In 2026, feeds are driven by AI models that prioritize watch time, shares, and predicted relevance over who you follow. TikTok led this shift, but Instagram, YouTube, and even LinkedIn now operate the same way. The result: a creator with zero followers can outperform someone with a million if the content hits. At the same time, average organic reach has collapsed. [Many accounts now reach only 3–5% of their followers,](https://influenceflow.io/resources/engagement-rate-and-reach-metrics-the-complete-2025-guide-for-creators-and-brands/) with reach down 15–20% year over year.

That’s the key disconnect: follower count ≠ distribution. In fact, most creators can’t even reliably reach their own audience anymore. [Over half of creators say](https://www.vogue.com/article/unpacking-the-creator-economy-battleground) it’s harder to reach their followers today than it was just a few years ago, because platforms are prioritizing recommended content over followed content. Algorithms are deciding what gets seen, not social graphs. And because those algorithms are personalized, two people can follow the same accounts and see entirely different feeds.
