...
The following report and findings are from [Bloomerang's Giving Signals Report for 2026](https://bloomerang.com/resources/giving-signals-report-2026).
...
Research shows that [77% of recurring donors say they want ongoing support for causes they care about, and 58% start giving without being directly asked](https://bloomerang.com/resources/giving-signals-report-2026). Visibility of "important work" triggers many recurring gifts more than aggressive solicitation.
...
A significant gap remains: [57% of surveyed fundraisers had varied giving options available to present, while 37% did not](https://bloomerang.com/resources/giving-signals-report-2026). [Recurring giving](https://bloomerang.com/blog/monthly-giving) is especially important as donor acquisition slows because it sustains operations between campaigns.

For upgrade pathways, [see Bloomerang's guide to upgrading nonprofit donors](https://bloomerang.com/blog/monthly-giving).

### Deepen donor relationships for sustained engagement

Donors who feel personally connected to a nonprofit's mission give more often, give larger amounts, and stay loyal longer. Relationship depth is the most cost-effective fundraising investment because [retained donors increase lifetime value by up to 18%](https://bloomerang.com/resources/giving-signals-report-2026).

[Donor retention rates average about 31.9%, meaning roughly 7 out of 10 donors give once and never return. First-to-second gift conversion has dipped to 25.84%](https://bloomerang.com/resources/giving-signals-report-2026), making early stewardship essential.

A four-step relationship framework helps nonprofits retain donors:

1. **Welcome series** — Send a [personalized thank-you within 48 hours](https://bloomerang.com/blog/thank-letters-springboard-donor-retention) and a "what your gift accomplished" update within 30 days.
...
[Learn more through Bloomerang's donor engagement strategies](https://bloomerang.com/blog/donor-engagement).
...
[The top 10% of prospects identified through behavioral signals are about 3.33 times more likely to donate than a random audience](https://bloomerang.com/resources/giving-signals-report-2026).
...
For database guidance, [see Bloomerang's donor management best practices](https://bloomerang.com/crm/).
...
Donor fatigue is the single greatest threat to sustainable fundraising in 2026, with [87% of organizations reporting it as a problem](https://bloomerang.com/resources/giving-signals-report-2026). The solution is not simply fewer asks; it is more meaningful non-ask touchpoints.

Events also create conversion opportunities: [64% of nonprofit auction attendees said they were likely to become recurring donors](https://bloomerang.com/resources/giving-signals-report-2026). Nonprofits should frame events as pathways into sustained support and optimize post-event stewardship.

A practical campaign target is to convert 10–15% of an audience or 100 new monthly donors per campaign. For event-based retention tactics, [see Bloomerang's guide to boosting donor retention through fundraising events](https://bloomerang.com/blog/donor-retention-math-made-simple).
...
- **Individual major gifts** — Major gifts are central to a pivot toward individual giving and reduced government reliance.
- **Recurring donor programs** — Recurring gifts are predictable and scalable.
- **Corporate partnerships** — [Corporate giving reached $44.4 billion, a year-over-year increase of over 9%](https://bloomerang.com/resources/giving-signals-report-2026).
- **Workplace giving and employee-led programs** — Workplace giving expands and diversifies donor pipelines.
- **Foundation grants and DAFs** — [Family offices distributing over $1 million annually rose from 23% to 36% over the past decade](https://bloomerang.com/resources/giving-signals-report-2026).
- **Events and peer-to-peer campaigns** — Events should be conversion-focused, not just revenue-focused.
...
For major gifts guidance, [see Bloomerang's major gift fundraising strategies](https://bloomerang.com/blog/major-donors).
...
Notably, [71% of family foundations spend above the mandatory 5% minimum payout](https://bloomerang.com/resources/giving-signals-report-2026), indicating that foundation-connected donors are motivated by impact beyond minimum requirements.

[Fundraisers rated their readiness to make proposals at 3.7 out of 5 on average](https://bloomerang.com/resources/giving-signals-report-2026), highlighting a training opportunity. For research-based approaches, [see Bloomerang's modern fundraising strategies](https://bloomerang.com/fundraising/).
...
- [**Bloomerang CRM**](https://bloomerang.com/crm/) — Centralizes donor history, engagement scores, and communication preferences.
- **Online giving forms** — Support mobile giving, multiple payment types, and fee transparency.
- [**Email automation**](https://bloomerang.com/features/marketing-and-engagement/) — Powers welcome series, re-engagement campaigns, and thank-you sequences.
- [**AI-powered insights**](https://bloomerang.com/ai) — Supports predictive scoring, lapsed-donor identification, and wealth screening.
...
For CRM capabilities, [explore Bloomerang's donor management solutions](https://bloomerang.com/crm/).
...
A fundraising message is a targeted communication that states a nonprofit need, quantifies the donor's potential impact, and provides a clear path to donate. Research shows that [75% of donors seek concrete impact information before deciding to give](https://bloomerang.com/resources/giving-signals-report-2026).
...
Next-generation donors expect channel integration and a seamless, data-driven giving experience. For multi-channel guidance, [see Bloomerang's nonprofit fundraising strategies for donor engagement](https://bloomerang.com/blog/donor-engagement).
...
Fee strategy should fit within a broader fundraising strategy focused on trust, clarity, and donor choice. For more context, [see Bloomerang's fundraising strategy guidance](https://bloomerang.com/fundraising/).
