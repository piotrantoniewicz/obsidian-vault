...
![blog-sektor30woven](https://sektor3-0.pl/wp-content/uploads/elementor/thumbs/blog-sektor30woven-1-qdycmipb4c7lb57nybb9ys2r3hjmv1j6wiaki2bv5i.jpg "blog-sektor30woven")
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201024%20465'%3E%3C/svg%3E)
...
Istnieje wiele metodologii pracy z zadaniami. Ja najbardziej lubię [Getting Things Done](https://pl.wikipedia.org/wiki/Getting_Things_Done), czyli tzw. sztukę bezstresowej produktywności, która sugeruje trzy ścieżki do pracy z danym zadaniem:

- **Zrób to**: jeżeli do wykonania danego zadania potrzebujesz mniej  
	niż 2 minuty – zrób to od razu.
- **Oddeleguj**: może się okazać, że aktualne zadanie nie jest w zakresie twoich kompetencji, albo po prostu jest ktoś, kto może to zrobić lepiej. W takim przypadku przekaż zadanie innej osobie.
...
- **Pracuj nad jednym zadaniem i staraj się na nim maksymalnie skupić** (multitasking na dłuższą metę naprawdę nie zdaje egzaminu!). W utrzymaniu koncentracji mogą ci pomóc aplikacje takie jak [Noisili](https://www.noisli.com/) czy [Forest](https://www.forestapp.cc/), a także metoda [Pomodoro](https://pl.wikipedia.org/wiki/Technika_Pomodoro), pomagająca pracować w określonych blokach czasowych i przypominająca o robieniu przerw.
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201024%20916'%3E%3C/svg%3E)

![](https://www.youtube.com/watch?v=8n2vL2I__WY)

**Automatyzuj proces**

Jeżeli wykonanie jakiegoś powtarzającego się zadania wymaga użycia kilku aplikacji, możesz stworzyć tzw. *workflow* – automatyczny proces, który wykona za ciebie poszczególne kroki. Pomogą ci w tym narzędzia takie jak [IFTTT](https://ifttt.com/) czy [Zapier](https://zapier.com/), za pomocą których możesz ustawić łańcuch wywołujący konkretne akcje w konkretnych aplikacjach.

Przykładowe procesy:

- Jeśli wspólnie z zespołem obsługujesz skrzynkę pocztową i chcecie lepiej zorganizować proces obsługi zapytań: [Stwórz nową kartę w Trello, kiedy pojawi się e-mail z zapytaniem od klienta](https://zapier.com/apps/gmail/integrations/trello/91/create-trello-cards-from-new-gmail-threads) albo nowa [wiadomość na Messengerze.](https://zapier.com/apps/facebook-messenger/integrations/trello/53610/create-trello-cards-from-new-facebook-page-messages)
- Jeśli „wyklikiwanie” wydarzeń w Kalendarzu Google jest dla Ciebie męczące: [Wygeneruj wydarzenia w Kalendarzu Google bezpośrednio z danych ze skoroszytu w Google.](https://zapier.com/apps/google-calendar/integrations/google-sheets/138/generate-google-calendar-events-from-new-google-sheets-rows)
- Kiedy zajmujesz się obsługą mediów społecznościowych i chcesz stworzyć raport z podsumowaniem opublikowanych postów: [Zapisz nowy post ze strony na Facebooku w skoroszycie Google.](https://zapier.com/apps/facebook-pages/integrations/google-sheets/3823/save-new-facebook-page-posts-to-google-sheets)
- Jeśli chcesz stworzyć listę e-mailingową z adresów osób wypełniających rekrutacyjny na szkolenie: [Stwórz lub aktualizuj subskrybentów listy mailingowej z Formularza Google.](https://zapier.com/apps/google-forms/integrations/mailchimp/11009/create-or-update-mailchimp-subscribers-from-new-google-forms-submissions)
- Kiedy chcesz na bieżąco tworzyć zestawienie zamówień ze sklepu internetowego (np. dla osób z zespołu, które nie mają wglądu do systemu sklepu): [Zapisz nowe zamówienie z WooCommerce do skoroszytu Google.](https://zapier.com/apps/google-sheets/integrations/woocommerce/3142/save-new-woocommerce-orders-to-google-sheets-rows)
- Kiedy chcesz podzielić się z zespołem ciekawymi treściami: [Zapisz w Feedly artykuł jako “Read later”, aby wysłać go automatycznie na kanał zespołu na Slacku](https://zapier.com/apps/feedly/integrations/slack/3186/share-feedly-saved-articles-in-slack) albo [automatycznie utwórz kartę w Trello z artykułu zapisanego w Pockecie](https://zapier.com/apps/pocket/integrations/trello/1680/create-trello-cards-for-new-tagged-pocket-items).

[![zapier](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201024%20920'%3E%3C/svg%3E)](https://zapier.com/apps/facebook-pages/integrations/google-sheets/3823/save-new-facebook-page-posts-to-google-sheets)
...
1. Zapisuj: nie trzymaj informacji o zadaniach w głowie – „odciążysz” ją, zapisując informacje w ulubionej aplikacji lub na papierze.
2. Segreguj: przygotuj „szufladki”/ listy zadań i „odkładaj” zadania na swoje miejsce – dzięki temu jeden rzut oka pozwoli ci ocenić, co masz do zrobienia i ile zajmie ci to czasu.
3. Automatyzuj: spraw, aby powtarzalne zadania wykonywały się same.
...
- [Pracowaliśmy zdalnie w zespole rozproszonym zanim to było modne – jak działa Stowarzyszenie LABiB?](https://sektor3-0.pl/blog/pracowalismy-zdalnie-w-zespole-rozproszonym-zanim-to-bylo-modne-jak-dziala-stowarzyszenie-labib/)
- [Z kanapy na Mokotowie czy leżaka w Tajlandii – jak pracować zdalnie?](https://sektor3-0.pl/blog/z-kanapy-na-mokotowie-czy-lezaka-w-tajlandii-praca-zdalna/)
- [Cyfrowe biurko trenera – jak ogarnąć chaos pracy twórczej](https://sektor3-0.pl/blog/cyfrowe-biurko-trenera-jak-ogarnac-chaos-pracy-tworczej/)
