...
## Why Funders Freeze on AI — and How to Break the ParalysisJared Chung Founder and Executive Director, CareerVillage.org
...
So how should funders evaluate AI projects? Here’s what we’ve learned on the front lines at [CareerVillage.org](https://www.careervillage.org/), where we’ve been implementing AI systems for years to help job seekers navigate the changing labor market.
...
Other nonprofits are seeing the same pattern. Take [Tarjimly](https://www.tarjimly.org/), an AI-powered translation service. They’ve long measured their impact by how quickly refugees and asylum seekers receive translation support. That core metric hasn’t changed — but AI tools now allow them to deliver translations faster and at greater scale. The outcome is the same; the delivery is different.
