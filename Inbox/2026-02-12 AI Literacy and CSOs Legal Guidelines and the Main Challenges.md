---
type: "Web"
authors: "[[Jean-Francois Lucas]]"
url: "https://en.hive-mind.community/blog/1170,ai-literacy-and-csos-legal-guidelines-and-the-main-challenges"
...
- **Make informed decisions about the use of AI.** In practical terms, this means adopting responsible AI practices, both in how AI is used and how it is deployed. Today, much attention is given to the “greatness” of models, particularly those with hundreds of billions of parameters. However, the so-called “sweet spot” typically lies around 40–50 billion parameters. Models of this size are sufficient for most targeted use cases. Much like software, there is little value in paying for an entire suite if you only need a fraction of its features. As of July 1st 2026, the size of AI models becomes less relevant, as performance begins slowly to be more dependent on other factors, such as tools and integration.
...
[![](https://en.hive-mind.community/images/u/69cd04121ea0f.png)](https://docs.google.com/forms/d/e/1FAIpQLSccI8P5EFgT01Qi3JWdjEg7yRdVHUZSfqs60Oxybdg43eo3HQ/viewform)

---

Last updated on July 1st 2026 to reflect the latest developments. In terms of AI literacy, it's now important to also include knowledge on how AI systems now have better memory across interactions and can influence future outputs.
...
This piece of resources has been created as part of the [AI for Social Change](https://en.hive-mind.community/blog/1134,ai-for-social-change-skills-tools-community) project within TechSoup's [Digital Activism Program](https://en.hive-mind.community/blog/1052,resilient-connected-empowered-how-techsoups-digital-activism-program-supports-civil-society-worldwide), with support from [Google.org](https://www.google.org/).

AI tools are evolving rapidly, and while we do our best to ensure the validity of the content we provide, sometimes some elements may no longer be up to date. If you notice that a piece of information is outdated, please let us know at [content@techsoup.org](mailto:content@techsoup.org).
