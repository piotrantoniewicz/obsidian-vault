...
Jednak nie chciałam być częścią narracji, która daje proste odpowiedzi, która mówi: „musicie spojrzeć na to, zrobić tamto i będzie super”. Wokół tego wszystkiego jest za dużo elementów, które mają wpływ na różne czynniki. Poza tym problem pojawia się, kiedy mamy przekształcić taką wizję w działania. Często kończy się na wizjach, raportach, slajdach. A kluczem powinno przecież być wprowadzenie tego w życie i działania organizacji.
...
## Jak dzisiaj wygląda świat raportów? Wydaje się to już trendem, że dostajemy… raporty o trendach. Ich liczba potrafi przytłoczyć!

Na przełomie grudnia i stycznia jest prawdziwy boom. Na [ogólnodostępnym dysku Google](https://drive.google.com/drive/folders/1tDzUTGyjnBSAJbID7vwpVLCo8xdDqFIq), który prowadzi jedna z badaczek, jest ich setka, jeśli nie więcej. Przeglądając je, zaczynam zastanawiać się, czego w nich szukamy.
...
Oczywiście, że w zależności od miejsca, w którym jesteśmy, w którym jest nasza organizacja, czasami może nam się wydawać jakąś kompletną pieśnią przyszłości. Ale skoro ktoś zwraca na to uwagę, to znaczy, że ta przyszłość już zaistniała.

Chyba najlepiej byłoby traktować te raporty jako narzędzie do pobudzenia wyobraźni – by zastanowić się, jak te kierunki przyszłości mogły wyglądać, ale też zrozumienie pewnych tendencji, które się dzieją. Tego brakuje mi w niektórych raportach.

![](https://www.youtube.com/watch?v=DGV1F2haSho)
...
Są raporty, które wskazują właśnie, dlaczego coś się wydarzyło i jakie to może mieć potencjalne konsekwencje. Nawet jeśli wpływ danego trendu będzie ogromny to pojawia się pytanie, jak ma on się ma do naszego kontekstu, do naszego wyzwania i rozwiązania.

## Rozumiem, że nie wszystkie raporty powinniśmy czytać od deski do deski? Chyba lepiej wybrać to, co jest istotne dla nas, patrzeć przez nasz pryzmat?
...
Tak, to jest super refleksja. Rzeczywiście. Co śmieszne, nawet o tym nadmiarze informacji, który nam towarzyszy, pisano w nowych raportach. Czasem, jak przeglądam analizy, to nawet nie mam siły tego czytać, nie mam siły przez to przechodzić, nie rozumiem też jaką wartość mi to daje.

Jak rozpoznać dobry raport? Na co zwaracać uwagę?  
W dobrych raportach, nawet jeśli tego nie rozumiemy i nie zweryfikujemy tego, jest podana metodologia badawcza. Czyli po prostu: jak to było zrobione. Nawet w prostych słowach, na początku lub na końcu pada odpowiedź na pytanie, jak zostało to zebrane. To nam powie, czy nie są to aby tylko przeczucia jakiejś grupy osób od marketingu.

Kolejna dobra rzecz to, gdy raport pokazuje skąd się ten trend wziął. Czyli na przykład odwołuje się do badań pokazujących, że to wyszło ze zmian użytkowników i dlatego ten trend rośnie w siłę.  
Mam raporty, które czytam co roku i które zawsze były dobre. Nawet jeśli ich poziom trochę spadł, to trzymają go przez długi czas.

**Karolina Michałkowska poleca:**

- Accenture Song
- Newsletter: [trendwathing.com](https://www.trendwatching.com/subscribe)
- Newsletter: [creativedestruction.club](https://www.creativedestruction.club/)
- [IDEO i imaginable futures](https://www.imaginablefutures.com/learning-reimagined/)
...
Z jaką intencją chcemy przeglądać te trendy? Czego w nich szukamy? Dlaczego szukamy? Uważamy, że utknęliśmy, czy może szukamy inspiracji? A jeśli inspiracji – to do czego? Intencja jest kluczowa, musimy ją określić zanim sięgniemy po raport.
...
Nie korzystam z takich rozwiązań, z uwagi na to, że zajmuje się bardziej obserwowaniem zmian, niż stricte obserwowaniem trendów. Ciekawi mnie bardziej to, co jest na horyzoncie, te rzeczy, które jeszcze nie są duże, jeszcze nie są widoczne. One mogą być bardzo dużym potencjałem do wykorzystania, pokazują, w jakim kierunku może iść przyszłość. Nie stosuję narzędzi AI, bo wiem, że potrafię to wyłapać.

Choć jestem blisko technologii, to bardziej lubię patrzeć na zmiany społeczne. Przy wykorzystywaniu takich narzędzi na pewno trzeba sprawdzić, czy nie halucynują. Mam też obawę, że przy takiej pracy możemy iść po linii najmniejszego oporu: prosząc o wypisanie dziesięciu trendów i po prostu wziąć je za pewnik.

Jeśli Sztuczna Inteligencja radziłaby sobie dobrze z przesianiem raportów, to pewnie – można z niej korzystać. Zaznaczam jednak, że lepiej podchodzić do tego z dystansem. Dobrze wiemy, że dużo osób nie podchodzi krytycznie do tego, co wypluwa sztuczna inteligencja, a nie tędy droga.

## Cechy dobrych raportów

- **Metodologia** – podano konkretne dokumenty, linki i dane dotyczące prowadzonych badań lub liczb, na których raport się opiera.
- **Struktura** – treść i sposób jej organizacji nie powinna wzbudzać zakłopotania, jeśli zaczynamy się gubić – to niedobrze!
...
Trendy powinny bazować na obserwacjach. Jak czytać raporty i wyciągnąć z nich jak najwięcej? Karolina Michałkowska Nowe Narracje infografika
...
![Karolina Michałkowska Nowe Narracje](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20717%20718'%3E%3C/svg%3E)
