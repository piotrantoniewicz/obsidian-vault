...
![](https://api.ngo.pl/media/get/258722?w=1200&h=800)
...
➡️ **W tym artykule pokaże Ci, jak zrobić to z pomocą** [**Google NotebookLM.**](https://notebooklm.google.com/)
...
➡️ **Więcej o NotebookLM przeczytasz w** [**tym artykule**](https://publicystyka.ngo.pl/jak-dziala-notebooklm-twoj-wirtualny-asystent-do-pracy-z-informacjami-film-tau)**. Zachęcamy też do udziału w** [**bezpłatnym kursie Zwiększ swoją efektywność z AI od Google: Gemini i NotebookLM**](https://elearning.sektor3-0.pl/obszary/zwieksz-swoja-efektywnosc-z-ai-od-google-gemini-i-notebooklm/)**.**

![Ekran NotebookLM, po lewej źródła, na środku okno chatu a po prawej dodatkowe narzędzia, w tym możliwość generowania podsumowań audio w języku polskim.](https://api.ngo.pl/media/get/258723?w=1600&h=877)

Ekran NotebookLM, po lewej źródła, na środku okno chatu a po prawej dodatkowe narzędzia, w tym możliwość generowania podsumowań audio w języku polskim. Autor/źródło: NotebookLM

### Dlaczego warto używać NotebookaLM?

1. Stworzysz w nim bazę wiedzy, z której łatwo wyciągniesz informacje – wystarczy, że wgrasz pliki tekstowe, linki, dokumenty Google czy PDF-y.
2. Wszystko w jednym miejscu – zgromadzisz wszystkie potrzebne źródła, z których możesz wyciągać informacje z pomocą chata.
3. Odpowiedzi możesz zapisywać w formie notatek do dalszej edycji.
4. Możesz udostępnić link do współpracy innym osobom z twojej organizacji – dzięki temu nie musicie wymieniać się pojedynczymi materiałami i możecie wszystko wspólnie analizować, a twoi współpracownicy i współpracowniczki mogą szybko poznać wyniki analizy.
5. Po wgraniu plików organizacji np. poprzednich wniosków czy linków do strony, możecie używać Notebooka także do innych zadań.

➡️ **Więcej o zarządzaniu wiedzą i edukacji z pomocą NotebookLM:** [**Google NotebookLM – narzędzie AI do zarządzania wiedzą i edukacji w NGO.**](https://sektor3-0.pl/blog/google-notebooklm-zarzadzania-wiedza-i-edukacji-w-ngo/)
...
![Ekran startowy NotebookLM, gdzie dodajesz źródła: pliki PDF, linki, teksty czy pliki z Dysku Google. Kluczowy etap wprowadzenia do pracy nad dotacją i planowaniem aplikacji.](https://api.ngo.pl/media/get/258724?w=1593&h=1090)

Ekran startowy NotebookLM, gdzie dodajesz źródła: pliki PDF, linki, teksty czy pliki z Dysku Google. Kluczowy etap wprowadzenia do pracy nad dotacją i planowaniem aplikacji. Autor/źródło: NotebookLM
...
1. Opisz krótko rolę, jaką ma objąć model – „Jesteś asystentem pisania wniosków o dofinansowanie”.
2. Doprecyzuj, czego szukasz i w jakim kontekście – „Przeanalizuj dokumenty \[nazwy dokumentów\] i podaj trzy kluczowe wyzwania społeczne związane z \[obszar projektu, np. edukacja cyfrowa\], uwzględniając dane liczbowe”.
3. Określ format – „Podaj pięć najważniejszych elementów strategii \[nazwa strategii\] dotyczących \[opis tematyki projektu\]. Każdy element powinien zawierać uzasadnienie i odniesienie do dokumentu”.
4. Poproś o przedstawienie rozumowania krok po kroku. Dzięki temu masz lepszy obraz, jak model podchodzi do zadania i czy zgadza się z tym, co chciałeś/łaś osiągnąć.
...
![Przykład pracy z raportem PDF – NotebookLM analizuje potrzeby młodzieży i generuje streszczenie. Przydatne przy opracowaniu argumentów do wniosku fundacji.](https://api.ngo.pl/media/get/258727?w=743&h=595)

Przykład pracy z raportem PDF – NotebookLM analizuje potrzeby młodzieży i generuje streszczenie. Przydatne przy opracowaniu argumentów do wniosku fundacji. Autor/źródło: NotebookLM
...
![Analiza raportu o potrzebach młodzieży w Lublinie – NotebookLM podsumowuje kluczowe dane z pliku PDF i generuje syntetyczne odpowiedzi.](https://api.ngo.pl/media/get/258728?w=1271&h=653)

Analiza raportu o potrzebach młodzieży w Lublinie – NotebookLM podsumowuje kluczowe dane z pliku PDF i generuje syntetyczne odpowiedzi. Autor/źródło: NotebookLM
...
![NotebookLM analizuje, jak projekt rozwijający kompetencje młodzieży wpisuje się w Strategię Rozwoju Kapitału Społecznego. Narzędzie wspiera opracowanie argumentacji do wniosku i pomaga powiązać działania z celami programu.](https://api.ngo.pl/media/get/258729?w=1600&h=820)

NotebookLM analizuje, jak projekt rozwijający kompetencje młodzieży wpisuje się w Strategię Rozwoju Kapitału Społecznego. Narzędzie wspiera opracowanie argumentacji do wniosku i pomaga powiązać działania z celami programu. Autor/źródło: NotebookLM
...
![NotebookLM analizuje dokument o włączeniu społecznym w Erasmus+, wskazując kluczowe priorytety programów. Ułatwia opracowanie części dotyczącej równości szans i znaczenie usuwania barier w aplikacjach.](https://api.ngo.pl/media/get/258730?w=1583&h=1090)

NotebookLM analizuje dokument o włączeniu społecznym w Erasmus+, wskazując kluczowe priorytety programów. Ułatwia opracowanie części dotyczącej równości szans i znaczenie usuwania barier w aplikacjach. Autor/źródło: NotebookLM
...
![NotebookLM wspiera analizę doświadczenia organizacji partnerskich na podstawie wgranych dokumentów. ](https://api.ngo.pl/media/get/258731?w=1276&h=688)

NotebookLM wspiera analizę doświadczenia organizacji partnerskich na podstawie wgranych dokumentów. Autor/źródło: NotebookLM
...
- [Jak poznać potrzeby społeczności? Zacznij od pytań! Badania ankietowe z pomocą sztucznej inteligencji](https://publicystyka.ngo.pl/jak-poznac-potrzeby-spolecznosci-zacznij-od-pytan-badania-ankietowe-z-pomoca-sztucznej-inteligencji)
