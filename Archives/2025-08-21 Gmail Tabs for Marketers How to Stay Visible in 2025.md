...
***\== Updated (Sept 2025)****Since publishing this piece on August 20th (less than a month ago!), Gmail has rolled out a couple of changes worth flagging, especially with the holidays looming. Consider this your quick add-on before diving into the full post.* 💌
...
- **Most Relevant View:** In addition to the standard “Most Recent” view, users can now sort the Promotions tab by “ *Most Relevant”*, which pushes the brands they actually interact with (e.g. opens, clicks, replies) to the top. If you’re just [background noise](https://www.youtube.com/watch?v=j5a0jTc9S10) in someone’s inbox, you sink to the bottom. If you’re earning consistent engagement, you’ll be front-row.
...
- **New Purchases Tab:** Gmail is also carving out a dedicated lane for purchase confirmations and shipping updates (yep, straight from [Google’s announcement](https://blog.google/products/gmail/one-stop-purchase-tracking-in-gmail/?ref=senditright)). For users, it’s clarity. For senders, it’s Gmail drawing a harder line between transactional or “critical service” mail vs. promotional. If you’ve blurred those lines, it’s time for a clean up on Aisle 5.
...
- **Manage Subscriptions Expansion:** Gmail’s [one-click unsubscribe](https://www.wordtothewise.com/2024/01/one-click-unsubscribe?ref=senditright) requirement (RFC 8058, if you want to get nerdy) is being surfaced more visibly, making it easier than ever for users to prune the brands they don’t value. That indirectly strengthens the “Most Relevant” signal for the ones they *do* engage with (and actively lowers *your* odds of ever showing up there). [Here’s the full scoop](https://blog.google/products/gmail/new-manage-subscriptions-unsubscribe/?ref=senditright).
	...
	*Seeing more opt-outs? Don’t panic.* [***Unsubscribes aren’t a deliverability death sentence***](https://send-it-right.com/blog/why-unsubscribes-arent-bad-for-deliverability)***!*** *Here’s when to worry and what to fix.*
...
[via GIPHY](https://giphy.com/gifs/ZekSUNSrts7rMjrgMD)

### 💌 Not Everyone’s Using Tabs

Tabs aren’t universal. According to a [2024 study](https://www.mailjet.com/resources/research/email-engagement-2024/?ref=senditright) by Sinch Mailjet, **only ~50% of Gmail users report having a tabbed inbox.** Setup, device settings, and habits still matter, alot.
...
- **~50% of folks with tabbed inboxes say they check Promotions *daily*** (which is consistent with their [2021 study](https://www.mailjet.com/blog/email-best-practices/email-engagement-key-learnings/?ref=senditright)). That’s *millions* of eyeballs that are actively looking (or at least open to) offers. Hardly the “black hole” some make it out to be… if your content earns engagement, that is.
...
[via GIPHY](https://giphy.com/gifs/laughing-smiling-30-rock-CW27AW0nlp5u0)
...
[via GIPHY](https://giphy.com/gifs/KJg6Znn4V1Jcs)
...
And here’s the kicker: Gmail itself has been steadily routing *more* mail into Promotions, even from senders who *used* to see regular Primary placement. [Netcore reports](https://netcorecloud.com/blog/decoding-gmails-new-tab-changes/?ref=send-it-right.com) a significant algorithm shift that pushes messages into Promotions regardless of sender reputation or content.
...
Data from George Schlossnagle’s [post-2019 panel study](https://www.onlyinfluencers.com/email-marketing-blog-posts/best-practice-email-strategy/entry/how-does-tab-placement-effect-email-engagement?utm_source=send-it-right.com) backs this up. Looking at senders whose campaigns straddled different tabs for different users (or shifted tabs entirely due to algorithm updates), the engagement patterns barely moved. Wanted mail performed, wherever it landed. Unwanted mail didn’t. Tabs simply organize mail; they don’t rewrite intent.
...
![](https://images.squarespace-cdn.com/content/v1/660772c2f422d154e08ae5a3/e2a27bf2-c3df-4491-a155-afa1cc31aaf3/Impact+of+the+Promo+tab?format=100w)
...
![Chart showing inbox tab categories: Gmail (Primary, Promotions, Social, Updates, Forums), Yahoo (Priority, Offers, Social, Newsletters), Outlook (Focused, Others), and Apple (Primary, Promotions, Updates, Transactional, All Mail).](https://images.squarespace-cdn.com/content/v1/660772c2f422d154e08ae5a3/b011933a-3180-4b93-8425-d49e2a4f31d6/Tabbed+Inboxes.jpg?format=100w)

Chart showing inbox tab categories: Gmail (Primary, Promotions, Social, Updates, Forums), Yahoo (Priority, Offers, Social, Newsletters), Outlook (Focused, Others), and Apple (Primary, Promotions, Updates, Transactional, All Mail).
...
- **Guardrails.** Keep your [spam complaint](https://www.socketlabs.com/blog/email-performance-red-flags-spam-complaints/utm_source=senditright&utm_medium=NL&utm_campaign=promo_tab) ceiling below 0.03%, watch for [unsubscribe spikes](https://www.socketlabs.com/blog/email-performance-red-flags-high-unsubscribe-rate/utm_source=senditright&utm_medium=NL&utm_campaign=promo_tab) (+25% vs baseline) and figure out when you’ll pull the plug if Postmaster Tools reputation dips or blocklistings pop up.
...
[via GIPHY](https://giphy.com/gifs/muppets-138Gn7ZOxMPy0M)
...
💌 **Treat unsubscribes as win-back intel:** they hurt our hearts, for sure. But [unsubscribes don’t hurt deliverability](https://click.kit-mail1.com/gku7mzrod4f5hlmxgw3crh8dmk999imh36v9d/6qheh8hl7r45dpao/aHR0cHM6Ly9zZW5kLWl0LXJpZ2h0LmNvbS9ibG9nL3doeS11bnN1YnNjcmliZXMtYXJlbnQtYmFkLWZvci1kZWxpdmVyYWJpbGl0eQ==), and you can use their trends and patterns to identify parts of your program that may be driving more churn than others.
...
*Need a deeper dive?* [***Why Unsubscribes Aren’t Bad for Deliverability***](https://send-it-right.com/blog/why-unsubscribes-arent-bad-for-deliverability) *covers the signals, thresholds to be on the lookout for, and a step-by-step plan for damage control.*
...
So, don’t just stare at your [opens](https://click.kit-mail1.com/gku7mzrod4f5hlmxgw3crh8dmk999imh36v9d/25h2hoh329x8e4t3/aHR0cHM6Ly9zZW5kLWl0LXJpZ2h0LmNvbS9ibG9nL3doeS15b3VyLW9wZW4tcmF0ZXMtYXJlLXdyb25n) and [CTRs](https://click.kit-mail1.)!
...
[via GIPHY](https://giphy.com/gifs/snl-saturday-night-live-season-45-kIKX3bCnEyjXv9mhqQ)
...
Separate transactional vs. promotional streams (e.g. with dedicated subdomains/IPs), [authenticate](https://send-it-right.com/blog/intro-to-email-authentication) properly, and use sender names/addresses that actually reflect the intent of the message.
...
Skip the “get into Primary” chase and focus on tactics that actually cut through the noise — without needing a dev army for solutions like [Gmail Annotations](https://developers.google.com/workspace/gmail/promotab/overview) and [AMP for Email](https://amp.dev/about/email):
...
And if opt-outs spike, remember: that’s usable intel, not doom and gloom. Start here: [**Unsubscribes ≠ deliverability doom**](https://send-it-right.com/blog/why-unsubscribes-arent-bad-for-deliverability).
...
![A meme of Tom Cruise as Jerry McGuire saying "Show me the receipts!" in place of "Show me the money!"](https://images.squarespace-cdn.com/content/v1/660772c2f422d154e08ae5a3/6bbf9a20-5037-422e-baac-114726824382/Show+me+the+receipts.jpg?format=100w)

Because I know this is gonna be your execs tomorrow...

- **Gmail “Manage Subscriptions”** [**announcement**](https://click.kit-mail1.com/gku7mzrod4f5hlmxgw3crh8dmk999imh36v9d/7qh7h8h9ole6m6iz/aHR0cHM6Ly9ibG9nLmdvb2dsZS9wcm9kdWN0cy9nbWFpbC9uZXctbWFuYWdlLXN1YnNjcmlwdGlvbnMtdW5zdWJzY3JpYmUvP3JlZj1zZW5kaXRyaWdodA==): where to find it and how it works. Screenshots, mechanics, details… all the goods.
- **Google on Purchases + Promotions:** the [**official update**](https://click.kit-mail1.com/gku7mzrod4f5hlmxgw3crh8dmk999imh36v9d/dpheh0he06xomzsm/aHR0cHM6Ly9ibG9nLmdvb2dsZS9wcm9kdWN0cy9nbWFpbC9vbmUtc3RvcC1wdXJjaGFzZS10cmFja2luZy1pbi1nbWFpbC8_cmVmPXNlbmRpdHJpZ2h0) on both; perfect for the “prove it” crowd, because you *knoooowww* somebody’s gonna ask. ¯\\\_(ツ)\_/¯
- **Sinch Mailjet’s** [**The Path to Email Engagement 2024**](https://click.kit-mail1.com/gku7mzrod4f5hlmxgw3crh8dmk999imh36v9d/48hvhehmrl3pn8sx/aHR0cHM6Ly93d3cubWFpbGpldC5jb20vcmVzb3VyY2VzL3Jlc2VhcmNoL2VtYWlsLWVuZ2FnZW1lbnQtMjAyNC8_dXRtX3NvdXJjZT1zZW5kaXRyaWdodA==): Promotions usage data (spoiler: yes, people check it… a lot).
- **Spam Resource: “** [**Relevance comes to the Gmail promo tab.**](https://click.kit-mail1.com/gku7mzrod4f5hlmxgw3crh8dmk999imh36v9d/08hwh9h2de49k3tl/aHR0cHM6Ly93d3cuc3BhbXJlc291cmNlLmNvbS8yMDI1LzA5L3JlbGV2YW5jZS1jb21lcy10by1nbWFpbC1wcm9tby10YWIuaHRtbD9yZWY9c2VuZC1pdC1yaWdodC5jb20=)**”** Short, pragmatic context from Al Iverson.
- **Got a great resource I should add?**[Send it my way](https://send-it-right.com/contact) (please!).

### But wait! Before you go...

![](https://images.squarespace-cdn.com/content/v1/660772c2f422d154e08ae5a3/fbdcd2a1-f34d-440c-9403-9bd82d6eae13/Double+dog+dare+ya.png?format=100w)
...
*Send It Right is a blog and weekly(ish) newsletter for marketers and email practitioners who want to reach the inboxes (and hearts) of email recipients.* [*Join 1,110+ other email nerds in subscribing*](https://send-it-right.com/newsletter) *to get the next lesson directly in your inbox. 💌*

[Send this to my inbox next time!](https://send-it-right.com/newsletter)
