...
## Wnioski
- Zestaw promptów nadaje się bezpośrednio do pracy nad własnym pozycjonowaniem (dobryai.pl) lub jako ćwiczenie na warsztacie z klientami indywidualnymi i organizacjami społecznymi budującymi markę osobistą lidera
- Zasada „jedna konkretna osoba w konkretnej sytuacji zamiast demografii" to praktyczna technika do person w kampaniach fundraisingowych i digital campaigningowych
- Sekwencyjne prompty (każdy zasila następny) to wzorzec promptowania wart przeniesienia na inne procesy odkrywania treści — np. definiowanie oferty programu szkoleniowego

## Zastosowanie
Gotowy zestaw pięciu promptów można wykorzystać wprost jako ćwiczenie na własnych warsztatach z pozycjonowania dla klientów lub do dopracowania własnej linii pozycjonującej na dobryai.pl.
