...
url: "https://weareastral.co.uk/thevault/the-email-glass-ceiling?utm_medium=email&_hsenc=p2ANqtz-_yhuvAIbWVVAqCXXeRTdGBh3pPkNmUCY01DHgvJa4hqebTgXMa2GshbvXuvbvW9Ubbr48M759jxXYo60KR8xeK0IwT0d2xXcNLLUUh1ozcCb4wYrc&_hsmi=136887126&utm_content=136828310&utm_source=hs_email"
...
## What the email glass ceiling actually is
...
Email is built on three pillars: systems, strategy, and data. I covered these in depth as part of the [PPPP™ Email Framework,](https://weareastral.co.uk/pppp-email-framework) if you have not read that yet, it is the foundation for everything in this blog.
...
## The three types of glass ceiling
...
## How to diagnose your glass ceiling
...
## Step 1: Describe the programme you want to build
...
## Step 2: Work backwards from where you are stuck
...
## Step 4: Build the case for the investment
...
## The compound ceiling, when all three pillars are blocking at once
...
## What to do while you're working on it: performing within the ceiling
...
## Be honest about what the current programme can and cannot do
...
## Quick wins within the current constraints
...
## The PPPP™ Email Framework

[The three pillars](https://weareastral.co.uk/pppp-email-framework) — systems, strategy, and data — do not operate in isolation. They are interconnected. The way to think about them is not as three separate problems but as three interdependent elements of a single email ecosystem.
