...
url: "https://publicystyka.ngo.pl/ai-ktore-zna-twoja-organizacje-jak-zbudowac-asystenta-ai-opartego-na-wiedzy-organizacji-taup"
...
![Drewniany regał biurowy z półkami pełnymi różnokolorowych segregatorów (m.in. niebieskich, zielonych, czerwonych i czarnych). W centralnej części grafiki umieszczono biały, poziomy pasek z czarnym napisem „Gemini Notebook” i niebieskim logo po lewej stronie.](https://api.ngo.pl/media/get/286414?w=1200&h=800)

Drewniany regał biurowy z półkami pełnymi różnokolorowych segregatorów (m.in. niebieskich, zielonych, czerwonych i czarnych). W centralnej części grafiki umieszczono biały, poziomy pasek z czarnym napisem „Gemini Notebook” i niebieskim logo po lewej stronie.
...
1. Wybieracie narzędzie (np. Gemini Notebook, Anything LLM) i wgrywacie do niego dokumenty: notatki, procedury, raporty, opisy projektów, dzienniki doświadczeń, etc.
2. Kiedy ktoś zadaje pytanie, asystent przeszukuje te dokumenty.
3. Generuje odpowiedź na podstawie tego, co w nich znalazł.
4. Często pokazuje też, skąd wziął daną informację (np. „źródło: procedura rozliczania projektów, s. 3”).
...
Jak to wygląda krok po kroku na żywym przykładzie, zobaczysz w [**wideotutorialu**](https://youtu.be/aFtD3wo0NTM) w dalszej części artykułu. Michał buduje tam dwóch asystentów od zera.

Jeśli twoja organizacja korzysta z subskrypcji Google Workspace, możecie stworzyć [automatyzację w Google Workspace Studio](https://workspaceupdates.googleblog.com/2026/08/automatically-add-sources-to-your-Gemini-Notebooks-in-Workspace-Studio.html), która będzie automatycznie wysyłała pliki z Dysku Google do Gemini Notebook. Czyli: wybieracie folder na Dysku, który będzie „obserwowany” przez automatyzację i jeśli jakiś plik zostanie do niego dodany – wasz asystent w Gemini Notebook będzie miał do niego dostęp.
...
![](https://www.youtube.com/watch?v=aFtD3wo0NTM)
...
**Pełny wideotutorial znajdziesz** [**tutaj**](https://youtu.be/aFtD3wo0NTM).
...
- [Jak uporządkować dane w NGO, aby ułatwić zarządzanie i pracę zespołową?](https://sektor3-0.pl/blog/jak-uporzadkowac-dane-w-ngo-aby-ulatwic-zarzadzanie-i-prace-zespolowa/)
- [Zarządzanie wiedzą w NGO: Jak zamienić rozmowy na czacie w systematyczny rozwój zespołu?](https://sektor3-0.pl/blog/zarzadzanie-wiedza-w-ngo-jak-zamienic-rozmowy-na-czacie-w-systematyczny-rozwoj-zespolu/)
- [Skróty klawiszowe i nie tylko. 11 sposobów, żeby pracować sprawniej przy komputerze](https://sektor3-0.pl/blog/skroty-klawiszowe-i-nie-tylko-11-sposobow-zeby-pracowac-sprawniej-przy-komputerze/)
...
**Interesujesz się nowymi technologiami i chcesz w oparciu o nie rozwijać swoją organizację? Zajrzyj również na** [**portal Sektor 3.0**](https://sektor3-0.pl/blog) **i zapisz się do** [**naszego newslettera**](https://sektor3-0.pl/zapisz-sie-do-newslettera/)**, żeby nie przegapić kolejnych artykułów. Zapraszamy!**

Źródło: [Sektor 3.0](https://sektor3-0.pl/)

Więcej tekstów autorstwa: Marzena Kacprowicz
