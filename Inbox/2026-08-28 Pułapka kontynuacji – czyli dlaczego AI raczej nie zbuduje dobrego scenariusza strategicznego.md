...
Całość domyka się w pętlli – obserwacja rynku wraca do punktu wyjścia i aktualizuje inicjalną hipotezę.

![Treść artykułu](https://media.licdn.com/dms/image/v2/D4D12AQHXJItHduM_oA/article-inline_image-shrink_400_744/B4DaBHVYd5GkAM-/0/1787903183098?e=1789603200&v=beta&t=Z6RRfd1Hqzks6KavdRnXaBmw8J6oLiPlbWjUnX0H70M)

Rys. Cykl strategiczny

Kluczowy okazuje się w tym procesie etap drugi. To właśnie on decyduje o jakości wszystkiego, co powstanie później. Jeśli zbiór rozważanych modeli przyszłości jest zbyt wąski, to cała dalsza praca okazać się może precyzyjną, ale zupełnie bezzasadną optymalizacją błędnego założenia.
...
![Treść artykułu](https://media.licdn.com/dms/image/v2/D4D12AQH1Nhv3Y3k9EA/article-inline_image-shrink_1000_1488/B4DaBHVYfvIEAI-/0/1787903183047?e=1789603200&v=beta&t=cNlbtYegiChPFEY9fuLRtj67Z6Svp6pItxZM2Z4rLfc)

Rys. Stożek możliwych przyszłości

## Naturalna pokusa zatrudnienia AI

Budowa alternatywnych modeli przyszłości na pozór wygląda na zadanie wręcz idealne aby je powierzyć dużym modelom językowym. Wymaga bowiem przebrnięcia przez sporą liczbę raportów, połączenia sygnałów z odległych branż, wygenerowania wielu wariantów i rozpisania każdego z nich. Wykonując to tradycyjną, ręczną metoda robimy to zazwyczaj długo, wybiórczo i w dodatku z ograniczoną cierpliwością. Model w kilkadziesiąt sekund potrafi stworzyć dla nas gotowy raport.

Problem polega jednak na tym, że nie każdy etap pracy strategicznej można wydelegować do LLM-ów z dobrym skutkiem. Oceniając jej poszczególne etapy według kluczowych kryteriów (czasochłonności, powtarzalności, wagi dla projektu, uciążliwości oraz dostępności wystarczających danych) ) otrzymać tu możemy obraz w rodzaju:.

![Treść artykułu](https://media.licdn.com/dms/image/v2/D4D12AQFH8nw4gadNnw/article-inline_image-shrink_400_744/B4DaBHVYgxJoAM-/0/1787903183341?e=1789603200&v=beta&t=vKyhdEGbIKZTmnQu2azQsSIzmPytaw9w8p9x5nCZ6yY)

Na górze tego zestawienia wylądowałyby więc etapy odtwórcze: desk research, audyt konkurencji czy dokumentacja. Mamy tu do bowiem czynienia z dużą ilością danych, wysoką powtarzalnością i w miarę jasnymi kryteriami poprawności. Zadania te najłatwiej więc przekazywać agentom AI.
...
Budowa scenariuszy należy dokładnie do tej drugiej rodziny. Jest krytycznie ważna i z definicji uboga w dane, bo dotyczy kreowania czegoś nowego lub stanu świata, który jeszcze nie zaistniał. A jeśli jeszcze nie zaistanił, to nie pozostawił po sobie także żadnych śladów w zbiorze treningowym…
...
![Treść artykułu](https://media.licdn.com/dms/image/v2/D4D12AQFnkitbO3oPNA/article-inline_image-shrink_1000_1488/B4DaBHVYd6KUAI-/0/1787903182978?e=1789603200&v=beta&t=HqiZlLJnGu5Nc636R2SLEA74oFty_HyvHr_tagp3vns)

Intuicja podpowiada, że model językowy poradzi sobie świetnie na poziomie pierwszym i drugim, słabiej na trzecim, na czwartym zaś w ogóle. Intuicja jest jednak zawodnajak wiadomo. Kwestię tą postanowiłem więc sprawdzić w sposób eksperymentalny.

## Dlaczego akurat prognoza?

Tym samym jest to czwarty eksperyment w serii, w której sprawdzałem jak modele językowe zawężają przestrzeń możliwych odpowiedzi. W poprzednich, opublikowanych na łamach "Marketing przy kawie" badałem [innowację produktową](https://marketingprzykawie.pl/artykuly/creative-strategy-fingerprint-czyli-dlaczego-ai-raczej-nie-wymysli-kolejnego-iphonea/) (framework SCAMPER), [kreatywność reklamową](https://marketingprzykawie.pl/artykuly/w-reklamach-generowanych-przez-llm-kreatywny-bias-to-regula/) (10 kodów reklamy TV) oraz [strategię marki](https://marketingprzykawie.pl/artykuly/bias-strategiczny-llm-ow-udowodniony-w-tescie-stworz-pozycjonowanie-marki/) (kody pozycjonowania). Za każdym razem wynik był podobny - model nie eksploruje całej dostępnej przestrzeni rozwiązań, ale osiada w wąskim paśmie tego, co najbardziej typowe w jakimś sensie uśrednione.

Eksperymenty te miały jednak pewną wspólną słabość. Bo kiedy mówimy np. że wygenerowane przez LLM pozycjonowanie jest banalne, to poruszamy się wciąż w świecie opinii. Zawsze można przezcież odpowiedzieć, że np. aspiracyjny lifestyle akurat w danej kategorii jest trafnym wyborem. Bias jest tam wyraźniej widoczny, ale nie jest rozstrzygalny.
...
Czyli obiliczamy kwadrat różnicy między prawdopodobieństwem prognozowanym a wynikiem rzeczywistym. 0 oznacza wtedy prognozę idealną (100%), a 1 całkowitą pomyłkę (0%).
...
![Treść artykułu](https://media.licdn.com/dms/image/v2/D4D12AQHJi-2rYS-QFw/article-inline_image-shrink_1000_1488/B4DaBHVYf5JcAM-/0/1787903183118?e=1789603200&v=beta&t=Pd8YRKrOsRT_bDSt5Wj7etRja5brWtHCwIGt1GrziH4)
...
![Treść artykułu](https://media.licdn.com/dms/image/v2/D4D12AQEMPSJdKGqN0A/article-inline_image-shrink_1500_2232/B4DaBHVYfUGYAQ-/0/1787903183055?e=1789603200&v=beta&t=hgyViJ6gRTp6UU50RNoF80BivVQwr2Gb2P9kxOHVHpA)
...
Dla planowania scenariuszowego jest to wynik istotny jeśli cchemy wnim stosować LLM. Bo jedną z możliwych technik mogłoby być właśnie wielokrotne odpytywanie modelu i traktowanie zbioru odpowiedzi jak rozkładu opinii – tak jakbyśmy zebrali panel stu ekspertów. Tymczasem okazuje się, że model nie będzie miał wtedy stu różnych opinii. Będzie miał jedną opinię, a wokół niej trochę szumu…

**Sto wywołań nie da nam stu scenariuszy. Daje jeden scenariusz zapisany na sto róznych sposobów.**
...
![Treść artykułu](https://media.licdn.com/dms/image/v2/D4D12AQFf_AlVgD-Krw/article-inline_image-shrink_1000_1488/B4DaBHge6gIEAI-/0/1787906093337?e=1789603200&v=beta&t=KyzaA5K9c62hc2TaVDIMYflhUbAM9BBhZgTUe2ac2zs)

Rys. Rozkład 100 niezależnych ocen GPT-4o oraz trafność prognoz

## Wynik 2: konsensus uzasadniany konsensusem

Ciekawsze od liczb wydają się jednak uzasadnienia udzilone przez LLM. Model konsekwentnie odwoływał się tu do jednego argumentu:
...
![Treść artykułu](https://media.licdn.com/dms/image/v2/D4D12AQFhsdsseYfa-g/article-inline_image-shrink_1500_2232/B4DaBHVYihJoAQ-/0/1787903183357?e=1789603200&v=beta&t=iF7wMzqoLlCTRO5Uv6noAsR3R06lfoFH3s6UgJBXK74)
...
Scenariusz S1, który da się wyprowadzić z trendu zbuduje każdy przeciętny analityk. Tym lepszym płaci się jednak za scenariusze odlegle od znanej trajektorii - w rodzaju S2 i S3.
...
![Treść artykułu](https://media.licdn.com/dms/image/v2/D4D12AQE-FRu7qVY94g/article-inline_image-shrink_1000_1488/B4DaBHVYiGHcAI-/0/1787903183330?e=1789603200&v=beta&t=QoJhRgFvXdYeUmUVclmNjAx1rU2GSdEUzJzU-d2YpZw)
...
**Poproszony o czarnego łabędzia model nie wychodzi poza znany repertuar „zaskakujących zdarzeń”. Zmiast generować prawdziwą nieciągłośćgeneruje to, co w danych treningowych już uchodzi za typowe zaskoczenie. Czyli "zaskoczenie", które mieści się w naszym wyobrażeniu o tym, co może wydawać się zaskakujące.**
...
![Treść artykułu](https://media.licdn.com/dms/image/v2/D4D12AQH2iePy1t28oA/article-inline_image-shrink_1000_1488/B4DaBHVYlCJcAM-/0/1787903183638?e=1789603200&v=beta&t=s6C_0A_fR43ZmNAZpaTdGH28YkBlYzSRCtiqpOcgAV8)
...
I to również może być największa pułapką. Bo S1a i S1b pozornie wyglądają jak scenariusze. Mają swoje tytuły, opisy świata czy implikacje dla marki. Cały taki zestaw leży jednak wciąż wewnątrz jednej gałęzi.
...
![Treść artykułu](https://media.licdn.com/dms/image/v2/D4D12AQFyXUpoHjWz7w/article-inline_image-shrink_1000_1488/B4DaBHVYicKgAI-/0/1787903183238?e=1789603200&v=beta&t=-_gUGc-rO5yX9sA_Wvg0COulokfqhgokGOo7HhmFOrQ)

Rys. Stożek zwężony do jednej linii — continuity bias
...
Wróćmy do cyklu z pierwszego rysunku w tym tekscie i przypiszmy role na podstawie tego, co wyszło z opisanego pomiaru, a nie np. z oczekiwań.

![Treść artykułu](https://media.licdn.com/dms/image/v2/D4D12AQEzOZ74Cz_4Gg/article-inline_image-shrink_1000_1488/B4DaBHoPeqJoAI-/0/1787908126871?e=1789603200&v=beta&t=z60xGkoR2M3zYu_AmB2SJQIF7vI9-u2x1MZTwSbEytM)

Podział pracy: człowiek – LLM w pętli strategicznej
...
Model językowy szybko wypełni każdą z tych ćwiartek. Prosząc więc o świat, w którym trendy są negatywne, a niepewność wysoka dostajemy jego szczegółowy opis. Ale to jest praca wewnątrz zadanej ramy, czyli L 2. Sam wybór osi i rozstrzygnięcie, która niepewność jest w tej kategorii naprawdę kluczowa pozostaje wciąż po stronie człowieka. A to właśnie ten wybór decyduje o wartości całego tego ćwiczenia wyobraźni na temat przyszłości.

![Treść artykułu](https://media.licdn.com/dms/image/v2/D4D12AQGvSZyT6RMToA/article-inline_image-shrink_400_744/B4DaBHVYg.I8AM-/0/1787903183148?e=1789603200&v=beta&t=7EA3qswYKV1TQwL_QXj7wryH2jHSJVRnxvT4ufUL8XA)

Rys. Macierz scenariuszy - gdzie kończy się rola modelu?

## Wnioski praktyczne

Wszystko, co powyżej możnaby więc zamknąć w postaci pewnych zaleceń praktycznych, które warto rozważyć zanim zaczniemy zatrudniać modele językowe do planowania scenariuszowego. Mogłyby one wtedy przyjąć formę poniższej listy:

1. **Nie pytaj LLM-a „co się wydarzy?”.** Takie pytanie najczęściej zwróci konsensus. Trajektorię trzeba narzucić samodzielnie na zasadzie: „opisz świat, w którym teza X upada”, „załóż, że dostęp do mocy obliczeniowej przestaje być przewagą – co wtedy?”. Kierunek poszukiwań musi być wyrażony explicite.
2. **Proś o atak na twoją hipotezę, a nie o samą hipotezę.** Poproszona o brief, AI oddaje średnią kategorii. Poproszona o atak na konkretny insight – oddaje…prawdziwą przysługę. Stress-test nie wymaga wychodzenia poza konsensus więc model wykonuje go bardzo dobrze.
3. **Wymuś łamanie założeń proceduralnie.** Zamiast prosić o oryginalność, każ modelowi wypisać założenia kategorii, a następnie każde z nich kolejno zaprzeczyć, zawiesić albo podmienić na założenie z odległej domeny. Dopiero z tak wykonanego ruchu wyprowadzać można scenariusz, a odrzucać te, które są de facto przebraniem wariantu bazowego.
4. Nie uśredniaj wielu wywołań. Model ma jedną opinię z szumem, a nie rozkład poglądów. Sto czy więcej wywołań daje złudzenie panelu ekspertów tam, gdzie mamy wciąż jednego, tego samego eksperta powtarzającego w kółko to samo zdanie.
5. Uważaj na pewność siebie LLM-a. Model np. odrzucał zdarzenie, przypisując mu 27% prawdopodobieństwa i formułując przy tym uzasadnienia brzmiące kompetentnie i rzeczowo. Jakość języka nie jest żadnym wskaźnikiem jakości scenariusza.
...
![Treść artykułu](https://media.licdn.com/dms/image/v2/D4D12AQErzAUj7Vpvag/article-inline_image-shrink_400_744/B4DaBHVYkCKQAM-/0/1787903183347?e=1789603200&v=beta&t=aq6eQiHxT0CYuCMKwu9kXdfmthrGZJcottxbu3LReS4)

Rys. Mapa konsensusu

## Lustro, nie wyrocznia

W [badaniu nad reklamą](https://marketingprzykawie.pl/artykuly/w-reklamach-generowanych-przez-llm-kreatywny-bias-to-regula/) napisałem, że przewidywalność modeli odsłania przewidywalność samej reklamy. Modele okazywały się lustrem, w którym widać, jak bardzo skonwencjonalizowany jest język komunikacji marketingowej.
...
Wartość w foresightcie leży zaś nie w środku rozkładu ale w odchyleniu od niego. A to odchyleniewciąż pozostaje po naszej – ludzkiej stronie (przynajmniej na razie...). Co nie znaczy, że model jest w tej pracy zupełnie bezużyteczny. Znaczy tylko tyle, że pełni w niej inną rolę, niż zwykle mu się przypisuje. Nie liczmy, że wskaże kierunek, ale z uwagą poptrzmy co mówi o tym gdzie obecnie stoi tłum. A to już może być informacja pierwszorzędna.

Marek Staniszewski

[Heuristica](https://heuristica.pl/)

---

### Nota metodologiczna

Opisany eksperyment miał charakter pilotażowy i obejmował tylko jeden model (GPT-4o) oraz jeden przypadek nieciągłości. Wyniki trzeba więc traktować bardziej jako sygnał wymagający replikacji na innych modelach oraz na innych "zdarzeniach przełomowych" z okresu po dacie odcięcia. Kodowanie odpowiedzi w zadaniu P01 wykonane zostało przez zastosowanie kategorii (archetyp kontynuacji, trafność mechanizmu, trafność aktora) ale mają charakter interpretacyjny. Kod dla chcących powtórzyć eksperytment także nainnych modelach znajdują się w załączonym [notatniku Colab](https://colab.research.google.com/drive/1-b201vq62Gj07RBoQgLd5hbAzMS7eicx?usp=sharing).
...
- [Creative Strategy Fingerprints – czyli dlaczego AI raczej nie wymyśli kolejnego iPhone’a (framework SCAMPER)](https://marketingprzykawie.pl/artykuly/creative-strategy-fingerprint-czyli-dlaczego-ai-raczej-nie-wymysli-kolejnego-iphonea/)
- [Creative Code Fingerprints – czyli dlaczego AI wciąż wymyśla takie same reklamy (10 kodów reklamy TV)](https://marketingprzykawie.pl/artykuly/w-reklamach-generowanych-przez-llm-kreatywny-bias-to-regula/)
- [Brand Positioning Fingerprints – czyli dlaczego AI zawsze pozycjonuje markę tak samo (kody strategii marki)](https://marketingprzykawie.pl/artykuly/bias-strategiczny-llm-ow-udowodniony-w-tescie-stworz-pozycjonowanie-marki/)