...
![Rodrigo Camarena Believes AI can Help Workers Access Justice](https://cdn.sanity.io/images/4cwcet86/production/be9d8a7754a24d1a24a6a17266f63b79ecadc91b-2000x1000.png?rect=111,0,1778,1000&w=3840&h=2160&q=70&auto=format)

Meet the leaders who are putting AI to work for good. *Humans of AI for Humanity* is a joint content series from the [Patrick J. McGovern Foundation](https://www.mcgovern.org/) and [Fast Forward](https://www.ffwd.org/). Each month, we highlight experts, builders, and thought leaders using AI to create a human-centered future — and the stories behind their work.
...
Enter [Reclamo AI](https://reclamo.ai/): a multilingual, mobile-first digital assistant that helps low-wage and immigrant workers prevent, assess, and document workplace violations in New York State. The product was built by [Justicia Lab](https://www.justicialab.org/), a program of [Pro Bono Net](https://www.probono.net/), in collaboration with worker organizers and employment attorneys at the [New York Legal Assistance Group](https://nylag.org/). Reclamo’s mission is to make wage theft recovery free, safe, and simple.
...
> 
> Rodrigo Camarena, Director, Justicia Lab and Creator of Reclamo
...
1. Scaling access to legal information, so workers don’t have to wait weeks for answers to urgent questions;
2. Strengthening organizing and advocacy by surfacing patterns of violations across industries and geographies; and
3. Freeing up advocates to focus on strategy and systemic change, while AI handles repetitive, time-consuming tasks.
...
The original version of Reclamo ([https://reclamoapp.org/](https://reclamoapp.org/)) helped file over $1.5M in wage claims over an 18-month period. With Reclamo AI ([https://reclamo.ai/](https://reclamo.ai/)), we see the potential to 100X this amount over the next three years.
