...
![Blog page website image (14)](https://smk.org.uk/wp-content/uploads/2025/10/Blog-page-website-image-14.png)

Blog page website image (14)
...
Campaigners often see legal tools as something to turn to only after other routes haven’t been as successful as anticipated. But some of the most successful cases, like those led by [Birthrights](https://birthrights.org.uk/campaigns-research/maternal-request-caesarean/) or [The Children’s Society](https://chrome-extension//efaidnbmnnnibpcajpcglclefindmkaj/https:/www.childrenssociety.org.uk/sites/default/files/2021-01/cut-off-from-justice.pdf), were years in the making, built on solid evidence and strong partnerships.
...
Build relationships across sectors where you can. Look at how projects like [The Unity Project](https://chrome-extension//efaidnbmnnnibpcajpcglclefindmkaj/https:/unity-project.org.uk/wp-content/uploads/2024/11/AccessDenied-thecostoftheNoRecoursetoPublicFundspolicy.TheUnityProject.June2019.pdf) and [We Belong](https://chrome-extension//efaidnbmnnnibpcajpcglclefindmkaj/https:/www.webelong.org.uk/sites/default/files/uploads/We%20Belong%20-%20Briefing%20-%2010-year%20route.pdf) worked with lawyers and researchers to combine lived experience, data, and advocacy in their legal campaign. Collaboration not only strengthens your legal arguments but also helps create public and political pressure.
...
Stay involved where possible. Campaigners can help jargon-bust legal outcomes for the public, use successes to influence policy, and ensure wins in court translate to improvements on the ground. It’s also entirely plausible that an organisation takes a legal route without heaps of involvement from lawyers – [The PAP Project](https://pollyglynn1.wixsite.com/paps) is a great example of empowering frontline workers to use legal tools directly, with huge success rates and minimal legal involvement.
...
If you want to explore these topics in more depth then book onto SMK’s [*Using the Legal System to Achieve Change*](https://smk.org.uk/training-events/using-the-legal-system-to-achieve-change/) workshop to see how lawyers, communities, and evidence can help your legal campaign make a real impact. The workshop takes place on Tuesday the 4th of November 2025, 2-5pm and Thursday the 26th of February 2026, 2-5pm.

This session is led by Shauneen Lambe, a barrister, and the Director of Impact at [Impact Law for Social Justice](https://www.impactsocialjustice.org/), with decades of experience using the law to drive systemic reform. She has represented clients before the US Supreme Court and co-founded the youth justice charity [Just for Kids Law](https://www.justforkidslaw.org/).
