...
type: "Web"
authors: "[[Rob Burke]]"
url: "https://www.donordock.com/articles/using-donor-data-to-identify-major-gifts?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup"
...
Below is a five-signal audit you can run this week, an easy way to score it, and what to do with the names that rise to the top. If you want the full argument for why these supporters deserve the attention, we made that case separately in [the importance of recurring donors](https://www.donordock.com/articles/importance-of-recurring-donors?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup). This piece is the mechanics.

## Why start with the donors you already have?

Because the odds aren't close.

In 2025, first-time donors were retained at 18.9 percent, while [repeat donors were retained at 59.3 percent](https://publications.fepreports.org/archive/2025-q4/retention-by-donor-type/). A supporter with a history is more than three times likelier to still be with you next year than someone who just arrived.

The revenue split points the same way. [M+R's 2026 Benchmarks report](https://2026.mrbenchmarks.com/fundraising/) found that new donors accounted for 31 percent of online revenue in 2025. The other 69 percent came from people who were already on the list.

And yet this data mostly sits untouched. In [NTEN's 2025 Data Empowerment Report](https://word.nten.org/wp-content/uploads/2025/07/2025-Data-Empowerment-Report.pdf), only 21 percent of organizations said they always use data to analyze constituent engagement or actions, while 39 percent said they do it only sometimes. In the same survey, 54 percent named tools that are not aligned with their workflow as a barrier to adopting technology.
...
Score a donor for upgrade readiness

Rate one supporter across the five signals below. Every answer comes from records you already keep. Totals run 0 to 11.

1\. Years of repeat givingmax 3

–/3

2\. Recurring gift tenuremax 3

–/3

3\. Affinity matchmax 2

–/2

4\. Non-gift touchpointsmax 2

–/2

5\. Rising gift sizemax 1

–/1 Start scoring

Answer all five signals to see where this donor lands.

0 /11

Your scored donors 0

**No donors scored yet.** Run a donor through the signals above, then hit **Save**.
...
![Donor upgrade-readiness score bands mapped to actions: 8 to 11 points assign to a person, 5 to 7 fill the data gap, 2 to 4 steward without asking, 0 to 1 leave for now](https://cdn.prod.website-files.com/63ce9d04b1ff6e1c14514251/6a7b54c6cc068439ba994f2f_6a7b5211e16fc2c4496fafe8_article-2-inline-2-score-bands.webp)

Donor upgrade-readiness score bands mapped to actions: 8 to 11 points assign to a person, 5 to 7 fill the data gap, 2 to 4 steward without asking, 0 to 1 leave for now

**Assign the 8-to-11 names to a person.** Not to a campaign, not to a mail segment. A person, with a due date. These names are few enough to work by hand, which is the entire advantage of scoring in the first place. DonorDock's [moves management](https://www.donordock.com/solution/major-gifts?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup) is built for exactly this handoff, moving a supporter through defined stages instead of leaving them in somebody's memory.
...
**Leave the 2-to-4 names alone, deliberately.** The failure mode here is soliciting everyone the audit touched. Resist it. This group's job this year is to keep giving and feel appreciated, and [stewardship on a limited weekly budget](https://www.donordock.com/articles/major-donor-stewardship-10-hours-a-week?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup) is a solved problem.

If board members are part of your cultivation strategy, run the top group through [a relationship mapping workflow](https://www.donordock.com/articles/board-powered-major-gifts-relationship-mapping-workflow?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup) before anyone picks up the phone. Occasionally the warm introduction is already sitting in your boardroom.
...
The one thing worth doing more often is capturing affinity data, because that is the signal that stays empty until somebody makes collecting it part of the normal rhythm. If you are not sure which fields to prioritize, [these ten donor data points](https://www.donordock.com/articles/10-data-points?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup) are a reasonable starting set.
...
For a broader look at how identification connects to the rest of the cycle, our video on [identifying, engaging, asking, and stewarding](https://www.youtube.com/watch?v=e7jlCPXSO3U) covers the full arc, and you can explore [major gift management in DonorDock](https://www.donordock.com/solution/major-gifts?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup) if you want to see the pipeline side in practice.