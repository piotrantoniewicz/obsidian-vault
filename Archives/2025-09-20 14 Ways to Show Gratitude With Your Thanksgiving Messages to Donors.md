...
This Thanksgiving, our [CauseVox](https://www.causevox.com/) team has talked a lot about how important the end of the year is from a fundraising standpoint. After all, many nonprofits and charities raise upwards of 30% or more of their annual operating budget during these few short months.
...
Your donors are the lifeblood of your organization. You know that you wouldn’t have the impact that you do without them and so do they. So, this Thanksgiving, aside from finalizing your [GivingTuesday](https://www.causevox.com/blog/giving-tuesday-ideas-best-practices/) plans and preparing your year-end fundraisers, spend some time crafting messages thanking the people who mean the most to your organization.
...
![thank-donors-call](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNjAwIDQxNCIgd2lkdGg9IjYwMCIgaGVpZ2h0PSI0MTQiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)

thank-donors-call

Your [Board of Directors](https://www.causevox.com/blog/nonprofit-board-donor-relations/) isn’t just a governing body, they’re also your biggest supporters and most eager volunteers. As Thanksgiving nears, provide your board members with a list of donors you’d like them to reach out to for a quick yet sincere “thank you.”
...
![thank-donors-clients](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNjAwIDQzOSIgd2lkdGg9IjYwMCIgaGVpZ2h0PSI0MzkiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)
...
![thank-donors-handwritten-note](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNjAwIDQxNCIgd2lkdGg9IjYwMCIgaGVpZ2h0PSI0MTQiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)

thank-donors-handwritten-note

Don’t wait until your annual report to start sharing the good news about [the impact](https://www.causevox.com/blog/show-donors-impact/) made with your donor’s dollars. This Thanksgiving, let your donor know exactly how they’ve contributed to the “bigger picture.”
...
![thank-donors-thanksgiving](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNjAwIDQxNSIgd2lkdGg9IjYwMCIgaGVpZ2h0PSI0MTUiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)

thank-donors-thanksgiving

Simple “Thank You” cards can be the best Thanksgiving messages to donors. Think about it: when was the last time you sent out a card to your donors that simply said: “thank you”? If it’s been a while, then Thanksgiving is the perfect time to let your donors know how much you appreciate them in this easy, yet personal way (if you’re using [CauseVox’s fundraising tools](https://www.causevox.com/), you’ll be able to customize an auto-thank you receipt and message to go out to all donors immediately).
...
![thank-donors-partner](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNjAwIDQwOSIgd2lkdGg9IjYwMCIgaGVpZ2h0PSI0MDkiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)
...
If you want to thank groups of donors at a time, consider highlighting them using Facebook or Instagram stories. You can use [Canva](https://www.canva.com/instagram-stories/templates/) to create free and customizable Instagram story templates that you can download and schedule out ahead of time. Or, if you collect your donors’ social media handles, you can tag them in a post.
...
![donor-thank-you-gift-thanksgiving-messages-to-donors](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNjAwIDQ1MCIgd2lkdGg9IjYwMCIgaGVpZ2h0PSI0NTAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)
...
![video-for-donors-thanksgiving-messages-to-donors](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNjAwIDQxMSIgd2lkdGg9IjYwMCIgaGVpZ2h0PSI0MTEiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)

video-for-donors-thanksgiving-messages-to-donors

There’s power in visual storytelling and crafting a [heartfelt thank you video](https://www.causevox.com/blog/10-powerful-nonprofit-videos-to-inspire-you/) can relay your appreciation in ways that written words or a phone call can’t. You don’t need a full production – in fact, a smartphone and good lighting can do the trick. We recommend keeping your thank you video short, sweet, and to the point (1-3 minutes should be sufficient).
...
![thank-donors-tour-thanksgiving-messages-to-donors](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNjAwIDQzNiIgd2lkdGg9IjYwMCIgaGVpZ2h0PSI0MzYiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)
...
![thank-donors-award-thanksgiving-messages-to-donors](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNjAwIDQxMCIgd2lkdGg9IjYwMCIgaGVpZ2h0PSI0MTAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)
...
![thank-donors-party-thanksgiving-messages-to-donors](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNjAwIDQwOSIgd2lkdGg9IjYwMCIgaGVpZ2h0PSI0MDkiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)
...
![donor-appreciation-wall-thanksgiving-messages-to-donors](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNjAwIDI5MCIgd2lkdGg9IjYwMCIgaGVpZ2h0PSIyOTAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)
...
![donor-welcome-kit-thanksgiving-messages-to-donors](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNjAwIDQxNCIgd2lkdGg9IjYwMCIgaGVpZ2h0PSI0MTQiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)
...
![thank-donors-surprise-thanksgiving-messages-to-donors](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNjAwIDQxNCIgd2lkdGg9IjYwMCIgaGVpZ2h0PSI0MTQiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)

thank-donors-surprise-thanksgiving-messages-to-donors

I always go back to [Watsi](https://www.causevox.com/blog/fundraising-email-strategy/) when it comes to rockstar “thank you” examples because they do it right. Out of the blue, Watsi mailed their recurring donors a printed book of beautiful photographs from the field.
...
- Compile and mail out your own photo book using a service such as [Social Print Studio](https://www.socialprintstudio.com/)
