...
type: "Web"
authors: "[[Rob Burke]]"
url: "https://www.donordock.com/articles/how-to-ask-donors-how-they-want-to-be-thanked?utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup&utm_medium=email&_hsenc=p2ANqtz--u0NInW_42ujvoWbRsusYPgHJT_XjyzMv819cXW1ArpLC3QZ97IFRbwsZf4VrStPjruLEfrezjlDr2ea7_77ObrkYGnjl-A-LBNPhVS_49tobBLVI&_hsmi=427084810&utm_content=427084810&utm_source=hs_email"
...
The point is contact that has nothing to do with fundraising. [As Patrick put it](https://youtu.be/ySJ1lvPHW_Q), you are one human connecting with another, and if your organization happens to be part of that connection, you are well on your way to being a great fundraiser.

## What should you track in your CRM to make this work?

A preference is only useful if you can find it again. Treat your CRM as a relationship tool, not a data lake, and capture a handful of fields for every committed donor. In [DonorDock](https://www.donordock.com/features-overview?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup) you can store all of this on the donor's record using [custom fields](https://www.donordock.com/features/custom-fields?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup) and notes, so it travels with the donor and is not trapped in one person's memory.

1. **Last meaningful contact.** The date and a one-line summary of the last real conversation, not just the last automated receipt.
2. **Thank-you preference.** Exactly how they told you they like to be appreciated.
3. **Communication preference.** Call, text, email, or mail, so you reach them where they actually pay attention.
4. **Giving rhythm.** Flag donors who give more than once a season. Repeat giving is a signal you are doing something right and a cue to deepen, not relax.
5. **One thing that has nothing to do with money.** A genuine, specific detail about the person. Patrick's mentor told him you never ask for a major gift until you know the name of the donor's dog. Capture the dog's name.
...
1. **Pick your top 25.** Start with your most committed or highest-capacity donors. A focused list you actually work beats a giant list you ignore.
2. **Commit to four touches a year, per donor.** Once a quarter, reach out with a thank-you, an update, or a personal note. None of them are asks.
3. **Match the touch to their preference.** Use the fields you logged so each contact lands the way that donor likes.
4. **Put it on a calendar and set reminders.** Use DonorDock's [Action Board](https://www.donordock.com/project-management?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup) to turn each planned touch into a dated task so it does not slip. The system holds the schedule so you do not have to.
5. **Log every touch as you go.** Update the last-contact field immediately. Next quarter, you will know exactly where you left off.

Twenty-five donors, four light touches a year, is one hundred meaningful contacts. It is completely doable even when you are wearing every hat in the building, and it is the kind of consistent care that quietly drives [retention and keeps donors from lapsing](https://www.donordock.com/articles/lapsed-donor-re-engagement-playbook?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup) in the first place.
...
1. Pull your list of donors who have given more than once. These are your warmest relationships.
2. Pick five. Add the thank-you and communication preference fields to their records now, even if blank.
3. Call one of them today, with no ask, just to say thank you and share one impact. Ask how they like to be thanked.
4. Write the answer in your CRM the moment you hang up, plus one personal detail you learned.
5. Schedule the next touch as a task in your CRM so the relationship has a next step, not a dead end.

Pick up the phone. Let the CRM do the back-end work of finding the number, surfacing the notes, and reminding you who is due, so you are free to just have a good conversation. If you want a system that can do this for you, [consider DonorDock which has all of this built into one place](https://www.donordock.com/features-overview?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup). The relationship is the work. Everything else is just support for it.