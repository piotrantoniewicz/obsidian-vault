...
Sep 24, 2025 at 12:44am EDT

![Computer programmer explaining adhesive note while giving presentation to colleagues in office](https://imageio.forbes.com/specials-images/imageserve/68c0d23a9dbe086a1241648b/Computer-programmer-explaining-adhesive-note-while-giving-presentation-to-colleagues/0x0.jpg?width=960&dpr=1)

Computer programmer explaining adhesive note while giving presentation to colleagues in office
...
<video aria-label="Connatix video player" role="application" title=""><source type="video/mp4" src="blob:https://www.forbes.com/eeb93b03-0a81-4f11-b261-6276f8975aff"></video>
...
If you ask AI to undertake a persona of someone for whom there was sparse data training at the setup stage, the persona is likely to be limited and unconvincing. You can augment the AI by providing additional data about the person, using an approach such as RAG (retrieval-augmented generation, see my discussion at [the link here](https://www.forbes.com/sites/lanceeliot/2025/01/27/heres-how-big-llms-teach-smaller-ai-models-via-leveraging-knowledge-distillation/)).

Personas are quick and easy to invoke. You just tell the AI to pretend to be this or that person. If you want to invoke a type of person, you will need to specify sufficient characteristics so that the AI will get the drift of what you intend. For prompting strategies on invoking AI personas, see my suggested steps at [the link here](https://www.forbes.com/sites/lanceeliot/2025/01/24/prompting-with-ai-personas-gets-streamlined-via-advent-of-million-and-billion-personas-sized-datasets/).

Invoking a type of person via an AI persona can be quite handy.

For example, I am a strident advocate of training therapists and mental health professionals via the use of AI personas (see my coverage on this useful approach, at [the link here](https://www.forbes.com/sites/lanceeliot/2025/07/18/orchestrating-mental-health-advice-via-multiple-ai-based-personas-diagnosing-human-psychological-disorders/)). Things go like this. A budding therapist might not yet be comfortable dealing with someone who has delusions. The therapist could practice on a person pretending to have delusions, though this is likely costly and logistically complicated to arrange.
...
Even then, there is still a solid chance that one thing or another will tilt the AI in that direction. There is no free lunch when it comes to making use of AI personas. That’s why it is important to have a range of AI safeguards when implementing an LLM-based app. See my discussion at [the link here](https://www.forbes.com/sites/lanceeliot/2025/09/08/utah-enacts-law-to-regulate-use-of-ai-for-mental-health-providing-deftness-and-is-less-onerous-than-other-similar-laws/).
