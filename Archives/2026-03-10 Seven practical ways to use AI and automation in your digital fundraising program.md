...
- **Automation** means setting up automatic steps inside the tools you use, like [your CRM](https://www.centerfordigitalaction.eu/toolbox/digital-organizing-basics/glossary), email, or text messaging platforms. Instead of doing tasks manually each time, you create a sequence that runs on its own.
...
If you already have [fundraising emails](https://www.centerfordigitalaction.eu/toolbox/technology/an-email-tutorial) that performed well, start there. Sort by best performing and upload those examples into your AI tool for context. If you’re just getting started, you can look at examples on sites like [politicalemails.org](http://politicalemails.org/) and tell the AI what you like about them. From there, outline your idea and use AI to help refine it.
...
[Digital fundraising](https://www.centerfordigitalaction.eu/fundraising-checklist) is often most effective during key moments in the news cycle.
...
1. Upload past campaign metrics and the creative brief.
2. Ask AI to identify performance patterns.
3. Work with AI to generate new [A/B test ideas](https://www.centerfordigitalaction.eu/toolbox/digital-organizing-basics/glossary).
4. Prioritize tests based on likely impact.
5. Run the tests in your email platform.
6. Feed results back in for analysis.
...
Automation tools inside our CRM, like Action Network’s [Ladders](https://help.actionnetwork.org/hc/en-us/sections/115000771483-Ladders), or no code tools like [n8n](https://n8n.io/) that connect multiple tools, allow us to design specific parts of the experience so that everyone gets what they need based on their behavior.
...
[*Jordan Harp*](https://www.notion.so/Scaling-impact-for-the-progressive-movement-2a088d0bf94480e092a1e2de36fccf02) *is Founder and Principal Consultant at Shift Cooperative, where he works with progressive organizations to scale their impact. He previously held digital roles at Harris Walz, the Green Party of England and Wales, the DCCC, and Obama White House. He works on product discovery & delivery, digital programs & strategy, and emerging AI & workflow automation.*
