...
As a consequence of being the year of COVID-19, 2020 has become the year of media consumption, especially during the spring lockdown. Yet while the massive consumption spikes we saw earlier this year have since dissipated, podcast engagement remains on track to post another record year, which is something all marketers should be tapped into.

The engagement with podcasts is both a testament to the medium and proof that the medium is not reliant on the workday commute to thrive. September 2020 [research from eMarketer](https://www.emarketer.com/content/us-digital-audio-ad-spending-2020) notes that more than 106 million Americans will be listening to podcasts by the end of the year, which represents annual growth of more than 16%. What’s more, the ad dollars have followed, with the [IAB forecasting](https://www.iab.com/wp-content/uploads/2020/07/Full-Year-2019-IAB-Podcast-Ad-Rev-Study_v20200710-FINAL-IAB_v2.pdf) U.S. podcast ad spend growth of just under 15%, pushing total spend to roughly $1 billion.
...
Aside from the fact that podcast ads drive significant brand lift, the podcast landscape is additionally lucrative because of its growth trajectory. Data from Nielsen’s [Podcast Buying Power service](https://www.nielsen.com/us/en/press-releases/2019/nielsen-launches-podcast-listener-buying-power-service-with-iheartmedia-cadence13-midroll-westwood-one-and-cabana-as-charter-clients/) shows that the U.S. podcast listener base has been growing at a 20% CAGR since 2014, and is projected to double by 2023. And even more importantly, adults 25-44 (a key buying demo) are driving much of that growth. Nearly 30% of adults 25-34, for example, listen to podcasts.

Podcast engagement in the audio space stands out much like [streaming stands out](https://www.nielsen.com/us/en/insights/article/2020/how-streaming-enablement-in-2020-has-changed-the-media-landscape/) in the video space, providing an ever-expanding array of options while growing the amount of time consumers spend each day with media. The big difference in the podcast space is the engagement with advertising.
