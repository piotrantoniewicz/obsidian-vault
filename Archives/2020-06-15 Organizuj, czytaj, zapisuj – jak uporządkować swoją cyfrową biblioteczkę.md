...
url: >-
  https://sektor3-0.pl/blog/organizuj-czytaj-zapisuj-jak-uporzadkowac-swoja-cyfrowa-biblioteczke/
...
![biblioteka[1]](https://sektor3-0.pl/wp-content/uploads/elementor/thumbs/biblioteka1-osg4p5al0k4duw7mwhbgfu8t6dir0g6l8vevnt50ty.jpg "biblioteka[1]")
...
Według dorocznych [badań Biblioteki Narodowej](https://www.bn.org.pl/w-bibliotece/3966-39%25---lekki-wzrost-czytelnictwa-w-polsce.html) czytamy coraz mniej książek (choć w 2020 coś drgnęło w drugą stronę zapewne dzięki nagrodzie Nobla dla Olgi Tokarczuk). Wielu badaczy i badaczek twierdzi, jednak, że niekoniecznie musi oznaczać to spadek kondycji czytelnictwa. To za sprawą sieci bardzo się zmienia. Scrollujemy, czytamy na telefonach, otwieramy dziesiątki zakładek z artykułami, których fragment widzimy najpierw na Facebooku, a kończymy (jeśli o nich nie zapomnimy) kilka godzin później, często na innym urządzeniu. Podobnie jak badanie czytelnictwa wydaje się trudnym zadaniem, tak samo organizacja treści z sieci, które chcielibyśmy poznać i mieć uporządkowane jak fizyczne biblioteczki w naszych domach. Jak więc w czasach przechowywania wszystkiego w chmurze wiedzieć co i jak chce przeczytać, zapisać na później, zapamiętać?

## Zakładki 2.0

Choć każda przeglądarka internetowa daje możliwość tworzenia zakładek do stron internetowych, to niestety im więcej treści przyswajamy z pomocą aplikacji mobilnych, a strony mediów społecznościowych takich jak Facebook dynamicznie się zmieniają, tym jest trudniej „zapisać stronę”. Jeśli korzystasz z tej samej przeglądarki na komputerze i smartfonie, to jest to łatwiejsze. Założenie konta w Google (przeglądarka chrome) lub konta Mozilla (przeglądarka Firefox) pozwala nie tylko zapisywać strony, ale również synchronizować je między urządzeniami. Firefox dodatkowo posiada takie drobne ułatwienia jak „wyślij kartę” czyli przesłanie strony na inne urządzenie czy wbudowane narzędzie do przesyłania bezpiecznie dużych plików (Firefox Send). Chrome od Google niedawno [wprowadził zaś możliwość łatwego grupowania zakładek](https://blog.google/products/chrome/manage-tabs-with-google-chrome), nadawania grupom nazw i kolorów dla łatwiejszej wizualnej nawigacji.

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201000%20550'%3E%3C/svg%3E)

Źródło: blog.google/products/chrome/manage-tabs-with-google-chrome/

Podstawowe grupowanie zakładek w obu przeglądarkach robimy za pomocą folderów. Jeśli to dla ciebie za mało, bo np. piszesz dużo tekstów opartych o risercz ze stron WWW, możesz przetestować przeglądarkę [Vivaldi](https://vivaldi.com/), która pozwala wyświetlać dwie strony WWW obok siebie, a grupowanie zakładek ma wiele dodatkowych narzędzi takich jak grupowanie otwartych karty i zbiorcze dodawanie ich do zakładek lub zapisywanie sesji otwartych stron WWW do późniejszego odtworzenia, lub łatwiejszego odtwarzania historii. Jeśli wolisz zarządzać zakładkami za pomocą dodatków do dowolnej przeglądarki możesz wypróbować raindrop.io lub gettoby.com. Oba serwisy służą nie tylko zbieraniu linków (multimediów, dokumentów etc.), ale również inteligentnie podpowiadają jak najlepiej je porządkować.

![Grupowanie kart w jedną sesję lub dodawanie ich do zakładek w przeglądarce Vivaldi](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201024%20526'%3E%3C/svg%3E)

Grupowanie kart w jedną sesję lub dodawanie ich do zakładek w przeglądarce Vivaldi
...
![czytanie firefox](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201024%20530'%3E%3C/svg%3E)

Tryb poprawienia czytelności z funkcją przetwarzania tekstu na mowę w przeglądarce Mozilla Firefox
...
- [Jak efektywnie uczyć się w sieci?](https://sektor3-0.pl/blog/jak-efektywnie-uczyc-sie-w-sieci/)
- [Kiedy zaczniemy się uczyć i przestaniemy „wykonywać zawody”?](https://sektor3-0.pl/blog/kiedy-zaczniemy-sie-uczyc-i-przestaniemy-wykonywac-zawody/)
- [Nieoczywiste źródła wiedzy w sieci](https://sektor3-0.pl/blog/nieoczywiste-zrodla-wiedzy-w-sieci/)
- [Zrozumieć sztuczną inteligencję. Co warto wiedzieć o jej aktualnych możliwościach i gdzie się o niej uczyć?](https://sektor3-0.pl/blog/zrozumiec-sztuczna-inteligencje-co-warto-wiedziec-o-jej-aktualnych-mozliwosciach-i-gdzie-sie-o-niej-uczyc/)
- [Do czego w edukacji przydają się dane?](https://sektor3-0.pl/blog/do-czego-w-edukacji-przydaja-sie-dane/)
- [Zdalnie ale nie samotnie – nauka w czasie epidemii](https://sektor3-0.pl/blog/zdalnie-ale-nie-samotnie-nauka-w-czasie-epidemii/)
