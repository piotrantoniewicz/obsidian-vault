...
sources:
  ...
  - "[[2000-07-24 The new rules of context engineering for Claude 5 generation models]]"
---
...
**8. Context layer organizacji — „boil the ocean" zamiast kuracji ([[Andrea Jones-Rooy]])** *(pojęcie wydzielone: [[2026-07-06 Context layer organizacji|Context layer organizacji]])*
...
- [[2026-06-14 RAG|RAG]] — szczególny, retrieval-owy przypadek context engineeringu: dostarczenie do okna świeżo pobranych, zaufanych fragmentów. RAG odpowiada na pytanie „skąd wziąć właściwy kontekst?", context engineering — na szersze „jak ułożyć *całe* okno?".
- [[2026-06-13 Wdrażanie AI w organizacji społecznej|Wdrażanie AI w organizacji społecznej]] — context engineering operacjonalizuje regułę „garbage in, garbage out": większość „złych wyników AI" to brak kontekstu, nie wada modelu. SCOPE to konkretna ścieżka wdrożeniowa filaru gotowości danych.
- [[2026-06-14 Storytelling oparty na danych|Storytelling oparty na danych]] — „ton marki" i „głos organizacji" jako warstwy kontekstu: zasilenie modelu próbkami stylu i danymi to warunek outputu gotowego do publikacji, nie generycznego.
- [[2026-06-15 Prompt engineering|Prompt engineering]] — węższy poprzednik (pisanie samej instrukcji); context engineering go obejmuje i przesuwa punkt ciężkości z treści promptu na cały stan tokenów.
- [[2026-07-06 Evale|Evale]] — częściowa odpowiedź na pytanie o pomiar jakości kontekstu: kontekstu nie mierzy się wprost, mierzy się evalem jego efekt na output.
- [[2026-07-06 Context layer organizacji|Context layer organizacji]] — makro-warstwa wydzielona z mechanizmu 8: trwała, odpytywalna baza wiedzy organizacji, z której okno czerpie przez retrieval; okno = mikro (minimalizm), warstwa = makro (fosa).
...
- **SCOPE jako usługa wdrożeniowa**: gotowy, wdrażalny przewodnik dla klienta z sektora społecznego — start od 3 najczęściej tworzonych treści (propozycje grantowe, newslettery, raporty), zbudowanie dla nich bazy kontekstu, pomiar oszczędności czasu. Mała organizacja może zacząć od 3 dokumentów.
...
- W jakim stopniu polskie organizacje społeczne są w stanie samodzielnie utrzymać bazę kontekstu (SCOPE wymaga dyscypliny porządkowania danych) bez stałego wsparcia konsultanta — czy to kompetencja do przekazania, czy usługa cykliczna?
