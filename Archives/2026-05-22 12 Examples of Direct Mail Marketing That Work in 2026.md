...
> **Need a quote on a campaign like one of these?** [Contact Mail Processing Associates](https://www.mailpro.org/contact/) and tell us the example you want to model. We will reply with a per-piece price, a turnaround estimate, and the postal class that fits.
...
List is the biggest lever in any examples of direct mail marketing you will read about. Direct mail to a house list delivers a 9% average response rate for B2C house lists (ANA). Mail to a cold prospect list drops to 5% average response rate for B2C prospect lists (ANA). The audience matters more than the artwork.
...
Postage is the third lever and the one most outside campaign teams ignore. EDDM at 25.9 cents per piece BMEU is a different campaign from First Class at 56 cents per piece, even if the artwork is identical. The postal class is part of the strategy, not an afterthought.
...
[Every Door Direct Mail (EDDM)](https://www.mailpro.org/post/every-door-direct-mail-eddm/) blankets every address on chosen USPS carrier routes. No mailing list. No personalization. You pay the postal rate of 25.9 cents per piece BMEU plus print, and the postcard lands in every mailbox on the routes you select.
...
Targeted postcards run at the Marketing Mail postcard rate of 36 cents per piece (nonprofit rates run lower where eligible). Print cost is roughly the same as EDDM. The list cost is added, usually 5 to 12 cents per record depending on selects. The math: you pay more per piece, but the list is qualified, so the response rate climbs.
...
Nonprofit Marketing Mail letter postage is $0.257 per piece at the Mixed tier. NCOA and CASS processing typically validates approximately 94% of house-file records as deliverable. Deliverability after NCOA hits 98.5% deliverability after NCOA hygiene. For a 50,000-piece appeal at a 9% house-list response rate, the ROI math gets serious.
...
EDDM at 25.9 cents BMEU per piece makes the saturation version of this campaign work for almost any local service business with a defined geographic catchment. Print cost on a 6x9 full-color two-sided postcard ranges from roughly 6 to 11 cents at production volume, so all-in delivered cost lands at roughly 31 to 36 cents per door.
...
For deeper dives on industry-specific direct mail, see [healthcare direct mail](https://www.mailpro.org/industries/healthcare/), [nonprofit direct mail](https://www.mailpro.org/industries/nonprofits/), and [political direct mail](https://www.mailpro.org/industries/political/).
...
| --- | --- | --- | --- |
| EDDM 6x9 postcard | $0.06 to $0.11 | $0.259 (BMEU) | 1% to 3% |
...
| Healthcare HIPAA mailer | $0.22 to $0.48 | $0.467 or $0.65 | 3% to 8% |
| Real estate "Just Sold" postcard | $0.07 to $0.13 | $0.36 | 0.5% to 2% |
| Insurance open enrollment letter | $0.25 to $0.55 | $0.467 | 2% to 6% |
| Political mailer | $0.10 to $0.45 | $0.36 to $0.65 | n/a (votes, not responses) |
| Retail coupon postcard | $0.07 to $0.13 | $0.259 or $0.36 | 1% to 5% |
...
If you are looking at one of the campaign examples above and trying to model the math for your own audience, [schedule a call with our direct mail team](https://www.mailpro.org/schedule/). We will walk through the list strategy, the format choice, the postal class, and the per-piece economics before anything gets quoted.
...
[Get a quote on a campaign like one of these](https://www.mailpro.org/contact/) | [Schedule a direct mail strategy call](https://www.mailpro.org/schedule/) | [Learn more about MPA direct mail services](https://www.mailpro.org/services/direct-mail/)
