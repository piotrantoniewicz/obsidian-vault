...
url: "https://weareastral.co.uk/thevault/10-things-i-stopped-doing-with-email-that-most-marketers-still-do?utm_medium=email&_hsenc=p2ANqtz-_MdzuXDbKZB6GzeGrX7sc94ucnMTI5oQgkM4zTAohO9bgk964abO6jtIoBEXPxqY-47sKLTtVa29iDGFnm9zm3OWBseliDqXiFz3PsLLDPHypA-4g&_hsmi=138619692&utm_content=138604867&utm_source=hs_email"
...
## 1\. Reporting on open rates as a performance metric
...
- Assess cognitive load (is this too hard to find the point of?)
- Triage (does this fit my current mode and priority?)
- Predictive coding (does this match what I expect from this sender?)
- Check emotional association (how do I feel about this sender based on history?)
- Test for pattern interruption (is anything here unexpected enough to spike my attention?).
...
[Email is an impact channel](https://weareastral.co.uk/thevault/email-is-an-awareness-channel.-heres-the-psychology-behind-why-and-how-to-measure-it), not a performance channel. The difference matters enormously, for how you build the programme, how you report on it, and how you defend its commercial value to stakeholders who want to see the number from the last send.
