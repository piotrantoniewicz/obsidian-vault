...
Because at its core, [philanthropy](https://bloomerang.com/blog/people-want-to-belong-to-your-nonprofits-community/) isn’t about transactions. It’s about connection, meaning, and the moment someone realizes they can make a real difference. And when that happens — when people feel inspired and useful — the money follows.
...
It’s a reasonable question, but it’s putting the cart before the horse. The most important question is this: [Why hold a fundraising event?](https://bloomerang.com/blog/should-your-nonprofit-do-an-event/)
...
First, ask yourself: [What are our priorities right now?](https://www.nonprofitpro.com/post/prioritize-these-4-high-yield-individual-giving-strategies-to-address-threats-to-your-nonprofit/) Creating awareness? Building community? Raising project-specific money? Retaining or upgrading major donors? Given limited resources, you may want to [consider whether other strategies fulfill those priorities more effectively](https://clairification.com/2022/04/18/common-sense-nonprofit-event-planning-advice/) and yield a bigger bang for your buck. At the very least, you’ll want to make sure your priority objectives are integrally woven into your event strategy.

\[Find a framework for evaluating different strategies against each other [here](https://bloomerang.com/blog/should-your-nonprofit-do-an-event/).\]
...
When you design your event with your particular vision and constituents in mind, you don’t have to push nearly as hard for the gift. [People want to give.](https://bloomerang.com/blog/why-donors-give-the-deep-human-need-to-matter/)
...
The goal isn’t just to host an event to check it off your to-do list. It’s to create [“WOW” experiences](https://bloomerang.com/blog/wow-special-event-moments-to-convert-guests-to-loyal-donors/) — moments people will remember, and want to be part of again.
...
When you get people fired up, that’s how you’ll raise more money — beyond just ticket sales — because [you’ve tapped into donor passions and made them feel they matter](https://www.nonprofitpro.com/post/say-it-simply-so-donors-feel-it-deeply/).
...
[Every effective fundraising event needs a clear and intentional pathway from inspiration to action.](https://bloomerang.com/webinar/ask-the-experts-maximizing-event-revenue/)
...
**[Start with a story that feels real.](https://bloomerang.com/blog/ask-an-expert-how-to-tell-a-compelling-fundraising-story/)** This might be a client or beneficiary (live or on video), an admired staff member sharing a specific moment, or an inspired donor explaining why they got involved. What matters is authenticity and specificity. One real story will do more than a broad overview ever could.
...
**Make a clear, confident ask.** Someone needs to say, plainly: here’s [the need](https://bloomerang.com/blog/how-to-include-relevancy-and-urgency-in-your-fundraising-appeal/), and here’s what we’re asking you to do.

Once your core giving moment is established, you can [layer in giving opportunities](https://www.qgiv.com/blog/how-to-engage-non-bidders-at-your-next-silent-auction-event/):
...
[In reality, some of the most successful events generate a significant portion of their support before anyone walks in the room.](https://bloomerang.com/blog/how-to-communicate-w-your-event-attendees-before-your-event/)

[**Sponsorships**](https://bloomerang.com/blog/ask-an-expert-how-to-approach-sponsorship-giving-levels/) are a top winning strategy — often the difference between an event that loses money or breaks even, and one that generates real net revenue.
...
[**Table hosts**](https://bloomerang.com/blog/special-event-follow-up-to-convert-guests-to-loyal-donors/), who commit to filling and supporting a table, are a way to both fill the room and your coffers. Ask key donors to buy tables and [challenge](https://doublethedonation.com/challenge-gifts/) their friends and colleagues to match their giving. This plays on the psychological principle of influence known as “ [social proof](https://clairification.com/2022/07/28/what-monkeys-can-teach-your-nonprofit/#:~:text=July%2028%2C%202022%20Leave%20a,be%20incredibly%20useful%20to%20fundraisers.).”

[**Peer-to-peer fundraising events**](https://bloomerang.com/blog/peer-to-peer-fundraising/), like walks or runs, are a great example of raising money before the event starts. Participants reach out to their networks in advance, expanding your reach and building momentum before the event even takes place.
...
After the event is when relationships — and trust — are truly built and cemented. [And trust is the foundation of all sustainable fundraising.](https://clairification.com/2025/02/13/people-want-to-know-if-they-can-trust-your-nonprofit-and-you/)
...
- Creating [meaningful experiences](https://bloomerang.com/blog/deeper-meaning-equals-deeper-gifts/)
- Connecting people to [purpose](https://bloomerang.com/blog/why-donors-give-the-deep-human-need-to-matter/)
- Inviting them to [belong to something](https://bloomerang.com/blog/people-want-to-belong-to-your-nonprofits-community/) larger than themselves
...
If you’re looking for tools to help you plan, promote, and follow up on your fundraising events more effectively, [Bloomerang offers solutions designed to support the entire donor journey](https://bloomerang.com/features/event-management/) — so you can focus on creating experiences that truly inspire giving.
