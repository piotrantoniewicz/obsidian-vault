...
## The first thing to understand: most people don't unsubscribe - they just ignore you
...
For unsubscribing, [predictive coding](https://weareastral.co.uk/thevault/the-psychology-of-email-design-how-humans-actually-behave-in-the-inbox) plays a specific role: once the brain has decided "this sender isn't worth my time", the threshold for action lowers. The tolerance reduces. The trigger event doesn't need to be dramatic — it just needs to be one more confirmation of what the brain already knew.  
...
## How to know if your unsubscribe rate is actually a problem
...
### The pattern diagnostic: when the rate creeps up over time
...
- [List Churn Is Normal](https://weareastral.co.uk/thevault/list-churn-is-normal-heres-how-to-measure-it-manage-it-and-stop-panicking-about-it)
- [Preference Centres Are Dead](https://weareastral.co.uk/thevault/preference-centres-are-dead-and-its-time-we-stop-pretending-they-work)
