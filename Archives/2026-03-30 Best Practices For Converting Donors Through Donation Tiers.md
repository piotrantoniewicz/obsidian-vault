...
Your [donation](https://www.causevox.com/donation-page/) form should be helping you get more donors, whether it’s on your website, or on your [crowdfunding](https://www.causevox.com/crowdfunding/) page, or your [peer-to-peer fundraising](https://www.causevox.com/peer-to-peer-fundraising-software/) campaign.

To make sure you’re getting as many donors as possible, your focus should be on increasing your donation form conversion rate, which is the percentage of people who actually [complete a donation once they’ve landed on your site](https://www.causevox.com/blog/raise-more-through-your-website/). How easy it is to give makes a big difference: if your donation form is too long, too confusing, or not mobile-friendly, many potential donors will navigate away.

However, when your donation form makes it as easy as possible to give, you can actually raise up to 2x as much, without any additional asks. For example, CauseVox users typically raise 82% more when they switch from a generic donation form, to a [custom one](https://www.causevox.com/donation-forms/) helping organizations raise nearly 2x as much through their website.

A significant part of driving conversions on your donation form has to do with your suggested levels of giving, aka your [donation tiers](https://www.causevox.com/blog/best-practices-for-converting-donors-through-donation-tiers/). The average gift sizes on CauseVox generally range between $78 and $109, with higher averages often driven by the use of [impact-driven donation tiers](https://www.causevox.com/blog/donation-tiers/) and [peer-to-peer campaigns](https://www.causevox.com/blog/peer-to-peer-fundraising/).

[Optimizing your conversion rate and average gift size](https://www.causevox.com/blog/6-donation-page-kpis-you-should-be-tracking/) isn’t just a nice-to-have. It’s the difference between your organization growing and your organization barely scraping by.
...
![descriptive-donation-tiers](https://causevox.com/nitropack_static/JFPqmTyVxWjeXYSyoyXguULdpBolhTvd/assets/images/optimized/rev-fae1511/www.causevox.com/wp-content/uploads/2020/05/recurring-donation-tiers-impact-driven.png)

descriptive-donation-tiers

*4 purposeful, impact driven donation tiers on a CauseVox campaign*

Especially if you know folks will be [giving on mobile](https://www.causevox.com/blog/mobile-wallets-and-nonprofit-fundraising/) (as we’ve seen 65% of them do), you want the form to be as short and simple as possible. One great option for mobile giving is to use CauseVox’s compact tiers.
...
Each nonprofit is different, and [any good donation page](https://www.causevox.com/blog/what-makes-a-good-donate-button/) is customized to your needs.
...
![simple-descriptive-donation-tiers](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMTIwMCA4NzkiIHdpZHRoPSIxMjAwIiBoZWlnaHQ9Ijg3OSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4=)
...
![impact-donation-tiers](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMTQ1NiAxMjkyIiB3aWR0aD0iMTQ1NiIgaGVpZ2h0PSIxMjkyIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)

impact-donation-tiers

*Summit Assistance Dogs uses impact-driven tiers*

![](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMTAyNCA3OTEiIHdpZHRoPSIxMDI0IiBoZWlnaHQ9Ijc5MSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4=)
...
When you pull the [average gift size](https://www.causevox.com/blog/convert-more-recurring-donors/), including the median gift size, you’ll have a great jumping off point to help you create your list of 3-6 customized tiers that fit your own audience.
...
To maximize [recurring giving](https://www.causevox.com/blog/the-complete-guide-to-recurring-donations/), you’ll want to create customized donation tiers that help drive more recurring gifts.
...
You can [segment out](https://www.causevox.com/blog/donor-segmentation-matters/) your recurring donor average/median gift amounts, and use recurring donation tiers to drive up recurring gifts too. With [CauseVox’s built-in CRM](https://www.causevox.com/crm/), you can take that a step further, filtering donors by giving history and frequency to send targeted upgrade asks to exactly the right people at the right time. Instead of blasting your whole list, you’re reaching out to your $25/month donors with a personalized nudge toward the $40 tier, making the ask feel thoughtful rather than transactional.

![](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMzUyIDQzOCIgd2lkdGg9IjM1MiIgaGVpZ2h0PSI0MzgiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)
...
![recurring-donation-tiers-causevox](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMTIwMCA5NDEiIHdpZHRoPSIxMjAwIiBoZWlnaHQ9Ijk0MSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4=)
...
The same set of donation tiers isn’t going to make sense everywhere. If you’re running a high-end [gala](https://www.causevox.com/use-case-seated-fundraising-events/) with your top donors, you’ll want a set of donation tiers that matches the depth of their pockets. If you’re running a school fundraiser with local parents, you want amounts that will feel accessible to everyone.

This might mean creating different pages or campaigns to be used in different settings. [Segment your donors based on the data](https://www.causevox.com/blog/donor-personas-how-to-identify-your-unique-donor-audience/) you have about them, and provide each segment with tiers that fit in their budget.

The same logic applies to [pledge campaigns](https://www.causevox.com/use-case-pledge-donations/), if you’re asking donors to commit to a gift over time, your tiers should reflect realistic installment amounts rather than a lump sum that feels out of reach. A donor who hesitates at a $5,000 ask might gladly commit to $500 a month over 10 months, so building [pledge-friendly tiers](https://www.causevox.com/blog/6-ways-to-use-pledge-now-pay-later-in-your-fundraising-campaigns/) into your campaign pages can open the door to major gift-level commitments without the sticker shock.

![](data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjQ0NiAxODgyIiB3aWR0aD0iMjQ0NiIgaGVpZ2h0PSIxODgyIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
CauseVox builds these design principles into our [donation form](https://www.causevox.com/donation-page/), helping you create tiers that match your needs.
...
Are you ready to raise more with less effort? [Schedule a demo today.](https://www.causevox.com/schedule-a-demo/)
