...
Our new report [*Building Power*](https://mobilisationlab.org/resources/buiding-power/), created in collaboration with [Intertidal Lab](https://intertidallab.org/), proposes that **civil society’s talent crisis is not accidental, it’s structural**. Short grant cycles, issue silos, weak shared infrastructure, missing mid-career pathways and a funding culture that rewards delivery over development.
...
Over the past four decades, **conservative and far-right actors have built dense, well-funded and vertically integrated talent ecosystems** that [identify people early](https://www.pbs.org/newshour/show/why-critics-are-alarmed-about-the-influence-of-pragerus-educational-videos), [shape their worldview](https://www.philanthropyroundtable.org/rebuilding-the-conservative-talent-pipeline-inside-the-david-network/), [train them](https://www.counterpunch.org/2021/01/28/the-leadership-institute-pr-school-for-right-wingers/), connect them, place them and keep them [circulating through institutions of power](https://www.washingtonpost.com/news/magazine/wp/2019/01/02/feature/conquerors-of-the-courts/). These pipelines do not begin when someone applies for a job. They begin with identity, belonging and narrative, then move through student organising, media training, leadership development, legal networks, policy shops and government placement.

The machinery is not subtle. It is not a loose collection of organisations. It is an ecosystem. We identified at least a dozen major conservative organisations in the US playing coordinated roles across recruitment, ideological formation, skills development, alumni networks and long-horizon placement. It is backed by stable, [deep-pocketed donors](https://youngmenresearchinitiative.substack.com/p/the-rights-12b-nonprofit-ecosystem) and institutions operating on 30 to 50 year horizons rather than election cycles.
...
**Unfortunately talent development in our sector is often treated as overhead**. Historically, [only around one percent of philanthropic grants have been designated for talent development](https://fundthepeople.org/toolkit/casemaking/less/). Most of what gets funded is tied to projects, which means it disappears when the project ends.
...
The consequences are visible everywhere. Entry-level activists may get fellowships. Senior leaders get executive programmes. But practitioners in the middle, those with three to 10 years of experience who are ready to step into strategic leadership, get almost nothing. Bridgespan reports that [only 30 percent of senior nonprofit roles are filled through internal promotion](https://www.bridgespan.org/insights/building-leadership-capacity), roughly half the rate of the private sector.
...
**Our report** [***Building Power***](https://mobilisationlab.org/resources/buiding-power/) **shares insights and recommendations for developing a talent ecosystem for progressive social change and a framework for action.** We hope it starts conversations that become strategies, and strategies that build power now and for the future.
...
Building Power: Insights and recommendations from a benchmarking study of developing talent for progressive social change →

[https://mobilisationlab.org/resources/buiding-power/](https://mobilisationlab.org/resources/buiding-power/)
