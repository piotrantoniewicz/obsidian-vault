...
type: "Web"
authors: "[[Rob Burke]]"
url: "https://www.donordock.com/articles/why-fundraisers-burn-out-organizational-structure?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup"
...
This is also why retention metrics across the sector keep sliding. When the people responsible for donor relationships are in survival mode, donors feel it. We have written before about how growing nonprofits move [from napkins to systems](https://www.donordock.com/articles/from-napkins-to-systems-why-growing-nonprofits-need-better-fundraising-infrastructure?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup), and the throughline is the same: infrastructure is not a luxury you add after growth. It is what makes growth survivable.
...
Saying yes to every event, every donor request, and every special project does not expand your impact. It dilutes what you can actually accomplish. The question is not “how do we get more capacity to do all of this?” It is “what structure would let us do the few things that matter, well?” That is the difference between doing more and focusing on what matters most, and it is a theme we keep coming back to in our work on [fundraising without simply doing more](https://www.donordock.com/articles/fundraising-is-an-and-game-but-that-doesnt-mean-doing-more?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup).
...
From there, the same move repeats. Every recurring scramble is a structure waiting to be written down. This is also how you protect your people, because the goal of all of this is not tidier org charts. It is keeping talented, mission-driven fundraisers long enough to do the work they came to do. For more on building that kind of durable, relationship-centered practice, explore our perspective on [fundraising strategy](https://www.donordock.com/fundraising-strategy?utm_medium=email&utm_source=hs_email&utm_campaign=19809586-Email%20Series%20-%20Weekly%20Roundup) and how the right systems support it.
