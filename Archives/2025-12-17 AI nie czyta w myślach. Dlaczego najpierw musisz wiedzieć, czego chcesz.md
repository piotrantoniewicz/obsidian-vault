...
![Osoba pracująca przy biurku patrzy na ekran komputera z otwartym narzędziem AI do generowania treści. Na grafice umieszczono hasło „AI działa tak dobrze, jak dobre są Twoje wskazówki” oraz logo TechSoup Polska.](https://api.ngo.pl/media/get/270476?w=1200&h=800)

Osoba pracująca przy biurku patrzy na ekran komputera z otwartym narzędziem AI do generowania treści. Na grafice umieszczono hasło „AI działa tak dobrze, jak dobre są Twoje wskazówki” oraz logo TechSoup Polska.
...
1. Po co mi ta odpowiedź: Czy potrzebujesz skrótu, pomysłu, szkicu, wersji finalnej, inspiracji, porządku w notatkach? Bez tego AI będzie zgadywać, a Ty będziesz poprawiać.
2. Dla kogo to powstaje: Inaczej piszemy do grantodawcy, inaczej do darczyńców, inaczej do uczestników szkolenia. Jeśli tego nie doprecyzujesz, AI wybierze najbezpieczniejszy, najbardziej ogólny ton.
3. Na jakim etapie pracy jestem: Burza mózgów, brudny szkic, układanie struktury, dopieszczanie wersji końcowej – każde z tych zadań wymaga innego podejścia.
...
Jeśli praca z AI i formułowanie poleceń nadal nie jest dla Ciebie czymś oczywistym, to zupełnie naturalne. W ramach naszego kursu [„AI od podstaw. Pierwsze kroki z Microsoft Copilot dla NGO”](https://ai.techsoup.pl/kurs-1?utm_source=ngo_pl&utm_medium=artykul&utm_campaign=microsoft_ai_2025&utm_content=artykul_ai_nie_czyta_w_myslach) pokazujemy podstawy korzystania z AI, w tym promptowanie i świadome nadawanie AI roli w działaniach organizacji. Nie jako narzędziu, które „robi za Ciebie”, ale jako asystentowi, który pomaga porządkować myślenie, zadawać lepsze pytania i wspierać Cię na różnych etapach pracy, gdy to Ty podejmujesz decyzje.
...
W kursie **„** [AI od podstaw. Pierwsze kroki z Microsoft Copilot dla NGO](https://ai.techsoup.pl/kurs-1?utm_source=ngo_pl&utm_medium=artykul&utm_campaign=microsoft_ai_2025&utm_content=artykul_ai_nie_czyta_w_myslach) **”** uczymy właśnie takiego podejścia do AI. Pokazujemy, jak traktować je jak asystenta do myślenia, rozmowy i porządkowania pomysłów, a nie automatycznego wykonawcę zadań. To Ty nadajesz kierunek, cel i ramy, a AI pomaga w analizie, generowaniu opcji i zadawaniu pytań, które prowadzą do lepszych decyzji.
